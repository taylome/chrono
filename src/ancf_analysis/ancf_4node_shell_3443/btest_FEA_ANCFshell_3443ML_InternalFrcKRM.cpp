...
class ANCFShellTest {
  public:
    ANCFShellTest(unsigned int num_layers);
...
template <int num_elements, typename ElementVersion, typename MaterialVersion>
ANCFShellTest<num_elements, ElementVersion, MaterialVersion>::ANCFShellTest(unsigned int num_layers) {
...
#define NUM_ELEMENTS 1024
    ...
    for (unsigned int layers = 1; layers <= max_layers; layers *= 2) {
        ANCFShellTest<NUM_ELEMENTS, ChElementShellANCF_3443<4, 2>, ChMaterialShellANCF> ShellTest_TR01(layers);
        std::cout << "ChElementShellANCF_3443, " << layers << ", ";
    ...
    //}
    //for (unsigned int layers = 1; layers <= max_layers; layers *= 2) {
    //    ANCFShellTest<NUM_ELEMENTS, ChElementShellANCF_3443ML_TR02_GQ332, ChMaterialShellANCF_3443ML_TR02_GQ332> ShellTest_TR02_GQ332(layers);
    //    std::cout << "ChElementShellANCF_3443ML_TR02_GQ332, " << layers << ", ";
    //    ShellTest_TR02_GQ332.PrintTimingResults(num_steps);
    //}
    for (unsigned int layers = 1; layers <= max_layers; layers *= 2) {
        ANCFShellTest<NUM_ELEMENTS, ChElementShellANCF_3443ML_TR02_GQ442, ChMaterialShellANCF_3443ML_TR02_GQ442> ShellTest_TR02_GQ442(layers);
        std::cout << "ChElementShellANCF_3443ML_TR02_GQ442, " << layers << ", ";
        ShellTest_TR02_GQ442.PrintTimingResults(num_steps);
    }
    //for (unsigned int layers = 1; layers <= max_layers; layers *= 2) {
    ...
    //}
    //for (unsigned int layers = 1; layers <= max_layers; layers *= 2) {
    //    ANCFShellTest<NUM_ELEMENTS, ChElementShellANCF_3443ML_TR03_GQ332, ChMaterialShellANCF_3443ML_TR03_GQ332> ShellTest_TR03_GQ332(layers);
    //    std::cout << "ChElementShellANCF_3443ML_TR03_GQ332, " << layers << ", ";
    //    ShellTest_TR03_GQ332.PrintTimingResults(num_steps);
    //}
    for (unsigned int layers = 1; layers <= max_layers; layers *= 2) {
        ANCFShellTest<NUM_ELEMENTS, ChElementShellANCF_3443ML_TR03_GQ442, ChMaterialShellANCF_3443ML_TR03_GQ442> ShellTest_TR03_GQ442(layers);
        std::cout << "ChElementShellANCF_3443ML_TR03_GQ442, " << layers << ", ";
        ShellTest_TR03_GQ442.PrintTimingResults(num_steps);
    }
    //for (unsigned int layers = 1; layers <= max_layers; layers *= 2) {
    ...
    //}
    //for (unsigned int layers = 1; layers <= max_layers; layers *= 2) {
    //    ANCFShellTest<NUM_ELEMENTS, ChElementShellANCF_3443ML_TR04_GQ332, ChMaterialShellANCF_3443ML_TR04_GQ332> ShellTest_TR04_GQ332(layers);
    //    std::cout << "ChElementShellANCF_3443ML_TR04_GQ332, " << layers << ", ";
    //    ShellTest_TR04_GQ332.PrintTimingResults(num_steps);
    //}
    for (unsigned int layers = 1; layers <= max_layers; layers *= 2) {
        ANCFShellTest<NUM_ELEMENTS, ChElementShellANCF_3443ML_TR04_GQ442, ChMaterialShellANCF_3443ML_TR04_GQ442> ShellTest_TR04_GQ442(layers);
        std::cout << "ChElementShellANCF_3443ML_TR04_GQ442, " << layers << ", ";
        ShellTest_TR04_GQ442.PrintTimingResults(num_steps);
    }
    //for (unsigned int layers = 1; layers <= max_layers; layers *= 2) {
    ...
    //}
    //for (unsigned int layers = 1; layers <= max_layers; layers *= 2) {
    //    ANCFShellTest<NUM_ELEMENTS, ChElementShellANCF_3443ML_TR05_GQ332, ChMaterialShellANCF_3443ML_TR05_GQ332> ShellTest_TR05_GQ332(layers);
    //    std::cout << "ChElementShellANCF_3443ML_TR05_GQ332, " << layers << ", ";
    //    ShellTest_TR05_GQ332.PrintTimingResults(num_steps);
    //}
    for (unsigned int layers = 1; layers <= max_layers; layers *= 2) {
        ANCFShellTest<NUM_ELEMENTS, ChElementShellANCF_3443ML_TR05_GQ442, ChMaterialShellANCF_3443ML_TR05_GQ442> ShellTest_TR05_GQ442(layers);
        std::cout << "ChElementShellANCF_3443ML_TR05_GQ442, " << layers << ", ";
        ShellTest_TR05_GQ442.PrintTimingResults(num_steps);
    }
    //for (unsigned int layers = 1; layers <= max_layers; layers *= 2) {
    ...
    //}
    //for (unsigned int layers = 1; layers <= max_layers; layers *= 2) {
    //    ANCFShellTest<NUM_ELEMENTS, ChElementShellANCF_3443ML_TR06_GQ332, ChMaterialShellANCF_3443ML_TR06_GQ332> ShellTest_TR06_GQ332(layers);
    //    std::cout << "ChElementShellANCF_3443ML_TR06_GQ332, " << layers << ", ";
    //    ShellTest_TR06_GQ332.PrintTimingResults(num_steps);
    //}
    for (unsigned int layers = 1; layers <= max_layers; layers *= 2) {
        ANCFShellTest<NUM_ELEMENTS, ChElementShellANCF_3443ML_TR06_GQ442, ChMaterialShellANCF_3443ML_TR06_GQ442> ShellTest_TR06_GQ442(layers);
        std::cout << "ChElementShellANCF_3443ML_TR06_GQ442, " << layers << ", ";
        ShellTest_TR06_GQ442.PrintTimingResults(num_steps);
    }
    //for (unsigned int layers = 1; layers <= max_layers; layers *= 2) {
    ...
    //}
    //for (unsigned int layers = 1; layers <= max_layers; layers *= 2) {
    //    ANCFShellTest<NUM_ELEMENTS, ChElementShellANCF_3443ML_TR07S_GQ332, ChMaterialShellANCF_3443ML_TR07S_GQ332> ShellTest_TR07S_GQ332(layers);
    //    std::cout << "ChElementShellANCF_3443ML_TR07S_GQ332, " << layers << ", ";
    //    ShellTest_TR07S_GQ332.PrintTimingResults(num_steps);
    //}
    for (unsigned int layers = 1; layers <= max_layers; layers *= 2) {
        ANCFShellTest<NUM_ELEMENTS, ChElementShellANCF_3443ML_TR07S_GQ442, ChMaterialShellANCF_3443ML_TR07S_GQ442> ShellTest_TR07S_GQ442(layers);
        std::cout << "ChElementShellANCF_3443ML_TR07S_GQ442, " << layers << ", ";
        ShellTest_TR07S_GQ442.PrintTimingResults(num_steps);
    }
    //for (unsigned int layers = 1; layers <= max_layers; layers *= 2) {
    ...
    //}
    //for (unsigned int layers = 1; layers <= max_layers; layers *= 2) {
    //    ANCFShellTest<NUM_ELEMENTS, ChElementShellANCF_3443ML_TR08S_GQ332, ChMaterialShellANCF_3443ML_TR08S_GQ332> ShellTest_TR08S_GQ332(layers);
    //    std::cout << "ChElementShellANCF_3443ML_TR08S_GQ332, " << layers << ", ";
    //    ShellTest_TR08S_GQ332.PrintTimingResults(num_steps);
    //}
    for (unsigned int layers = 1; layers <= max_layers; layers *= 2) {
        ANCFShellTest<NUM_ELEMENTS, ChElementShellANCF_3443ML_TR08S_GQ442, ChMaterialShellANCF_3443ML_TR08S_GQ442> ShellTest_TR08S_GQ442(layers);
        std::cout << "ChElementShellANCF_3443ML_TR08S_GQ442, " << layers << ", ";
        ShellTest_TR08S_GQ442.PrintTimingResults(num_steps);
    }
    for (unsigned int layers = 1; layers <= max_layers; layers *= 2) {
