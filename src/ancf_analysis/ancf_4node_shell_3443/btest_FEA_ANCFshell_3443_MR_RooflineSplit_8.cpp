...
void Run_ANCFShell_3443_Tests() {
    ...
    int num_steps_Jac_MR_Damp         = 25 * 8192 / num_elements;
	int num_steps_Jac_MR_DampNumJac   = 3 * 8192 / num_elements;
	int num_steps_Jac_MR_NoDamp       = 25 * 8192 / num_elements;
	int num_steps_Jac_MR_NoDampNumJac = 10 * 8192 / num_elements;

    //{
    //    ANCFShell3443Test<num_elements, ChElementShellANCF_3443_TR08, ChMaterialBeamANCF> Shell3443Test_TR08(1);
...

    {
        ...
        Test.PrintTimingResults("ChElementHShellANCF_3443_MR_Damp", num_steps_IntFrc_MR_Damp, num_steps_Jac_MR_Damp);
    }
    {
        ANCFShell3443Test_MR<num_elements, ChElementShellANCF_3443_MR_DampNumJac> Test(1);
        Test.PrintTimingResults("ChElementShellANCF_3443_MR_DampNumJac", num_steps_IntFrc_MR_DampNumJac, num_steps_Jac_MR_DampNumJac);
    }
    {
        ANCFShell3443Test_MR<num_elements, ChElementShellANCF_3443_MR_NoDamp> Test(1);
        Test.PrintTimingResults("ChElementShellANCF_3443_MR_NoDamp", num_steps_IntFrc_MR_NoDamp, num_steps_Jac_MR_NoDamp);
    }
    {
        ANCFShell3443Test_MR<num_elements, ChElementShellANCF_3443_MR_NoDampNumJac> Test(1);
        Test.PrintTimingResults("ChElementShellANCF_3443_MR_NoDampNumJac", num_steps_IntFrc_MR_NoDampNumJac, num_steps_Jac_MR_NoDampNumJac);
    }
