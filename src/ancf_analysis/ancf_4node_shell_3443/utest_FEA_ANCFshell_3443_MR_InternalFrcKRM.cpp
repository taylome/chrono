...
class ANCFShellTest {
  ...
  protected:
    ...
    std::shared_ptr<ChMaterialShellANCF_MR> m_material;
};

// =============================================================================

template <typename ElementVersion>
ANCFShellTest<ElementVersion>::ANCFShellTest() {
    ...
    m_material = chrono_types::make_shared<ChMaterialShellANCF_MR>(rho, c10, c01, k, mu);
    ...
    element->AddLayer(thickness, m_material);
...
template <typename ElementVersion>
bool ANCFShellTest<ElementVersion>::RunElementChecks(int msglvl) {
...
template <typename ElementVersion>
bool ANCFShellTest<ElementVersion>::MassMatrixCheck(int msglvl) {
    // =============================================================================
...
template <typename ElementVersion>
bool ANCFShellTest<ElementVersion>::GeneralizedGravityForceCheck(int msglvl) {
    // =============================================================================
...
template <typename ElementVersion>
bool ANCFShellTest<ElementVersion>::GeneralizedInternalForceNoDispNoVelCheck(int msglvl) {
    // =============================================================================
...
template <typename ElementVersion>
bool ANCFShellTest<ElementVersion>::GeneralizedInternalForceSmallDispNoVelCheck(int msglvl) {
    // =============================================================================
    ...
    if (!load_validation_data("UT_ANCFShell_3443_MR_IntFrcSmallDispNoVel.txt", Expected_InternalForceSmallDispNoVel))
        return false;
...
template <typename ElementVersion>
bool ANCFShellTest<ElementVersion>::GeneralizedInternalForceNoDispSmallVelCheck(int msglvl) {
    // =============================================================================
    ...
    if (!load_validation_data("UT_ANCFShell_3443_MR_IntFrcNoDispSmallVel.txt", Expected_InternalForceNoDispSmallVel))
        return false;
...
template <typename ElementVersion>
bool ANCFShellTest<ElementVersion>::JacobianNoDispNoVelNoDampingCheck(int msglvl) {
    // =============================================================================
    ...
    if (!load_validation_data("UT_ANCFShell_3443_MR_JacNoDispNoVelNoDamping.txt", Expected_JacobianK_NoDispNoVelNoDamping))
        return false;
...
template <typename ElementVersion>
bool ANCFShellTest<ElementVersion>::JacobianSmallDispNoVelNoDampingCheck(int msglvl) {
    // =============================================================================
    ...
    if (!load_validation_data("UT_ANCFShell_3443_MR_JacSmallDispNoVelNoDamping.txt",
...
template <typename ElementVersion>
bool ANCFShellTest<ElementVersion>::JacobianNoDispNoVelWithDampingCheck(int msglvl) {
    // =============================================================================
    ...
    if (!load_validation_data("UT_ANCFShell_3443_MR_JacNoDispNoVelWithDamping.txt", Expected_Jacobians))
        return false;
...
template <typename ElementVersion>
bool ANCFShellTest<ElementVersion>::JacobianSmallDispNoVelWithDampingCheck(int msglvl) {
    // =============================================================================
    ...
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor> Expected_Jacobians;
    Expected_Jacobians.resize(2 * 3 * NSF, 3 * NSF);
    if (!load_validation_data("UT_ANCFShell_3443_MR_JacSmallDispNoVelWithDamping.txt", Expected_Jacobians))
        return false;
...
template <typename ElementVersion>
bool ANCFShellTest<ElementVersion>::JacobianNoDispSmallVelWithDampingCheck(int msglvl) {
    // =============================================================================
    ...
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor> Expected_Jacobians;
    Expected_Jacobians.resize(2 * 3 * NSF, 3 * NSF);
    if (!load_validation_data("UT_ANCFShell_3443_MR_JacNoDispSmallVelWithDamping.txt", Expected_Jacobians))
        return false;
...
template <typename ElementVersion>
bool ANCFShellTest<ElementVersion>::AxialDisplacementCheck(int msglvl) {
    // =============================================================================
...
template <typename ElementVersion>
bool ANCFShellTest<ElementVersion>::CantileverTipLoadCheck(int msglvl) {
    // =============================================================================
...
template <typename ElementVersion>
bool ANCFShellTest<ElementVersion>::CantileverGravityCheck(int msglvl) {
    // =============================================================================
...
template <typename ElementVersion>
bool ANCFShellTest<ElementVersion>::AxialTwistCheck(int msglvl) {
    // =============================================================================
    ...
    // check the off-axis angles which should be zeros
    bool passed_angles = (abs(Tip_Angles.y() * CH_RAD_TO_DEG) < 0.1) && (abs(Tip_Angles.z() * CH_RAD_TO_DEG) < 0.1);
...
template <typename ElementVersion>
bool ANCFShellTest<ElementVersion>::NonlinearAxialDisplacementCheck(int msglvl) {
    // =============================================================================
    //  Check the Axial Displacement of a Beam compared to the analytical result
    //  (some small error expected depending on the formulation/steps used)
    // =============================================================================
...
int main(int argc, char* argv[]) {
    ...
    std::cout << "-------------------------------------" << std::endl;
    ANCFShellTest<ChElementShellANCF_3443_MR_Damp> ChElementShellANCF_3443_MR_Damp_test;
    if (ChElementShellANCF_3443_MR_Damp_test.RunElementChecks(1))
        print_green("ChElementShellANCF_3443_MR_Damp Element Checks = PASSED\n");
    else
        print_red("ChElementShellANCF_3443_MR_Damp Element Checks = FAILED\n");

    std::cout << "-------------------------------------" << std::endl;
    ANCFShellTest<ChElementShellANCF_3443_MR_NoDamp> ChElementShellANCF_3443_MR_NoDamp_test;
    if (ChElementShellANCF_3443_MR_NoDamp_test.RunElementChecks(1))
        print_green("ChElementShellANCF_3443_MR_NoDamp Element Checks = PASSED\n");
    else
        print_red("ChElementShellANCF_3443_MR_NoDamp Element Checks = FAILED\n");

    std::cout << "-------------------------------------" << std::endl;
    ANCFShellTest<ChElementShellANCF_3443_MR_DampNumJac> ChElementShellANCF_3443_MR_DampNumJac_test;
    if (ChElementShellANCF_3443_MR_DampNumJac_test.RunElementChecks(1))
        print_green("ChElementShellANCF_3443_MR_DampNumJac Element Checks = PASSED\n");
    else
        print_red("ChElementShellANCF_3443_MR_DampNumJac Element Checks = FAILED\n");

    std::cout << "-------------------------------------" << std::endl;
    ANCFShellTest<ChElementShellANCF_3443_MR_NoDampNumJac> ChElementShellANCF_3443_MR_NoDampNumJac_test;
    if (ChElementShellANCF_3443_MR_NoDampNumJac_test.RunElementChecks(1))
        print_green("ChElementShellANCF_3443_MR_NoDampNumJac Element Checks = PASSED\n");
    else
        print_red("ChElementShellANCF_3443_MR_NoDampNumJac Element Checks = FAILED\n");
