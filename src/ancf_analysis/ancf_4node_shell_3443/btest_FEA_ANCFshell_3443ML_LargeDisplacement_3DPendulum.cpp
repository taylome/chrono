...
class ANCFShellTest {
  public:
    ANCFShellTest(int num_elements, SolverType solver_type, int NumThreads);
...
template <typename ElementVersion, typename MaterialVersion>
ANCFShellTest<ElementVersion, MaterialVersion>::ANCFShellTest(int num_elements,
    ...
    for (auto i = 0; i < 2 * num_elements; i++) {
        for (auto j = 0; j < num_elements; j++) {
            int nodeA_idx = j + i * (num_elements + 1);
            int nodeD_idx = (j + 1) + i * (num_elements + 1);
            int nodeB_idx = j + (i + 1) * (num_elements + 1);
            int nodeC_idx = (j + 1) + (i + 1) * (num_elements + 1);
...
template <typename ElementVersion, typename MaterialVersion>
void ANCFShellTest<ElementVersion, MaterialVersion>::SimulateVis() {
#ifdef CHRONO_IRRLICHT
    irrlicht::ChIrrApp application(m_system, L"ANCF Shells 3443", irr::core::dimension2d<irr::u32>(800, 600), false, true);
...
template <typename ElementVersion, typename MaterialVersion>
void ANCFShellTest<ElementVersion, MaterialVersion>::RunTimingTest(ChMatrixNM<double, 4, 19>& timing_stats,
...
int main(int argc, char* argv[]) {
    ...
    for (const auto& ls : Solver) {
        for (auto i = 0; i < num_els.size(); i++) {
            ...
            while (run) {
                if (i == 0) {
                    ANCFShellTest<ChElementShellANCF_3443ML_TR01, ChMaterialShellANCF_3443ML_TR01> test(num_els(i), ls, NumThreads);
                    test.RunTimingTest(timing_stats, "ChElementShellANCF_3443ML_TR01");
                }
                //if (i == 0) {
                //    ANCFShellTest<ChElementShellANCF_3443ML_TR02, ChMaterialShellANCF_3443ML_TR02> test(num_els(i), ls, NumThreads);
                //    test.RunTimingTest(timing_stats, "ChElementShellANCF_3443ML_TR02");
                //}
                //if (i == 0) {
                //    ANCFShellTest<ChElementShellANCF_3443ML_TR02_GQ332, ChMaterialShellANCF_3443ML_TR02_GQ332> test(num_els(i), ls, NumThreads);
                //    test.RunTimingTest(timing_stats, "ChElementShellANCF_3443ML_TR02_GQ332");
                //}
                if (i == 0) {
                    ANCFShellTest<ChElementShellANCF_3443ML_TR02_GQ442, ChMaterialShellANCF_3443ML_TR02_GQ442> test(num_els(i), ls, NumThreads);
                    test.RunTimingTest(timing_stats, "ChElementShellANCF_3443ML_TR02_GQ442");
                }
                //if (i == 0) {
                //    ANCFShellTest<ChElementShellANCF_3443ML_TR03, ChMaterialShellANCF_3443ML_TR03> test(num_els(i), ls, NumThreads);
                //    test.RunTimingTest(timing_stats, "ChElementShellANCF_3443ML_TR03");
                //}
                //if (i == 0) {
                //    ANCFShellTest<ChElementShellANCF_3443ML_TR03_GQ332, ChMaterialShellANCF_3443ML_TR03_GQ332> test(num_els(i), ls, NumThreads);
                //    test.RunTimingTest(timing_stats, "ChElementShellANCF_3443ML_TR03_GQ332");
                //}
                if (i == 0) {
                    ANCFShellTest<ChElementShellANCF_3443ML_TR03_GQ442, ChMaterialShellANCF_3443ML_TR03_GQ442> test(num_els(i), ls, NumThreads);
                    test.RunTimingTest(timing_stats, "ChElementShellANCF_3443ML_TR03_GQ442");
                }
                //if (i == 0) {
                //    ANCFShellTest<ChElementShellANCF_3443ML_TR04, ChMaterialShellANCF_3443ML_TR04> test(num_els(i), ls, NumThreads);
                //    test.RunTimingTest(timing_stats, "ChElementShellANCF_3443ML_TR04");
                //}
                //if (i == 0) {
                //    ANCFShellTest<ChElementShellANCF_3443ML_TR04_GQ332, ChMaterialShellANCF_3443ML_TR04_GQ332> test(num_els(i), ls, NumThreads);
                //    test.RunTimingTest(timing_stats, "ChElementShellANCF_3443ML_TR04_GQ332");
                //}
                if (i == 0) {
                    ANCFShellTest<ChElementShellANCF_3443ML_TR04_GQ442, ChMaterialShellANCF_3443ML_TR04_GQ442> test(num_els(i), ls, NumThreads);
                    test.RunTimingTest(timing_stats, "ChElementShellANCF_3443ML_TR04_GQ442");
                }
                //if (i == 0) {
                //    ANCFShellTest<ChElementShellANCF_3443ML_TR05, ChMaterialShellANCF_3443ML_TR05> test(num_els(i), ls, NumThreads);
                //    test.RunTimingTest(timing_stats, "ChElementShellANCF_3443ML_TR05");
                //}
                //{
                //    ANCFShellTest<ChElementShellANCF_3443ML_TR05_GQ332, ChMaterialShellANCF_3443ML_TR05_GQ332> test(num_els(i), ls, NumThreads);
                //    test.RunTimingTest(timing_stats, "ChElementShellANCF_3443ML_TR05_GQ332");
                //}
                {
                    ANCFShellTest<ChElementShellANCF_3443ML_TR05_GQ442, ChMaterialShellANCF_3443ML_TR05_GQ442> test(num_els(i), ls, NumThreads);
                    test.RunTimingTest(timing_stats, "ChElementShellANCF_3443ML_TR05_GQ442");
                }
                //if (i == 0) {
                //    ANCFShellTest<ChElementShellANCF_3443ML_TR06, ChMaterialShellANCF_3443ML_TR06> test(num_els(i), ls, NumThreads);
                //    test.RunTimingTest(timing_stats, "ChElementShellANCF_3443ML_TR06");
                //}
                //{
                //    ANCFShellTest<ChElementShellANCF_3443ML_TR06_GQ332, ChMaterialShellANCF_3443ML_TR06_GQ332> test(num_els(i), ls, NumThreads);
                //    test.RunTimingTest(timing_stats, "ChElementShellANCF_3443ML_TR06_GQ332");
                //}
                {
                    ANCFShellTest<ChElementShellANCF_3443ML_TR06_GQ442, ChMaterialShellANCF_3443ML_TR06_GQ442> test(num_els(i), ls, NumThreads);
                    test.RunTimingTest(timing_stats, "ChElementShellANCF_3443ML_TR06_GQ442");
                }
                //{
                //    ANCFShellTest<ChElementShellANCF_3443ML_TR07, ChMaterialShellANCF_3443ML_TR07> test(num_els(i), ls, NumThreads);
                //    test.RunTimingTest(timing_stats, "ChElementShellANCF_3443ML_TR07");
                //}
                //{
                //    ANCFShellTest<ChElementShellANCF_3443ML_TR07S, ChMaterialShellANCF_3443ML_TR07S> test(num_els(i), ls, NumThreads);
                //    test.RunTimingTest(timing_stats, "ChElementShellANCF_3443ML_TR07S");
                //}
                //{
                //    ANCFShellTest<ChElementShellANCF_3443ML_TR07S_GQ332, ChMaterialShellANCF_3443ML_TR07S_GQ332> test(num_els(i), ls, NumThreads);
                //    test.RunTimingTest(timing_stats, "ChElementShellANCF_3443ML_TR07S_GQ332");
                //}
                {
                    ANCFShellTest<ChElementShellANCF_3443ML_TR07S_GQ442, ChMaterialShellANCF_3443ML_TR07S_GQ442> test(num_els(i), ls, NumThreads);
                    test.RunTimingTest(timing_stats, "ChElementShellANCF_3443ML_TR07S_GQ442");
                }
                //{
                //    ANCFShellTest<ChElementShellANCF_3443ML_TR08, ChMaterialShellANCF_3443ML_TR08> test(num_els(i), ls, NumThreads);
                //    test.RunTimingTest(timing_stats, "ChElementShellANCF_3443ML_TR08");
                //}
                //{
                //    ANCFShellTest<ChElementShellANCF_3443ML_TR08S, ChMaterialShellANCF_3443ML_TR08S> test(num_els(i), ls, NumThreads);
                //    test.RunTimingTest(timing_stats, "ChElementShellANCF_3443ML_TR08S");
                //}
                //{
                //    ANCFShellTest<ChElementShellANCF_3443ML_TR08S_GQ332, ChMaterialShellANCF_3443ML_TR08S_GQ332> test(num_els(i), ls, NumThreads);
                //    test.RunTimingTest(timing_stats, "ChElementShellANCF_3443ML_TR08S_GQ332");
                //}
                {
                    ANCFShellTest<ChElementShellANCF_3443ML_TR08S_GQ442, ChMaterialShellANCF_3443ML_TR08S_GQ442> test(num_els(i), ls, NumThreads);
                    test.RunTimingTest(timing_stats, "ChElementShellANCF_3443ML_TR08S_GQ442");
                }
                {
                    ANCFShellTest<ChElementShellANCF_3443ML_TR09, ChMaterialShellANCF_3443ML_TR09> test(num_els(i), ls, NumThreads);
                    test.RunTimingTest(timing_stats, "ChElementShellANCF_3443ML_TR09");
                }
                {
                    ANCFShellTest<ChElementShellANCF_3443ML_TR10, ChMaterialShellANCF_3443ML_TR10> test(num_els(i), ls, NumThreads);
                    test.RunTimingTest(timing_stats, "ChElementShellANCF_3443ML_TR10");
                }
                //{
                //    ANCFShellTest<ChElementShellANCF_3443ML_TR11, ChMaterialShellANCF_3443ML_TR11> test(num_els(i), ls, NumThreads);
                //    test.RunTimingTest(timing_stats, "ChElementShellANCF_3443ML_TR11");
                //}
                {
                    ANCFShellTest<ChElementShellANCF_3443ML_TR11S, ChMaterialShellANCF_3443ML_TR11S> test(num_els(i), ls, NumThreads);
                    test.RunTimingTest(timing_stats, "ChElementShellANCF_3443ML_TR11S");
                }
