...
ANCFBeamTest<ElementVersion, MaterialVersion>::ANCFBeamTest(int num_elements,
    ...
    m_NumElements = num_elements * num_elements;
    ...
    double E = 10e5;  // Pa
    double nu = 0.3;                       // Poisson effect neglected for this model
...
int main(int argc, char* argv[]) {
    ...
    for (const auto& ls : Solver) {
        for (auto i = 0; i < num_els.size(); i++) {
            ...
            while (run) {
                {
                    ANCFBeamTest<ChElementShellANCF_3443_TR01, ChMaterialShellANCF_3443_TR01> test(num_els(i), ls, NumThreads, f);
                    test.RunTimingTest(timing_stats, "ChElementShellANCF_3443_TR01");
                }
                {
                    ANCFBeamTest<ChElementShellANCF_3443_TR02, ChMaterialShellANCF_3443_TR02> test(num_els(i), ls, NumThreads, f);
                    test.RunTimingTest(timing_stats, "ChElementShellANCF_3443_TR02");
                }
                {
                    ANCFBeamTest<ChElementShellANCF_3443_TR03, ChMaterialShellANCF_3443_TR03> test(num_els(i), ls, NumThreads, f);
                    test.RunTimingTest(timing_stats, "ChElementShellANCF_3443_TR03");
                }
                //{
                //    ANCFBeamTest<ChElementShellANCF_3443_TR04, ChMaterialShellANCF_3443_TR04> test(num_els(i), ls, NumThreads, f);
                //    test.RunTimingTest(timing_stats, "ChElementShellANCF_3443_TR04");
                //}
                //{
                //    ANCFBeamTest<ChElementShellANCF_3443_TR05, ChMaterialShellANCF_3443_TR05> test(num_els(i), ls, NumThreads, f);
                //    test.RunTimingTest(timing_stats, "ChElementShellANCF_3443_TR05");
                //}
                //{
                //    ANCFBeamTest<ChElementShellANCF_3443_TR06, ChMaterialShellANCF_3443_TR06> test(num_els(i), ls, NumThreads, f);
                //    test.RunTimingTest(timing_stats, "ChElementShellANCF_3443_TR06");
                //}
                //{
                //    ANCFBeamTest<ChElementShellANCF_3443_TR07, ChMaterialShellANCF_3443_TR07> test(num_els(i), ls, NumThreads, f);
                //    test.RunTimingTest(timing_stats, "ChElementShellANCF_3443_TR07");
                //}
                //{
                //    ANCFBeamTest<ChElementShellANCF_3443_TR08, ChMaterialShellANCF_3443_TR08> test(num_els(i), ls, NumThreads, f);
                //    test.RunTimingTest(timing_stats, "ChElementShellANCF_3443_TR08");
                //}
                //{
                //    ANCFBeamTest<ChElementShellANCF_3443_TR08b, ChMaterialShellANCF_3443_TR08b> test(num_els(i), ls, NumThreads, f);
                //    test.RunTimingTest(timing_stats, "ChElementShellANCF_3443_TR08b");
                //}
                //{
                //    ANCFBeamTest<ChElementShellANCF_3443_TR09, ChMaterialShellANCF_3443_TR09> test(num_els(i), ls, NumThreads, f);
                //    test.RunTimingTest(timing_stats, "ChElementShellANCF_3443_TR09");
                //}
                //{
                //    ANCFBeamTest<ChElementShellANCF_3443_TR10, ChMaterialShellANCF_3443_TR10> test(num_els(i), ls, NumThreads, f);
