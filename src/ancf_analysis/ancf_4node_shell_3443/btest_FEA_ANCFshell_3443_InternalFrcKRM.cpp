...
#define NUM_ELEMENTS 1024
    ...
    std::cout << "Element, Avg Internal Force Time per Element(micro s), Avg Jacobian Time per Element(micro s), Total "
              ...
              << std::endl;
    {
        ANCFShellTest<NUM_ELEMENTS, ChElementShellANCF_3443_TR01, ChMaterialShellANCF_3443_TR01> BeamTest_TR01;
        std::cout << "ChElementShellANCF_3443_TR01, ";
        BeamTest_TR01.PrintTimingResults(num_steps);
    }
    {
        ANCFShellTest<NUM_ELEMENTS, ChElementShellANCF_3443_TR02, ChMaterialShellANCF_3443_TR02> BeamTest_TR02;
        std::cout << "ChElementShellANCF_3443_TR02, ";
        BeamTest_TR02.PrintTimingResults(num_steps);
    }
    {
        ANCFShellTest<NUM_ELEMENTS, ChElementShellANCF_3443_TR03, ChMaterialShellANCF_3443_TR03> BeamTest_TR03;
        std::cout << "ChElementShellANCF_3443_TR03, ";
        BeamTest_TR03.PrintTimingResults(num_steps);
    }
    {
        ANCFShellTest<NUM_ELEMENTS, ChElementShellANCF_3443_TR04, ChMaterialShellANCF_3443_TR04> BeamTest_TR04;
        std::cout << "ChElementShellANCF_3443_TR04, ";
        BeamTest_TR04.PrintTimingResults(num_steps);
    }
    {
        ANCFShellTest<NUM_ELEMENTS, ChElementShellANCF_3443_TR05, ChMaterialShellANCF_3443_TR05> BeamTest_TR05;
        std::cout << "ChElementShellANCF_3443_TR05, ";
        BeamTest_TR05.PrintTimingResults(num_steps);
    }
    {
        ANCFShellTest<NUM_ELEMENTS, ChElementShellANCF_3443_TR06, ChMaterialShellANCF_3443_TR06> BeamTest_TR06;
        std::cout << "ChElementShellANCF_3443_TR06, ";
        BeamTest_TR06.PrintTimingResults(num_steps);
    }
    {
        ANCFShellTest<NUM_ELEMENTS, ChElementShellANCF_3443_TR07, ChMaterialShellANCF_3443_TR07> BeamTest_TR07;
        std::cout << "ChElementShellANCF_3443_TR07, ";
        BeamTest_TR07.PrintTimingResults(num_steps);
    }
    {
        ANCFShellTest<NUM_ELEMENTS, ChElementShellANCF_3443_TR08, ChMaterialShellANCF_3443_TR08> BeamTest_TR08;
        std::cout << "ChElementShellANCF_3443_TR08, ";
        BeamTest_TR08.PrintTimingResults(num_steps);
    }
    {
        ANCFShellTest<NUM_ELEMENTS, ChElementShellANCF_3443_TR08b, ChMaterialShellANCF_3443_TR08b> BeamTest_TR08b;
        std::cout << "ChElementShellANCF_3443_TR08b, ";
        BeamTest_TR08b.PrintTimingResults(num_steps);
    }
    {
        ANCFShellTest<NUM_ELEMENTS, ChElementShellANCF_3443_TR09, ChMaterialShellANCF_3443_TR09> BeamTest_TR09;
        std::cout << "ChElementShellANCF_3443_TR09, ";
        BeamTest_TR09.PrintTimingResults(num_steps);
    }
    {
        ANCFShellTest<NUM_ELEMENTS, ChElementShellANCF_3443_TR10, ChMaterialShellANCF_3443_TR10> BeamTest_TR10;
