...
int main(int argc, char* argv[]) {
    ...
    std::cout << "-------------------------------------" << std::endl;
    ANCFShellMLTest<ChElementShellANCF_8, ChMaterialShellANCF> ChElementShellANCF_3833_Org_test;
    ...
    if (ChElementShellANCF_3833ML_TR01_test.RunElementChecks(0))
        ...
        print_red("ChElementShellANCF_3833ML_TR01 Element Checks = FAILED\n");

    std::cout << "-------------------------------------" << std::endl;
    ANCFShellMLTest<ChElementShellANCF_3833ML_TR02, ChMaterialShellANCF_3833ML_TR02> ChElementShellANCF_3833ML_TR02_test;
    if (ChElementShellANCF_3833ML_TR02_test.RunElementChecks(0))
        print_green("ChElementShellANCF_3833ML_TR02 Element Checks = PASSED\n");
    else
    ...
    if (ChElementShellANCF_3833ML_TR04_test.RunElementChecks(0))
        print_green("ChElementShellANCF_3833ML_TR04 Element Checks = PASSED\n");
    else
    ...
    std::cout << "-------------------------------------" << std::endl;
    ANCFShellMLTest<ChElementShellANCF_3833ML_TR11, ChMaterialShellANCF_3833ML_TR11> ChElementShellANCF_3833ML_TR11_test;
    if (ChElementShellANCF_3833ML_TR11_test.RunElementChecks(1))
        print_green("ChElementShellANCF_3833ML_TR11 Element Checks = PASSED\n");
    else
        print_red("ChElementShellANCF_3833ML_TR11 Element Checks = FAILED\n");

    std::cout << "-------------------------------------" << std::endl;
    ANCFShellMLTest<ChElementShellANCF_3833ML_TR11S, ChMaterialShellANCF_3833ML_TR11S> ChElementShellANCF_3833ML_TR11S_test;
    if (ChElementShellANCF_3833ML_TR11S_test.RunElementChecks(1))
        print_green("ChElementShellANCF_3833ML_TR11S Element Checks = PASSED\n");
    else
        print_red("ChElementShellANCF_3833ML_TR11S Element Checks = FAILED\n");
