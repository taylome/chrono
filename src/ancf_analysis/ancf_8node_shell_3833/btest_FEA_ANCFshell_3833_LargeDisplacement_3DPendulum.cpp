...
ANCFBeamTest<ElementVersion, MaterialVersion>::ANCFBeamTest(int num_elements,
    ...
    for (auto i = 0; i < num_elements; i++) {
        for (auto j = 0; j < num_elements; j++) {
            ...
            m_nodeEndPoint = std::dynamic_pointer_cast<ChNodeFEAxyzDD>(mesh->GetNode(nodeC_idx));
        }
    }
...
int main(int argc, char* argv[]) {
    ...
    for (const auto& ls : Solver) {
        for (auto i = 0; i < num_els.size(); i++) {
            ...
            while (run) {
                {
                    ANCFBeamTest<ChElementShellANCF_3833_TR01, ChMaterialShellANCF_3833_TR01> test(num_els(i), ls, NumThreads, f);
                    test.RunTimingTest(timing_stats, "ChElementShellANCF_3833_TR01");
                }
                {
                    ANCFBeamTest<ChElementShellANCF_3833_TR02, ChMaterialShellANCF_3833_TR02> test(num_els(i), ls, NumThreads, f);
                    test.RunTimingTest(timing_stats, "ChElementShellANCF_3833_TR02");
                }
                {
                    ANCFBeamTest<ChElementShellANCF_3833_TR03, ChMaterialShellANCF_3833_TR03> test(num_els(i), ls, NumThreads, f);
                    test.RunTimingTest(timing_stats, "ChElementShellANCF_3833_TR03");
                }
                //{
                //    ANCFBeamTest<ChElementShellANCF_3833_TR04, ChMaterialShellANCF_3833_TR04> test(num_els(i), ls, NumThreads, f);
                //    test.RunTimingTest(timing_stats, "ChElementShellANCF_3833_TR04");
                //}
                //{
                //    ANCFBeamTest<ChElementShellANCF_3833_TR05, ChMaterialShellANCF_3833_TR05> test(num_els(i), ls, NumThreads, f);
                //    test.RunTimingTest(timing_stats, "ChElementShellANCF_3833_TR05");
                //}
                //{
                //    ANCFBeamTest<ChElementShellANCF_3833_TR06, ChMaterialShellANCF_3833_TR06> test(num_els(i), ls, NumThreads, f);
                //    test.RunTimingTest(timing_stats, "ChElementShellANCF_3833_TR06");
                //}
                //{
                //    ANCFBeamTest<ChElementShellANCF_3833_TR07, ChMaterialShellANCF_3833_TR07> test(num_els(i), ls, NumThreads, f);
                //    test.RunTimingTest(timing_stats, "ChElementShellANCF_3833_TR07");
                //}
                //{
                //    ANCFBeamTest<ChElementShellANCF_3833_TR08, ChMaterialShellANCF_3833_TR08> test(num_els(i), ls, NumThreads, f);
                //    test.RunTimingTest(timing_stats, "ChElementShellANCF_3833_TR08");
                //}
                //{
                //    ANCFBeamTest<ChElementShellANCF_3833_TR08b, ChMaterialShellANCF_3833_TR08b> test(num_els(i), ls, NumThreads, f);
                //    test.RunTimingTest(timing_stats, "ChElementShellANCF_3833_TR08b");
                //}
                //{
                //    ANCFBeamTest<ChElementShellANCF_3833_TR09, ChMaterialShellANCF_3833_TR09> test(num_els(i), ls, NumThreads, f);
                //    test.RunTimingTest(timing_stats, "ChElementShellANCF_3833_TR09");
                //}
                //{
                //    ANCFBeamTest<ChElementShellANCF_3833_TR10, ChMaterialShellANCF_3833_TR10> test(num_els(i), ls, NumThreads, f);
