...
bool ANCFShellTest<ElementVersion>::GeneralizedInternalForceSmallDispNoVelCheck(int msglvl) {
    ...
    if (!load_validation_data("UT_ANCFShell_3833_MR_IntFrcSmallDispNoVel.txt", Expected_InternalForceSmallDispNoVel))
        return false;
...
bool ANCFShellTest<ElementVersion>::GeneralizedInternalForceNoDispSmallVelCheck(int msglvl) {
    ...
    if (!load_validation_data("UT_ANCFShell_3833_MR_IntFrcNoDispSmallVel.txt", Expected_InternalForceNoDispSmallVel))
        return false;
...
bool ANCFShellTest<ElementVersion>::JacobianNoDispNoVelNoDampingCheck(int msglvl) {
    ...
    if (!load_validation_data("UT_ANCFShell_3833_MR_JacNoDispNoVelNoDamping.txt", Expected_JacobianK_NoDispNoVelNoDamping))
        return false;
...
bool ANCFShellTest<ElementVersion>::JacobianSmallDispNoVelNoDampingCheck(int msglvl) {
    ...
    if (!load_validation_data("UT_ANCFShell_3833_MR_JacSmallDispNoVelNoDamping.txt",
...
bool ANCFShellTest<ElementVersion>::JacobianNoDispNoVelWithDampingCheck(int msglvl) {
    ...
    if (!load_validation_data("UT_ANCFShell_3833_MR_JacNoDispNoVelWithDamping.txt", Expected_Jacobians))
        return false;
...
bool ANCFShellTest<ElementVersion>::JacobianSmallDispNoVelWithDampingCheck(int msglvl) {
    ...
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor> Expected_Jacobians;
    Expected_Jacobians.resize(2 * 3 * NSF, 3 * NSF);
    if (!load_validation_data("UT_ANCFShell_3833_MR_JacSmallDispNoVelWithDamping.txt", Expected_Jacobians))
        return false;
...
bool ANCFShellTest<ElementVersion>::JacobianNoDispSmallVelWithDampingCheck(int msglvl) {
    ...
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor> Expected_Jacobians;
    Expected_Jacobians.resize(2 * 3 * NSF, 3 * NSF);
    if (!load_validation_data("UT_ANCFShell_3833_MR_JacNoDispSmallVelWithDamping.txt", Expected_Jacobians))
        return false;
...
int main(int argc, char* argv[]) {
    ...
    std::cout << "-------------------------------------" << std::endl;
    ANCFShellTest<ChElementShellANCF_3833_MR_Damp> ChElementShellANCF_3833_MR_Damp_test;
    if (ChElementShellANCF_3833_MR_Damp_test.RunElementChecks(1))
        print_green("ChElementShellANCF_3833_MR_Damp Element Checks = PASSED\n");
    else
        print_red("ChElementShellANCF_3833_MR_Damp Element Checks = FAILED\n");

    std::cout << "-------------------------------------" << std::endl;
    ANCFShellTest<ChElementShellANCF_3833_MR_NoDamp> ChElementShellANCF_3833_MR_NoDamp_test;
    if (ChElementShellANCF_3833_MR_NoDamp_test.RunElementChecks(1))
        print_green("ChElementShellANCF_3833_MR_NoDamp Element Checks = PASSED\n");
    else
        print_red("ChElementShellANCF_3833_MR_NoDamp Element Checks = FAILED\n");

    std::cout << "-------------------------------------" << std::endl;
    ANCFShellTest<ChElementShellANCF_3833_MR_DampNumJac> ChElementShellANCF_3833_MR_DampNumJac_test;
    if (ChElementShellANCF_3833_MR_DampNumJac_test.RunElementChecks(1))
        print_green("ChElementShellANCF_3833_MR_DampNumJac Element Checks = PASSED\n");
    else
        print_red("ChElementShellANCF_3833_MR_DampNumJac Element Checks = FAILED\n");

    std::cout << "-------------------------------------" << std::endl;
    ANCFShellTest<ChElementShellANCF_3833_MR_NoDampNumJac> ChElementShellANCF_3833_MR_NoDampNumJac_test;
    if (ChElementShellANCF_3833_MR_NoDampNumJac_test.RunElementChecks(1))
        print_green("ChElementShellANCF_3833_MR_NoDampNumJac Element Checks = PASSED\n");
    else
        print_red("ChElementShellANCF_3833_MR_NoDampNumJac Element Checks = FAILED\n");
