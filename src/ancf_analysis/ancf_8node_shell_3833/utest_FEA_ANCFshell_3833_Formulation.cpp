...
// =============================================================================
//
// Unit test for the formulation of the higher order 8 node ANCF shell element 3833.
//
...
class ANCFShellTest {
  ...
  protected:
    ...
    std::shared_ptr<ChElementShellANCF_3833<>> m_element;
...
bool ANCFShellTest::GeneralizedInternalForceSmallDispNoVelCheck(int msglvl) {
    ...
    if (!load_validation_data("UT_ANCFShell_3833_IntFrcSmallDispNoVelNoGravity.txt",
                              Expected_InternalForceSmallDispNoVelNoGravity))
        return false;
...
bool ANCFShellTest::GeneralizedInternalForceNoDispSmallVelCheck(int msglvl) {
    ...
    if (!load_validation_data("UT_ANCFShell_3833_IntFrcNoDispSmallVelNoGravity.txt",
                              Expected_InternalForceNoDispSmallVelNoGravity))
        return false;
...
bool ANCFShellTest::CantileverCheck(int msglvl) {
    // =============================================================================
    ...
    if (msglvl >= 1) {
        std::cout << "Cantilever Beam - Tip Displacement Check (Percent Error less than 2%) = " << Percent_Error << "%";
        if (passed_displacement)
            print_green(" - Test PASSED\n");
        else
            print_red(" - Test FAILED\n");
...
int main(int argc, char* argv[]) {
    ...
    std::cout << "-------------------------------------" << std::endl;
    ANCFShellTest ChElementShellANCF_3833_ContInt_test(true);
    if (ChElementShellANCF_3833_ContInt_test.RunElementChecks(1))
        print_green("ChElementShellANCF_3833 Element (ContInt Method) Checks = PASSED\n");
    else {
        print_red("ChElementShellANCF_3833 Element (ContInt Method) Checks = FAILED\n");
        tests_passed = false;
    }

    std::cout << "-------------------------------------" << std::endl;
    ANCFShellTest ChElementShellANCF_3833_PreInt_test(false);
    if (ChElementShellANCF_3833_PreInt_test.RunElementChecks(1))
        print_green("ChElementShellANCF_3833 Element (PreInt Method) Checks = PASSED\n");
    else {
        print_red("ChElementShellANCF_3833 Element (PreInt Method) Checks = FAILED\n");
        tests_passed = false;
    }
