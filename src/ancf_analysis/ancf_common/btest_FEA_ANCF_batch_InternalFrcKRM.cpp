...
void Run_ANCFBeam_3333_Tests() {
    ...
    {
        ANCFBeam3333Test<num_elements, ChElementBeamANCF_TR01, ChMaterialBeamANCF_TR01> Beam3333Test_TR01;
        Beam3333Test_TR01.PrintTimingResults("ChElementBeamANCF_TR01", num_steps);
    }
    {
        ANCFBeam3333Test<num_elements, ChElementBeamANCF_TR02, ChMaterialBeamANCF_TR02> Beam3333Test_TR02;
        Beam3333Test_TR02.PrintTimingResults("ChElementBeamANCF_TR02", num_steps);
    }
    {
        ANCFBeam3333Test<num_elements, ChElementBeamANCF_TR03, ChMaterialBeamANCF_TR03> Beam3333Test_TR03;
        Beam3333Test_TR03.PrintTimingResults("ChElementBeamANCF_TR03", num_steps);
    }
    {
        ANCFBeam3333Test<num_elements, ChElementBeamANCF_TR04, ChMaterialBeamANCF_TR04> Beam3333Test_TR04;
        Beam3333Test_TR04.PrintTimingResults("ChElementBeamANCF_TR04", num_steps);
    }
    {
        ANCFBeam3333Test<num_elements, ChElementBeamANCF_TR05, ChMaterialBeamANCF_TR05> Beam3333Test_TR05;
        Beam3333Test_TR05.PrintTimingResults("ChElementBeamANCF_TR05", num_steps);
    }
    {
        ANCFBeam3333Test<num_elements, ChElementBeamANCF_TR06, ChMaterialBeamANCF_TR06> Beam3333Test_TR06;
        Beam3333Test_TR06.PrintTimingResults("ChElementBeamANCF_TR06", num_steps);
    }
    {
        ANCFBeam3333Test<num_elements, ChElementBeamANCF_TR07, ChMaterialBeamANCF_TR07> Beam3333Test_TR07;
        Beam3333Test_TR07.PrintTimingResults("ChElementBeamANCF_TR07", num_steps);
    }
    {
        ANCFBeam3333Test<num_elements, ChElementBeamANCF_TR08, ChMaterialBeamANCF_TR08> Beam3333Test_TR08;
        Beam3333Test_TR08.PrintTimingResults("ChElementBeamANCF_TR08", num_steps);
    }
    {
        ANCFBeam3333Test<num_elements, ChElementBeamANCF_TR09, ChMaterialBeamANCF_TR09> Beam3333Test_TR09;
        Beam3333Test_TR09.PrintTimingResults("ChElementBeamANCF_TR09", num_steps);
    }
    {
