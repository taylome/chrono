...
//    }
//    {
//        ANCFShell3443MLTest<num_elements, ChElementShellANCF_3443ML_TR06S_GQ442, ChMaterialShellANCF_3443ML_TR06S_GQ442> Shell3443MLTest_TR06S_GQ442(1);
//        Shell3443MLTest_TR06S_GQ442.PrintTimingResults("ChElementShellANCF_3443ML_TR06S_GQ442", num_steps);
//    }
//    //{
...
//    }
//    {
//        ANCFShell3443MLTest<num_elements, ChElementShellANCF_3443ML_TR07SS_GQ442, ChMaterialShellANCF_3443ML_TR07SS_GQ442> Shell3443MLTest_TR07SS_GQ442(1);
//        Shell3443MLTest_TR07SS_GQ442.PrintTimingResults("ChElementShellANCF_3443ML_TR07SS_GQ442", num_steps);
//    }
//    //{
...
//    }
//    {
//        ANCFShell3443MLTest<num_elements, ChElementShellANCF_3443ML_TR08SS_GQ442, ChMaterialShellANCF_3443ML_TR08SS_GQ442> Shell3443MLTest_TR08SS_GQ442(1);
//        Shell3443MLTest_TR08SS_GQ442.PrintTimingResults("ChElementShellANCF_3443ML_TR08SS_GQ442", num_steps);
//    }
//    //{
...
//    }
//    {
//        ANCFShell3833MLTest<num_elements, ChElementShellANCF_3833ML_TR06S_GQ332, ChMaterialShellANCF_3833ML_TR06S_GQ332> Shell3833MLTest_TR06S_GQ332(1);
//        Shell3833MLTest_TR06S_GQ332.PrintTimingResults("ChElementShellANCF_3833ML_TR06S_GQ332", num_steps);
//    }
//    //{
...
//    }
//    {
//        ANCFShell3833MLTest<num_elements, ChElementShellANCF_3833ML_TR07SS_GQ332, ChMaterialShellANCF_3833ML_TR07SS_GQ332> Shell3833MLTest_TR07SS_GQ332(1);
//        Shell3833MLTest_TR07SS_GQ332.PrintTimingResults("ChElementShellANCF_3833ML_TR07SS_GQ332", num_steps);
//    }
//    //{
...
//    }
//    {
//        ANCFShell3833MLTest<num_elements, ChElementShellANCF_3833ML_TR08SS_GQ332, ChMaterialShellANCF_3833ML_TR08SS_GQ332> Shell3833MLTest_TR08SS_GQ332(1);
//        Shell3833MLTest_TR08SS_GQ332.PrintTimingResults("ChElementShellANCF_3833ML_TR08SS_GQ332", num_steps);
//    }
//    //{
...
template <int num_elements, typename ElementVersion>
ANCFBrick3843Test<num_elements, ElementVersion>::ANCFBrick3843Test() {
    m_system = new ChSystemSMC();
    m_system->Set_G_acc(ChVector<>(0, 0, -9.80665));
...
template <int num_elements, typename ElementVersion>
void ANCFBrick3843Test<num_elements, ElementVersion>::PerturbNodes(const bool Use_OMP) {
    auto MeshList = m_system->Get_meshlist();
    for (auto& Mesh : MeshList) {
        auto NodeList = Mesh->GetNodes();
        ChVector<double> Perturbation;
...
template <int num_elements, typename ElementVersion>
double ANCFBrick3843Test<num_elements, ElementVersion>::GetInternalFrc(const bool Use_OMP) {
    ChTimer<> timer_internal_forces;
    timer_internal_forces.reset();
...
template <int num_elements, typename ElementVersion>
double ANCFBrick3843Test<num_elements, ElementVersion>::GetJacobian(const bool Use_OMP) {
    ChTimer<> timer_KRM;
    timer_KRM.reset();
...
template <int num_elements, typename ElementVersion>
void ANCFBrick3843Test<num_elements, ElementVersion>::PrintTimingResults(const std::string& TestName, int steps) {
    std::cout << "-------------------------------------" << std::endl;
    std::cout << "Test Name, Num Els, Steps, Threads, ";
    std::cout << "IntFrc Max(us), IntFrc Min(us), IntFrc Mean(us), IntFrc StDev(us), ";
    std::cout << "KRM Max(us), KRM Min(us), KRM Mean(us), KRM StDev(us), " << std::endl;
...
void Run_ANCFBrick_3843_Tests() {
    ...
    //{
    //    ANCFBrick3843Test<num_elements, ChElementHexaANCF_3843_MR_V1> Test;
    //    Test.PrintTimingResults("ChElementHexaANCF_3843_MR_V1", num_steps);
    //}
    //{
    //    ANCFBrick3843Test<num_elements, ChElementHexaANCF_3843_MR_V2> Test;
    //    Test.PrintTimingResults("ChElementHexaANCF_3843_MR_V2", num_steps);
    //}
    {
        ANCFBrick3843Test<num_elements, ChElementHexaANCF_3843_MR_V3> Test;
        Test.PrintTimingResults("ChElementHexaANCF_3843_MR_V3", num_steps);
    }
    //{
    //    ANCFBrick3843Test<num_elements, ChElementHexaANCF_3843_MR_V4> Test;
    //    Test.PrintTimingResults("ChElementHexaANCF_3843_MR_V4", num_steps);
    //}
    {
        ANCFBrick3843Test<num_elements, ChElementHexaANCF_3843_MR_V5> Test;
        Test.PrintTimingResults("ChElementHexaANCF_3843_MR_V5", num_steps);
    }
    {
        ANCFBrick3843Test<num_elements, ChElementHexaANCF_3843_MR_V6> Test;
        Test.PrintTimingResults("ChElementHexaANCF_3843_MR_V6", num_steps);
    }
    {
        ANCFBrick3843Test<num_elements, ChElementHexaANCF_3843_MR_V7> Test;
