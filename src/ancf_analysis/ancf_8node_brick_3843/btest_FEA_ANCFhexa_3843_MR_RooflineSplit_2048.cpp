...
template <int num_elements, typename ElementVersion>
void ANCFHexa3843Test_MR<num_elements, ElementVersion>::PrintTimingResults(const std::string& TestName,
    int IntFrcSteps, int JacSteps) {
    std::cout << "-------------------------------------" << std::endl;
    std::cout << "Test Name, Num Els, IntFrcSteps, JacSteps, Threads, ";
    std::cout << "IntFrc Min(us), IntFrc Q1(us), IntFrc Median(us), IntFrc Q3(us), ";
...
void Run_ANCFHexa_3843_Tests() {
    ...
    int num_steps_IntFrc_MR_Damp         = 100 * 8192 / num_elements;
	int num_steps_IntFrc_MR_DampNumJac   = 100 * 8192 / num_elements;
	int num_steps_IntFrc_MR_NoDamp       = 100 * 8192 / num_elements;
	int num_steps_IntFrc_MR_NoDampNumJac = 100 * 8192 / num_elements;

    int num_steps_Jac_MR_Damp         = 4 * 8192 / num_elements;
	int num_steps_Jac_MR_DampNumJac   = 1 * 8192 / num_elements;
	int num_steps_Jac_MR_NoDamp       = 4 * 8192 / num_elements;
	int num_steps_Jac_MR_NoDampNumJac = 2 * 8192 / num_elements;

    //{
    //    ANCFHexa3843Test<num_elements, ChElementHexaANCF_3843_TR08, ChMaterialBeamANCF> Hexa3843Test_TR08;
...

    {
        ...
        Test.PrintTimingResults("ChElementHHexaANCF_3843_MR_Damp", num_steps_IntFrc_MR_Damp, num_steps_Jac_MR_Damp);
    }
    {
        ANCFHexa3843Test_MR<num_elements, ChElementHexaANCF_3843_MR_DampNumJac> Test;
        Test.PrintTimingResults("ChElementHexaANCF_3843_MR_DampNumJac", num_steps_IntFrc_MR_DampNumJac, num_steps_Jac_MR_DampNumJac);
    }
    {
        ANCFHexa3843Test_MR<num_elements, ChElementHexaANCF_3843_MR_NoDamp> Test;
        Test.PrintTimingResults("ChElementHexaANCF_3843_MR_NoDamp", num_steps_IntFrc_MR_NoDamp, num_steps_Jac_MR_NoDamp);
    }
    {
        ANCFHexa3843Test_MR<num_elements, ChElementHexaANCF_3843_MR_NoDampNumJac> Test;
        Test.PrintTimingResults("ChElementHexaANCF_3843_MR_NoDampNumJac", num_steps_IntFrc_MR_NoDampNumJac, num_steps_Jac_MR_NoDampNumJac);
    }
