...
bool ANCFBrickTest<ElementVersion>::AxialDisplacementCheck(int msglvl) {
    ...
    if ((abs(Tip_Angles.x() * CH_RAD_TO_DEG) > 0.1) || (abs(Tip_Angles.y() * CH_RAD_TO_DEG) > 0.1) || (abs(Tip_Angles.z() * CH_RAD_TO_DEG) > 0.1)) {
        passed_tests = false;
    }
...
bool ANCFBrickTest<ElementVersion>::CantileverTipLoadCheck(int msglvl) {
    ...
    if ((abs(Tip_Angles.x() * CH_RAD_TO_DEG) > 0.1) || (abs(Tip_Angles.z() * CH_RAD_TO_DEG) > 0.1)) {
        passed_tests = false;
    }
...
bool ANCFBrickTest<ElementVersion>::AxialTwistCheck(int msglvl) {
    ...
    if ((abs(Tip_Angles.y() * CH_RAD_TO_DEG) > 0.1) || (abs(Tip_Angles.z() * CH_RAD_TO_DEG) > 0.1)) {
        passed_tests = false;
    }
...
int main(int argc, char* argv[]) {
    ...
    std::cout << "-------------------------------------" << std::endl;
    ANCFBrickTest<ChElementHexaANCF_3843_MR_Damp> ChElementHexaANCF_3843_MR_Damp_test;
    if (ChElementHexaANCF_3843_MR_Damp_test.RunElementChecks(1))
        print_green("ChElementHexaANCF_3843_MR_Damp Element Checks = PASSED\n");
    else
        print_red("ChElementHexaANCF_3843_MR_Damp Element Checks = FAILED\n");

    std::cout << "-------------------------------------" << std::endl;
    ANCFBrickTest<ChElementHexaANCF_3843_MR_NoDamp> ChElementHexaANCF_3843_MR_NoDamp_test;
    if (ChElementHexaANCF_3843_MR_NoDamp_test.RunElementChecks(1))
        print_green("ChElementHexaANCF_3843_MR_NoDamp Element Checks = PASSED\n");
    else
        print_red("ChElementHexaANCF_3843_MR_NoDamp Element Checks = FAILED\n");

    std::cout << "-------------------------------------" << std::endl;
    ANCFBrickTest<ChElementHexaANCF_3843_MR_DampNumJac> ChElementHexaANCF_3843_MR_DampNumJac_test;
    if (ChElementHexaANCF_3843_MR_DampNumJac_test.RunElementChecks(1))
        print_green("ChElementHexaANCF_3843_MR_DampNumJac Element Checks = PASSED\n");
    else
        print_red("ChElementHexaANCF_3843_MR_DampNumJac Element Checks = FAILED\n");

    std::cout << "-------------------------------------" << std::endl;
    ANCFBrickTest<ChElementHexaANCF_3843_MR_NoDampNumJac> ChElementHexaANCF_3843_MR_NoDampNumJac_test;
    if (ChElementHexaANCF_3843_MR_NoDampNumJac_test.RunElementChecks(1))
        print_green("ChElementHexaANCF_3843_MR_NoDampNumJac Element Checks = PASSED\n");
    else
        print_red("ChElementHexaANCF_3843_MR_NoDampNumJac Element Checks = FAILED\n");
    ...
    //std::cout << "-------------------------------------" << std::endl;
    //ANCFBrickTest<ChElementHexaANCF_3843_MR_V8> ChElementHexaANCF_3843_MR_V8_test;
    //if (ChElementHexaANCF_3843_MR_V8_test.RunElementChecks(1))
    //    print_green("ChElementHexaANCF_3843_MR_V8 Element Checks = PASSED\n");
    //else
    //    print_red("ChElementHexaANCF_3843_MR_V8 Element Checks = FAILED\n");
