...
void Run_ANCFBeam_3333_Tests() {
    ...
    int num_steps_IntFrc_MR_Damp         = 800 * 8192 / num_elements;
	int num_steps_IntFrc_MR_DampNumJac   = 800 * 8192 / num_elements;
	int num_steps_IntFrc_MR_NoDamp       = 800 * 8192 / num_elements;
	int num_steps_IntFrc_MR_NoDampNumJac = 800 * 8192 / num_elements;

    int num_steps_Jac_MR_Damp         = 120 * 8192 / num_elements;
	int num_steps_Jac_MR_DampNumJac   = 14 * 8192 / num_elements;
	int num_steps_Jac_MR_NoDamp       = 120 * 8192 / num_elements;
	int num_steps_Jac_MR_NoDampNumJac = 40 * 8192 / num_elements;
...

    {
        ...
        Test.PrintTimingResults("ChElementBeamANCF_3333_MR_Damp", num_steps_IntFrc_MR_Damp, num_steps_Jac_MR_Damp);
    }
    {
        ANCFBeam3333Test_MR<num_elements, ChElementBeamANCF_3333_MR_DampNumJac> Test;
        Test.PrintTimingResults("ChElementBeamANCF_3333_MR_DampNumJac", num_steps_IntFrc_MR_DampNumJac, num_steps_Jac_MR_DampNumJac);
    }
    {
        ANCFBeam3333Test_MR<num_elements, ChElementBeamANCF_3333_MR_NoDamp> Test;
        Test.PrintTimingResults("ChElementBeamANCF_3333_MR_NoDamp", num_steps_IntFrc_MR_NoDamp, num_steps_Jac_MR_NoDamp);
    }
    {
        ANCFBeam3333Test_MR<num_elements, ChElementBeamANCF_3333_MR_NoDampNumJac> Test;
        Test.PrintTimingResults("ChElementBeamANCF_3333_MR_NoDampNumJac", num_steps_IntFrc_MR_NoDampNumJac, num_steps_Jac_MR_NoDampNumJac);
    }
}
