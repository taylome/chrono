...
int main(int argc, char* argv[]) {
    ...
    std::cout << "-------------------------------------" << std::endl;
    ANCFBeamTest<ChElementBeamANCF_3333_TR05_GQ322, ChMaterialBeamANCF_3333_TR05_GQ322> ChElementBeamANCF_3333_TR05_GQ322_test;
    if (ChElementBeamANCF_3333_TR05_GQ322_test.RunElementChecks(0))
        print_green("ChElementBeamANCF_3333_TR05_GQ322 Element Checks = PASSED\n");
    else
        print_red("ChElementBeamANCF_3333_TR05_GQ322 Element Checks = FAILED\n");
    ...
    std::cout << "-------------------------------------" << std::endl;
    ANCFBeamTest<ChElementBeamANCF_3333_TR06_GQ322, ChMaterialBeamANCF_3333_TR06_GQ322> ChElementBeamANCF_3333_TR06_GQ322_test;
    if (ChElementBeamANCF_3333_TR06_GQ322_test.RunElementChecks(0))
        print_green("ChElementBeamANCF_3333_TR06_GQ322 Element Checks = PASSED\n");
    else
        print_red("ChElementBeamANCF_3333_TR06_GQ322 Element Checks = FAILED\n");
    ...
    std::cout << "-------------------------------------" << std::endl;
    ANCFBeamTest<ChElementBeamANCF_3333_TR07S, ChMaterialBeamANCF_3333_TR07S> ChElementBeamANCF_3333_TR07S_test;
    if (ChElementBeamANCF_3333_TR07S_test.RunElementChecks(0))
        print_green("ChElementBeamANCF_3333_TR07S Element Checks = PASSED\n");
    else
        print_red("ChElementBeamANCF_3333_TR07S Element Checks = FAILED\n");

    std::cout << "-------------------------------------" << std::endl;
    ANCFBeamTest<ChElementBeamANCF_3333_TR07S_GQ322, ChMaterialBeamANCF_3333_TR07S_GQ322> ChElementBeamANCF_3333_TR07S_GQ322_test;
    if (ChElementBeamANCF_3333_TR07S_GQ322_test.RunElementChecks(0))
        print_green("ChElementBeamANCF_3333_TR07S_GQ322 Element Checks = PASSED\n");
    else
        print_red("ChElementBeamANCF_3333_TR07S_GQ322 Element Checks = FAILED\n");
    ...
    std::cout << "-------------------------------------" << std::endl;
    ANCFBeamTest<ChElementBeamANCF_3333_TR08S, ChMaterialBeamANCF_3333_TR08S> ChElementBeamANCF_3333_TR08S_test;
    if (ChElementBeamANCF_3333_TR08S_test.RunElementChecks(0))
        print_green("ChElementBeamANCF_3333_TR08S Element Checks = PASSED\n");
    else
        print_red("ChElementBeamANCF_3333_TR08S Element Checks = FAILED\n");

    std::cout << "-------------------------------------" << std::endl;
    ANCFBeamTest<ChElementBeamANCF_3333_TR08S_GQ322, ChMaterialBeamANCF_3333_TR08S_GQ322> ChElementBeamANCF_3333_TR08S_GQ322_test;
    if (ChElementBeamANCF_3333_TR08S_GQ322_test.RunElementChecks(0))
        print_green("ChElementBeamANCF_3333_TR08S_GQ322 Element Checks = PASSED\n");
    else
        print_red("ChElementBeamANCF_3333_TR08S_GQ322 Element Checks = FAILED\n");
    ...
    std::cout << "-------------------------------------" << std::endl;
    ANCFBeamTest<ChElementBeamANCF_3333_TR11S, ChMaterialBeamANCF_3333_TR11S> ChElementBeamANCF_3333_TR11S_test;
    if (ChElementBeamANCF_3333_TR11S_test.RunElementChecks(0))
        print_green("ChElementBeamANCF_3333_TR11S Element Checks = PASSED\n");
    else
        print_red("ChElementBeamANCF_3333_TR11S Element Checks = FAILED\n");
