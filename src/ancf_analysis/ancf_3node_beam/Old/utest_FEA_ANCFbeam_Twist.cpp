...
int main(int argc, char* argv[]) {
    ...
    auto m_system = new ChSystemSMC();
    m_system->Set_G_acc(ChVector<>(0, 0, 0));  //Turn off gravity since this is a statics test against an analytical solution
