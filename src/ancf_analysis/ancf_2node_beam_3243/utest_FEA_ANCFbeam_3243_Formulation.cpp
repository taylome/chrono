...
// =============================================================================
//
// Unit test for the formulation of the fully parameterized 2 node ANCF beam element 3243.
//
...
class ANCFBeamTest {
  ...
  protected:
    ...
    std::shared_ptr<ChElementBeamANCF_3243<>> m_element;
...
bool ANCFBeamTest::GeneralizedInternalForceSmallDispNoVelCheck(int msglvl) {
    ...
    if (!load_validation_data("UT_ANCFBeam_3243_IntFrcSmallDispNoVelNoGravity.txt",
                              Expected_InternalForceSmallDispNoVelNoGravity))
        return false;
...
bool ANCFBeamTest::GeneralizedInternalForceNoDispSmallVelCheck(int msglvl) {
    ...
    if (!load_validation_data("UT_ANCFBeam_3243_IntFrcNoDispSmallVelNoGravity.txt",
                              Expected_InternalForceNoDispSmallVelNoGravity))
        return false;
...
bool ANCFBeamTest::CantileverCheck(int msglvl) {
    // =============================================================================
...
int main(int argc, char* argv[]) {
    ...
    std::cout << "-------------------------------------" << std::endl;
    ANCFBeamTest ChElementBeamANCF_3243_ContInt_test(true);
    if (ChElementBeamANCF_3243_ContInt_test.RunElementChecks(1))
        print_green("ChElementBeamANCF_3243 Element (ContInt Method) Checks = PASSED\n");
    else {
        print_red("ChElementBeamANCF_3243 Element (ContInt Method) Checks = FAILED\n");
        tests_passed = false;
    }

    std::cout << "-------------------------------------" << std::endl;
    ANCFBeamTest ChElementBeamANCF_3243_PreInt_test(false);
    if (ChElementBeamANCF_3243_PreInt_test.RunElementChecks(1))
        print_green("ChElementBeamANCF_3243 Element (PreInt Method) Checks = PASSED\n");
    else {
        print_red("ChElementBeamANCF_3243 Element (PreInt Method) Checks = FAILED\n");
        tests_passed = false;
    }
