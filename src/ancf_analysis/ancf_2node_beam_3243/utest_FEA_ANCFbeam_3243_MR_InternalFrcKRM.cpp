...
// =============================================================================
//
// Unit test for ANCF beam elements
//
// =============================================================================
...
bool ANCFBeamTest<ElementVersion>::GeneralizedInternalForceSmallDispNoVelCheck(int msglvl) {
    ...
    if (!load_validation_data("UT_ANCFBeam_3243_MR_IntFrcSmallDispNoVel.txt", Expected_InternalForceSmallDispNoVel))
        return false;
...
bool ANCFBeamTest<ElementVersion>::GeneralizedInternalForceNoDispSmallVelCheck(int msglvl) {
    ...
    if (!load_validation_data("UT_ANCFBeam_3243_MR_IntFrcNoDispSmallVel.txt", Expected_InternalForceNoDispSmallVel))
        return false;
...
bool ANCFBeamTest<ElementVersion>::JacobianNoDispNoVelNoDampingCheck(int msglvl) {
    ...
    if (!load_validation_data("UT_ANCFBeam_3243_MR_JacNoDispNoVelNoDamping.txt", Expected_JacobianK_NoDispNoVelNoDamping))
        return false;
...
bool ANCFBeamTest<ElementVersion>::JacobianSmallDispNoVelNoDampingCheck(int msglvl) {
    ...
    if (!load_validation_data("UT_ANCFBeam_3243_MR_JacSmallDispNoVelNoDamping.txt",
...
bool ANCFBeamTest<ElementVersion>::JacobianNoDispNoVelWithDampingCheck(int msglvl) {
    ...
    if (!load_validation_data("UT_ANCFBeam_3243_MR_JacNoDispNoVelWithDamping.txt", Expected_Jacobians))
        return false;
...
bool ANCFBeamTest<ElementVersion>::JacobianSmallDispNoVelWithDampingCheck(int msglvl) {
    ...
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor> Expected_Jacobians;
    Expected_Jacobians.resize(2 * 3 * NSF, 3 * NSF);
    if (!load_validation_data("UT_ANCFBeam_3243_MR_JacSmallDispNoVelWithDamping.txt", Expected_Jacobians))
        return false;
...
bool ANCFBeamTest<ElementVersion>::JacobianNoDispSmallVelWithDampingCheck(int msglvl) {
    ...
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor> Expected_Jacobians;
    Expected_Jacobians.resize(2 * 3 * NSF, 3 * NSF);
    if (!load_validation_data("UT_ANCFBeam_3243_MR_JacNoDispSmallVelWithDamping.txt", Expected_Jacobians))
        return false;
...
bool ANCFBeamTest<ElementVersion>::CantileverTipLoadCheck(int msglvl) {
    ...
    class MyLoaderTimeDependentTipLoad : public ChLoaderUatomic {
      public:
        ...
        virtual void ComputeF(
            ...
            F.setZero();
            F(2) = TIP_FORCE * 0.0001;  // Apply the force along the global Z axis (beam axis)
        }
    ...
    double Displacement_Theory = (TIP_FORCE * 0.0001 * std::pow(length, 3)) / (3.0 * E * I);
...
int main(int argc, char* argv[]) {
    ...
    std::cout << "-------------------------------------" << std::endl;
    ANCFBeamTest<ChElementBeamANCF_3243_MR_Damp> ChElementBeamANCF_3243_MR_Damp_test;
    if (ChElementBeamANCF_3243_MR_Damp_test.RunElementChecks(1))
        print_green("ChElementBeamANCF_3243_MR_Damp Element Checks = PASSED\n");
    else
        print_red("ChElementBeamANCF_3243_MR_Damp Element Checks = FAILED\n");

    std::cout << "-------------------------------------" << std::endl;
    ANCFBeamTest<ChElementBeamANCF_3243_MR_NoDamp> ChElementBeamANCF_3243_MR_NoDamp_test;
    if (ChElementBeamANCF_3243_MR_NoDamp_test.RunElementChecks(1))
        print_green("ChElementBeamANCF_3243_MR_NoDamp Element Checks = PASSED\n");
    else
        print_red("ChElementBeamANCF_3243_MR_NoDamp Element Checks = FAILED\n");

    std::cout << "-------------------------------------" << std::endl;
    ANCFBeamTest<ChElementBeamANCF_3243_MR_DampNumJac> ChElementBeamANCF_3243_MR_DampNumJac_test;
    if (ChElementBeamANCF_3243_MR_DampNumJac_test.RunElementChecks(1))
        print_green("ChElementBeamANCF_3243_MR_DampNumJac Element Checks = PASSED\n");
    else
        print_red("ChElementBeamANCF_3243_MR_DampNumJac Element Checks = FAILED\n");

    std::cout << "-------------------------------------" << std::endl;
    ANCFBeamTest<ChElementBeamANCF_3243_MR_NoDampNumJac> ChElementBeamANCF_3243_MR_NoDampNumJac_test;
    if (ChElementBeamANCF_3243_MR_NoDampNumJac_test.RunElementChecks(1))
        print_green("ChElementBeamANCF_3243_MR_NoDampNumJac Element Checks = PASSED\n");
    else
        print_red("ChElementBeamANCF_3243_MR_NoDampNumJac Element Checks = FAILED\n");
