...
#ifdef CHRONO_IRRLICHT
    irrlicht::ChIrrApp application(m_system, L"ANCF Beam 3243", irr::core::dimension2d<irr::u32>(800, 600));
    ...
    if (argc > 1) {
...
#ifdef CHRONO_IRRLICHT
        ANCFBeamTest<ChElementBeamANCF_3243_TR08, ChMaterialBeamANCF> test(8, SolverType::SparseLU, 1);
        test.SimulateVis();
#endif
    } else {
        ...
        for (const auto& ls : Solver) {
            for (auto i = 0; i < num_els.size(); i++) {
                ...
                while (run) {
                    {
                        ANCFBeamTest<ChElementBeamANCF_3243, ChMaterialBeamANCF> test(num_els(i), ls, NumThreads);
                        test.RunTimingTest(timing_stats, "ChElementBeamANCF_3243_Chrono7");
                    }
                    //{
                    //    ANCFBeamTest<ChElementBeamANCF_3243_TR01, ChMaterialBeamANCF> test(num_els(i), ls,
                    //    NumThreads); test.RunTimingTest(timing_stats, "ChElementBeamANCF_3243_TR01");
                    //}
                    //{
                    //    ANCFBeamTest<ChElementBeamANCF_3243_TR01B, ChMaterialBeamANCF> test(num_els(i), ls,
                    //    NumThreads); test.RunTimingTest(timing_stats, "ChElementBeamANCF_3243_TR01B");
                    //}
                    //{
                    //    ANCFBeamTest<ChElementBeamANCF_3243_TR02, ChMaterialBeamANCF> test(num_els(i), ls,
                    //    NumThreads); test.RunTimingTest(timing_stats, "ChElementBeamANCF_3243_TR02");
                    //}
                    //{
                    //    ANCFBeamTest<ChElementBeamANCF_3243_TR02B, ChMaterialBeamANCF> test(num_els(i), ls,
                    //    NumThreads); test.RunTimingTest(timing_stats, "ChElementBeamANCF_3243_TR02B");
                    //}
                    //{
                    //    ANCFBeamTest<ChElementBeamANCF_3243_TR03, ChMaterialBeamANCF> test(num_els(i), ls,
                    //    NumThreads); test.RunTimingTest(timing_stats, "ChElementBeamANCF_3243_TR03");
                    //}
                    //{
                    //    ANCFBeamTest<ChElementBeamANCF_3243_TR03B, ChMaterialBeamANCF> test(num_els(i), ls,
                    //    NumThreads); test.RunTimingTest(timing_stats, "ChElementBeamANCF_3243_TR03B");
                    //}
                    //{
                    //    ANCFBeamTest<ChElementBeamANCF_3243_TR04, ChMaterialBeamANCF> test(num_els(i), ls,
                    //    NumThreads); test.RunTimingTest(timing_stats, "ChElementBeamANCF_3243_TR04");
                    //}
                    //{
                    //    ANCFBeamTest<ChElementBeamANCF_3243_TR04B, ChMaterialBeamANCF> test(num_els(i), ls,
                    //    NumThreads); test.RunTimingTest(timing_stats, "ChElementBeamANCF_3243_TR04B");
                    //}
                    {
                        ANCFBeamTest<ChElementBeamANCF_3243_TR05, ChMaterialBeamANCF> test(num_els(i), ls, NumThreads);
                        test.RunTimingTest(timing_stats, "ChElementBeamANCF_3243_TR05");
                    }
                    {
                        ANCFBeamTest<ChElementBeamANCF_3243_TR05B, ChMaterialBeamANCF> test(num_els(i), ls, NumThreads);
                        test.RunTimingTest(timing_stats, "ChElementBeamANCF_3243_TR05B");
                    }
                    {
                        ANCFBeamTest<ChElementBeamANCF_3243_TR06, ChMaterialBeamANCF> test(num_els(i), ls, NumThreads);
                        test.RunTimingTest(timing_stats, "ChElementBeamANCF_3243_TR06");
                    }
                    {
                        ANCFBeamTest<ChElementBeamANCF_3243_TR06B, ChMaterialBeamANCF> test(num_els(i), ls, NumThreads);
                        test.RunTimingTest(timing_stats, "ChElementBeamANCF_3243_TR06B");
                    }
                    {
                        ANCFBeamTest<ChElementBeamANCF_3243_TR07, ChMaterialBeamANCF> test(num_els(i), ls, NumThreads);
                        test.RunTimingTest(timing_stats, "ChElementBeamANCF_3243_TR07");
                    }
                    {
                        ANCFBeamTest<ChElementBeamANCF_3243_TR07B, ChMaterialBeamANCF> test(num_els(i), ls, NumThreads);
                        test.RunTimingTest(timing_stats, "ChElementBeamANCF_3243_TR07B");
                    }
                    {
                        ANCFBeamTest<ChElementBeamANCF_3243_TR08, ChMaterialBeamANCF> test(num_els(i), ls, NumThreads);
                        test.RunTimingTest(timing_stats, "ChElementBeamANCF_3243_TR08");
                    }
                    {
                        ANCFBeamTest<ChElementBeamANCF_3243_TR08B, ChMaterialBeamANCF> test(num_els(i), ls, NumThreads);
                        test.RunTimingTest(timing_stats, "ChElementBeamANCF_3243_TR08B");
                    }
                    {
                        ANCFBeamTest<ChElementBeamANCF_3243_TR09, ChMaterialBeamANCF> test(num_els(i), ls, NumThreads);
                        test.RunTimingTest(timing_stats, "ChElementBeamANCF_3243_TR09");
                    }
                    {
                        ANCFBeamTest<ChElementBeamANCF_3243_TR09B, ChMaterialBeamANCF> test(num_els(i), ls, NumThreads);
                        test.RunTimingTest(timing_stats, "ChElementBeamANCF_3243_TR09B");
                    }
                    {
                        ANCFBeamTest<ChElementBeamANCF_3243_TR10, ChMaterialBeamANCF> test(num_els(i), ls, NumThreads);
                        test.RunTimingTest(timing_stats, "ChElementBeamANCF_3243_TR10");
                    }
                    {
                        ANCFBeamTest<ChElementBeamANCF_3243_TR10B, ChMaterialBeamANCF> test(num_els(i), ls, NumThreads);
                        test.RunTimingTest(timing_stats, "ChElementBeamANCF_3243_TR10B");
                    }
                    {
                        ANCFBeamTest<ChElementBeamANCF_3243_TR11, ChMaterialBeamANCF> test(num_els(i), ls, NumThreads);
                        test.RunTimingTest(timing_stats, "ChElementBeamANCF_3243_TR11");
                    }
                    {
                        ANCFBeamTest<ChElementBeamANCF_3243_TR11B, ChMaterialBeamANCF> test(num_els(i), ls, NumThreads);
                        test.RunTimingTest(timing_stats, "ChElementBeamANCF_3243_TR11B");
                    }
