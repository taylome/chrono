...
bool ANCFBeamTest<ElementVersion, MaterialVersion>::MassMatrixCheck(int msglvl) {
    ...
    Expected_MassMatrix_Compact.resize(8, 8);
...
bool ANCFBeamTest<ElementVersion, MaterialVersion>::GeneralizedGravityForceCheck(int msglvl) {
    ...
    Expected_InternalForceDueToGravity.resize(24, 1);
...
bool ANCFBeamTest<ElementVersion, MaterialVersion>::GeneralizedInternalForceSmallDispNoVelCheck(int msglvl) {
    ...
    Expected_InternalForceSmallDispNoVelNoGravity.resize(24, 1);
    if (!load_validation_data("UT_ANCFBeam_3243_IntFrcSmallDispNoVelNoGravity.txt", Expected_InternalForceSmallDispNoVelNoGravity))
        return false;
...
bool ANCFBeamTest<ElementVersion, MaterialVersion>::GeneralizedInternalForceNoDispSmallVelCheck(int msglvl) {
    ...
    Expected_InternalForceNoDispSmallVelNoGravity.resize(24, 1);
    if (!load_validation_data("UT_ANCFBeam_3243_IntFrcNoDispSmallVelNoGravity.txt", Expected_InternalForceNoDispSmallVelNoGravity))
        return false;
...
bool ANCFBeamTest<ElementVersion, MaterialVersion>::JacobianNoDispNoVelNoDampingCheck(int msglvl) {
    ...
    Expected_JacobianK_NoDispNoVelNoDamping.resize(24, 24);
...
bool ANCFBeamTest<ElementVersion, MaterialVersion>::JacobianSmallDispNoVelNoDampingCheck(int msglvl) {
    ...
    Expected_JacobianK_SmallDispNoVelNoDamping.resize(24, 24);
    if (!load_validation_data("UT_ANCFBeam_3243_JacSmallDispNoVelNoDamping.txt", Expected_JacobianK_SmallDispNoVelNoDamping))
        return false;
...
bool ANCFBeamTest<ElementVersion, MaterialVersion>::JacobianNoDispNoVelWithDampingCheck(int msglvl) {
    ...
    Expected_Jacobians.resize(2*24, 24);
...
int main(int argc, char* argv[]) {
    ...
    std::cout << "-------------------------------------" << std::endl;
    ANCFBeamTest<ChElementBeamANCF_3243_TR07S, ChMaterialBeamANCF_3243_TR07S> ChElementBeamANCF_3243_TR07S_test;
    if (ChElementBeamANCF_3243_TR07S_test.RunElementChecks(0))
