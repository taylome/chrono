...
class ANCFHexaTest {
  public:
    ANCFHexaTest(int num_elements, SolverType solver_type, int NumThreads);
...
template <typename ElementVersion, typename MaterialVersion>
ANCFHexaTest<ElementVersion, MaterialVersion>::ANCFHexaTest(int num_elements, SolverType solver_type, int NumThreads) {
...
template <typename ElementVersion, typename MaterialVersion>
void ANCFHexaTest<ElementVersion, MaterialVersion>::SimulateVis() {
#ifdef CHRONO_IRRLICHT
    irrlicht::ChIrrApp application(m_system, L"ANCF Hexas 3843", irr::core::dimension2d<irr::u32>(800, 600), false,
                                   true);
...
template <typename ElementVersion, typename MaterialVersion>
void ANCFHexaTest<ElementVersion, MaterialVersion>::RunTimingTest(ChMatrixNM<double, 4, 19>& timing_stats,
    ...
    if (argc > 1) {
...
#ifdef CHRONO_IRRLICHT
        ANCFHexaTest<ChElementHexaANCF_3843_TR08, ChMaterialHexaANCF> test(8, SolverType::SparseLU, 1);
        test.SimulateVis();
#endif
    } else {
        ...
        for (const auto& ls : Solver) {
            for (auto i = 0; i < num_els.size(); i++) {
                ...
                while (run) {
                    {
                        ANCFHexaTest<ChElementHexaANCF_3843, ChMaterialHexaANCF> test(num_els(i), ls, NumThreads);
                        test.RunTimingTest(timing_stats, "ChElementHexaANCF_3843_Chrono7");
                    }
                    //{
                    //    ANCFHexaTest<ChElementHexaANCF_3843_TR01, ChMaterialHexaANCF> test(num_els(i), ls,
                    //    NumThreads); test.RunTimingTest(timing_stats, "ChElementHexaANCF_3843_TR01");
                    //}
                    //{
                    //    ANCFHexaTest<ChElementHexaANCF_3843_TR01B, ChMaterialHexaANCF> test(num_els(i), ls,
                    //    NumThreads); test.RunTimingTest(timing_stats, "ChElementHexaANCF_3843_TR01B");
                    //}
                    //{
                    //    ANCFHexaTest<ChElementHexaANCF_3843_TR02, ChMaterialHexaANCF> test(num_els(i), ls,
                    //    NumThreads); test.RunTimingTest(timing_stats, "ChElementHexaANCF_3843_TR02");
                    //}
                    //{
                    //    ANCFHexaTest<ChElementHexaANCF_3843_TR02B, ChMaterialHexaANCF> test(num_els(i), ls,
                    //    NumThreads); test.RunTimingTest(timing_stats, "ChElementHexaANCF_3843_TR02B");
                    //}
                    //{
                    //    ANCFHexaTest<ChElementHexaANCF_3843_TR03, ChMaterialHexaANCF> test(num_els(i), ls,
                    //    NumThreads); test.RunTimingTest(timing_stats, "ChElementHexaANCF_3843_TR03");
                    //}
                    //{
                    //    ANCFHexaTest<ChElementHexaANCF_3843_TR03B, ChMaterialHexaANCF> test(num_els(i), ls,
                    //    NumThreads); test.RunTimingTest(timing_stats, "ChElementHexaANCF_3843_TR03B");
                    //}
                    //{
                    //    ANCFHexaTest<ChElementHexaANCF_3843_TR04, ChMaterialHexaANCF> test(num_els(i), ls,
                    //    NumThreads); test.RunTimingTest(timing_stats, "ChElementHexaANCF_3843_TR04");
                    //}
                    //{
                    //    ANCFHexaTest<ChElementHexaANCF_3843_TR04B, ChMaterialHexaANCF> test(num_els(i), ls,
                    //    NumThreads); test.RunTimingTest(timing_stats, "ChElementHexaANCF_3843_TR04B");
                    //}
                    {
                        ANCFHexaTest<ChElementHexaANCF_3843_TR05, ChMaterialHexaANCF> test(num_els(i), ls, NumThreads);
                        test.RunTimingTest(timing_stats, "ChElementHexaANCF_3843_TR05");
                    }
                    {
                        ANCFHexaTest<ChElementHexaANCF_3843_TR05B, ChMaterialHexaANCF> test(num_els(i), ls, NumThreads);
                        test.RunTimingTest(timing_stats, "ChElementHexaANCF_3843_TR05B");
                    }
                    {
                        ANCFHexaTest<ChElementHexaANCF_3843_TR06, ChMaterialHexaANCF> test(num_els(i), ls, NumThreads);
                        test.RunTimingTest(timing_stats, "ChElementHexaANCF_3843_TR06");
                    }
                    {
                        ANCFHexaTest<ChElementHexaANCF_3843_TR06B, ChMaterialHexaANCF> test(num_els(i), ls, NumThreads);
                        test.RunTimingTest(timing_stats, "ChElementHexaANCF_3843_TR06B");
                    }
                    {
                        ANCFHexaTest<ChElementHexaANCF_3843_TR07, ChMaterialHexaANCF> test(num_els(i), ls, NumThreads);
                        test.RunTimingTest(timing_stats, "ChElementHexaANCF_3843_TR07");
                    }
                    {
                        ANCFHexaTest<ChElementHexaANCF_3843_TR07B, ChMaterialHexaANCF> test(num_els(i), ls, NumThreads);
                        test.RunTimingTest(timing_stats, "ChElementHexaANCF_3843_TR07B");
                    }
                    {
                        ANCFHexaTest<ChElementHexaANCF_3843_TR08, ChMaterialHexaANCF> test(num_els(i), ls, NumThreads);
                        test.RunTimingTest(timing_stats, "ChElementHexaANCF_3843_TR08");
                    }
                    {
                        ANCFHexaTest<ChElementHexaANCF_3843_TR08B, ChMaterialHexaANCF> test(num_els(i), ls, NumThreads);
                        test.RunTimingTest(timing_stats, "ChElementHexaANCF_3843_TR08B");
                    }
                    {
                        ANCFHexaTest<ChElementHexaANCF_3843_TR09, ChMaterialHexaANCF> test(num_els(i), ls, NumThreads);
                        test.RunTimingTest(timing_stats, "ChElementHexaANCF_3843_TR09");
                    }
                    {
                        ANCFHexaTest<ChElementHexaANCF_3843_TR09B, ChMaterialHexaANCF> test(num_els(i), ls, NumThreads);
                        test.RunTimingTest(timing_stats, "ChElementHexaANCF_3843_TR09B");
                    }
                    {
                        ANCFHexaTest<ChElementHexaANCF_3843_TR10, ChMaterialHexaANCF> test(num_els(i), ls, NumThreads);
                        test.RunTimingTest(timing_stats, "ChElementHexaANCF_3843_TR10");
                    }
                    {
                        ANCFHexaTest<ChElementHexaANCF_3843_TR10B, ChMaterialHexaANCF> test(num_els(i), ls, NumThreads);
                        test.RunTimingTest(timing_stats, "ChElementHexaANCF_3843_TR10B");
                    }
                    {
                        ANCFHexaTest<ChElementHexaANCF_3843_TR11, ChMaterialHexaANCF> test(num_els(i), ls, NumThreads);
                        test.RunTimingTest(timing_stats, "ChElementHexaANCF_3843_TR11");
                    }
                    {
                        ANCFHexaTest<ChElementHexaANCF_3843_TR11B, ChMaterialHexaANCF> test(num_els(i), ls, NumThreads);
                        test.RunTimingTest(timing_stats, "ChElementHexaANCF_3843_TR11B");
                    }
