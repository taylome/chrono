...
#ifndef CHELEMENTSHELLANCF3833TR08B_H
#define CHELEMENTSHELLANCF3833TR08B_H
...
class ChApi ChMaterialShellANCF_3833_TR08b {
  public:
    /// Construct an isotropic material.
    ChMaterialShellANCF_3833_TR08b(double rho,        ///< material density
...
class ChApi ChElementShellANCF_3833_TR08b : public ChElementShell, public ChLoadableUV, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialShellANCF_3833_TR08b> shell_mat) { m_material = shell_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialShellANCF_3833_TR08b> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>  m_MassMatrix;                                    ///< mass matrix
    std::shared_ptr<ChMaterialShellANCF_3833_TR08b> m_material;  ///< shell material
