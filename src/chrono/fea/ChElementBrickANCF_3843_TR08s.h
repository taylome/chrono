...
#ifndef CHELEMENTBRICKANCF3843TR08S_H
#define CHELEMENTBRICKANCF3843TR08S_H
...
/// This class implements material properties for an ANCF Brick.
    class ChApi ChMaterialBrickANCF_3843_TR08S {
    public:
        /// Construct an isotropic material.
        ChMaterialBrickANCF_3843_TR08S(double rho,        ///< material density
...
class ChApi ChElementBrickANCF_3843_TR08S : public ChElementGeneric, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBrickANCF_3843_TR08S> brick_mat) { m_material = brick_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBrickANCF_3843_TR08S> GetMaterial() const { return m_material; }
...
public:
  ...
  private:
      ...
      std::shared_ptr<ChMaterialBrickANCF_3843_TR08S> m_material;  ///< shell material
