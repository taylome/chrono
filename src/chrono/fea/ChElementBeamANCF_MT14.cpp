...
// =============================================================================
//
// MT14 = MT13 + no recycling of Jacobian temporary variables
...
////
//// What should be done with ChVector<> ChElementBeamANCF_MT14::EvaluateBeamSectionStrains()... It doesn't seems to make sense for this element since there are no input arguments
...
////
//// For ChElementBeamANCF_MT14::ComputeNF, Need to figure out the state update stuff and exactly what Jacobian is being asked for
...
ChElementBeamANCF_MT14::ChElementBeamANCF_MT14() : m_gravity_on(false), m_thicknessY(0), m_thicknessZ(0), m_lenX(0), m_Alpha(0), m_damping_enabled(false){
    m_nodes.resize(3);
}
...
void ChElementBeamANCF_MT14::SetNodes(std::shared_ptr<ChNodeFEAxyzDD> nodeA,
...
void ChElementBeamANCF_MT14::SetupInitial(ChSystem* system) {
...
// State update.
void ChElementBeamANCF_MT14::Update() {
    ChElementGeneric::Update();
}

// Fill the D vector with the current field values at the element nodes.
void ChElementBeamANCF_MT14::GetStateBlock(ChVectorDynamic<>& mD) {
...
void ChElementBeamANCF_MT14::ComputeKRMmatricesGlobal(ChMatrixRef H, double Kfactor, double Rfactor, double Mfactor) {
    ...
    if (GetStrainFormulation() == ChElementBeamANCF_MT14::StrainFormulation::CMPoisson) {
...
void ChElementBeamANCF_MT14::ComputeMmatrixGlobal(ChMatrixRef M) {
    M.setZero();
...
// -----------------------------------------------------------------------------
void ChElementBeamANCF_MT14::ComputeMassMatrixAndGravityForce(const ChVector<>& g_acc) {
...
void ChElementBeamANCF_MT14::PrecomputeInternalForceMatricesWeights() {
    ChQuadratureTables* GQTable = GetStaticGQTables();
...
void ChElementBeamANCF_MT14::ComputeNodalMass() {
...
void ChElementBeamANCF_MT14::SetAlphaDamp(double a) {
    m_Alpha = a;
...
void ChElementBeamANCF_MT14::ComputeInternalForces(ChVectorDynamic<>& Fi) {
    ChMatrixNMc<double, 9, 3> e_bar;
    ChMatrixNMc<double, 9, 3> e_bar_dot;
...
void ChElementBeamANCF_MT14::ComputeInternalForcesAtState(ChVectorDynamic<>& Fi, ChMatrixNMc<double, 9, 3>& e_bar, ChMatrixNMc<double, 9, 3>& e_bar_dot) {
...
void ChElementBeamANCF_MT14::ComputeInternalForcesSingleGQPnt(ChMatrixNM<double, 9, 3>& QiCompact, unsigned int index, ChVectorN<double, 6>& D0, ChMatrixNMc<double, 9, 3>& e_bar, ChMatrixNMc<double, 9, 3>& e_bar_dot) {
    //ChMatrix33<double> J_0xi;               //Element Jacobian between the reference configuration and normalized configuration
...
void ChElementBeamANCF_MT14::ComputeInternalForcesSingleGQPnt(ChMatrixNM<double, 9, 3>& QiCompact, unsigned int index, ChMatrix33<double>& Dv, ChMatrixNMc<double, 9, 3>& e_bar, ChMatrixNMc<double, 9, 3>& e_bar_dot) {
    //ChMatrix33<double> J_0xi;               //Element Jacobian between the reference configuration and normalized configuration
    //ChMatrixNM<double, 9, 3> Sxi_D;         //Matrix of normalized shape function derivatives
    ChMatrixNMc<double, 9, 3> Sxi_D_0xi;     //Matrix of normalized shape function derivatives corrected for a potentially non-straight reference configuration
    ChMatrix33<double> F;                   //Deformation Gradient tensor (non-symmetric tensor)
...
void ChElementBeamANCF_MT14::ComputeInternalForcesSingleGQPnt(ChMatrixNM<double, 9, 3>& QiCompact, double xi, double eta, double zeta, ChMatrixNM<double, 6, 6>& D, ChMatrixNMc<double, 9, 3>& e_bar, ChMatrixNMc<double, 9, 3>& e_bar_dot) {
    ChMatrix33<double> J_0xi;               //Element Jacobian between the reference configuration and normalized configuration
    ChMatrixNMc<double, 9, 3> Sxi_D;         //Matrix of normalized shape function derivatives
    ChMatrixNMc<double, 9, 3> Sxi_D_0xi;     //Matrix of normalized shape function derivatives corrected for a potentially non-straight reference configuration
...
void ChElementBeamANCF_MT14::ComputeInternalJacobianSingleGQPnt(ChMatrixNM<double, 27, 27>& Jac_Dense, ChMatrixNM<double, 9, 9>& Jac_Compact, double Kfactor, double Rfactor, unsigned int index, ChVectorN<double, 6>& D0, ChMatrixNMc<double, 9, 3>& e_bar, ChMatrixNMc<double, 9, 3>& e_bar_dot) {
    ...
    ChMatrixNM<double, 9, 3> partial_e_temp3;//temporary matrix for calculating the partial derivatives of the strains with respect to the nodal coordinates
    Eigen::Map<ChRowVectorN<double, 27>> partial_e_tempReshaped3(partial_e_temp3.data(), partial_e_temp3.size());
    ChMatrixNM<double, 9, 3> partial_e_temp4;//temporary matrix for calculating the partial derivatives of the strains with respect to the nodal coordinates
    Eigen::Map<ChRowVectorN<double, 27>> partial_e_tempReshaped4(partial_e_temp4.data(), partial_e_temp4.size());
    ChMatrixNM<double, 9, 3> partial_e_temp5;//temporary matrix for calculating the partial derivatives of the strains with respect to the nodal coordinates
    Eigen::Map<ChRowVectorN<double, 27>> partial_e_tempReshaped5(partial_e_temp5.data(), partial_e_temp5.size());
    ...
    partial_e_temp3 = Sxi_D_0xi.col(2)*F.col(1).transpose() + Sxi_D_0xi.col(1)*F.col(2).transpose();
    partial_epsilon_partial_e.row(3) = partial_e_tempReshaped3;
    partial_e_temp4 = Sxi_D_0xi.col(2)*F.col(0).transpose() + Sxi_D_0xi.col(0)*F.col(2).transpose();
    partial_epsilon_partial_e.row(4) = partial_e_tempReshaped4;
    partial_e_temp5 = Sxi_D_0xi.col(1)*F.col(0).transpose() + Sxi_D_0xi.col(0)*F.col(1).transpose();
    partial_epsilon_partial_e.row(5) = partial_e_tempReshaped5;
    ...
    if (m_damping_enabled) {        //If linear Kelvin-Voigt viscoelastic material model is enabled 
        ...
        //with respect to the nodal coordinates entry by entry in the vector epsilon
        partial_e_temp0 = D0(0)*Sxi_D_0xi.col(0)*Scaled_Combined_F.col(0).transpose();
        Scaled_Combined_partial_epsilon_partial_e.row(0) = partial_e_tempReshaped0;
        partial_e_temp1 = D0(1)*Sxi_D_0xi.col(1)*Scaled_Combined_F.col(1).transpose();
        Scaled_Combined_partial_epsilon_partial_e.row(1) = partial_e_tempReshaped1;
        partial_e_temp2 = D0(2)*Sxi_D_0xi.col(2)*Scaled_Combined_F.col(2).transpose();
        Scaled_Combined_partial_epsilon_partial_e.row(2) = partial_e_tempReshaped2;
        partial_e_temp3 = D0(3)*(Sxi_D_0xi.col(2)*Scaled_Combined_F.col(1).transpose() + Sxi_D_0xi.col(1)*Scaled_Combined_F.col(2).transpose());
        Scaled_Combined_partial_epsilon_partial_e.row(3) = partial_e_tempReshaped3;
        partial_e_temp4 = D0(4)*(Sxi_D_0xi.col(2)*Scaled_Combined_F.col(0).transpose() + Sxi_D_0xi.col(0)*Scaled_Combined_F.col(2).transpose());
        Scaled_Combined_partial_epsilon_partial_e.row(4) = partial_e_tempReshaped4;
        partial_e_temp5 = D0(5)*(Sxi_D_0xi.col(1)*Scaled_Combined_F.col(0).transpose() + Sxi_D_0xi.col(0)*Scaled_Combined_F.col(1).transpose());
...
void ChElementBeamANCF_MT14::ComputeInternalJacobianSingleGQPnt(ChMatrixNM<double, 27, 27>& Jac_Dense, ChMatrixNM<double, 9, 9>& Jac_Compact, double Kfactor, double Rfactor, unsigned int index, ChMatrix33<double>& Dv, ChMatrixNMc<double, 9, 3>& e_bar, ChMatrixNMc<double, 9, 3>& e_bar_dot) {
...
void ChElementBeamANCF_MT14::ComputeInternalJacobianSingleGQPnt(ChMatrixNM<double, 27, 27>& Jac_Dense, ChMatrixNM<double, 9, 9>& Jac_Compact, double Kfactor, double Rfactor, double GQ_weight, double xi, double eta, double zeta, ChMatrixNM<double, 6, 6>& D, ChMatrixNMc<double, 9, 3>& e_bar, ChMatrixNMc<double, 9, 3>& e_bar_dot){
    ChMatrix33<double> J_0xi;               //Element Jacobian between the reference configuration and normalized configuration
    ChMatrixNMc<double, 9, 3> Sxi_D;         //Matrix of normalized shape function derivatives
    ChMatrixNMc<double, 9, 3> Sxi_D_0xi;     //Matrix of normalized shape function derivatives corrected for a potentially non-straight reference configuration
    ChVectorN<double, 6> epsilon;           //Green-Lagrange strain tensor in Voigt notation
    ...
    if (m_damping_enabled) {        //If linear Kelvin-Voigt viscoelastic material model is enabled 
        ...
        partial_e_temp2 = Sxi_D_0xi.col(2)*Scaled_Combined_F.col(2).transpose();
        Scaled_Combined_partial_epsilon_partial_e.row(2) = partial_e_tempReshaped2;
        partial_e_temp3 = Sxi_D_0xi.col(2)*Scaled_Combined_F.col(1).transpose() + Sxi_D_0xi.col(1)*Scaled_Combined_F.col(2).transpose();
        Scaled_Combined_partial_epsilon_partial_e.row(3) = partial_e_tempReshaped3;
        partial_e_temp4 = Sxi_D_0xi.col(2)*Scaled_Combined_F.col(0).transpose() + Sxi_D_0xi.col(0)*Scaled_Combined_F.col(2).transpose();
        Scaled_Combined_partial_epsilon_partial_e.row(4) = partial_e_tempReshaped4;
        partial_e_temp5 = Sxi_D_0xi.col(1)*Scaled_Combined_F.col(0).transpose() + Sxi_D_0xi.col(0)*Scaled_Combined_F.col(1).transpose();
        Scaled_Combined_partial_epsilon_partial_e.row(5) = partial_e_tempReshaped5;
...
void ChElementBeamANCF_MT14::ComputeInternalJacobians(ChMatrixNM<double, 27, 27>& JacobianMatrix, double Kfactor, double Rfactor) {
...
void ChElementBeamANCF_MT14::ComputeInternalJacobiansAnalytic(ChMatrixNM<double, 27, 27>& JacobianMatrix, double Kfactor, double Rfactor) {
    ChMatrixNMc<double, 9, 3> e_bar;
    ChMatrixNMc<double, 9, 3> e_bar_dot;
...
void ChElementBeamANCF_MT14::Calc_Sxi(ChMatrixNM<double, 3, 27>& Sxi, double xi, double eta, double zeta) {
...
// [s1; s2; s3; ...]
void ChElementBeamANCF_MT14::Calc_Sxi_compact(ChVectorN<double, 9>& Sxi_compact, double xi, double eta, double zeta) {
...
void ChElementBeamANCF_MT14::Calc_Sxi_D(ChMatrixNMc<double, 9, 3>& Sxi_D, double xi, double eta, double zeta) {
    Sxi_D(0, 0) = xi - 0.5;
...
void ChElementBeamANCF_MT14::CalcCoordMatrix(ChMatrixNMc<double, 9, 3>& e) {
...
void ChElementBeamANCF_MT14::CalcCoordVector(ChVectorN<double, 27>& e) {
...
void ChElementBeamANCF_MT14::CalcCoordDerivMatrix(ChMatrixNMc<double, 9, 3>& edot) {
...
void ChElementBeamANCF_MT14::CalcCoordDerivVector(ChVectorN<double, 27>& edot) {
...
void ChElementBeamANCF_MT14::Calc_J_0xi(ChMatrix33<double>& J_0xi, double xi, double eta, double zeta) {
...
double ChElementBeamANCF_MT14::Calc_det_J_0xi(double xi, double eta, double zeta) {
    ChMatrixNMc<double, 9, 3> Sxi_D;
...
// -----------------------------------------------------------------------------
//ChVector<> ChElementBeamANCF_MT14::EvaluateBeamSectionStrains() {
...
//}
//
// void ChElementBeamANCF_MT14::EvaluateSectionDisplacement(const double u,
//                                                    const double v,
//                                                    ChVector<>& u_displ,
//                                                    ChVector<>& u_rotaz) {
...
void ChElementBeamANCF_MT14::EvaluateSectionFrame(const double eta, ChVector<>& point, ChQuaternion<>& rot) {
...
// void ChElementBeamANCF_MT14::EvaluateSectionPoint(const double u,
//                                             const double v,
//                                             ChVector<>& point) {
//    ChVector<> u_displ;
//
...
void ChElementBeamANCF_MT14::LoadableGetStateBlock_x(int block_offset, ChState& mD) {
...
void ChElementBeamANCF_MT14::LoadableGetStateBlock_w(int block_offset, ChStateDelta& mD) {
...
void ChElementBeamANCF_MT14::LoadableStateIncrement(const unsigned int off_x,
                                               ChState& x_new,
                                               const ChState& x,
...
//void ChElementBeamANCF_MT14::EvaluateSectionVelNorm(double U, ChVector<>& Result) {
//    ShapeVector N;
...
void ChElementBeamANCF_MT14::LoadableGetVariables(std::vector<ChVariables*>& mvars) {
...
void ChElementBeamANCF_MT14::ComputeNF(
...
double ChElementBeamANCF_MT14::GetDensity() {
    return GetMaterial()->Get_rho();
}

// Calculate tangent to the centerline at (U) coordinates.
ChVector<> ChElementBeamANCF_MT14::ComputeTangent(const double U) {
    ChMatrixNMc<double, 9, 3> e_bar;
    ChMatrixNMc<double, 9, 3> Sxi_D;
    ChVector<> r_xi;
...
ChQuadratureTables static_tables_MT14(1, CH_QUADRATURE_STATIC_TABLES);
//#endif // !CH_QUADRATURE_STATIC_TABLES

ChQuadratureTables* ChElementBeamANCF_MT14::GetStaticGQTables() {
    return &static_tables_MT14;
}

////////////////////////////////////////////////////////////////

// ============================================================================
// Implementation of ChMaterialBeamANCF_MT14 methods
// ============================================================================

// Construct an isotropic material.
ChMaterialBeamANCF_MT14::ChMaterialBeamANCF_MT14(double rho,        // material density
...
void ChMaterialBeamANCF_MT14::Calc_D0_Dv(const ChVector<>& E, const ChVector<>& nu, const ChVector<>& G, double k1, double k2) {
