...
ChElementHexaANCF_3843_MR_V8::ChElementHexaANCF_3843_MR_V8()
...
void ChElementHexaANCF_3843_MR_V8::SetNodes(std::shared_ptr<ChNodeFEAxyzDDD> nodeA,
...
void ChElementHexaANCF_3843_MR_V8::SetDimensions(double lenX, double lenY, double lenZ) {
    m_lenX = lenX;
    m_lenY = lenY;
    m_lenZ = lenZ;
}
...
void ChElementHexaANCF_3843_MR_V8::SetMaterial(std::shared_ptr<ChMaterialHexaANCF_MR> brick_mat) {
...
ChMatrix33d ChElementHexaANCF_3843_MR_V8::GetGreenLagrangeStrain(const double xi, const double eta, const double zeta) {
...
ChMatrix33d ChElementHexaANCF_3843_MR_V8::GetPK2Stress(const double xi, const double eta, const double zeta) {
    MatrixNx3c Sxi_D;  // Matrix of normalized shape function derivatives
    Calc_Sxi_D(Sxi_D, xi, eta, zeta);
...
double ChElementHexaANCF_3843_MR_V8::GetVonMissesStress(const double xi, const double eta, const double zeta) {
    MatrixNx3c Sxi_D;  // Matrix of normalized shape function derivatives
    Calc_Sxi_D(Sxi_D, xi, eta, zeta);
...
void ChElementHexaANCF_3843_MR_V8::SetupInitial(ChSystem* system) {
...
void ChElementHexaANCF_3843_MR_V8::GetStateBlock(ChVectorDynamic<>& mD) {
...
void ChElementHexaANCF_3843_MR_V8::Update() {
    ChElementGeneric::Update();
}

// Return the mass matrix in full sparse form.

void ChElementHexaANCF_3843_MR_V8::ComputeMmatrixGlobal(ChMatrixRef M) {
    M.setZero();
...
void ChElementHexaANCF_3843_MR_V8::ComputeNodalMass() {
...
void ChElementHexaANCF_3843_MR_V8::ComputeInternalForces(ChVectorDynamic<>& Fi) {
...
void ChElementHexaANCF_3843_MR_V8::ComputeKRMmatricesGlobal(ChMatrixRef H, double Kfactor, double Rfactor, double Mfactor) {
...
void ChElementHexaANCF_3843_MR_V8::ComputeGravityForces(ChVectorDynamic<>& Fg, const ChVector3d& G_acc) {
...
void ChElementHexaANCF_3843_MR_V8::EvaluateElementFrame(const double xi,
                                                       const double eta,
                                                       const double zeta,
                                                       ChVector3d& point,
                                                       ChQuaternion<>& rot) {
...
void ChElementHexaANCF_3843_MR_V8::EvaluateElementPoint(const double xi,
                                                       const double eta,
                                                       const double zeta,
                                                       ChVector3d& point) {
    VectorN Sxi_compact;
...
void ChElementHexaANCF_3843_MR_V8::EvaluateElementVel(double xi, double eta, const double zeta, ChVector3d& Result) {
    VectorN Sxi_compact;
    Calc_Sxi_compact(Sxi_compact, xi, eta, zeta);
...
void ChElementHexaANCF_3843_MR_V8::LoadableGetStateBlockPosLevel(int block_offset, ChState& mD) {
...
void ChElementHexaANCF_3843_MR_V8::LoadableGetStateBlockVelLevel(int block_offset, ChStateDelta& mD) {
...
void ChElementHexaANCF_3843_MR_V8::LoadableStateIncrement(const unsigned int off_x,
                                                         ChState& x_new,
                                                         const ChState& x,
...
void ChElementHexaANCF_3843_MR_V8::LoadableGetVariables(std::vector<ChVariables*>& mvars) {
...
void ChElementHexaANCF_3843_MR_V8::ComputeNF(
...
double ChElementHexaANCF_3843_MR_V8::GetDensity() {
...
void ChElementHexaANCF_3843_MR_V8::ComputeMassMatrixAndGravityForce() {
...
void ChElementHexaANCF_3843_MR_V8::PrecomputeInternalForceMatricesWeights() {
    ChQuadratureTables* GQTable = GetStaticGQTables();
...
//void ChElementHexaANCF_3843_MR_V8::ComputeInternalForceDamping(ChVectorDynamic<>& Fi) {
//    assert((unsigned int)Fi.size() == GetNumCoordsPosLevel());
//
//    //Use the no-damping code until I can write the with damping code
//    ComputeInternalForceNoDamping(Fi);
//}
...
void ChElementHexaANCF_3843_MR_V8::ComputeInternalForceNoDamping(ChVectorDynamic<>& Fi) {
    assert((unsigned int)Fi.size() == GetNumCoordsPosLevel());
...
void ChElementHexaANCF_3843_MR_V8::ComputeInternalJacobianDamping(ChMatrixRef H, double Kfactor, double Rfactor, double Mfactor) {
...
void ChElementHexaANCF_3843_MR_V8::ComputeInternalJacobianNoDamping(ChMatrixRef H, double Kfactor, double Mfactor) {
    assert((H.rows() == 3 * NSF) && (H.cols() == 3 * NSF));
...
void ChElementHexaANCF_3843_MR_V8::Calc_Sxi_compact(VectorN& Sxi_compact, double xi, double eta, double zeta) {
    Sxi_compact(0) =
...
void ChElementHexaANCF_3843_MR_V8::Calc_Sxi_xi_compact(VectorN& Sxi_xi_compact, double xi, double eta, double zeta) {
...
void ChElementHexaANCF_3843_MR_V8::Calc_Sxi_eta_compact(VectorN& Sxi_eta_compact, double xi, double eta, double zeta) {
...
void ChElementHexaANCF_3843_MR_V8::Calc_Sxi_zeta_compact(VectorN& Sxi_zeta_compact, double xi, double eta, double zeta) {
...
void ChElementHexaANCF_3843_MR_V8::Calc_Sxi_D(MatrixNx3c& Sxi_D, double xi, double eta, double zeta) {
    VectorN Sxi_D_col;
...
void ChElementHexaANCF_3843_MR_V8::CalcCoordVector(Vector3N& e) {
...
void ChElementHexaANCF_3843_MR_V8::CalcCoordMatrix(Matrix3xN& ebar) {
...
void ChElementHexaANCF_3843_MR_V8::CalcCoordDtVector(Vector3N& edot) {
...
void ChElementHexaANCF_3843_MR_V8::CalcCoordDtMatrix(Matrix3xN& ebardot) {
...
void ChElementHexaANCF_3843_MR_V8::CalcCombinedCoordMatrix(Matrix6xN& ebar_ebardot) {
...
void ChElementHexaANCF_3843_MR_V8::Calc_J_0xi(ChMatrix33d& J_0xi, double xi, double eta, double zeta) {
    MatrixNx3c Sxi_D;
    Calc_Sxi_D(Sxi_D, xi, eta, zeta);
...
double ChElementHexaANCF_3843_MR_V8::Calc_det_J_0xi(double xi, double eta, double zeta) {
    ChMatrix33d J_0xi;
...
ChQuadratureTables static_tables_3843_MR_V8(1, CH_QUADRATURE_STATIC_TABLES);
//#endif // !CH_QUADRATURE_STATIC_TABLES

ChQuadratureTables* ChElementHexaANCF_3843_MR_V8::GetStaticGQTables() {
    return &static_tables_3843_MR_V8;
}
