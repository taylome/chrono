...
#ifndef CHELEMENTBEAMANCF3333_TR04B_H
#define CHELEMENTBEAMANCF3333_TR04B_H
...
class ChApi ChElementBeamANCF_3333_TR04B : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
  ...
  private:
    ...
    void ComputeInternalForcesSingleGQPntD0(Vector3N& Qi,
                                            double xi,
                                            double eta,
                                            double zeta,
    ...
    /// Compute the integrand for the generalized internal force at the specified location assuming damping is included
    void ComputeInternalForcesSingleGQPntDv(Vector3N& Qi,
                                            double xi,
                                            double eta,
                                            double zeta,
                                            const ChMatrix33<>& Dv,
