...
#ifndef CHELEMENTBEAMANCFMT05_H
#define CHELEMENTBEAMANCFMT05_H
...
class ChApi ChMaterialBeamANCF_MT05 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_MT05(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_MT05 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    using ShapeVector = ChMatrixNM<double, 1, 9>;

    ChElementBeamANCF_MT05();
    ~ChElementBeamANCF_MT05() {}
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MT05> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_MT05> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    void ComputeInternalForcesSingleGQPnt(ChVectorN<double, 27>& Qi, double xi, double eta, double zeta, ChVectorN<double, 6>& D0, ChMatrixNM<double, 9, 3>& e_bar, ChMatrixNM<double, 9, 3>& e_bar_dot);
    ...
    void ComputeInternalForcesSingleGQPnt(ChVectorN<double, 27>& Qi, double xi, double eta, double zeta, ChMatrix33<double>& Dv, ChMatrixNM<double, 9, 3>& e_bar, ChMatrixNM<double, 9, 3>& e_bar_dot);
    ...
    std::shared_ptr<ChMaterialBeamANCF_MT05> m_material;    ///< beam material
