...
#ifndef CHELEMENTSHELLANCF3833_TR01B_H
#define CHELEMENTSHELLANCF3833_TR01B_H
...
class ChApi ChElementShellANCF_3833_TR01B : public ChElementShell, public ChLoadableUV, public ChLoadableUVW {
  public:
    ...
    static const int NP = 5;              ///< number of Gauss quadrature points for each midsurface direction
    static const int NT = 5;              ///< number of quadrature points through the thickness
    ...
    class Layer {
      ...
      public:
        ...
        friend class ChElementShellANCF_3833_TR01B;
    };
  ...
  private:
    ...
    /// Calculate the generalized internal force for the element at the given nodal coordinates and time derivatives
    ...
    /// Compute the integrand for the generalized internal force at the specified location assuming damping is included
    ...
    /// Calculate the 3x3N Sparse Matrix Form of the Derivative of the Normalized Shape Function Matrix with respect to
    /// xi
    void Calc_Sxi_xi(Matrix3x3N& Sxi_xi, double xi, double eta, double zeta, double thickness, double zoffset);

    /// Calculate the 3x3N Sparse Matrix Form of the Derivative of the Normalized Shape Function Matrix with respect to
    /// eta
    void Calc_Sxi_eta(Matrix3x3N& Sxi_xi, double xi, double eta, double zeta, double thickness, double zoffset);

    /// Calculate the 3x3N Sparse Matrix Form of the Derivative of the Normalized Shape Function Matrix with respect to
    /// zeta
    void Calc_Sxi_zeta(Matrix3x3N& Sxi_xi, double xi, double eta, double zeta, double thickness, double zoffset);
