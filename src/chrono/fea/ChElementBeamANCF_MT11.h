...
#ifndef CHELEMENTBEAMANCFMT11_H
#define CHELEMENTBEAMANCFMT11_H
...
class ChApi ChMaterialBeamANCF_MT11 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_MT11(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_MT11 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    using ShapeVector = ChMatrixNM<double, 1, 9>;

    ChElementBeamANCF_MT11();
    ~ChElementBeamANCF_MT11() {}
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MT11> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_MT11> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_MT11> m_material;    ///< beam material
