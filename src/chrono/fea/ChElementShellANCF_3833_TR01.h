...
#ifndef CHELEMENTSHELLANCF3833TR01_H
#define CHELEMENTSHELLANCF3833TR01_H
...
class ChApi ChMaterialShellANCF_3833_TR01 {
  public:
    /// Construct an isotropic material.
    ChMaterialShellANCF_3833_TR01(double rho,        ///< material density
...
class ChApi ChElementShellANCF_3833_TR01 : public ChElementShell, public ChLoadableUV, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialShellANCF_3833_TR01> shell_mat) { m_material = shell_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialShellANCF_3833_TR01> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialShellANCF_3833_TR01> m_material;  ///< shell material
