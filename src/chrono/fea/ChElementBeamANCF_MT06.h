...
#ifndef CHELEMENTBEAMANCFMT06_H
#define CHELEMENTBEAMANCFMT06_H
...
class ChApi ChMaterialBeamANCF_MT06 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_MT06(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_MT06 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    using ShapeVector = ChMatrixNM<double, 1, 9>;

    ChElementBeamANCF_MT06();
    ~ChElementBeamANCF_MT06() {}
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MT06> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_MT06> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_MT06> m_material;    ///< beam material
