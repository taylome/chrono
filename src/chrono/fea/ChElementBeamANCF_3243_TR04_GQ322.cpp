...
ChElementBeamANCF_3243_TR04_GQ322::ChElementBeamANCF_3243_TR04_GQ322()
    : m_gravity_on(false), m_thicknessY(0), m_thicknessZ(0), m_lenX(0), m_Alpha(0), m_damping_enabled(false) {
    m_nodes.resize(2);
    m_strain_form = ChElementBeamANCF_3243_TR04_GQ322::CMPoisson;
}
...
void ChElementBeamANCF_3243_TR04_GQ322::SetNodes(std::shared_ptr<ChNodeFEAxyzDDD> nodeA,
...
void ChElementBeamANCF_3243_TR04_GQ322::SetupInitial(ChSystem* system) {
...
// State update.
void ChElementBeamANCF_3243_TR04_GQ322::Update() {
    ChElementGeneric::Update();
}

// Fill the D vector with the current field values at the element nodes.
void ChElementBeamANCF_3243_TR04_GQ322::GetStateBlock(ChVectorDynamic<>& mD) {
...
void ChElementBeamANCF_3243_TR04_GQ322::ComputeKRMmatricesGlobal(ChMatrixRef H,
                                                           double Kfactor,
                                                           double Rfactor,
                                                           double Mfactor) {
...
void ChElementBeamANCF_3243_TR04_GQ322::ComputeMmatrixGlobal(ChMatrixRef M) {
    M = m_MassMatrix;
}
...
// -----------------------------------------------------------------------------
void ChElementBeamANCF_3243_TR04_GQ322::ComputeMassMatrixAndGravityForce(const ChVector<>& g_acc) {
...
void ChElementBeamANCF_3243_TR04_GQ322::ComputeNodalMass() {
...
void ChElementBeamANCF_3243_TR04_GQ322::SetAlphaDamp(double a) {
    m_Alpha = a;
...
void ChElementBeamANCF_3243_TR04_GQ322::ComputeInternalForces(ChVectorDynamic<>& Fi) {
...
void ChElementBeamANCF_3243_TR04_GQ322::ComputeInternalForcesAtState(ChVectorDynamic<>& Fi,
    ...
    // beam axis
    if (GetStrainFormulation() == ChElementBeamANCF_3243_TR04_GQ322::StrainFormulation::CMPoisson) {
...
void ChElementBeamANCF_3243_TR04_GQ322::ComputeInternalForcesSingleGQPnt(ChVectorN<double, 24>& Qi,
                                                                   double xi,
                                                                   double eta,
                                                                   double zeta,
...
void ChElementBeamANCF_3243_TR04_GQ322::ComputeInternalJacobians(ChMatrixNM<double, 24, 24>& JacobianMatrix,
                                                           double Kfactor,
                                                           double Rfactor) {
...
void ChElementBeamANCF_3243_TR04_GQ322::Calc_Sxi(ChMatrixNM<double, 3, 24>& Sxi, double xi, double eta, double zeta) {
...
// [s1; s2; s3; ...]
void ChElementBeamANCF_3243_TR04_GQ322::Calc_Sxi_compact(ChVectorN<double, 8>& Sxi_compact,
                                                   double xi,
                                                   double eta,
                                                   double zeta) {
...
// [s1*I_3x3, s2*I_3x3, s3*I_3x3, ...]
void ChElementBeamANCF_3243_TR04_GQ322::Calc_Sxi_xi(ChMatrixNM<double, 3, 24>& Sxi_xi, double xi, double eta, double zeta) {
...
// [s1; s2; s3; ...]
void ChElementBeamANCF_3243_TR04_GQ322::Calc_Sxi_xi_compact(ChVectorN<double, 8>& Sxi_xi_compact,
                                                      double xi,
                                                      double eta,
                                                      double zeta) {
...
// [s1*I_3x3, s2*I_3x3, s3*I_3x3, ...]
void ChElementBeamANCF_3243_TR04_GQ322::Calc_Sxi_eta(ChMatrixNM<double, 3, 24>& Sxi_eta, double xi, double eta, double zeta) {
...
// [s1; s2; s3; ...]
void ChElementBeamANCF_3243_TR04_GQ322::Calc_Sxi_eta_compact(ChVectorN<double, 8>& Sxi_eta_compact,
                                                       double xi,
                                                       double eta,
                                                       double zeta) {
...
// [s1*I_3x3, s2*I_3x3, s3*I_3x3, ...]
void ChElementBeamANCF_3243_TR04_GQ322::Calc_Sxi_zeta(ChMatrixNM<double, 3, 24>& Sxi_zeta,
                                                double xi,
                                                double eta,
                                                double zeta) {
...
// 8x1 Vector Form of the partial derivatives of Normalized Shape Functions with respect to eta
// [s1; s2; s3; ...]
void ChElementBeamANCF_3243_TR04_GQ322::Calc_Sxi_zeta_compact(ChVectorN<double, 8>& Sxi_zeta_compact,
                                                        double xi,
                                                        double eta,
                                                        double zeta) {
...
void ChElementBeamANCF_3243_TR04_GQ322::Calc_Sxi_D(ChMatrixNMc<double, 8, 3>& Sxi_D, double xi, double eta, double zeta) {
...
void ChElementBeamANCF_3243_TR04_GQ322::CalcCoordVector(ChVectorN<double, 24>& e) {
...
void ChElementBeamANCF_3243_TR04_GQ322::CalcCoordMatrix(ChMatrixNM<double, 3, 8>& ebar) {
...
void ChElementBeamANCF_3243_TR04_GQ322::CalcCoordDerivVector(ChVectorN<double, 24>& edot) {
...
void ChElementBeamANCF_3243_TR04_GQ322::CalcCoordDerivMatrix(ChMatrixNM<double, 3, 8>& ebardot) {
...
void ChElementBeamANCF_3243_TR04_GQ322::Calc_J_0xi(ChMatrix33<double>& J_0xi, double xi, double eta, double zeta) {
...
double ChElementBeamANCF_3243_TR04_GQ322::Calc_det_J_0xi(double xi, double eta, double zeta) {
...
// -----------------------------------------------------------------------------
// ChVector<> ChElementBeamANCF_3243_TR04_GQ322::EvaluateBeamSectionStrains() {
...
//}
//
// void ChElementBeamANCF_3243_TR04_GQ322::EvaluateSectionDisplacement(const double u,
//                                                    const double v,
//                                                    ChVector<>& u_displ,
//                                                    ChVector<>& u_rotaz) {
...
//}
//
// void ChElementBeamANCF_3243_TR04_GQ322::EvaluateSectionFrame(const double u,
//                                             const double v,
//                                             ChVector<>& point,
//                                             ChQuaternion<>& rot) {
//    // this is not a corotational element, so just do:
...
//}
//
// void ChElementBeamANCF_3243_TR04_GQ322::EvaluateSectionPoint(const double u,
//                                             const double v,
//                                             ChVector<>& point) {
//    ChVector<> u_displ;
//
...
void ChElementBeamANCF_3243_TR04_GQ322::EvaluateSectionFrame(const double xi, ChVector<>& point, ChQuaternion<>& rot) {
...
void ChElementBeamANCF_3243_TR04_GQ322::LoadableGetStateBlock_x(int block_offset, ChState& mD) {
...
void ChElementBeamANCF_3243_TR04_GQ322::LoadableGetStateBlock_w(int block_offset, ChStateDelta& mD) {
...
void ChElementBeamANCF_3243_TR04_GQ322::LoadableStateIncrement(const unsigned int off_x,
                                                         ChState& x_new,
                                                         const ChState& x,
...
// void ChElementBeamANCF_3243_TR04_GQ322::EvaluateSectionVelNorm(double U, ChVector<>& Result) {
//    ChMatrixNM<double, 1, 9> N;
...
void ChElementBeamANCF_3243_TR04_GQ322::LoadableGetVariables(std::vector<ChVariables*>& mvars) {
...
void ChElementBeamANCF_3243_TR04_GQ322::ComputeNF(
...
double ChElementBeamANCF_3243_TR04_GQ322::GetDensity() {
    return GetMaterial()->Get_rho();
}

// Calculate tangent to the centerline at (U) coordinates.
ChVector<> ChElementBeamANCF_3243_TR04_GQ322::ComputeTangent(const double U) {
    ChMatrixNM<double, 3, 24> Sxi_xi;
    ChVectorN<double, 24> e;
    ChVector<> r_xi;
...
ChQuadratureTables static_tables_2_TR04_GQ322(1, CH_QUADRATURE_STATIC_TABLES);
//#endif // !CH_QUADRATURE_STATIC_TABLES

ChQuadratureTables* ChElementBeamANCF_3243_TR04_GQ322::GetStaticGQTables() {
    return &static_tables_2_TR04_GQ322;
}

////////////////////////////////////////////////////////////////

// ============================================================================
// Implementation of ChMaterialBeamANCF_3243_TR04_GQ322 methods
// ============================================================================

// Construct an isotropic material.
ChMaterialBeamANCF_3243_TR04_GQ322::ChMaterialBeamANCF_3243_TR04_GQ322(
...
// Poisson effect
void ChMaterialBeamANCF_3243_TR04_GQ322::Calc_D0_Dv(const ChVector<>& E,
                                              const ChVector<>& nu,
                                              const ChVector<>& G,
                                              double k1,
                                              double k2) {
