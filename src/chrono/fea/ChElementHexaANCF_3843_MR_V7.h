...
#ifndef CH_ELEMENT_HEXA_ANCF_3843_MR_V7_H
#define CH_ELEMENT_HEXA_ANCF_3843_MR_V7_H
...
class ChApi ChElementHexaANCF_3843_MR_V7 : public ChElementHexahedron, public ChElementGeneric, public ChLoadableUVW {
  public:
    ...
    // Short-cut for defining a column-major Eigen array
    using ArrayNIP = Eigen::Array<double, NIP, 1, Eigen::ColMajor>;
