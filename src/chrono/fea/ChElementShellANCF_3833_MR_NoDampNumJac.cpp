...
ChMatrix33<> ChElementShellANCF_3833_MR_NoDampNumJac::GetGreenLagrangeStrain(const double xi,
                                                                  const double eta,
                                                                  const double zeta) {
...
ChMatrix33<> ChElementShellANCF_3833_MR_NoDampNumJac::GetPK2Stress(const double layer,
                                                        const double xi,
                                                        const double eta,
...
void ChElementShellANCF_3833_MR_NoDampNumJac::ComputeGravityForces(ChVectorDynamic<>& Fg, const ChVector<>& G_acc) {
...
void ChElementShellANCF_3833_MR_NoDampNumJac::EvaluateSectionPoint(const double xi, const double eta, ChVector<>& point) {
    VectorN Sxi_compact;
    Calc_Sxi_compact(Sxi_compact, xi, eta, 0, m_thicknessZ, m_midsurfoffset);
...
void ChElementShellANCF_3833_MR_NoDampNumJac::EvaluateSectionVelNorm(const double xi, const double eta, ChVector<>& Result) {
    VectorN Sxi_compact;
    Calc_Sxi_compact(Sxi_compact, xi, eta, 0, m_thicknessZ, m_midsurfoffset);
...
void ChElementShellANCF_3833_MR_NoDampNumJac::LoadableGetStateBlock_x(int block_offset, ChState& mD) {
...
void ChElementShellANCF_3833_MR_NoDampNumJac::LoadableGetStateBlock_w(int block_offset, ChStateDelta& mD) {
...
ChVector<> ChElementShellANCF_3833_MR_NoDampNumJac::ComputeNormal(const double xi, const double eta) {
...
void ChElementShellANCF_3833_MR_NoDampNumJac::CalcCoordDerivVector(Vector3N& edot) {
...
void ChElementShellANCF_3833_MR_NoDampNumJac::CalcCoordDerivMatrix(Matrix3xN& ebardot) {
...
void ChElementShellANCF_3833_MR_NoDampNumJac::Calc_J_0xi(ChMatrix33<double>& J_0xi,
                                              double xi,
                                              double eta,
                                              double zeta,
                                              double thickness,
...
void ChElementShellANCF_3833_MR_NoDampNumJac::RotateReorderStiffnessMatrix(ChMatrixNM<double, 6, 6>& D, double theta) {
