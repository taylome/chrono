...
#ifndef CHELEMENTBEAMANCFMT29_H
#define CHELEMENTBEAMANCFMT29_H
...
class ChApi ChMaterialBeamANCF_MT29 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_MT29(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_MT29 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MT29> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_MT29> GetMaterial() const { return m_material; }
  ...
  public:
    ...
    void ComputeInternalForcesAtState(ChVectorDynamic<>& Fi, const ChMatrixNMc<double, 9, 3>& e_bar, const ChMatrixNMc<double, 9, 3>& e_bar_dot);
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_MT29> m_material;    ///< beam material
