...
#ifndef CHELEMENTBEAMANCF3243_MR_DAMPNUMJAC_H
#define CHELEMENTBEAMANCF3243_MR_DAMPNUMJAC_H
...
class ChApi ChElementBeamANCF_3243_MR_DampNumJac : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    ChElementBeamANCF_3243_MR_DampNumJac();
    ~ChElementBeamANCF_3243_MR_DampNumJac() {}
