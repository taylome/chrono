...
ChMatrix33<> ChElementShellANCF_3443_MR_Damp::GetGreenLagrangeStrain(const double xi,
                                                                  const double eta,
                                                                  const double zeta) {
...
ChMatrix33<> ChElementShellANCF_3443_MR_Damp::GetPK2Stress(const double layer,
                                                        const double xi,
                                                        const double eta,
...
void ChElementShellANCF_3443_MR_Damp::ComputeGravityForces(ChVectorDynamic<>& Fg, const ChVector<>& G_acc) {
...
void ChElementShellANCF_3443_MR_Damp::EvaluateSectionPoint(const double xi, const double eta, ChVector<>& point) {
    VectorN Sxi_compact;
    Calc_Sxi_compact(Sxi_compact, xi, eta, 0, m_thicknessZ, m_midsurfoffset);
...
void ChElementShellANCF_3443_MR_Damp::EvaluateSectionVelNorm(const double xi, const double eta, ChVector<>& Result) {
    VectorN Sxi_compact;
    Calc_Sxi_compact(Sxi_compact, xi, eta, 0, m_thicknessZ, m_midsurfoffset);
...
void ChElementShellANCF_3443_MR_Damp::LoadableGetStateBlock_x(int block_offset, ChState& mD) {
...
void ChElementShellANCF_3443_MR_Damp::LoadableGetStateBlock_w(int block_offset, ChStateDelta& mD) {
...
ChVector<> ChElementShellANCF_3443_MR_Damp::ComputeNormal(const double xi, const double eta) {
...
void ChElementShellANCF_3443_MR_Damp::CalcCoordDerivVector(Vector3N& edot) {
...
void ChElementShellANCF_3443_MR_Damp::CalcCoordDerivMatrix(Matrix3xN& ebardot) {
...
void ChElementShellANCF_3443_MR_Damp::Calc_J_0xi(ChMatrix33<double>& J_0xi,
                                              double xi,
                                              double eta,
                                              double zeta,
                                              double thickness,
...
void ChElementShellANCF_3443_MR_Damp::RotateReorderStiffnessMatrix(ChMatrixNM<double, 6, 6>& D, double theta) {
