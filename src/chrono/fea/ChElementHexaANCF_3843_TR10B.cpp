...
ChElementHexaANCF_3843_TR10B::ChElementHexaANCF_3843_TR10B()
...
void ChElementHexaANCF_3843_TR10B::SetNodes(std::shared_ptr<ChNodeFEAxyzDDD> nodeA,
...
void ChElementHexaANCF_3843_TR10B::SetDimensions(double lenX, double lenY, double lenZ) {
    m_lenX = lenX;
    m_lenY = lenY;
    m_lenZ = lenZ;
}
...
void ChElementHexaANCF_3843_TR10B::SetMaterial(std::shared_ptr<ChMaterialHexaANCF> brick_mat) {
    m_material = brick_mat;
}

// Set the value for the single term structural damping coefficient.

void ChElementHexaANCF_3843_TR10B::SetAlphaDamp(double a) {
    m_Alpha = a;
...
ChMatrix33<> ChElementHexaANCF_3843_TR10B::GetGreenLagrangeStrain(const double xi,
                                                                  const double eta,
                                                                  const double zeta) {
...
ChMatrix33<> ChElementHexaANCF_3843_TR10B::GetPK2Stress(const double xi, const double eta, const double zeta) {
    MatrixNx3c Sxi_D;  // Matrix of normalized shape function derivatives
    Calc_Sxi_D(Sxi_D, xi, eta, zeta);
...
double ChElementHexaANCF_3843_TR10B::GetVonMissesStress(const double xi, const double eta, const double zeta) {
    MatrixNx3c Sxi_D;  // Matrix of normalized shape function derivatives
    Calc_Sxi_D(Sxi_D, xi, eta, zeta);
...
void ChElementHexaANCF_3843_TR10B::SetupInitial(ChSystem* system) {
...
void ChElementHexaANCF_3843_TR10B::GetStateBlock(ChVectorDynamic<>& mD) {
...
void ChElementHexaANCF_3843_TR10B::Update() {
    ChElementGeneric::Update();
}

// Return the mass matrix in full sparse form.

void ChElementHexaANCF_3843_TR10B::ComputeMmatrixGlobal(ChMatrixRef M) {
    M.setZero();
...
void ChElementHexaANCF_3843_TR10B::ComputeNodalMass() {
...
void ChElementHexaANCF_3843_TR10B::ComputeInternalForces(ChVectorDynamic<>& Fi) {
...
void ChElementHexaANCF_3843_TR10B::ComputeKRMmatricesGlobal(ChMatrixRef H,
                                                            double Kfactor,
                                                            double Rfactor,
                                                            double Mfactor) {
    ...
    for (unsigned int f = 0; f < NSF; f++) {
        for (unsigned int t = 0; t < NSF; t++) {
            O2.block<NSF, NSF>(NSF * t, NSF * f).noalias() = m_O1.block<NSF, NSF>(NSF * t, NSF * f).transpose();
        }
    }
...
void ChElementHexaANCF_3843_TR10B::ComputeGravityForces(ChVectorDynamic<>& Fg, const ChVector<>& G_acc) {
...
void ChElementHexaANCF_3843_TR10B::EvaluateElementFrame(const double xi,
                                                        const double eta,
                                                        const double zeta,
                                                        ChVector<>& point,
                                                        ChQuaternion<>& rot) {
...
void ChElementHexaANCF_3843_TR10B::EvaluateElementPoint(const double xi,
                                                        const double eta,
                                                        const double zeta,
                                                        ChVector<>& point) {
    VectorN Sxi_compact;
...
void ChElementHexaANCF_3843_TR10B::EvaluateElementVel(double xi, double eta, const double zeta, ChVector<>& Result) {
    VectorN Sxi_compact;
    Calc_Sxi_compact(Sxi_compact, xi, eta, zeta);
...
void ChElementHexaANCF_3843_TR10B::LoadableGetStateBlock_x(int block_offset, ChState& mD) {
...
void ChElementHexaANCF_3843_TR10B::LoadableGetStateBlock_w(int block_offset, ChStateDelta& mD) {
...
void ChElementHexaANCF_3843_TR10B::LoadableStateIncrement(const unsigned int off_x,
                                                          ChState& x_new,
                                                          const ChState& x,
...
void ChElementHexaANCF_3843_TR10B::LoadableGetVariables(std::vector<ChVariables*>& mvars) {
...
void ChElementHexaANCF_3843_TR10B::ComputeNF(
...
double ChElementHexaANCF_3843_TR10B::GetDensity() {
...
void ChElementHexaANCF_3843_TR10B::ComputeMassMatrixAndGravityForce() {
...
void ChElementHexaANCF_3843_TR10B::PrecomputeInternalForceMatricesWeights() {
    ChQuadratureTables* GQTable = GetStaticGQTables();
...
void ChElementHexaANCF_3843_TR10B::Calc_Sxi_compact(VectorN& Sxi_compact, double xi, double eta, double zeta) {
    Sxi_compact(0) =
...
void ChElementHexaANCF_3843_TR10B::Calc_Sxi_xi_compact(VectorN& Sxi_xi_compact, double xi, double eta, double zeta) {
...
void ChElementHexaANCF_3843_TR10B::Calc_Sxi_eta_compact(VectorN& Sxi_eta_compact, double xi, double eta, double zeta) {
...
void ChElementHexaANCF_3843_TR10B::Calc_Sxi_zeta_compact(VectorN& Sxi_zeta_compact,
                                                         double xi,
                                                         double eta,
                                                         double zeta) {
...
void ChElementHexaANCF_3843_TR10B::Calc_Sxi_D(MatrixNx3c& Sxi_D, double xi, double eta, double zeta) {
    VectorN Sxi_D_col;
...
void ChElementHexaANCF_3843_TR10B::CalcCoordVector(Vector3N& e) {
...
void ChElementHexaANCF_3843_TR10B::CalcCoordMatrix(Matrix3xN& ebar) {
...
void ChElementHexaANCF_3843_TR10B::CalcCoordDerivVector(Vector3N& edot) {
...
void ChElementHexaANCF_3843_TR10B::CalcCoordDerivMatrix(Matrix3xN& ebardot) {
...
void ChElementHexaANCF_3843_TR10B::CalcCombinedCoordMatrix(Matrix6xN& ebar_ebardot) {
...
void ChElementHexaANCF_3843_TR10B::Calc_J_0xi(ChMatrix33<double>& J_0xi, double xi, double eta, double zeta) {
    MatrixNx3c Sxi_D;
    Calc_Sxi_D(Sxi_D, xi, eta, zeta);
...
double ChElementHexaANCF_3843_TR10B::Calc_det_J_0xi(double xi, double eta, double zeta) {
...
ChQuadratureTables static_tables_3843_TR10B(1, CH_QUADRATURE_STATIC_TABLES);
//#endif // !CH_QUADRATURE_STATIC_TABLES

ChQuadratureTables* ChElementHexaANCF_3843_TR10B::GetStaticGQTables() {
    return &static_tables_3843_TR10B;
}
