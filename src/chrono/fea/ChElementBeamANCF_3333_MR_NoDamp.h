...
#ifndef CHELEMENTBEAMANCF3333_MR_NODAMP_H
#define CHELEMENTBEAMANCF3333_MR_NODAMP_H
...
class ChApi ChElementBeamANCF_3333_MR_NoDamp : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    ChElementBeamANCF_3333_MR_NoDamp();
    ~ChElementBeamANCF_3333_MR_NoDamp() {}
