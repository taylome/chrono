...
#ifndef CHELEMENTBEAMANCFTR08_H
#define CHELEMENTBEAMANCFTR08_H
...
class ChApi ChMaterialBeamANCF_TR08 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_TR08(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_TR08 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_TR08> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_TR08> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_TR08> m_material;  ///< beam material
