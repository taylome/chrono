...
#ifndef CHELEMENTBEAMANCF3333_TR07B_H
#define CHELEMENTBEAMANCF3333_TR07B_H
...
class ChApi ChElementBeamANCF_3333_TR07B : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
  ...
  private:
    ...
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>
        m_FC;  ///< Cached calculation for all the Deformation Gradients and Deformation Gradient Time Derivatives
    Eigen::Array<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>
        m_SPK2_1_D0;  ///< Cached calculation for the 2nd PK2 Stresses - 1st Entry in Voigt
                      ///< Notation for all the GQ Points for no Poisson Effect
    Eigen::Array<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>
        m_SPK2_2_D0;  ///< Cached calculation for the 2nd PK2 Stresses - 2nd Entry in Voigt
                      ///< Notation for all the GQ Points for no Poisson Effect
    Eigen::Array<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>
        m_SPK2_3_D0;  ///< Cached calculation for the 2nd PK2 Stresses - 3rd Entry in Voigt
                      ///< Notation for all the GQ Points for no Poisson Effect
    Eigen::Array<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>
        m_SPK2_4_D0;  ///< Cached calculation for the 2nd PK2 Stresses - 4th Entry in Voigt
                      ///< Notation for all the GQ Points for no Poisson Effect
    Eigen::Array<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>
        m_SPK2_5_D0;  ///< Cached calculation for the 2nd PK2 Stresses - 5th Entry in Voigt
                      ///< Notation for all the GQ Points for no Poisson Effect
    Eigen::Array<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>
        m_SPK2_6_D0;  ///< Cached calculation for the 2nd PK2 Stresses - 6th Entry in Voigt
                      ///< Notation for all the GQ Points for no Poisson Effect
    Eigen::Array<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>
        m_Sdiag_1_Dv;  ///< Cached calculation for the 2nd PK2 Stresses - 1st Entry in Voigt
                       ///< Notation for all the GQ Points with Poisson Effect
    Eigen::Array<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>
        m_Sdiag_2_Dv;  ///< Cached calculation for the 2nd PK2 Stresses - 2nd Entry in Voigt
                       ///< Notation for all the GQ Points with Poisson Effect
    Eigen::Array<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>
        m_Sdiag_3_Dv;  ///< Cached calculation for the 2nd PK2 Stresses - 3rd Entry in Voigt
                       ///< Notation for all the GQ Points with Poisson Effect
