...
ChElementBeamANCF_3333_TR02::ChElementBeamANCF_3333_TR02()
    ...
    m_nodes.resize(3);
    m_strain_form = ChElementBeamANCF_3333_TR02::CMPoisson;
}
...
void ChElementBeamANCF_3333_TR02::ComputeKRMmatricesGlobal(ChMatrixRef H, double Kfactor, double Rfactor, double Mfactor) {
...
// -----------------------------------------------------------------------------
void ChElementBeamANCF_3333_TR02::ComputeMassMatrixAndGravityForce(const ChVector<>& g_acc) {
...
void ChElementBeamANCF_3333_TR02::ComputeInternalForcesAtState(ChVectorDynamic<>& Fi, const Vector3N& e, const Vector3N& edot) {
    ...
    // beam axis
    if (GetStrainFormulation() == ChElementBeamANCF_3333_TR02::StrainFormulation::CMPoisson) {
...
void ChElementBeamANCF_3333_TR02::ComputeInternalJacobians(Matrix3Nx3N& JacobianMatrix, double Kfactor, double Rfactor) {
...
void ChElementBeamANCF_3333_TR02::Calc_Sxi(Matrix3x3N& Sxi, double xi, double eta, double zeta) {
    VectorN Sxi_compact;
...
// -----------------------------------------------------------------------------
// ChVector<> ChElementBeamANCF_3333_TR02::EvaluateBeamSectionStrains() {
...
//}
//
// void ChElementBeamANCF_3333_TR02::EvaluateSectionDisplacement(const double u,
//                                                    const double v,
//                                                    ChVector<>& u_displ,
//                                                    ChVector<>& u_rotaz) {
...
//}
//
// void ChElementBeamANCF_3333_TR02::EvaluateSectionFrame(const double u,
//                                             const double v,
//                                             ChVector<>& point,
//                                             ChQuaternion<>& rot) {
//    // this is not a corotational element, so just do:
...
//}
//
// void ChElementBeamANCF_3333_TR02::EvaluateSectionPoint(const double u,
//                                             const double v,
//                                             ChVector<>& point) {
//    ChVector<> u_displ;
//
...
// void ChElementBeamANCF_3333_TR02::EvaluateSectionVelNorm(double U, ChVector<>& Result) {
//    ChMatrixNM<double, 1, 9> N;
...
ChVector<> ChElementBeamANCF_3333_TR02::ComputeTangent(const double U) {
    Matrix3x3N Sxi_xi;
    Vector3N e;
    ChVector<> r_xi;
...
ChQuadratureTables static_tables_TR02(1, CH_QUADRATURE_STATIC_TABLES);
//#endif // !CH_QUADRATURE_STATIC_TABLES

ChQuadratureTables* ChElementBeamANCF_3333_TR02::GetStaticGQTables() {
    return &static_tables_TR02;
}

////////////////////////////////////////////////////////////////

// ============================================================================
// Implementation of ChMaterialBeamANCF_3333_TR02 methods
// ============================================================================

// Construct an isotropic material.
ChMaterialBeamANCF_3333_TR02::ChMaterialBeamANCF_3333_TR02(double rho,        // material density
...
// Poisson effect
void ChMaterialBeamANCF_3333_TR02::Calc_D0_Dv(const ChVector<>& E,
                                         const ChVector<>& nu,
                                         const ChVector<>& G,
                                         double k1,
                                         double k2) {
