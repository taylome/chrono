...
#ifndef CHELEMENTBRICKANCF3843TR07S_H
#define CHELEMENTBRICKANCF3843TR07S_H
...
/// This class implements material properties for an ANCF Brick.
    class ChApi ChMaterialBrickANCF_3843_TR07S {
    public:
        /// Construct an isotropic material.
        ChMaterialBrickANCF_3843_TR07S(double rho,        ///< material density
...
class ChApi ChElementBrickANCF_3843_TR07S : public ChElementGeneric, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBrickANCF_3843_TR07S> brick_mat) { m_material = brick_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBrickANCF_3843_TR07S> GetMaterial() const { return m_material; }
...
public:
  ...
  private:
      ...
      std::shared_ptr<ChMaterialBrickANCF_3843_TR07S> m_material;  ///< shell material
