...
ChElementBeamANCF_3243_TR05::ChElementBeamANCF_3243_TR05()
    ...
    m_nodes.resize(2);
    m_strain_form = ChElementBeamANCF_3243_TR05::CMPoisson;
}
...
// -----------------------------------------------------------------------------
void ChElementBeamANCF_3243_TR05::ComputeMassMatrixAndGravityForce(const ChVector<>& g_acc) {
...
void ChElementBeamANCF_3243_TR05::ComputeInternalForcesAtState(ChVectorDynamic<>& Fi,
    ...
    // beam axis
    if (GetStrainFormulation() == ChElementBeamANCF_3243_TR05::StrainFormulation::CMPoisson) {
...
void ChElementBeamANCF_3243_TR05::ComputeInternalJacobians(ChMatrixNM<double, 24, 24>& JacobianMatrix,
                                                           double Kfactor,
                                                           double Rfactor) {
...
void ChElementBeamANCF_3243_TR05::Calc_Sxi(ChMatrixNM<double, 3, 24>& Sxi, double xi, double eta, double zeta) {
...
// [s1; s2; s3; ...]
void ChElementBeamANCF_3243_TR05::Calc_Sxi_compact(ChVectorN<double, 8>& Sxi_compact,
                                                   double xi,
                                                   double eta,
                                                   double zeta) {
...
// [s1*I_3x3, s2*I_3x3, s3*I_3x3, ...]
void ChElementBeamANCF_3243_TR05::Calc_Sxi_xi(ChMatrixNM<double, 3, 24>& Sxi_xi, double xi, double eta, double zeta) {
...
// [s1; s2; s3; ...]
void ChElementBeamANCF_3243_TR05::Calc_Sxi_xi_compact(ChVectorN<double, 8>& Sxi_xi_compact,
                                                      double xi,
                                                      double eta,
                                                      double zeta) {
...
// [s1*I_3x3, s2*I_3x3, s3*I_3x3, ...]
void ChElementBeamANCF_3243_TR05::Calc_Sxi_eta(ChMatrixNM<double, 3, 24>& Sxi_eta, double xi, double eta, double zeta) {
...
// [s1; s2; s3; ...]
void ChElementBeamANCF_3243_TR05::Calc_Sxi_eta_compact(ChVectorN<double, 8>& Sxi_eta_compact,
                                                       double xi,
                                                       double eta,
                                                       double zeta) {
...
// [s1*I_3x3, s2*I_3x3, s3*I_3x3, ...]
void ChElementBeamANCF_3243_TR05::Calc_Sxi_zeta(ChMatrixNM<double, 3, 24>& Sxi_zeta,
                                                double xi,
                                                double eta,
                                                double zeta) {
...
// 8x1 Vector Form of the partial derivatives of Normalized Shape Functions with respect to eta
// [s1; s2; s3; ...]
void ChElementBeamANCF_3243_TR05::Calc_Sxi_zeta_compact(ChVectorN<double, 8>& Sxi_zeta_compact,
                                                        double xi,
                                                        double eta,
                                                        double zeta) {
...
void ChElementBeamANCF_3243_TR05::Calc_Sxi_D(ChMatrixNMc<double, 8, 3>& Sxi_D, double xi, double eta, double zeta) {
...
void ChElementBeamANCF_3243_TR05::CalcCoordVector(ChVectorN<double, 24>& e) {
...
void ChElementBeamANCF_3243_TR05::CalcCoordMatrix(ChMatrixNM<double, 3, 8>& ebar) {
...
void ChElementBeamANCF_3243_TR05::CalcCoordDerivVector(ChVectorN<double, 24>& edot) {
...
void ChElementBeamANCF_3243_TR05::CalcCoordDerivMatrix(ChMatrixNM<double, 3, 8>& ebardot) {
...
// -----------------------------------------------------------------------------
// ChVector<> ChElementBeamANCF_3243_TR05::EvaluateBeamSectionStrains() {
...
//}
//
// void ChElementBeamANCF_3243_TR05::EvaluateSectionDisplacement(const double u,
//                                                    const double v,
//                                                    ChVector<>& u_displ,
//                                                    ChVector<>& u_rotaz) {
...
//}
//
// void ChElementBeamANCF_3243_TR05::EvaluateSectionFrame(const double u,
//                                             const double v,
//                                             ChVector<>& point,
//                                             ChQuaternion<>& rot) {
//    // this is not a corotational element, so just do:
...
//}
//
// void ChElementBeamANCF_3243_TR05::EvaluateSectionPoint(const double u,
//                                             const double v,
//                                             ChVector<>& point) {
//    ChVector<> u_displ;
//
...
// void ChElementBeamANCF_3243_TR05::EvaluateSectionVelNorm(double U, ChVector<>& Result) {
//    ChMatrixNM<double, 1, 9> N;
...
ChVector<> ChElementBeamANCF_3243_TR05::ComputeTangent(const double U) {
    ChMatrixNM<double, 3, 24> Sxi_xi;
    ChVectorN<double, 24> e;
    ChVector<> r_xi;
...
ChQuadratureTables static_tables_2_TR05(1, CH_QUADRATURE_STATIC_TABLES);
//#endif // !CH_QUADRATURE_STATIC_TABLES

ChQuadratureTables* ChElementBeamANCF_3243_TR05::GetStaticGQTables() {
    return &static_tables_2_TR05;
}

////////////////////////////////////////////////////////////////

// ============================================================================
// Implementation of ChMaterialBeamANCF_3243_TR05 methods
// ============================================================================

// Construct an isotropic material.
ChMaterialBeamANCF_3243_TR05::ChMaterialBeamANCF_3243_TR05(
...
// Poisson effect
void ChMaterialBeamANCF_3243_TR05::Calc_D0_Dv(const ChVector<>& E,
                                              const ChVector<>& nu,
                                              const ChVector<>& G,
                                              double k1,
                                              double k2) {
