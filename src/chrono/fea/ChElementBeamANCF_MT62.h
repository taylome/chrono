...
#ifndef CHELEMENTBEAMANCFMT62_H
#define CHELEMENTBEAMANCFMT62_H
...
class ChApi ChMaterialBeamANCF_MT62 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_MT62(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_MT62 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MT62> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_MT62> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_MT62> m_material;    ///< beam material
