...
#ifndef CH_ELEMENT_HEXA_ANCF_3843_TR07B_H
#define CH_ELEMENT_HEXA_ANCF_3843_TR07B_H
...
class ChApi ChElementHexaANCF_3843_TR07B : public ChElementHexahedron, public ChElementGeneric, public ChLoadableUVW {
  public:
  ...
  private:
    ...
    Eigen::Array<double, 1, Eigen::Dynamic, Eigen::RowMajor>
