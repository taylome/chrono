...
#ifndef CHELEMENTBEAMANCFMT17_H
#define CHELEMENTBEAMANCFMT17_H
...
class ChApi ChMaterialBeamANCF_MT17 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_MT17(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_MT17 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MT17> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_MT17> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_MT17> m_material;    ///< beam material
