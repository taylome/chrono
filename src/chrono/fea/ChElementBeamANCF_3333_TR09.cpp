...
ChElementBeamANCF_3333_TR09::ChElementBeamANCF_3333_TR09()
...
void ChElementBeamANCF_3333_TR09::SetNodes(std::shared_ptr<ChNodeFEAxyzDD> nodeA,
...
void ChElementBeamANCF_3333_TR09::SetupInitial(ChSystem* system) {
...
// State update.
void ChElementBeamANCF_3333_TR09::Update() {
    ChElementGeneric::Update();
}

// Fill the D vector with the current field values at the element nodes.
void ChElementBeamANCF_3333_TR09::GetStateBlock(ChVectorDynamic<>& mD) {
...
void ChElementBeamANCF_3333_TR09::ComputeKRMmatricesGlobal(ChMatrixRef H, double Kfactor, double Rfactor, double Mfactor) {
    ...
    ChMatrixNMc<double, 9, 81> K2 = -PI2 * m_O2;
...
void ChElementBeamANCF_3333_TR09::ComputeMmatrixGlobal(ChMatrixRef M) {
    M.setZero();
...
// -----------------------------------------------------------------------------
void ChElementBeamANCF_3333_TR09::ComputeMassMatrixAndGravityForce(const ChVector<>& g_acc) {
...
void ChElementBeamANCF_3333_TR09::PrecomputeInternalForceMatricesWeights() {
    ChQuadratureTables* GQTable = GetStaticGQTables();
        ...
        for (unsigned int it_eta = 0; it_eta < GQTable->Lroots[GQ_idx_eta_zeta].size(); it_eta++) {
            for (unsigned int it_zeta = 0; it_zeta < GQTable->Lroots[GQ_idx_eta_zeta].size(); it_zeta++) {
                ...
                m_K3Compact += GQWeight_det_J_0xi * 0.5 *
                               (D0(0) * Sxi_D_0xi.block<9, 1>(0, 0) * Sxi_D_0xi.block<9, 1>(0, 0).transpose() +
                ...
                for (unsigned int n = 0; n < 3; n++) {
                    for (unsigned int c = 0; c < 3; c++) {
                        ...
                        ChMatrixNM<double, 9, 9> Sxi_D_0xi_n_Sxi_D_0xi_c_transpose =
                            Sxi_D_0xi.block<9, 1>(0, n) * Sxi_D_0xi.block<9, 1>(0, c).transpose();
                        for (unsigned int f = 0; f < 9; f++) {
...
void ChElementBeamANCF_3333_TR09::ComputeNodalMass() {
...
void ChElementBeamANCF_3333_TR09::SetAlphaDamp(double a) {
    m_Alpha = a;
...
void ChElementBeamANCF_3333_TR09::ComputeInternalForces(ChVectorDynamic<>& Fi) {
    ChMatrixNMc<double, 9, 3> e_bar;
    ChMatrixNMc<double, 9, 3> e_bar_dot;
...
void ChElementBeamANCF_3333_TR09::ComputeInternalForcesAtState(ChVectorDynamic<>& Fi,
...
void ChElementBeamANCF_3333_TR09::ComputeInternalJacobians(ChMatrixNM<double, 27, 27>& JacobianMatrix,
                                                      double Kfactor,
                                                      double Rfactor) {
...
void ChElementBeamANCF_3333_TR09::Calc_Sxi(ChMatrixNM<double, 3, 27>& Sxi, double xi, double eta, double zeta) {
...
// [s1; s2; s3; ...]
void ChElementBeamANCF_3333_TR09::Calc_Sxi_compact(ChVectorN<double, 9>& Sxi_compact, double xi, double eta, double zeta) {
...
void ChElementBeamANCF_3333_TR09::Calc_Sxi_D(ChMatrixNMc<double, 9, 3>& Sxi_D, double xi, double eta, double zeta) {
    Sxi_D(0, 0) = xi - 0.5;
...
void ChElementBeamANCF_3333_TR09::CalcCoordMatrix(ChMatrixNMc<double, 9, 3>& e) {
...
void ChElementBeamANCF_3333_TR09::CalcCoordVector(ChVectorN<double, 27>& e) {
...
void ChElementBeamANCF_3333_TR09::CalcCoordDerivMatrix(ChMatrixNMc<double, 9, 3>& edot) {
...
void ChElementBeamANCF_3333_TR09::CalcCoordDerivVector(ChVectorN<double, 27>& edot) {
...
void ChElementBeamANCF_3333_TR09::Calc_J_0xi(ChMatrix33<double>& J_0xi, double xi, double eta, double zeta) {
...
double ChElementBeamANCF_3333_TR09::Calc_det_J_0xi(double xi, double eta, double zeta) {
    ChMatrixNMc<double, 9, 3> Sxi_D;
...
// -----------------------------------------------------------------------------
// ChVector<> ChElementBeamANCF_3333_TR09::EvaluateBeamSectionStrains() {
...
//}
//
// void ChElementBeamANCF_3333_TR09::EvaluateSectionDisplacement(const double u,
//                                                    const double v,
//                                                    ChVector<>& u_displ,
//                                                    ChVector<>& u_rotaz) {
...
void ChElementBeamANCF_3333_TR09::EvaluateSectionFrame(const double xi, ChVector<>& point, ChQuaternion<>& rot) {
    ChMatrixNMc<double, 9, 3> e_bar;
    ChVectorN<double, 9> Sxi_compact;
    ChMatrixNMc<double, 9, 3> Sxi_D;
...
// void ChElementBeamANCF_3333_TR09::EvaluateSectionPoint(const double u,
//                                             const double v,
//                                             ChVector<>& point) {
//    ChVector<> u_displ;
//
...
void ChElementBeamANCF_3333_TR09::LoadableGetStateBlock_x(int block_offset, ChState& mD) {
...
void ChElementBeamANCF_3333_TR09::LoadableGetStateBlock_w(int block_offset, ChStateDelta& mD) {
...
void ChElementBeamANCF_3333_TR09::LoadableStateIncrement(const unsigned int off_x,
                                                    ChState& x_new,
                                                    const ChState& x,
...
// void ChElementBeamANCF_3333_TR09::EvaluateSectionVelNorm(double U, ChVector<>& Result) {
//    ShapeVector N;
...
void ChElementBeamANCF_3333_TR09::LoadableGetVariables(std::vector<ChVariables*>& mvars) {
...
void ChElementBeamANCF_3333_TR09::ComputeNF(
...
double ChElementBeamANCF_3333_TR09::GetDensity() {
    return GetMaterial()->Get_rho();
}

// Calculate tangent to the centerline at (U) coordinates.
ChVector<> ChElementBeamANCF_3333_TR09::ComputeTangent(const double U) {
    ChMatrixNMc<double, 9, 3> e_bar;
    ChMatrixNMc<double, 9, 3> Sxi_D;
    ChVector<> r_xi;
...
ChQuadratureTables static_tables_TR09(1, CH_QUADRATURE_STATIC_TABLES);
//#endif // !CH_QUADRATURE_STATIC_TABLES

ChQuadratureTables* ChElementBeamANCF_3333_TR09::GetStaticGQTables() {
    return &static_tables_TR09;
}

////////////////////////////////////////////////////////////////

// ============================================================================
// Implementation of ChMaterialBeamANCF_3333_TR09 methods
// ============================================================================

// Construct an isotropic material.
ChMaterialBeamANCF_3333_TR09::ChMaterialBeamANCF_3333_TR09(double rho,        // material density
...
// Poisson effect
void ChMaterialBeamANCF_3333_TR09::Calc_D0_Dv(const ChVector<>& E,
                                         const ChVector<>& nu,
                                         const ChVector<>& G,
                                         double k1,
                                         double k2) {
