...
ChElementShellANCF_3833_TR08b::ChElementShellANCF_3833_TR08b()
...
void ChElementShellANCF_3833_TR08b::SetNodes(std::shared_ptr<ChNodeFEAxyzDD> nodeA,
...
void ChElementShellANCF_3833_TR08b::SetupInitial(ChSystem* system) {
    // Initial positions and slopes of the element nodes
    // These values define the reference configuration of the element
    CalcCoordMatrix(m_ebar0);
...
// State update.
void ChElementShellANCF_3833_TR08b::Update() {
    ChElementGeneric::Update();
}

// Fill the D vector with the current field values at the element nodes.
void ChElementShellANCF_3833_TR08b::GetStateBlock(ChVectorDynamic<>& mD) {
...
void ChElementShellANCF_3833_TR08b::ComputeKRMmatricesGlobal(ChMatrixRef H,
    double Kfactor,
    double Rfactor,
    double Mfactor) {
...
void ChElementShellANCF_3833_TR08b::ComputeMmatrixGlobal(ChMatrixRef M) {
    M.setZero();
...
// -----------------------------------------------------------------------------
void ChElementShellANCF_3833_TR08b::ComputeMassMatrixAndGravityForce(const ChVector<>& g_acc) {
...
void ChElementShellANCF_3833_TR08b::ComputeNodalMass() {
...
void ChElementShellANCF_3833_TR08b::PrecomputeInternalForceMatricesWeights() {
    ChQuadratureTables* GQTable = GetStaticGQTables();
...
void ChElementShellANCF_3833_TR08b::SetAlphaDamp(double a) {
    m_Alpha = a;
    m_2Alpha = 2 * a;
...
void ChElementShellANCF_3833_TR08b::ComputeInternalForces(ChVectorDynamic<>& Fi) {
...
void ChElementShellANCF_3833_TR08b::ComputeInternalForcesAtState(ChVectorDynamic<>& Fi, const MatrixNx6& ebar_ebardot) {
    ...
    E0_Block.noalias() += F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(0, 1).cwiseProduct(
        F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(0, 1));
    E0_Block.noalias() += F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(0, 2).cwiseProduct(
    ...
    E_BlockDamping.noalias() += F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(0, 1).cwiseProduct(
        F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(0, 4));
    E_BlockDamping.noalias() += F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(0, 2).cwiseProduct(
    ...
    E1_Block.noalias() += F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(64, 1).cwiseProduct(
        F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(64, 1));
    E1_Block.noalias() += F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(64, 2).cwiseProduct(
    ...
    E_BlockDamping.noalias() += F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(64, 1).cwiseProduct(
        F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(64, 4));
    E_BlockDamping.noalias() += F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(64, 2).cwiseProduct(
    ...
    E2_Block.noalias() += F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(128, 1).cwiseProduct(
        F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(128, 1));
    E2_Block.noalias() += F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(128, 2).cwiseProduct(
    ...
    E_BlockDamping.noalias() += F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(128, 1).cwiseProduct(
        F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(128, 4));
    E_BlockDamping.noalias() += F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(128, 2).cwiseProduct(
    ...
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::ColMajor>  E3_Block = F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(64, 0).cwiseProduct(
        F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(128, 0));
    E3_Block.noalias() += F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(64, 1).cwiseProduct(
        F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(128, 1));
    E3_Block.noalias() += F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(64, 2).cwiseProduct(
        F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(128, 2));
    E_BlockDamping.noalias() = F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(128, 0).cwiseProduct(
        F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(64, 3));
    E_BlockDamping.noalias() += F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(128, 1).cwiseProduct(
    ...
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::ColMajor>  E4_Block = F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(0, 0).cwiseProduct(
        F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(128, 0));
    E4_Block.noalias() += F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(0, 1).cwiseProduct(
        F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(128, 1));
    E4_Block.noalias() += F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(0, 2).cwiseProduct(
        F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(128, 2));
    E_BlockDamping.noalias() = F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(128, 0).cwiseProduct(
        F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(0, 3));
    E_BlockDamping.noalias() += F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(128, 1).cwiseProduct(
    ...
    E_BlockDamping.noalias() += F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(128, 2).cwiseProduct(
        F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(0, 5));
    E_BlockDamping.noalias() += F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(0, 0).cwiseProduct(
        F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(128, 3));
    E_BlockDamping.noalias() += F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(0, 1).cwiseProduct(
        F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(128, 4));
    E_BlockDamping.noalias() += F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(0, 2).cwiseProduct(
    ...
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::ColMajor>  E5_Block = F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(0, 0).cwiseProduct(
        F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(64, 0));
    E5_Block.noalias() += F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(0, 1).cwiseProduct(
        F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(64, 1));
    E5_Block.noalias() += F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(0, 2).cwiseProduct(
        F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(64, 2));
    E_BlockDamping.noalias() = F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(64, 0).cwiseProduct(
        F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(0, 3));
    E_BlockDamping.noalias() += F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(64, 1).cwiseProduct(
...
void ChElementShellANCF_3833_TR08b::ComputeInternalForcesAtStateNoDamping(ChVectorDynamic<>& Fi,
    ...
    E0_Block.noalias() += F_Transpose_CombinedBlock_col_ordered.block<64, 1>(0, 1).cwiseProduct(
        F_Transpose_CombinedBlock_col_ordered.block<64, 1>(0, 1));
    E0_Block.noalias() += F_Transpose_CombinedBlock_col_ordered.block<64, 1>(0, 2).cwiseProduct(
    ...
    E1_Block.noalias() += F_Transpose_CombinedBlock_col_ordered.block<64, 1>(64, 1).cwiseProduct(
        F_Transpose_CombinedBlock_col_ordered.block<64, 1>(64, 1));
    E1_Block.noalias() += F_Transpose_CombinedBlock_col_ordered.block<64, 1>(64, 2).cwiseProduct(
    ...
    E2_Block.noalias() += F_Transpose_CombinedBlock_col_ordered.block<64, 1>(128, 1).cwiseProduct(
        F_Transpose_CombinedBlock_col_ordered.block<64, 1>(128, 1));
    E2_Block.noalias() += F_Transpose_CombinedBlock_col_ordered.block<64, 1>(128, 2).cwiseProduct(
    ...
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::ColMajor>  E3_Block = F_Transpose_CombinedBlock_col_ordered.block<64, 1>(64, 0).cwiseProduct(
        F_Transpose_CombinedBlock_col_ordered.block<64, 1>(128, 0));
    E3_Block.noalias() += F_Transpose_CombinedBlock_col_ordered.block<64, 1>(64, 1).cwiseProduct(
        F_Transpose_CombinedBlock_col_ordered.block<64, 1>(128, 1));
    E3_Block.noalias() += F_Transpose_CombinedBlock_col_ordered.block<64, 1>(64, 2).cwiseProduct(
        F_Transpose_CombinedBlock_col_ordered.block<64, 1>(128, 2));
    E3_Block.array() *= m_GQWeight_det_J_0xi_D.array();
    ...
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::ColMajor>  E4_Block = F_Transpose_CombinedBlock_col_ordered.block<64, 1>(0, 0).cwiseProduct(
        F_Transpose_CombinedBlock_col_ordered.block<64, 1>(128, 0));
    E4_Block.noalias() += F_Transpose_CombinedBlock_col_ordered.block<64, 1>(0, 1).cwiseProduct(
        F_Transpose_CombinedBlock_col_ordered.block<64, 1>(128, 1));
    E4_Block.noalias() += F_Transpose_CombinedBlock_col_ordered.block<64, 1>(0, 2).cwiseProduct(
        F_Transpose_CombinedBlock_col_ordered.block<64, 1>(128, 2));
    E4_Block.array() *= m_GQWeight_det_J_0xi_D.array();
    ...
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::ColMajor>  E5_Block = F_Transpose_CombinedBlock_col_ordered.block<64, 1>(0, 0).cwiseProduct(
        F_Transpose_CombinedBlock_col_ordered.block<64, 1>(64, 0));
    E5_Block.noalias() += F_Transpose_CombinedBlock_col_ordered.block<64, 1>(0, 1).cwiseProduct(
        F_Transpose_CombinedBlock_col_ordered.block<64, 1>(64, 1));
    E5_Block.noalias() += F_Transpose_CombinedBlock_col_ordered.block<64, 1>(0, 2).cwiseProduct(
        F_Transpose_CombinedBlock_col_ordered.block<64, 1>(64, 2));
    E5_Block.array() *= m_GQWeight_det_J_0xi_D.array();
...
void ChElementShellANCF_3833_TR08b::ComputeInternalJacobians(Matrix3Nx3N& JacobianMatrix,
                                                           double Kfactor,
                                                           double Rfactor) {
    ...
    if (m_damping_enabled) {
        ...
        for (unsigned int i = 0; i < 72; i++) {
            ...
            ComputeInternalForcesAtState(FiDelta, ebar_ebardot);
            JacobianMatrix.col(i).noalias() += -Rfactor / delta * (FiDelta - FiOrignal);
            ebar_ebardot(i / 3, (i % 3) + 3) = ebar_ebardot(i / 3, (i % 3) + 3) - delta;
        }
    }
    else {
...
void ChElementShellANCF_3833_TR08b::ComputeInternalJacobianDamping(ChMatrixRef& H,
    double Kfactor,
    double Rfactor,
    double Mfactor) {
    ...
    DScaled_Combined_partial_epsilon_partial_e_Transpose.block(0, 0, 72, 64) = D(0, 0)*Scaled_Combined_partial_epsilon_partial_e_Transpose.block(0, 0, 72, 64) + D(0, 1)*Scaled_Combined_partial_epsilon_partial_e_Transpose.block(0, 64, 72, 64) + D(0, 2)*Scaled_Combined_partial_epsilon_partial_e_Transpose.block(0, 128, 72, 64) + D(0, 3)*Scaled_Combined_partial_epsilon_partial_e_Transpose.block(0, 192, 72, 64) + D(0, 4)*Scaled_Combined_partial_epsilon_partial_e_Transpose.block(0, 256, 72, 64) + D(0, 5)*Scaled_Combined_partial_epsilon_partial_e_Transpose.block(0, 320, 72, 64);
    DScaled_Combined_partial_epsilon_partial_e_Transpose.block(0, 64, 72, 64) = D(1, 0)*Scaled_Combined_partial_epsilon_partial_e_Transpose.block(0, 0, 72, 64) + D(1, 1)*Scaled_Combined_partial_epsilon_partial_e_Transpose.block(0, 64, 72, 64) + D(1, 2)*Scaled_Combined_partial_epsilon_partial_e_Transpose.block(0, 128, 72, 64) + D(1, 3)*Scaled_Combined_partial_epsilon_partial_e_Transpose.block(0, 192, 72, 64) + D(1, 4)*Scaled_Combined_partial_epsilon_partial_e_Transpose.block(0, 256, 72, 64) + D(1, 5)*Scaled_Combined_partial_epsilon_partial_e_Transpose.block(0, 320, 72, 64);
    DScaled_Combined_partial_epsilon_partial_e_Transpose.block(0, 128, 72, 64) = D(2, 0)*Scaled_Combined_partial_epsilon_partial_e_Transpose.block(0, 0, 72, 64) + D(2, 1)*Scaled_Combined_partial_epsilon_partial_e_Transpose.block(0, 64, 72, 64) + D(2, 2)*Scaled_Combined_partial_epsilon_partial_e_Transpose.block(0, 128, 72, 64) + D(2, 3)*Scaled_Combined_partial_epsilon_partial_e_Transpose.block(0, 192, 72, 64) + D(2, 4)*Scaled_Combined_partial_epsilon_partial_e_Transpose.block(0, 256, 72, 64) + D(2, 5)*Scaled_Combined_partial_epsilon_partial_e_Transpose.block(0, 320, 72, 64);
    DScaled_Combined_partial_epsilon_partial_e_Transpose.block(0, 192, 72, 64) = D(3, 0)*Scaled_Combined_partial_epsilon_partial_e_Transpose.block(0, 0, 72, 64) + D(3, 1)*Scaled_Combined_partial_epsilon_partial_e_Transpose.block(0, 64, 72, 64) + D(3, 2)*Scaled_Combined_partial_epsilon_partial_e_Transpose.block(0, 128, 72, 64) + D(3, 3)*Scaled_Combined_partial_epsilon_partial_e_Transpose.block(0, 192, 72, 64) + D(3, 4)*Scaled_Combined_partial_epsilon_partial_e_Transpose.block(0, 256, 72, 64) + D(3, 5)*Scaled_Combined_partial_epsilon_partial_e_Transpose.block(0, 320, 72, 64);
    DScaled_Combined_partial_epsilon_partial_e_Transpose.block(0, 256, 72, 64) = D(4, 0)*Scaled_Combined_partial_epsilon_partial_e_Transpose.block(0, 0, 72, 64) + D(4, 1)*Scaled_Combined_partial_epsilon_partial_e_Transpose.block(0, 64, 72, 64) + D(4, 2)*Scaled_Combined_partial_epsilon_partial_e_Transpose.block(0, 128, 72, 64) + D(4, 3)*Scaled_Combined_partial_epsilon_partial_e_Transpose.block(0, 192, 72, 64) + D(4, 4)*Scaled_Combined_partial_epsilon_partial_e_Transpose.block(0, 256, 72, 64) + D(4, 5)*Scaled_Combined_partial_epsilon_partial_e_Transpose.block(0, 320, 72, 64);
    DScaled_Combined_partial_epsilon_partial_e_Transpose.block(0, 320, 72, 64) = D(5, 0)*Scaled_Combined_partial_epsilon_partial_e_Transpose.block(0, 0, 72, 64) + D(5, 1)*Scaled_Combined_partial_epsilon_partial_e_Transpose.block(0, 64, 72, 64) + D(5, 2)*Scaled_Combined_partial_epsilon_partial_e_Transpose.block(0, 128, 72, 64) + D(5, 3)*Scaled_Combined_partial_epsilon_partial_e_Transpose.block(0, 192, 72, 64) + D(5, 4)*Scaled_Combined_partial_epsilon_partial_e_Transpose.block(0, 256, 72, 64) + D(5, 5)*Scaled_Combined_partial_epsilon_partial_e_Transpose.block(0, 320, 72, 64);

    H = partial_epsilon_partial_e_Transpose * DScaled_Combined_partial_epsilon_partial_e_Transpose.transpose();

    //===========================================================================================

    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::ColMajor> E0_Block = F_Transpose_CombinedBlockDamping_col_ordered.block(0, 0, 64, 1).cwiseProduct(
        F_Transpose_CombinedBlockDamping_col_ordered.block(0, 0, 64, 1));
    E0_Block.noalias() += F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(0, 1).cwiseProduct(
        F_Transpose_CombinedBlockDamping_col_ordered.block(0, 1, 64, 1));
    E0_Block.noalias() += F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(0, 2).cwiseProduct(
        F_Transpose_CombinedBlockDamping_col_ordered.block(0, 2, 64, 1));
    E0_Block.array() -= 1;
    E0_Block *= 0.5;
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::ColMajor> E_BlockDamping = F_Transpose_CombinedBlockDamping_col_ordered.block(0, 0, 64, 1).cwiseProduct(
        F_Transpose_CombinedBlockDamping_col_ordered.block(0, 3, 64, 1));
    E_BlockDamping.noalias() += F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(0, 1).cwiseProduct(
        F_Transpose_CombinedBlockDamping_col_ordered.block(0, 4, 64, 1));
    E_BlockDamping.noalias() += F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(0, 2).cwiseProduct(
        F_Transpose_CombinedBlockDamping_col_ordered.block(0, 5, 64, 1));
    E0_Block.noalias() += m_Alpha * E_BlockDamping;
    E0_Block.array() *= m_GQWeight_det_J_0xi_D.array();
...
void ChElementShellANCF_3833_TR08b::ComputeInternalJacobianNoDamping(ChMatrixRef& H, double Kfactor, double Mfactor) {
...
void ChElementShellANCF_3833_TR08b::Calc_Sxi(Matrix3x3N& Sxi, double xi, double eta, double zeta) {
    VectorN Sxi_compact;
    Calc_Sxi_compact(Sxi_compact, xi, eta, zeta);
    Sxi.setZero();
...
// [s1; s2; s3; ...]
void ChElementShellANCF_3833_TR08b::Calc_Sxi_compact(VectorN& Sxi_compact, double xi, double eta, double zeta) {    
...
// [s1*I_3x3, s2*I_3x3, s3*I_3x3, ...]
void ChElementShellANCF_3833_TR08b::Calc_Sxi_xi(Matrix3x3N& Sxi_xi, double xi, double eta, double zeta) {
...
// [s1; s2; s3; ...]
void ChElementShellANCF_3833_TR08b::Calc_Sxi_xi_compact(VectorN& Sxi_xi_compact, double xi, double eta, double zeta) {
...
// [s1*I_3x3, s2*I_3x3, s3*I_3x3, ...]
void ChElementShellANCF_3833_TR08b::Calc_Sxi_eta(Matrix3x3N& Sxi_eta, double xi, double eta, double zeta) {
...
// [s1; s2; s3; ...]
void ChElementShellANCF_3833_TR08b::Calc_Sxi_eta_compact(VectorN& Sxi_eta_compact, double xi, double eta, double zeta) {
...
// [s1*I_3x3, s2*I_3x3, s3*I_3x3, ...]
void ChElementShellANCF_3833_TR08b::Calc_Sxi_zeta(Matrix3x3N& Sxi_zeta, double xi, double eta, double zeta) {
...
// [s1; s2; s3; ...]
void ChElementShellANCF_3833_TR08b::Calc_Sxi_zeta_compact(VectorN& Sxi_zeta_compact, double xi, double eta, double zeta) {
...
void ChElementShellANCF_3833_TR08b::Calc_Sxi_D(MatrixNx3c& Sxi_D, double xi, double eta, double zeta) {
...
void ChElementShellANCF_3833_TR08b::CalcCoordVector(Vector3N& e) {
...
void ChElementShellANCF_3833_TR08b::CalcCoordMatrix(Matrix3xN& ebar) {
...
void ChElementShellANCF_3833_TR08b::CalcCoordMatrix(MatrixNx3c& ebar) {
...
void ChElementShellANCF_3833_TR08b::CalcCoordMatrix(MatrixNx3& ebar) {
    ebar.row(0) = m_nodes[0]->GetPos().eigen();
    ebar.row(1) = m_nodes[0]->GetD().eigen();
    ebar.row(2) = m_nodes[0]->GetDD().eigen();
...
void ChElementShellANCF_3833_TR08b::CalcCoordDerivVector(Vector3N& edot) {
...
void ChElementShellANCF_3833_TR08b::CalcCoordDerivMatrix(Matrix3xN& ebardot) {
...
void ChElementShellANCF_3833_TR08b::CalcCoordDerivMatrix(MatrixNx3c& ebardot) {
...
void ChElementShellANCF_3833_TR08b::CalcCombinedCoordMatrix(MatrixNx6& ebar_ebardot) {
...
void ChElementShellANCF_3833_TR08b::Calc_J_0xi(ChMatrix33<double>& J_0xi, double xi, double eta, double zeta) {
    MatrixNx3c Sxi_D;
    Calc_Sxi_D(Sxi_D, xi, eta, zeta);
...
double ChElementShellANCF_3833_TR08b::Calc_det_J_0xi(double xi, double eta, double zeta) {
...
void ChElementShellANCF_3833_TR08b::EvaluateSectionFrame(const double xi, const double eta, ChVector<>& point, ChQuaternion<>& rot) {
    Matrix3x3N Sxi;
    Matrix3x3N Sxi_xi;
    Matrix3x3N Sxi_eta;
...
void ChElementShellANCF_3833_TR08b::EvaluateSectionPoint(const double u, const double v, ChVector<>& point) {
    Matrix3x3N Sxi;
    Calc_Sxi(Sxi, u, v, 0);
...
void ChElementShellANCF_3833_TR08b::EvaluateSectionVelNorm(double U, double V, ChVector<>& Result) {
    Matrix3x3N Sxi_zeta;
    Vector3N edot;
    ChVector<> r_zeta;
...
void ChElementShellANCF_3833_TR08b::LoadableGetStateBlock_x(int block_offset, ChState& mD) {
...
void ChElementShellANCF_3833_TR08b::LoadableGetStateBlock_w(int block_offset, ChStateDelta& mD) {
...
void ChElementShellANCF_3833_TR08b::LoadableStateIncrement(const unsigned int off_x,
                                                         ChState& x_new,
                                                         const ChState& x,
...
void ChElementShellANCF_3833_TR08b::LoadableGetVariables(std::vector<ChVariables*>& mvars) {
...
void ChElementShellANCF_3833_TR08b::ComputeNF(
...
double ChElementShellANCF_3833_TR08b::GetDensity() {
    return GetMaterial()->Get_rho();
}

// Calculate tangent to the centerline at (U) coordinates.
ChVector<> ChElementShellANCF_3833_TR08b::ComputeNormal(const double U, const double V) {
    Matrix3x3N Sxi_zeta;
    Vector3N e;
    ChVector<> r_zeta;
...
ChQuadratureTables static_tables_3833_TR08b(1, CH_QUADRATURE_STATIC_TABLES);
//#endif // !CH_QUADRATURE_STATIC_TABLES

ChQuadratureTables* ChElementShellANCF_3833_TR08b::GetStaticGQTables() {
    return &static_tables_3833_TR08b;
}

////////////////////////////////////////////////////////////////

// ============================================================================
// Implementation of ChMaterialShellANCF_3833_TR08b methods
// ============================================================================

// Construct an isotropic material.
ChMaterialShellANCF_3833_TR08b::ChMaterialShellANCF_3833_TR08b(
...
// Poisson effect
void ChMaterialShellANCF_3833_TR08b::Calc_D0_Dv(const ChVector<>& E,
                                              const ChVector<>& nu,
                                              const ChVector<>& G) {
