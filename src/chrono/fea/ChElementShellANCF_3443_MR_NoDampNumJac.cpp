...
ChElementShellANCF_3443_MR_NoDampNumJac::ChElementShellANCF_3443_MR_NoDampNumJac()
...
void ChElementShellANCF_3443_MR_NoDampNumJac::SetNodes(std::shared_ptr<ChNodeFEAxyzDDD> nodeA,
...
void ChElementShellANCF_3443_MR_NoDampNumJac::AddLayer(double thickness,
...
void ChElementShellANCF_3443_MR_NoDampNumJac::SetDimensions(double lenX, double lenY) {
    m_lenX = lenX;
    m_lenY = lenY;
}
...
void ChElementShellANCF_3443_MR_NoDampNumJac::SetMidsurfaceOffset(const double offset) {
...
ChMatrix33d ChElementShellANCF_3443_MR_NoDampNumJac::GetGreenLagrangeStrain(const double xi,
                                                                  const double eta,
                                                                  const double zeta) {
...
ChMatrix33d ChElementShellANCF_3443_MR_NoDampNumJac::GetPK2Stress(const double layer,
                                                        const double xi,
                                                        const double eta,
...
double ChElementShellANCF_3443_MR_NoDampNumJac::GetVonMissesStress(const double layer,
                                                        const double xi,
                                                        const double eta,
                                                        const double layer_zeta) {
    MatrixNx3c Sxi_D;  // Matrix of normalized shape function derivatives
...
void ChElementShellANCF_3443_MR_NoDampNumJac::SetupInitial(ChSystem* system) {
...
void ChElementShellANCF_3443_MR_NoDampNumJac::GetStateBlock(ChVectorDynamic<>& mD) {
...
void ChElementShellANCF_3443_MR_NoDampNumJac::Update() {
    ChElementGeneric::Update();
}

// Return the mass matrix in full sparse form.

void ChElementShellANCF_3443_MR_NoDampNumJac::ComputeMmatrixGlobal(ChMatrixRef M) {
    M.setZero();
...
void ChElementShellANCF_3443_MR_NoDampNumJac::ComputeNodalMass() {
...
void ChElementShellANCF_3443_MR_NoDampNumJac::ComputeInternalForces(ChVectorDynamic<>& Fi) {
...
void ChElementShellANCF_3443_MR_NoDampNumJac::ComputeKRMmatricesGlobal(ChMatrixRef H,
                                                            double Kfactor,
                                                            double Rfactor,
                                                            double Mfactor) {
...
void ChElementShellANCF_3443_MR_NoDampNumJac::ComputeGravityForces(ChVectorDynamic<>& Fg, const ChVector3d& G_acc) {
...
void ChElementShellANCF_3443_MR_NoDampNumJac::EvaluateSectionFrame(const double xi,
                                                        const double eta,
                                                        ChVector3d& point,
                                                        ChQuaternion<>& rot) {
    VectorN Sxi_compact;
...
void ChElementShellANCF_3443_MR_NoDampNumJac::EvaluateSectionPoint(const double xi, const double eta, ChVector3d& point) {
    VectorN Sxi_compact;
    Calc_Sxi_compact(Sxi_compact, xi, eta, 0, m_thicknessZ, m_midsurfoffset);
...
void ChElementShellANCF_3443_MR_NoDampNumJac::EvaluateSectionVelNorm(const double xi, const double eta, ChVector3d& Result) {
    VectorN Sxi_compact;
    Calc_Sxi_compact(Sxi_compact, xi, eta, 0, m_thicknessZ, m_midsurfoffset);
...
void ChElementShellANCF_3443_MR_NoDampNumJac::LoadableGetStateBlockPosLevel(int block_offset, ChState& mD) {
...
void ChElementShellANCF_3443_MR_NoDampNumJac::LoadableGetStateBlockVelLevel(int block_offset, ChStateDelta& mD) {
...
void ChElementShellANCF_3443_MR_NoDampNumJac::LoadableStateIncrement(const unsigned int off_x,
                                                          ChState& x_new,
                                                          const ChState& x,
...
void ChElementShellANCF_3443_MR_NoDampNumJac::LoadableGetVariables(std::vector<ChVariables*>& mvars) {
...
void ChElementShellANCF_3443_MR_NoDampNumJac::ComputeNF(
...
double ChElementShellANCF_3443_MR_NoDampNumJac::GetDensity() {
...
ChVector3d ChElementShellANCF_3443_MR_NoDampNumJac::ComputeNormal(const double xi, const double eta) {
...
void ChElementShellANCF_3443_MR_NoDampNumJac::ComputeMassMatrixAndGravityForce() {
...
void ChElementShellANCF_3443_MR_NoDampNumJac::PrecomputeInternalForceMatricesWeights() {
    ChQuadratureTables* GQTable = GetStaticGQTables();
...
void ChElementShellANCF_3443_MR_NoDampNumJac::ComputeInternalForceDamping(ChVectorDynamic<>& Fi, Matrix6xN& ebar_ebardot) {
...
void ChElementShellANCF_3443_MR_NoDampNumJac::ComputeInternalForceNoDamping(ChVectorDynamic<>& Fi, Matrix3xN& ebar) {
    assert((unsigned int)Fi.size() == GetNumCoordsPosLevel());
...
void ChElementShellANCF_3443_MR_NoDampNumJac::ComputeInternalJacobianDamping(ChMatrixRef H, double Kfactor, double Rfactor, double Mfactor) {
...
void ChElementShellANCF_3443_MR_NoDampNumJac::ComputeInternalJacobianNoDamping(ChMatrixRef H, double Kfactor, double Mfactor) {
    assert((H.rows() == 3 * NSF) && (H.cols() == 3 * NSF));
...
void ChElementShellANCF_3443_MR_NoDampNumJac::Calc_Sxi_compact(VectorN& Sxi_compact,
                                                    double xi,
                                                    double eta,
                                                    double zeta,
                                                    double thickness,
...
void ChElementShellANCF_3443_MR_NoDampNumJac::Calc_Sxi_xi_compact(VectorN& Sxi_xi_compact,
                                                       double xi,
                                                       double eta,
                                                       double zeta,
                                                       double thickness,
...
void ChElementShellANCF_3443_MR_NoDampNumJac::Calc_Sxi_eta_compact(VectorN& Sxi_eta_compact,
                                                        double xi,
                                                        double eta,
                                                        double zeta,
                                                        double thickness,
...
void ChElementShellANCF_3443_MR_NoDampNumJac::Calc_Sxi_zeta_compact(VectorN& Sxi_zeta_compact,
                                                         double xi,
                                                         double eta,
                                                         double zeta,
                                                         double thickness,
...
void ChElementShellANCF_3443_MR_NoDampNumJac::Calc_Sxi_D(MatrixNx3c& Sxi_D,
                                              double xi,
                                              double eta,
                                              double zeta,
                                              double thickness,
...
void ChElementShellANCF_3443_MR_NoDampNumJac::CalcCoordVector(Vector3N& e) {
...
void ChElementShellANCF_3443_MR_NoDampNumJac::CalcCoordMatrix(Matrix3xN& ebar) {
...
void ChElementShellANCF_3443_MR_NoDampNumJac::CalcCoordDtVector(Vector3N& edot) {
...
void ChElementShellANCF_3443_MR_NoDampNumJac::CalcCoordDtMatrix(Matrix3xN& ebardot) {
...
void ChElementShellANCF_3443_MR_NoDampNumJac::CalcCombinedCoordMatrix(Matrix6xN& ebar_ebardot) {
...
void ChElementShellANCF_3443_MR_NoDampNumJac::Calc_J_0xi(ChMatrix33d& J_0xi,
                                              double xi,
                                              double eta,
                                              double zeta,
                                              double thickness,
...
double ChElementShellANCF_3443_MR_NoDampNumJac::Calc_det_J_0xi(double xi,
                                                    double eta,
                                                    double zeta,
                                                    double thickness,
                                                    double zoffset) {
...
void ChElementShellANCF_3443_MR_NoDampNumJac::RotateReorderStiffnessMatrix(ChMatrix66d& D, double theta) {
...
ChQuadratureTables static_tables_3443_MR_NoDampNumJac(1, CH_QUADRATURE_STATIC_TABLES);
//#endif // !CH_QUADRATURE_STATIC_TABLES

ChQuadratureTables* ChElementShellANCF_3443_MR_NoDampNumJac::GetStaticGQTables() {
    return &static_tables_3443_MR_NoDampNumJac;
}

////////////////////////////////////////////////////////////////

// ============================================================================
// Implementation of ChElementShellANCF_3443_MR_NoDampNumJac::Layer methods
// ============================================================================

// Private constructor (a layer can be created only by adding it to an element)

ChElementShellANCF_3443_MR_NoDampNumJac::Layer::Layer(double thickness,
                                           std::shared_ptr<ChMaterialShellANCF_MR> material)
