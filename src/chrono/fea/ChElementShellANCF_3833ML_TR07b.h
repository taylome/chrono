...
#ifndef CHELEMENTSHELLANCF3833MLTR07B_H
#define CHELEMENTSHELLANCF3833MLTR07B_H
...
class ChApi ChMaterialShellANCF_3833ML_TR07B {
  public:
    /// Construct an isotropic material.
    ChMaterialShellANCF_3833ML_TR07B(double rho,        ///< material density
...
class ChApi ChElementShellANCF_3833ML_TR07B : public ChElementShell, public ChLoadableUV, public ChLoadableUVW {
  public:
    ...
    ChElementShellANCF_3833ML_TR07B();
    ~ChElementShellANCF_3833ML_TR07B() {}
    ...
    public:
        ...
        std::shared_ptr<ChMaterialShellANCF_3833ML_TR07B> GetMaterial() const { return m_material; }

    private:
        /// Private constructor (a layer can be created only by adding it to an element)
        Layer(ChElementShellANCF_3833ML_TR07B* element,                 ///< containing element
            double thickness,                              ///< layer thickness
            double theta,                                  ///< fiber angle
            std::shared_ptr<ChMaterialShellANCF_3833ML_TR07B> material  ///< layer material
        );

        ChElementShellANCF_3833ML_TR07B* m_element;                  ///< containing ANCF shell element
        std::shared_ptr<ChMaterialShellANCF_3833ML_TR07B> m_material;  ///< layer material
    ...
    public:
        ...
        friend class ChElementShellANCF_3833ML_TR07B;
    };
