...
#ifndef CHELEMENTSHELLANCF3443MLTR07SGQ442_H
#define CHELEMENTSHELLANCF3443MLTR07SGQ442_H
...
class ChApi ChMaterialShellANCF_3443ML_TR07S_GQ442 {
  public:
    /// Construct an isotropic material.
    ChMaterialShellANCF_3443ML_TR07S_GQ442(double rho,        ///< material density
...
class ChApi ChElementShellANCF_3443ML_TR07S_GQ442 : public ChElementShell, public ChLoadableUV, public ChLoadableUVW {
  public:
    ...
    using VectorNIP = ChVectorN<double, 32>;
    ...
    ChElementShellANCF_3443ML_TR07S_GQ442();
    ~ChElementShellANCF_3443ML_TR07S_GQ442() {}
    ...
    public:
        ...
        std::shared_ptr<ChMaterialShellANCF_3443ML_TR07S_GQ442> GetMaterial() const { return m_material; }

    private:
        /// Private constructor (a layer can be created only by adding it to an element)
        Layer(ChElementShellANCF_3443ML_TR07S_GQ442* element,                 ///< containing element
            double thickness,                              ///< layer thickness
            double theta,                                  ///< fiber angle
            std::shared_ptr<ChMaterialShellANCF_3443ML_TR07S_GQ442> material  ///< layer material
        );

        ChElementShellANCF_3443ML_TR07S_GQ442* m_element;                  ///< containing ANCF shell element
        std::shared_ptr<ChMaterialShellANCF_3443ML_TR07S_GQ442> m_material;  ///< layer material
    ...
    public:
        ...
        friend class ChElementShellANCF_3443ML_TR07S_GQ442;
    };
