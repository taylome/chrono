...
// =============================================================================
//
// MT34 = MT32 with AVX2 intrinsics for PTranspose Calcs
...
////
//// What should be done with ChVector<> ChElementBeamANCF_MT34::EvaluateBeamSectionStrains()... It doesn't seems to make sense for this element since there are no input arguments
...
////
//// For ChElementBeamANCF_MT34::ComputeNF, Need to figure out the state update stuff and exactly what Jacobian is being asked for
...
ChElementBeamANCF_MT34::ChElementBeamANCF_MT34() : m_gravity_on(false), m_thicknessY(0), m_thicknessZ(0), m_lenX(0), m_Alpha(0), m_damping_enabled(false){
    m_nodes.resize(3);
}
...
void ChElementBeamANCF_MT34::SetNodes(std::shared_ptr<ChNodeFEAxyzDD> nodeA,
...
void ChElementBeamANCF_MT34::SetupInitial(ChSystem* system) {
...
// State update.
void ChElementBeamANCF_MT34::Update() {
    ChElementGeneric::Update();
}

// Fill the D vector with the current field values at the element nodes.
void ChElementBeamANCF_MT34::GetStateBlock(ChVectorDynamic<>& mD) {
...
void ChElementBeamANCF_MT34::ComputeKRMmatricesGlobal(ChMatrixRef H, double Kfactor, double Rfactor, double Mfactor) {
    ...
    if (GetStrainFormulation() == ChElementBeamANCF_MT34::StrainFormulation::CMPoisson) {
...
void ChElementBeamANCF_MT34::ComputeMmatrixGlobal(ChMatrixRef M) {
    M.setZero();
...
// -----------------------------------------------------------------------------
void ChElementBeamANCF_MT34::ComputeMassMatrixAndGravityForce(const ChVector<>& g_acc) {
...
void ChElementBeamANCF_MT34::PrecomputeInternalForceMatricesWeights() {
    ChQuadratureTables* GQTable = GetStaticGQTables();
...
void ChElementBeamANCF_MT34::ComputeNodalMass() {
...
void ChElementBeamANCF_MT34::SetAlphaDamp(double a) {
    m_Alpha = a;
    m_2Alpha = 2 * a;
...
void ChElementBeamANCF_MT34::ComputeInternalForces(ChVectorDynamic<>& Fi) {   
...
void ChElementBeamANCF_MT34::ComputeInternalForcesAtState(ChVectorDynamic<>& Fi, const ChMatrixNMc<double, 9, 6>& ebar_ebardot) {

//#ifdef __AVX2__
#if true

    //Calculate F is one big block and then split up afterwards to improve efficiency (hopefully)
    //Preallocate F_Transpose so that it 32byte aligned for AVX loads
    ...
    F_Transpose_CombinedBlock_col_ordered = m_SD_precompute_col_ordered.transpose()*ebar_ebardot;

    //Preallocate P_Transpose so that it 32byte aligned for AVX stores
    ...
    //Ensure that GQWeight_det_J_0xi is 32 byte aligned for AVX2...need to check to see if Eigen already does this
    ...
    GQWeight_det_J_0xi = m_GQWeight_det_J_0xi;

    ChVectorN<double, 6> D0 = GetMaterial()->Get_D0();

    // =============================================================================
    // Now Compute P_Transpose from the Deformation Gradient without looping over
    // the GQ Points, but instead doing those calculations in parallel with AVX2
    // =============================================================================

    __m256d ones = _mm256_set1_pd(1.0);
    __m256d Alpha = _mm256_set1_pd(m_Alpha);
    __m256d TwiceAlpha = _mm256_set1_pd(m_2Alpha);

    //-------------------------------------------------------------
    //Loop over the columns of F in groups of 4 GQ points (AVX2 register size)
    for (auto i = 0; i < 16; i += 4) {
        ...
        __m256d Fcol0_Transpose_Block_col0 = _mm256_load_pd(&F_Transpose_CombinedBlock_col_ordered_Pointer[i]);
        __m256d Fcol0_Transpose_Block_col1 = _mm256_load_pd(&F_Transpose_CombinedBlock_col_ordered_Pointer[60 + i]);
        __m256d Fcol0_Transpose_Block_col2 = _mm256_load_pd(&F_Transpose_CombinedBlock_col_ordered_Pointer[120 + i]);
        __m256d Fdotcol0_Transpose_Block_col0 = _mm256_load_pd(&F_Transpose_CombinedBlock_col_ordered_Pointer[180 + i]);
        __m256d Fdotcol0_Transpose_Block_col1 = _mm256_load_pd(&F_Transpose_CombinedBlock_col_ordered_Pointer[240 + i]);
        __m256d Fdotcol0_Transpose_Block_col2 = _mm256_load_pd(&F_Transpose_CombinedBlock_col_ordered_Pointer[300 + i]);

        __m256d SPK2_Scale = _mm256_set1_pd(0.5 * D0(0));

        __m256d SPK2_0_D0_Block = _mm256_mul_pd(Fcol0_Transpose_Block_col0, Fcol0_Transpose_Block_col0);
        SPK2_0_D0_Block = _mm256_fmadd_pd(Fcol0_Transpose_Block_col1, Fcol0_Transpose_Block_col1, SPK2_0_D0_Block);
        SPK2_0_D0_Block = _mm256_fmadd_pd(Fcol0_Transpose_Block_col2, Fcol0_Transpose_Block_col2, SPK2_0_D0_Block);
        SPK2_0_D0_Block = _mm256_sub_pd(SPK2_0_D0_Block, ones);
        __m256d BlockDamping = _mm256_mul_pd(Fcol0_Transpose_Block_col0, Fdotcol0_Transpose_Block_col0);
        BlockDamping = _mm256_fmadd_pd(Fcol0_Transpose_Block_col1, Fdotcol0_Transpose_Block_col1, BlockDamping);
        BlockDamping = _mm256_fmadd_pd(Fcol0_Transpose_Block_col2, Fdotcol0_Transpose_Block_col2, BlockDamping);
        ...
        __m256d Fcol1_Transpose_Block_col0 = _mm256_load_pd(&F_Transpose_CombinedBlock_col_ordered_Pointer[16 + i]);
        __m256d Fcol1_Transpose_Block_col1 = _mm256_load_pd(&F_Transpose_CombinedBlock_col_ordered_Pointer[76 + i]);
        __m256d Fcol1_Transpose_Block_col2 = _mm256_load_pd(&F_Transpose_CombinedBlock_col_ordered_Pointer[136 + i]);
        __m256d Fdotcol1_Transpose_Block_col0 = _mm256_load_pd(&F_Transpose_CombinedBlock_col_ordered_Pointer[196 + i]);
        __m256d Fdotcol1_Transpose_Block_col1 = _mm256_load_pd(&F_Transpose_CombinedBlock_col_ordered_Pointer[256 + i]);
        __m256d Fdotcol1_Transpose_Block_col2 = _mm256_load_pd(&F_Transpose_CombinedBlock_col_ordered_Pointer[316 + i]);

        SPK2_Scale = _mm256_set1_pd(0.5 * D0(1));

        __m256d SPK2_1_D0_Block = _mm256_mul_pd(Fcol1_Transpose_Block_col0, Fcol1_Transpose_Block_col0);
        SPK2_1_D0_Block = _mm256_fmadd_pd(Fcol1_Transpose_Block_col1, Fcol1_Transpose_Block_col1, SPK2_1_D0_Block);
        SPK2_1_D0_Block = _mm256_fmadd_pd(Fcol1_Transpose_Block_col2, Fcol1_Transpose_Block_col2, SPK2_1_D0_Block);
        SPK2_1_D0_Block = _mm256_sub_pd(SPK2_1_D0_Block, ones);
        BlockDamping = _mm256_mul_pd(Fcol1_Transpose_Block_col0, Fdotcol1_Transpose_Block_col0);
        BlockDamping = _mm256_fmadd_pd(Fcol1_Transpose_Block_col1, Fdotcol1_Transpose_Block_col1, BlockDamping);
        BlockDamping = _mm256_fmadd_pd(Fcol1_Transpose_Block_col2, Fdotcol1_Transpose_Block_col2, BlockDamping);
        ...
        __m256d Fcol2_Transpose_Block_col0 = _mm256_load_pd(&F_Transpose_CombinedBlock_col_ordered_Pointer[32 + i]);
        __m256d Fcol2_Transpose_Block_col1 = _mm256_load_pd(&F_Transpose_CombinedBlock_col_ordered_Pointer[92 + i]);
        __m256d Fcol2_Transpose_Block_col2 = _mm256_load_pd(&F_Transpose_CombinedBlock_col_ordered_Pointer[152 + i]);
        __m256d Fdotcol2_Transpose_Block_col0 = _mm256_load_pd(&F_Transpose_CombinedBlock_col_ordered_Pointer[212 + i]);
        __m256d Fdotcol2_Transpose_Block_col1 = _mm256_load_pd(&F_Transpose_CombinedBlock_col_ordered_Pointer[272 + i]);
        __m256d Fdotcol2_Transpose_Block_col2 = _mm256_load_pd(&F_Transpose_CombinedBlock_col_ordered_Pointer[332 + i]);

        SPK2_Scale = _mm256_set1_pd(0.5 * D0(2));

        __m256d SPK2_2_D0_Block = _mm256_mul_pd(Fcol2_Transpose_Block_col0, Fcol2_Transpose_Block_col0);
        SPK2_2_D0_Block = _mm256_fmadd_pd(Fcol2_Transpose_Block_col1, Fcol2_Transpose_Block_col1, SPK2_2_D0_Block);
        SPK2_2_D0_Block = _mm256_fmadd_pd(Fcol2_Transpose_Block_col2, Fcol2_Transpose_Block_col2, SPK2_2_D0_Block);
        SPK2_2_D0_Block = _mm256_sub_pd(SPK2_2_D0_Block, ones);
        BlockDamping = _mm256_mul_pd(Fcol2_Transpose_Block_col0, Fdotcol2_Transpose_Block_col0);
        BlockDamping = _mm256_fmadd_pd(Fcol2_Transpose_Block_col1, Fdotcol2_Transpose_Block_col1, BlockDamping);
        BlockDamping = _mm256_fmadd_pd(Fcol2_Transpose_Block_col2, Fdotcol2_Transpose_Block_col2, BlockDamping);
        ...
        __m256d SPK2_3_D0_Block = _mm256_mul_pd(Fcol1_Transpose_Block_col0, Fcol2_Transpose_Block_col0);
        SPK2_3_D0_Block = _mm256_fmadd_pd(Fcol1_Transpose_Block_col1, Fcol2_Transpose_Block_col1, SPK2_3_D0_Block);
        SPK2_3_D0_Block = _mm256_fmadd_pd(Fcol1_Transpose_Block_col2, Fcol2_Transpose_Block_col2, SPK2_3_D0_Block);
        BlockDamping = _mm256_mul_pd(Fcol2_Transpose_Block_col0, Fdotcol1_Transpose_Block_col0);
        BlockDamping = _mm256_fmadd_pd(Fcol2_Transpose_Block_col1, Fdotcol1_Transpose_Block_col1, BlockDamping);
        BlockDamping = _mm256_fmadd_pd(Fcol2_Transpose_Block_col2, Fdotcol1_Transpose_Block_col2, BlockDamping);
        BlockDamping = _mm256_fmadd_pd(Fcol1_Transpose_Block_col0, Fdotcol2_Transpose_Block_col0, BlockDamping);
        BlockDamping = _mm256_fmadd_pd(Fcol1_Transpose_Block_col1, Fdotcol2_Transpose_Block_col1, BlockDamping);
        BlockDamping = _mm256_fmadd_pd(Fcol1_Transpose_Block_col2, Fdotcol2_Transpose_Block_col2, BlockDamping);
        ...
        __m256d SPK2_4_D0_Block = _mm256_mul_pd(Fcol0_Transpose_Block_col0, Fcol2_Transpose_Block_col0);
        SPK2_4_D0_Block = _mm256_fmadd_pd(Fcol0_Transpose_Block_col1, Fcol2_Transpose_Block_col1, SPK2_4_D0_Block);
        SPK2_4_D0_Block = _mm256_fmadd_pd(Fcol0_Transpose_Block_col2, Fcol2_Transpose_Block_col2, SPK2_4_D0_Block);
        BlockDamping = _mm256_mul_pd(Fcol2_Transpose_Block_col0, Fdotcol0_Transpose_Block_col0);
        BlockDamping = _mm256_fmadd_pd(Fcol2_Transpose_Block_col1, Fdotcol0_Transpose_Block_col1, BlockDamping);
        BlockDamping = _mm256_fmadd_pd(Fcol2_Transpose_Block_col2, Fdotcol0_Transpose_Block_col2, BlockDamping);
        BlockDamping = _mm256_fmadd_pd(Fcol0_Transpose_Block_col0, Fdotcol2_Transpose_Block_col0, BlockDamping);
        BlockDamping = _mm256_fmadd_pd(Fcol0_Transpose_Block_col1, Fdotcol2_Transpose_Block_col1, BlockDamping);
        BlockDamping = _mm256_fmadd_pd(Fcol0_Transpose_Block_col2, Fdotcol2_Transpose_Block_col2, BlockDamping);
        ...
        __m256d SPK2_5_D0_Block = _mm256_mul_pd(Fcol0_Transpose_Block_col0, Fcol1_Transpose_Block_col0);
        SPK2_5_D0_Block = _mm256_fmadd_pd(Fcol0_Transpose_Block_col1, Fcol1_Transpose_Block_col1, SPK2_5_D0_Block);
        SPK2_5_D0_Block = _mm256_fmadd_pd(Fcol0_Transpose_Block_col2, Fcol1_Transpose_Block_col2, SPK2_5_D0_Block);
        BlockDamping = _mm256_mul_pd(Fcol1_Transpose_Block_col0, Fdotcol0_Transpose_Block_col0);
        BlockDamping = _mm256_fmadd_pd(Fcol1_Transpose_Block_col1, Fdotcol0_Transpose_Block_col1, BlockDamping);
        BlockDamping = _mm256_fmadd_pd(Fcol1_Transpose_Block_col2, Fdotcol0_Transpose_Block_col2, BlockDamping);
        BlockDamping = _mm256_fmadd_pd(Fcol0_Transpose_Block_col0, Fdotcol1_Transpose_Block_col0, BlockDamping);
        BlockDamping = _mm256_fmadd_pd(Fcol0_Transpose_Block_col1, Fdotcol1_Transpose_Block_col1, BlockDamping);
        BlockDamping = _mm256_fmadd_pd(Fcol0_Transpose_Block_col2, Fdotcol1_Transpose_Block_col2, BlockDamping);
        ...
        __m256d P_transpose_scaled_Block = _mm256_mul_pd(Fcol0_Transpose_Block_col0, SPK2_0_D0_Block);
        P_transpose_scaled_Block = _mm256_fmadd_pd(Fcol1_Transpose_Block_col0, SPK2_5_D0_Block, P_transpose_scaled_Block);
        P_transpose_scaled_Block = _mm256_fmadd_pd(Fcol2_Transpose_Block_col0, SPK2_4_D0_Block, P_transpose_scaled_Block);
        _mm256_store_pd(&P_transpose_scaled_Block_col_ordered_Pointer[i], P_transpose_scaled_Block);

        P_transpose_scaled_Block = _mm256_mul_pd(Fcol0_Transpose_Block_col1, SPK2_0_D0_Block);
        P_transpose_scaled_Block = _mm256_fmadd_pd(Fcol1_Transpose_Block_col1, SPK2_5_D0_Block, P_transpose_scaled_Block);
        P_transpose_scaled_Block = _mm256_fmadd_pd(Fcol2_Transpose_Block_col1, SPK2_4_D0_Block, P_transpose_scaled_Block);
        _mm256_store_pd(&P_transpose_scaled_Block_col_ordered_Pointer[60 + i], P_transpose_scaled_Block);

        P_transpose_scaled_Block = _mm256_mul_pd(Fcol0_Transpose_Block_col2, SPK2_0_D0_Block);
        P_transpose_scaled_Block = _mm256_fmadd_pd(Fcol1_Transpose_Block_col2, SPK2_5_D0_Block, P_transpose_scaled_Block);
        P_transpose_scaled_Block = _mm256_fmadd_pd(Fcol2_Transpose_Block_col2, SPK2_4_D0_Block, P_transpose_scaled_Block);
        _mm256_store_pd(&P_transpose_scaled_Block_col_ordered_Pointer[120 + i], P_transpose_scaled_Block);


        P_transpose_scaled_Block = _mm256_mul_pd(Fcol0_Transpose_Block_col0, SPK2_5_D0_Block);
        P_transpose_scaled_Block = _mm256_fmadd_pd(Fcol1_Transpose_Block_col0, SPK2_1_D0_Block, P_transpose_scaled_Block);
        P_transpose_scaled_Block = _mm256_fmadd_pd(Fcol2_Transpose_Block_col0, SPK2_3_D0_Block, P_transpose_scaled_Block);
        _mm256_store_pd(&P_transpose_scaled_Block_col_ordered_Pointer[16 + i], P_transpose_scaled_Block);

        P_transpose_scaled_Block = _mm256_mul_pd(Fcol0_Transpose_Block_col1, SPK2_5_D0_Block);
        P_transpose_scaled_Block = _mm256_fmadd_pd(Fcol1_Transpose_Block_col1, SPK2_1_D0_Block, P_transpose_scaled_Block);
        P_transpose_scaled_Block = _mm256_fmadd_pd(Fcol2_Transpose_Block_col1, SPK2_3_D0_Block, P_transpose_scaled_Block);
        _mm256_store_pd(&P_transpose_scaled_Block_col_ordered_Pointer[76 + i], P_transpose_scaled_Block);

        P_transpose_scaled_Block = _mm256_mul_pd(Fcol0_Transpose_Block_col2, SPK2_5_D0_Block);
        P_transpose_scaled_Block = _mm256_fmadd_pd(Fcol1_Transpose_Block_col2, SPK2_1_D0_Block, P_transpose_scaled_Block);
        P_transpose_scaled_Block = _mm256_fmadd_pd(Fcol2_Transpose_Block_col2, SPK2_3_D0_Block, P_transpose_scaled_Block);
        _mm256_store_pd(&P_transpose_scaled_Block_col_ordered_Pointer[136 + i], P_transpose_scaled_Block);


        P_transpose_scaled_Block = _mm256_mul_pd(Fcol0_Transpose_Block_col0, SPK2_4_D0_Block);
        P_transpose_scaled_Block = _mm256_fmadd_pd(Fcol1_Transpose_Block_col0, SPK2_3_D0_Block, P_transpose_scaled_Block);
        P_transpose_scaled_Block = _mm256_fmadd_pd(Fcol2_Transpose_Block_col0, SPK2_2_D0_Block, P_transpose_scaled_Block);
        _mm256_store_pd(&P_transpose_scaled_Block_col_ordered_Pointer[32 + i], P_transpose_scaled_Block);

        P_transpose_scaled_Block = _mm256_mul_pd(Fcol0_Transpose_Block_col1, SPK2_4_D0_Block);
        P_transpose_scaled_Block = _mm256_fmadd_pd(Fcol1_Transpose_Block_col1, SPK2_3_D0_Block, P_transpose_scaled_Block);
        P_transpose_scaled_Block = _mm256_fmadd_pd(Fcol2_Transpose_Block_col1, SPK2_2_D0_Block, P_transpose_scaled_Block);
        _mm256_store_pd(&P_transpose_scaled_Block_col_ordered_Pointer[92 + i], P_transpose_scaled_Block);

        P_transpose_scaled_Block = _mm256_mul_pd(Fcol0_Transpose_Block_col2, SPK2_4_D0_Block);
        P_transpose_scaled_Block = _mm256_fmadd_pd(Fcol1_Transpose_Block_col2, SPK2_3_D0_Block, P_transpose_scaled_Block);
        P_transpose_scaled_Block = _mm256_fmadd_pd(Fcol2_Transpose_Block_col2, SPK2_2_D0_Block, P_transpose_scaled_Block);
    ...
    __m256d Fcol0_Transpose_Block_col0 = _mm256_load_pd(&F_Transpose_CombinedBlock_col_ordered_Pointer[48]);
    __m256d Fcol0_Transpose_Block_col1 = _mm256_load_pd(&F_Transpose_CombinedBlock_col_ordered_Pointer[108]);
    __m256d Fcol0_Transpose_Block_col2 = _mm256_load_pd(&F_Transpose_CombinedBlock_col_ordered_Pointer[168]);
    __m256d Fdotcol0_Transpose_Block_col0 = _mm256_load_pd(&F_Transpose_CombinedBlock_col_ordered_Pointer[228]);
    __m256d Fdotcol0_Transpose_Block_col1 = _mm256_load_pd(&F_Transpose_CombinedBlock_col_ordered_Pointer[288]);
    __m256d Fdotcol0_Transpose_Block_col2 = _mm256_load_pd(&F_Transpose_CombinedBlock_col_ordered_Pointer[348]);

    __m256d Ediag_0_Dv_Block = _mm256_mul_pd(Fcol0_Transpose_Block_col0, Fcol0_Transpose_Block_col0);
    Ediag_0_Dv_Block = _mm256_fmadd_pd(Fcol0_Transpose_Block_col1, Fcol0_Transpose_Block_col1, Ediag_0_Dv_Block);
    Ediag_0_Dv_Block = _mm256_fmadd_pd(Fcol0_Transpose_Block_col2, Fcol0_Transpose_Block_col2, Ediag_0_Dv_Block);
    ...
    __m256d Fcol1_Transpose_Block_col0 = _mm256_load_pd(&F_Transpose_CombinedBlock_col_ordered_Pointer[52]);
    __m256d Fcol1_Transpose_Block_col1 = _mm256_load_pd(&F_Transpose_CombinedBlock_col_ordered_Pointer[112]);
    __m256d Fcol1_Transpose_Block_col2 = _mm256_load_pd(&F_Transpose_CombinedBlock_col_ordered_Pointer[172]);
    __m256d Fdotcol1_Transpose_Block_col0 = _mm256_load_pd(&F_Transpose_CombinedBlock_col_ordered_Pointer[232]);
    __m256d Fdotcol1_Transpose_Block_col1 = _mm256_load_pd(&F_Transpose_CombinedBlock_col_ordered_Pointer[292]);
    __m256d Fdotcol1_Transpose_Block_col2 = _mm256_load_pd(&F_Transpose_CombinedBlock_col_ordered_Pointer[352]);

    __m256d Ediag_1_Dv_Block = _mm256_mul_pd(Fcol1_Transpose_Block_col0, Fcol1_Transpose_Block_col0);
    Ediag_1_Dv_Block = _mm256_fmadd_pd(Fcol1_Transpose_Block_col1, Fcol1_Transpose_Block_col1, Ediag_1_Dv_Block);
    Ediag_1_Dv_Block = _mm256_fmadd_pd(Fcol1_Transpose_Block_col2, Fcol1_Transpose_Block_col2, Ediag_1_Dv_Block);
    ...
    __m256d Fcol2_Transpose_Block_col0 = _mm256_load_pd(&F_Transpose_CombinedBlock_col_ordered_Pointer[56]);
    __m256d Fcol2_Transpose_Block_col1 = _mm256_load_pd(&F_Transpose_CombinedBlock_col_ordered_Pointer[116]);
    __m256d Fcol2_Transpose_Block_col2 = _mm256_load_pd(&F_Transpose_CombinedBlock_col_ordered_Pointer[176]);
    __m256d Fdotcol2_Transpose_Block_col0 = _mm256_load_pd(&F_Transpose_CombinedBlock_col_ordered_Pointer[236]);
    __m256d Fdotcol2_Transpose_Block_col1 = _mm256_load_pd(&F_Transpose_CombinedBlock_col_ordered_Pointer[296]);
    __m256d Fdotcol2_Transpose_Block_col2 = _mm256_load_pd(&F_Transpose_CombinedBlock_col_ordered_Pointer[356]);

    __m256d Ediag_2_Dv_Block = _mm256_mul_pd(Fcol2_Transpose_Block_col0, Fcol2_Transpose_Block_col0);
    Ediag_2_Dv_Block = _mm256_fmadd_pd(Fcol2_Transpose_Block_col1, Fcol2_Transpose_Block_col1, Ediag_2_Dv_Block);
    Ediag_2_Dv_Block = _mm256_fmadd_pd(Fcol2_Transpose_Block_col2, Fcol2_Transpose_Block_col2, Ediag_2_Dv_Block);
    ...
    __m256d P_transpose_scaled_Block = _mm256_mul_pd(Fcol0_Transpose_Block_col0, Sdiag_0_Dv_Block);
    _mm256_store_pd(&P_transpose_scaled_Block_col_ordered_Pointer[48], P_transpose_scaled_Block);

    P_transpose_scaled_Block = _mm256_mul_pd(Fcol0_Transpose_Block_col1, Sdiag_0_Dv_Block);
    _mm256_store_pd(&P_transpose_scaled_Block_col_ordered_Pointer[108], P_transpose_scaled_Block);

    P_transpose_scaled_Block = _mm256_mul_pd(Fcol0_Transpose_Block_col2, Sdiag_0_Dv_Block);
    _mm256_store_pd(&P_transpose_scaled_Block_col_ordered_Pointer[168], P_transpose_scaled_Block);


    P_transpose_scaled_Block = _mm256_mul_pd(Fcol1_Transpose_Block_col0, Sdiag_1_Dv_Block);
    _mm256_store_pd(&P_transpose_scaled_Block_col_ordered_Pointer[52], P_transpose_scaled_Block);

    P_transpose_scaled_Block = _mm256_mul_pd(Fcol1_Transpose_Block_col1, Sdiag_1_Dv_Block);
    _mm256_store_pd(&P_transpose_scaled_Block_col_ordered_Pointer[112], P_transpose_scaled_Block);

    P_transpose_scaled_Block = _mm256_mul_pd(Fcol1_Transpose_Block_col2, Sdiag_1_Dv_Block);
    _mm256_store_pd(&P_transpose_scaled_Block_col_ordered_Pointer[172], P_transpose_scaled_Block);


    P_transpose_scaled_Block = _mm256_mul_pd(Fcol2_Transpose_Block_col0, Sdiag_2_Dv_Block);
    _mm256_store_pd(&P_transpose_scaled_Block_col_ordered_Pointer[56], P_transpose_scaled_Block);

    P_transpose_scaled_Block = _mm256_mul_pd(Fcol2_Transpose_Block_col1, Sdiag_2_Dv_Block);
    _mm256_store_pd(&P_transpose_scaled_Block_col_ordered_Pointer[116], P_transpose_scaled_Block);

    P_transpose_scaled_Block = _mm256_mul_pd(Fcol2_Transpose_Block_col2, Sdiag_2_Dv_Block);
    ...
    //Calculate F is one big block and then split up afterwards to improve efficiency (hopefully)
    ChMatrixNMc<double, 60, 6> F_Transpose_CombinedBlock_col_ordered = m_SD_precompute_col_ordered.transpose()*ebar_ebardot;
    ...
    ChMatrixNMc<double, 16, 1> Fdotcol0_Transpose_D0_Block_col0 = F_Transpose_CombinedBlock_col_ordered.block<16, 1>(0, 3);
	ChMatrixNMc<double, 16, 1> Fdotcol0_Transpose_D0_Block_col1 = F_Transpose_CombinedBlock_col_ordered.block<16, 1>(0, 4);
	ChMatrixNMc<double, 16, 1> Fdotcol0_Transpose_D0_Block_col2 = F_Transpose_CombinedBlock_col_ordered.block<16, 1>(0, 5);
    ...
    ChMatrixNMc<double, 16, 1> Fdotcol1_Transpose_D0_Block_col0 = F_Transpose_CombinedBlock_col_ordered.block<16, 1>(16, 3);
	ChMatrixNMc<double, 16, 1> Fdotcol1_Transpose_D0_Block_col1 = F_Transpose_CombinedBlock_col_ordered.block<16, 1>(16, 4);
	ChMatrixNMc<double, 16, 1> Fdotcol1_Transpose_D0_Block_col2 = F_Transpose_CombinedBlock_col_ordered.block<16, 1>(16, 5);
    ...
    ChMatrixNMc<double, 16, 1> Fdotcol2_Transpose_D0_Block_col0 = F_Transpose_CombinedBlock_col_ordered.block<16, 1>(32, 3);
	ChMatrixNMc<double, 16, 1> Fdotcol2_Transpose_D0_Block_col1 = F_Transpose_CombinedBlock_col_ordered.block<16, 1>(32, 4);
	ChMatrixNMc<double, 16, 1> Fdotcol2_Transpose_D0_Block_col2 = F_Transpose_CombinedBlock_col_ordered.block<16, 1>(32, 5);
    ...
    ChMatrixNMc<double, 4, 1> Fdotcol0_Transpose_Dv_Block_col0 = F_Transpose_CombinedBlock_col_ordered.block<4, 1>(48, 3);
	ChMatrixNMc<double, 4, 1> Fdotcol0_Transpose_Dv_Block_col1 = F_Transpose_CombinedBlock_col_ordered.block<4, 1>(48, 4);
	ChMatrixNMc<double, 4, 1> Fdotcol0_Transpose_Dv_Block_col2 = F_Transpose_CombinedBlock_col_ordered.block<4, 1>(48, 5);
    ...
    ChMatrixNMc<double, 4, 1> Fdotcol1_Transpose_Dv_Block_col0 = F_Transpose_CombinedBlock_col_ordered.block<4, 1>(52, 3);
	ChMatrixNMc<double, 4, 1> Fdotcol1_Transpose_Dv_Block_col1 = F_Transpose_CombinedBlock_col_ordered.block<4, 1>(52, 4);
	ChMatrixNMc<double, 4, 1> Fdotcol1_Transpose_Dv_Block_col2 = F_Transpose_CombinedBlock_col_ordered.block<4, 1>(52, 5);
    ...
    ChMatrixNMc<double, 4, 1> Fdotcol2_Transpose_Dv_Block_col0 = F_Transpose_CombinedBlock_col_ordered.block<4, 1>(56, 3);
    ChMatrixNMc<double, 4, 1> Fdotcol2_Transpose_Dv_Block_col1 = F_Transpose_CombinedBlock_col_ordered.block<4, 1>(56, 4);
	ChMatrixNMc<double, 4, 1> Fdotcol2_Transpose_Dv_Block_col2 = F_Transpose_CombinedBlock_col_ordered.block<4, 1>(56, 5);
...
void ChElementBeamANCF_MT34::ComputeInternalForcesAtStateNoDamping(ChVectorDynamic<>& Fi, const ChMatrixNMc<double, 9, 3>& e_bar) {
    ...
    //Calculate F is one big block and then split up afterwards to improve efficiency (hopefully)
    //Preallocate F_Transpose so that it 32byte aligned for AVX loads
    double* F_Transpose_CombinedBlock_col_ordered_Pointer = static_cast<double*>(_mm_malloc(sizeof(double) * 180, 32));
    Eigen::Map<ChMatrixNMc<double, 60, 3>> F_Transpose_CombinedBlock_col_ordered(F_Transpose_CombinedBlock_col_ordered_Pointer);
...
void ChElementBeamANCF_MT34::ComputeInternalForcesSingleGQPnt(ChMatrixNM<double, 9, 3>& QiCompact, unsigned int index, ChVectorN<double, 6>& D0, ChMatrixNMc<double, 9, 3>& e_bar, ChMatrixNMc<double, 9, 3>& e_bar_dot) {
    //ChMatrix33<double> J_0xi;               //Element Jacobian between the reference configuration and normalized configuration
...
void ChElementBeamANCF_MT34::ComputeInternalForcesSingleGQPnt(ChMatrixNM<double, 9, 3>& QiCompact, unsigned int index, ChMatrix33<double>& Dv, ChMatrixNMc<double, 9, 3>& e_bar, ChMatrixNMc<double, 9, 3>& e_bar_dot) {
    //ChMatrix33<double> J_0xi;               //Element Jacobian between the reference configuration and normalized configuration
    //ChMatrixNM<double, 9, 3> Sxi_D;         //Matrix of normalized shape function derivatives
...
void ChElementBeamANCF_MT34::ComputeInternalForcesSingleGQPnt(ChMatrixNM<double, 9, 3>& QiCompact, double xi, double eta, double zeta, ChMatrixNM<double, 6, 6>& D, ChMatrixNMc<double, 9, 3>& e_bar, ChMatrixNMc<double, 9, 3>& e_bar_dot) {
    ChMatrix33<double> J_0xi;               //Element Jacobian between the reference configuration and normalized configuration
    ChMatrixNMc<double, 9, 3> Sxi_D;         //Matrix of normalized shape function derivatives
...
void ChElementBeamANCF_MT34::ComputeInternalJacobianSingleGQPnt(ChMatrixNM<double, 27, 27>& Jac_Dense, ChMatrixNM<double, 9, 9>& Jac_Compact, double Kfactor, double Rfactor, unsigned int index, ChVectorN<double, 6>& D0, ChMatrixNMc<double, 9, 3>& e_bar, ChMatrixNMc<double, 9, 3>& e_bar_dot) {
...
void ChElementBeamANCF_MT34::ComputeInternalJacobianSingleGQPnt(ChMatrixNM<double, 27, 27>& Jac_Dense, ChMatrixNM<double, 9, 9>& Jac_Compact, double Kfactor, double Rfactor, unsigned int index, ChMatrix33<double>& Dv, ChMatrixNMc<double, 9, 3>& e_bar, ChMatrixNMc<double, 9, 3>& e_bar_dot) {
...
void ChElementBeamANCF_MT34::ComputeInternalJacobianSingleGQPnt(ChMatrixNM<double, 27, 27>& Jac_Dense, ChMatrixNM<double, 9, 9>& Jac_Compact, double Kfactor, double Rfactor, double GQ_weight, double xi, double eta, double zeta, ChMatrixNM<double, 6, 6>& D, ChMatrixNMc<double, 9, 3>& e_bar, ChMatrixNMc<double, 9, 3>& e_bar_dot){
    ChMatrix33<double> J_0xi;               //Element Jacobian between the reference configuration and normalized configuration
    ChMatrixNMc<double, 9, 3> Sxi_D;         //Matrix of normalized shape function derivatives
    ChMatrixNMc<double, 9, 3> Sxi_D_0xi;     //Matrix of normalized shape function derivatives corrected for a potentially non-straight reference configuration
    ChVectorN<double, 6> epsilon;           //Green-Lagrange strain tensor in Voigt notation
...
void ChElementBeamANCF_MT34::ComputeInternalJacobians(ChMatrixNM<double, 27, 27>& JacobianMatrix, double Kfactor, double Rfactor) {
...
void ChElementBeamANCF_MT34::ComputeInternalJacobiansAnalytic(ChMatrixNM<double, 27, 27>& JacobianMatrix, double Kfactor, double Rfactor) {
    ChMatrixNMc<double, 9, 3> e_bar;
    ChMatrixNMc<double, 9, 3> e_bar_dot;
...
void ChElementBeamANCF_MT34::Calc_Sxi(ChMatrixNM<double, 3, 27>& Sxi, double xi, double eta, double zeta) {
...
// [s1; s2; s3; ...]
void ChElementBeamANCF_MT34::Calc_Sxi_compact(ChVectorN<double, 9>& Sxi_compact, double xi, double eta, double zeta) {
...
void ChElementBeamANCF_MT34::Calc_Sxi_D(ChMatrixNMc<double, 9, 3>& Sxi_D, double xi, double eta, double zeta) {
    Sxi_D(0, 0) = xi - 0.5;
...
void ChElementBeamANCF_MT34::CalcCoordMatrix(ChMatrixNMc<double, 9, 3>& e) {
...
void ChElementBeamANCF_MT34::CalcCoordVector(ChVectorN<double, 27>& e) {
...
void ChElementBeamANCF_MT34::CalcCoordDerivMatrix(ChMatrixNMc<double, 9, 3>& edot) {
...
void ChElementBeamANCF_MT34::CalcCoordDerivVector(ChVectorN<double, 27>& edot) {
...
void ChElementBeamANCF_MT34::CalcCombinedCoordMatrix(ChMatrixNMc<double, 9, 6>& ebar_ebardot) {
...
void ChElementBeamANCF_MT34::Calc_J_0xi(ChMatrix33<double>& J_0xi, double xi, double eta, double zeta) {
...
double ChElementBeamANCF_MT34::Calc_det_J_0xi(double xi, double eta, double zeta) {
    ChMatrixNMc<double, 9, 3> Sxi_D;
...
// -----------------------------------------------------------------------------
//ChVector<> ChElementBeamANCF_MT34::EvaluateBeamSectionStrains() {
...
//}
//
// void ChElementBeamANCF_MT34::EvaluateSectionDisplacement(const double u,
//                                                    const double v,
//                                                    ChVector<>& u_displ,
//                                                    ChVector<>& u_rotaz) {
...
void ChElementBeamANCF_MT34::EvaluateSectionFrame(const double eta, ChVector<>& point, ChQuaternion<>& rot) {
...
// void ChElementBeamANCF_MT34::EvaluateSectionPoint(const double u,
//                                             const double v,
//                                             ChVector<>& point) {
//    ChVector<> u_displ;
//
...
void ChElementBeamANCF_MT34::LoadableGetStateBlock_x(int block_offset, ChState& mD) {
...
void ChElementBeamANCF_MT34::LoadableGetStateBlock_w(int block_offset, ChStateDelta& mD) {
...
void ChElementBeamANCF_MT34::LoadableStateIncrement(const unsigned int off_x,
                                               ChState& x_new,
                                               const ChState& x,
...
//void ChElementBeamANCF_MT34::EvaluateSectionVelNorm(double U, ChVector<>& Result) {
//    ShapeVector N;
...
void ChElementBeamANCF_MT34::LoadableGetVariables(std::vector<ChVariables*>& mvars) {
...
void ChElementBeamANCF_MT34::ComputeNF(
...
double ChElementBeamANCF_MT34::GetDensity() {
    return GetMaterial()->Get_rho();
}

// Calculate tangent to the centerline at (U) coordinates.
ChVector<> ChElementBeamANCF_MT34::ComputeTangent(const double U) {
    ChMatrixNMc<double, 9, 3> e_bar;
    ChMatrixNMc<double, 9, 3> Sxi_D;
    ChVector<> r_xi;
...
ChQuadratureTables static_tables_MT34(1, CH_QUADRATURE_STATIC_TABLES);
//#endif // !CH_QUADRATURE_STATIC_TABLES

ChQuadratureTables* ChElementBeamANCF_MT34::GetStaticGQTables() {
    return &static_tables_MT34;
}

////////////////////////////////////////////////////////////////

// ============================================================================
// Implementation of ChMaterialBeamANCF_MT34 methods
// ============================================================================

// Construct an isotropic material.
ChMaterialBeamANCF_MT34::ChMaterialBeamANCF_MT34(double rho,        // material density
...
void ChMaterialBeamANCF_MT34::Calc_D0_Dv(const ChVector<>& E, const ChVector<>& nu, const ChVector<>& G, double k1, double k2) {
