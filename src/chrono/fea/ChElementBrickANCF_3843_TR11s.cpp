...
ChElementBrickANCF_3843_TR11S::ChElementBrickANCF_3843_TR11S()
...
void ChElementBrickANCF_3843_TR11S::SetNodes(std::shared_ptr<ChNodeFEAxyzDDD> nodeA,
...
void ChElementBrickANCF_3843_TR11S::SetupInitial(ChSystem* system) {
...
// State update.
void ChElementBrickANCF_3843_TR11S::Update() {
    ChElementGeneric::Update();
}

// Fill the D vector with the current field values at the element nodes.
void ChElementBrickANCF_3843_TR11S::GetStateBlock(ChVectorDynamic<>& mD) {
...
void ChElementBrickANCF_3843_TR11S::ComputeKRMmatricesGlobal(ChMatrixRef H,
                                                            double Kfactor,
                                                            double Rfactor,
                                                            double Mfactor) {
    ...
    for (unsigned int i = 0; i < 32; i++) {
        for (unsigned int s = i; s < 32; s++) {
            ChMatrixNM<double, 32, 32> Ccompact = m_Ccompact.block<32, 32>(32 * index, 0);
            index++;
...
void ChElementBrickANCF_3843_TR11S::ComputeMmatrixGlobal(ChMatrixRef M) {
    M.setZero();
...
// -----------------------------------------------------------------------------
void ChElementBrickANCF_3843_TR11S::ComputeMassMatrixAndGravityForce(const ChVector<>& g_acc) {
...
void ChElementBrickANCF_3843_TR11S::ComputeNodalMass() {
...
void ChElementBrickANCF_3843_TR11S::PrecomputeInternalForceMatricesWeights() {
    ChQuadratureTables* GQTable = GetStaticGQTables();
                    ...
                    for (unsigned int j = i; j < 32; j++) {
                        for (unsigned int k = 0; k < 6; k++) {
                            for (unsigned int l = 0; l < 6; l++) {
                                m_Ccompact.block<32, 32>(32 * index, 0) +=
...
void ChElementBrickANCF_3843_TR11S::SetAlphaDamp(double a) {
    m_Alpha = a;
    m_2Alpha = 2 * a;
...
void ChElementBrickANCF_3843_TR11S::ComputeInternalForces(ChVectorDynamic<>& Fi) {
...
void ChElementBrickANCF_3843_TR11S::ComputeInternalForcesAtState(ChVectorDynamic<>& Fi,
    ...
    for (unsigned int i = 0; i < 32; i++) {
        for (unsigned int j = i; j < 32; j++) {
            Block = -ebar.transpose() * m_Ccompact.block<32, 32>(32 * index, 0) * ebar;
...
void ChElementBrickANCF_3843_TR11S::ComputeInternalJacobians(Matrix3Nx3N& JacobianMatrix,
                                                            double Kfactor,
                                                            double Rfactor) {
...
void ChElementBrickANCF_3843_TR11S::Calc_Sxi(Matrix3x3N& Sxi, double xi, double eta, double zeta) {
    VectorN Sxi_compact;
    Calc_Sxi_compact(Sxi_compact, xi, eta, zeta);
    Sxi.setZero();
...
// [s1; s2; s3; ...]
void ChElementBrickANCF_3843_TR11S::Calc_Sxi_compact(VectorN& Sxi_compact, double xi, double eta, double zeta) {
    Sxi_compact(0) =
...
// [s1*I_3x3, s2*I_3x3, s3*I_3x3, ...]
void ChElementBrickANCF_3843_TR11S::Calc_Sxi_xi(Matrix3x3N& Sxi_xi, double xi, double eta, double zeta) {
...
// [s1; s2; s3; ...]
void ChElementBrickANCF_3843_TR11S::Calc_Sxi_xi_compact(VectorN& Sxi_xi_compact, double xi, double eta, double zeta) {
...
// [s1*I_3x3, s2*I_3x3, s3*I_3x3, ...]
void ChElementBrickANCF_3843_TR11S::Calc_Sxi_eta(Matrix3x3N& Sxi_eta, double xi, double eta, double zeta) {
...
// [s1; s2; s3; ...]
void ChElementBrickANCF_3843_TR11S::Calc_Sxi_eta_compact(VectorN& Sxi_eta_compact, double xi, double eta, double zeta) {
...
// [s1*I_3x3, s2*I_3x3, s3*I_3x3, ...]
void ChElementBrickANCF_3843_TR11S::Calc_Sxi_zeta(Matrix3x3N& Sxi_zeta, double xi, double eta, double zeta) {
...
// [s1; s2; s3; ...]
void ChElementBrickANCF_3843_TR11S::Calc_Sxi_zeta_compact(VectorN& Sxi_zeta_compact,
                                                         double xi,
                                                         double eta,
                                                         double zeta) {
...
void ChElementBrickANCF_3843_TR11S::Calc_Sxi_D(MatrixNx3c& Sxi_D, double xi, double eta, double zeta) {
...
void ChElementBrickANCF_3843_TR11S::CalcCoordVector(Vector3N& e) {
...
void ChElementBrickANCF_3843_TR11S::CalcCoordMatrix(Matrix3xN& ebar) {
...
void ChElementBrickANCF_3843_TR11S::CalcCoordMatrix(MatrixNx3c& ebar) {
...
void ChElementBrickANCF_3843_TR11S::CalcCoordDerivVector(Vector3N& edot) {
...
void ChElementBrickANCF_3843_TR11S::CalcCoordDerivMatrix(Matrix3xN& ebardot) {
...
void ChElementBrickANCF_3843_TR11S::CalcCoordDerivMatrix(MatrixNx3c& ebardot) {
...
void ChElementBrickANCF_3843_TR11S::Calc_J_0xi(ChMatrix33<double>& J_0xi, double xi, double eta, double zeta) {
    MatrixNx3c Sxi_D;
    Calc_Sxi_D(Sxi_D, xi, eta, zeta);
...
double ChElementBrickANCF_3843_TR11S::Calc_det_J_0xi(double xi, double eta, double zeta) {
...
void ChElementBrickANCF_3843_TR11S::EvaluateSectionFrame(const double xi,
                                                        const double eta,
                                                        const double zeta,
                                                        ChVector<>& point,
                                                        ChQuaternion<>& rot) {
...
void ChElementBrickANCF_3843_TR11S::EvaluateSectionPoint(const double u,
                                                        const double v,
                                                        const double w,
                                                        ChVector<>& point) {
    Matrix3x3N Sxi;
...
void ChElementBrickANCF_3843_TR11S::LoadableGetStateBlock_x(int block_offset, ChState& mD) {
...
void ChElementBrickANCF_3843_TR11S::LoadableGetStateBlock_w(int block_offset, ChStateDelta& mD) {
...
void ChElementBrickANCF_3843_TR11S::LoadableStateIncrement(const unsigned int off_x,
                                                          ChState& x_new,
                                                          const ChState& x,
...
void ChElementBrickANCF_3843_TR11S::LoadableGetVariables(std::vector<ChVariables*>& mvars) {
...
void ChElementBrickANCF_3843_TR11S::ComputeNF(
...
double ChElementBrickANCF_3843_TR11S::GetDensity() {
...
ChQuadratureTables static_tables_3843_TR11S(1, CH_QUADRATURE_STATIC_TABLES);
//#endif // !CH_QUADRATURE_STATIC_TABLES

ChQuadratureTables* ChElementBrickANCF_3843_TR11S::GetStaticGQTables() {
    return &static_tables_3843_TR11S;
}

////////////////////////////////////////////////////////////////

// ============================================================================
// Implementation of ChMaterialBrickANCF_3843_TR11S methods
// ============================================================================

// Construct an isotropic material.
ChMaterialBrickANCF_3843_TR11S::ChMaterialBrickANCF_3843_TR11S(double rho,  // material density
...
ChMaterialBrickANCF_3843_TR11S::ChMaterialBrickANCF_3843_TR11S(
...
// Poisson effect
void ChMaterialBrickANCF_3843_TR11S::Calc_D0_Dv(const ChVector<>& E, const ChVector<>& nu, const ChVector<>& G) {
