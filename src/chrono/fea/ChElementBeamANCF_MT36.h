...
#ifndef CHELEMENTBEAMANCFMT36_H
#define CHELEMENTBEAMANCFMT36_H
...
class ChApi ChMaterialBeamANCF_MT36 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_MT36(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_MT36 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MT36> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_MT36> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_MT36> m_material;    ///< beam material
    ...
    ChMatrixNM<double, 9, 60> m_SD_precompute_col_ordered;  ///< Precomputed corrected normalized shape function derivative matrices for no Poisson Effect followed by Poisson Effect on the beam axis only in column by column order
