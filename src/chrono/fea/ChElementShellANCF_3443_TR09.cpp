...
ChElementShellANCF_3443_TR09::ChElementShellANCF_3443_TR09()
...
void ChElementShellANCF_3443_TR09::SetNodes(std::shared_ptr<ChNodeFEAxyzDDD> nodeA,
...
void ChElementShellANCF_3443_TR09::SetupInitial(ChSystem* system) {
...
// State update.
void ChElementShellANCF_3443_TR09::Update() {
    ChElementGeneric::Update();
}

// Fill the D vector with the current field values at the element nodes.
void ChElementShellANCF_3443_TR09::GetStateBlock(ChVectorDynamic<>& mD) {
...
void ChElementShellANCF_3443_TR09::ComputeKRMmatricesGlobal(ChMatrixRef H,
                                                           double Kfactor,
                                                           double Rfactor,
                                                           double Mfactor) {
...
void ChElementShellANCF_3443_TR09::ComputeMmatrixGlobal(ChMatrixRef M) {
    M.setZero();
...
// -----------------------------------------------------------------------------
void ChElementShellANCF_3443_TR09::ComputeMassMatrixAndGravityForce(const ChVector<>& g_acc) {
...
void ChElementShellANCF_3443_TR09::ComputeNodalMass() {
...
void ChElementShellANCF_3443_TR09::PrecomputeInternalForceMatricesWeights() {
    ChQuadratureTables* GQTable = GetStaticGQTables();
    unsigned int GQ_idx_xi_eta = 6;    // 7 Point Gauss-Quadrature;
    unsigned int GQ_idx_zeta = 2;      // 3 Point Gauss-Quadrature;
...
void ChElementShellANCF_3443_TR09::SetAlphaDamp(double a) {
    m_Alpha = a;
...
void ChElementShellANCF_3443_TR09::ComputeInternalForces(ChVectorDynamic<>& Fi) {
...
void ChElementShellANCF_3443_TR09::ComputeInternalForcesAtState(ChVectorDynamic<>& Fi,
...
void ChElementShellANCF_3443_TR09::ComputeInternalJacobians(Matrix3Nx3N& JacobianMatrix,
                                                           double Kfactor,
                                                           double Rfactor) {
...
void ChElementShellANCF_3443_TR09::Calc_Sxi(Matrix3x3N& Sxi, double xi, double eta, double zeta) {
    VectorN Sxi_compact;
    Calc_Sxi_compact(Sxi_compact, xi, eta, zeta);
    Sxi.setZero();
...
// [s1; s2; s3; ...]
void ChElementShellANCF_3443_TR09::Calc_Sxi_compact(VectorN& Sxi_compact, double xi, double eta, double zeta) {    
...
// [s1*I_3x3, s2*I_3x3, s3*I_3x3, ...]
void ChElementShellANCF_3443_TR09::Calc_Sxi_xi(Matrix3x3N& Sxi_xi, double xi, double eta, double zeta) {
...
// [s1; s2; s3; ...]
void ChElementShellANCF_3443_TR09::Calc_Sxi_xi_compact(VectorN& Sxi_xi_compact, double xi, double eta, double zeta) {
...
// [s1*I_3x3, s2*I_3x3, s3*I_3x3, ...]
void ChElementShellANCF_3443_TR09::Calc_Sxi_eta(Matrix3x3N& Sxi_eta, double xi, double eta, double zeta) {
...
// [s1; s2; s3; ...]
void ChElementShellANCF_3443_TR09::Calc_Sxi_eta_compact(VectorN& Sxi_eta_compact, double xi, double eta, double zeta) {
...
// [s1*I_3x3, s2*I_3x3, s3*I_3x3, ...]
void ChElementShellANCF_3443_TR09::Calc_Sxi_zeta(Matrix3x3N& Sxi_zeta, double xi, double eta, double zeta) {
...
// [s1; s2; s3; ...]
void ChElementShellANCF_3443_TR09::Calc_Sxi_zeta_compact(VectorN& Sxi_zeta_compact, double xi, double eta, double zeta) {
...
void ChElementShellANCF_3443_TR09::Calc_Sxi_D(MatrixNx3c& Sxi_D, double xi, double eta, double zeta) {
...
void ChElementShellANCF_3443_TR09::CalcCoordVector(Vector3N& e) {
...
void ChElementShellANCF_3443_TR09::CalcCoordMatrix(Matrix3xN& ebar) {
...
void ChElementShellANCF_3443_TR09::CalcCoordMatrix(MatrixNx3c& ebar) {
...
void ChElementShellANCF_3443_TR09::CalcCoordDerivVector(Vector3N& edot) {
...
void ChElementShellANCF_3443_TR09::CalcCoordDerivMatrix(Matrix3xN& ebardot) {
...
void ChElementShellANCF_3443_TR09::CalcCoordDerivMatrix(MatrixNx3c& ebardot) {
...
void ChElementShellANCF_3443_TR09::Calc_J_0xi(ChMatrix33<double>& J_0xi, double xi, double eta, double zeta) {
    MatrixNx3c Sxi_D;
    Calc_Sxi_D(Sxi_D, xi, eta, zeta);
...
double ChElementShellANCF_3443_TR09::Calc_det_J_0xi(double xi, double eta, double zeta) {
...
void ChElementShellANCF_3443_TR09::EvaluateSectionFrame(const double xi, const double eta, ChVector<>& point, ChQuaternion<>& rot) {
    Matrix3x3N Sxi;
    Matrix3x3N Sxi_xi;
    Matrix3x3N Sxi_eta;
...
void ChElementShellANCF_3443_TR09::EvaluateSectionPoint(const double u, const double v, ChVector<>& point) {
    Matrix3x3N Sxi;
    Calc_Sxi(Sxi, u, v, 0);
...
void ChElementShellANCF_3443_TR09::EvaluateSectionVelNorm(double U, double V, ChVector<>& Result) {
    Matrix3x3N Sxi_zeta;
    Vector3N edot;
    ChVector<> r_zeta;
...
void ChElementShellANCF_3443_TR09::LoadableGetStateBlock_x(int block_offset, ChState& mD) {
...
void ChElementShellANCF_3443_TR09::LoadableGetStateBlock_w(int block_offset, ChStateDelta& mD) {
...
void ChElementShellANCF_3443_TR09::LoadableStateIncrement(const unsigned int off_x,
                                                         ChState& x_new,
                                                         const ChState& x,
...
void ChElementShellANCF_3443_TR09::LoadableGetVariables(std::vector<ChVariables*>& mvars) {
...
void ChElementShellANCF_3443_TR09::ComputeNF(
...
double ChElementShellANCF_3443_TR09::GetDensity() {
    return GetMaterial()->Get_rho();
}

// Calculate tangent to the centerline at (U) coordinates.
ChVector<> ChElementShellANCF_3443_TR09::ComputeNormal(const double U, const double V) {
    Matrix3x3N Sxi_zeta;
    Vector3N e;
    ChVector<> r_zeta;
...
ChQuadratureTables static_tables_3443_TR09(1, CH_QUADRATURE_STATIC_TABLES);
//#endif // !CH_QUADRATURE_STATIC_TABLES

ChQuadratureTables* ChElementShellANCF_3443_TR09::GetStaticGQTables() {
    return &static_tables_3443_TR09;
}

////////////////////////////////////////////////////////////////

// ============================================================================
// Implementation of ChMaterialShellANCF_3443_TR09 methods
// ============================================================================

// Construct an isotropic material.
ChMaterialShellANCF_3443_TR09::ChMaterialShellANCF_3443_TR09(
...
// Poisson effect
void ChMaterialShellANCF_3443_TR09::Calc_D0_Dv(const ChVector<>& E,
                                              const ChVector<>& nu,
                                              const ChVector<>& G) {
