...
// =============================================================================
// Updated for the correct number of GQ Points
// =============================================================================
...
ChElementShellANCF_3833_TR00::ChElementShellANCF_3833_TR00()
...
void ChElementShellANCF_3833_TR00::SetNodes(std::shared_ptr<ChNodeFEAxyzDD> nodeA,
...
void ChElementShellANCF_3833_TR00::AddLayer(double thickness, double theta, std::shared_ptr<ChMaterialShellANCF> material) {
...
void ChElementShellANCF_3833_TR00::SetupInitial(ChSystem* system) {
...
// State update.
void ChElementShellANCF_3833_TR00::Update() {
    ChElementGeneric::Update();
}

// Fill the DD vector with the current field values at the element nodes.
void ChElementShellANCF_3833_TR00::GetStateBlock(ChVectorDynamic<>& mDD) {
...
void ChElementShellANCF_3833_TR00::ComputeKRMmatricesGlobal(ChMatrixRef H, double Kfactor, double Rfactor, double Mfactor) {
...
void ChElementShellANCF_3833_TR00::ComputeMmatrixGlobal(ChMatrixRef M) {
    M = m_MassMatrix;
}
...
class ShellANCF_3833_TR00_Mass : public ChIntegrable3D<ChMatrixNM<double, 72, 72>> {
  public:
    ShellANCF_3833_TR00_Mass(ChElementShellANCF_3833_TR00* element) : m_element(element) {}
    ~ShellANCF_3833_TR00_Mass() {}

  private:
    ChElementShellANCF_3833_TR00* m_element;

    virtual void Evaluate(ChMatrixNM<double, 72, 72>& result, const double x, const double y, const double z) override;
};

void ShellANCF_3833_TR00_Mass::Evaluate(ChMatrixNM<double, 72, 72>& result, const double x, const double y, const double z) {
    ChElementShellANCF_3833_TR00::ShapeVector N;
...
void ChElementShellANCF_3833_TR00::ComputeMassMatrix() {
    m_MassMatrix.setZero();

    for (size_t kl = 0; kl < m_numLayers; kl++) {
        double rho = m_layers[kl].GetMaterial()->Get_rho();
        ShellANCF_3833_TR00_Mass myformula(this);
...
void ChElementShellANCF_3833_TR00::ComputeNodalMass() {
...
class ShellANCF_3833_TR00_Gravity : public ChIntegrable3D<ChVectorN<double, 72>> {
  public:
    ShellANCF_3833_TR00_Gravity(ChElementShellANCF_3833_TR00* element, const ChVector<> gacc) : m_element(element), m_gacc(gacc) {}
    ~ShellANCF_3833_TR00_Gravity() {}
...
void ShellANCF_3833_TR00_Gravity::Evaluate(ChVectorN<double, 72>& result, const double x, const double y, const double z) {
    ChElementShellANCF_3833_TR00::ShapeVector N;
    m_element->ShapeFunctions(N, x, y, z);
    double detJ0 = m_element->Calc_detJ0(x, y, z);
...
void ChElementShellANCF_3833_TR00::ComputeGravityForce(const ChVector<>& g_acc) {
    m_GravForce.setZero();

    for (size_t kl = 0; kl < m_numLayers; kl++) {
        double rho = m_layers[kl].GetMaterial()->Get_rho();
        ShellANCF_3833_TR00_Gravity myformula(this, g_acc);
...
// The class ShellANCF_3833_TR00_Force provides the integrand for the calculation of the internal forces
...
class ShellANCF_3833_TR00_Force : public ChIntegrable3D<ChVectorN<double, 72>> {
  public:
    ShellANCF_3833_TR00_Force(ChElementShellANCF_3833_TR00* element,  // Containing element
                     size_t kl                       // Current layer index
                     )
        : m_element(element), m_kl(kl) {}
    ~ShellANCF_3833_TR00_Force() {}
...
void ShellANCF_3833_TR00_Force::Evaluate(ChVectorN<double, 72>& result, const double x, const double y, const double z) {
...
void ChElementShellANCF_3833_TR00::ComputeInternalForces(ChVectorDynamic<>& Fi) {
    ...
    for (size_t kl = 0; kl < m_numLayers; kl++) {
        ShellANCF_3833_TR00_Force formula(this, kl);
...
// The class ShellANCF_3833_TR00_Jacobian provides the integrand for the calculation of the Jacobians
// (stiffness and damping matrices) of the internal forces for one layer of an ANCF
// shell element.
// 72x72 Jacobian
//      Kfactor * [K] + Rfactor * [R]

class ShellANCF_3833_TR00_Jacobian : public ChIntegrable3D<ChVectorN<double, 5184>> {
  public:
    ShellANCF_3833_TR00_Jacobian(ChElementShellANCF_3833_TR00* element,  // Containing element
...
void ShellANCF_3833_TR00_Jacobian::Evaluate(ChVectorN<double, 5184>& result, const double x, const double y, const double z) {
    // Element shape function
    ChElementShellANCF_3833_TR00::ShapeVector N;
    m_element->ShapeFunctions(N, x, y, z);
...
void ChElementShellANCF_3833_TR00::ComputeInternalJacobians(double Kfactor, double Rfactor) {
    ...
    for (size_t kl = 0; kl < m_numLayers; kl++) {
        ShellANCF_3833_TR00_Jacobian formula(this, Kfactor, Rfactor, kl);
...
void ChElementShellANCF_3833_TR00::ShapeFunctions(ShapeVector& N, double x, double y, double z) {
    double a = GetLengthX();
    double b = GetLengthY();
...
void ChElementShellANCF_3833_TR00::ShapeFunctionsDerivativeX(ShapeVector& Nx, double x, double y, double z) {
    double a = GetLengthX();
    double b = GetLengthY();
    double c = m_thickness;
...
void ChElementShellANCF_3833_TR00::ShapeFunctionsDerivativeY(ShapeVector& Ny, double x, double y, double z) {
    double a = GetLengthX();
    double b = GetLengthY();
    double c = m_thickness;
...
void ChElementShellANCF_3833_TR00::ShapeFunctionsDerivativeZ(ShapeVector& Nz, double x, double y, double z) {
    double a = GetLengthX();
    double b = GetLengthY();
    double c = m_thickness;
    Nz(0) = 0.0;
...
// Helper functions
// -----------------------------------------------------------------------------
double ChElementShellANCF_3833_TR00::Calc_detJ0(double x,
                                        double y,
                                        double z,
                                        ShapeVector& Nx,
                                        ShapeVector& Ny,
...
double ChElementShellANCF_3833_TR00::Calc_detJ0(double x, double y, double z) {
    ChMatrixNM<double, 1, 24> Nx;
    ChMatrixNM<double, 1, 24> Ny;
    ChMatrixNM<double, 1, 24> Nz;
    ChMatrixNM<double, 1, 3> Nx_d0;
...
void ChElementShellANCF_3833_TR00::CalcCoordMatrix(ChMatrixNM<double, 24, 3>& d) {
...
void ChElementShellANCF_3833_TR00::CalcCoordDerivMatrix(ChVectorN<double, 72>& dt) {
...
ChStrainStress3D ChElementShellANCF_3833_TR00::EvaluateSectionStrainStress(const ChVector<>& loc, int layer_id) {
    // Element shape function
    ShapeVector N;
...
void ChElementShellANCF_3833_TR00::EvaluateSectionDisplacement(const double u,
                                                       const double v,
                                                       ChVector<>& u_displ,
                                                       ChVector<>& u_rotaz) {
...
void ChElementShellANCF_3833_TR00::EvaluateSectionFrame(const double u,
                                                const double v,
                                                ChVector<>& point,
                                                ChQuaternion<>& rot) {
    // this is not a corotational element, so just do:
...
void ChElementShellANCF_3833_TR00::EvaluateSectionPoint(const double u, const double v, ChVector<>& point) {
...
void ChElementShellANCF_3833_TR00::LoadableGetStateBlock_x(int block_offset, ChState& mD) {
...
void ChElementShellANCF_3833_TR00::LoadableGetStateBlock_w(int block_offset, ChStateDelta& mD) {
...
void ChElementShellANCF_3833_TR00::LoadableStateIncrement(const unsigned int off_x,
                                                  ChState& x_new,
                                                  const ChState& x,
...
void ChElementShellANCF_3833_TR00::EvaluateSectionVelNorm(double U, double V, ChVector<>& Result) {
    ShapeVector N;
...
void ChElementShellANCF_3833_TR00::LoadableGetVariables(std::vector<ChVariables*>& mvars) {
...
void ChElementShellANCF_3833_TR00::ComputeNF(
...
double ChElementShellANCF_3833_TR00::GetDensity() {
...
ChVector<> ChElementShellANCF_3833_TR00::ComputeNormal(const double U, const double V) {
    ShapeVector Nx;
    ShapeVector Ny;
    ShapeVector Nz;
    ShapeFunctionsDerivativeX(Nx, U, V, 0);
...
// ============================================================================
// Implementation of ChElementShellANCF_3833_TR00::Layer methods
// ============================================================================

// Private constructor (a layer can be created only by adding it to an element)
ChElementShellANCF_3833_TR00::Layer::Layer(ChElementShellANCF_3833_TR00* element,
                                   double thickness,
                                   double theta,
...
void ChElementShellANCF_3833_TR00::Layer::SetupInitial() {
