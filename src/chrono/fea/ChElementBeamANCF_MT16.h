...
#ifndef CHELEMENTBEAMANCFMT16_H
#define CHELEMENTBEAMANCFMT16_H
...
class ChApi ChMaterialBeamANCF_MT16 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_MT16(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_MT16 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MT16> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_MT16> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_MT16> m_material;    ///< beam material
