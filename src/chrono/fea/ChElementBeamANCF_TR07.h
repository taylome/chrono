...
#ifndef CHELEMENTBEAMANCFTR07_H
#define CHELEMENTBEAMANCFTR07_H
...
class ChApi ChMaterialBeamANCF_TR07 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_TR07(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_TR07 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_TR07> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_TR07> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_TR07> m_material;  ///< beam material
