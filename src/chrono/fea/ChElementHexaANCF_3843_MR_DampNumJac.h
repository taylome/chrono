...
#ifndef CH_ELEMENT_HEXA_ANCF_3843_MR_DampNumJac_H
#define CH_ELEMENT_HEXA_ANCF_3843_MR_DampNumJac_H
...
class ChApi ChElementHexaANCF_3843_MR_DampNumJac : public ChElementANCF, public ChElementHexahedron, public ChElementGeneric, public ChLoadableUVW {
  public:
    ...
    ChElementHexaANCF_3843_MR_DampNumJac();
    ~ChElementHexaANCF_3843_MR_DampNumJac() {}
