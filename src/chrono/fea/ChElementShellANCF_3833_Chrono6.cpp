...
ChElementShellANCF_3833_Chrono6::ChElementShellANCF_3833_Chrono6()
...
void ChElementShellANCF_3833_Chrono6::SetNodes(std::shared_ptr<ChNodeFEAxyzDD> nodeA,
...
void ChElementShellANCF_3833_Chrono6::AddLayer(double thickness, double theta, std::shared_ptr<ChMaterialShellANCF> material) {
...
void ChElementShellANCF_3833_Chrono6::SetupInitial(ChSystem* system) {
    m_element_dof = 0;
    for (int i = 0; i < 8; i++) {
...
// State update.
void ChElementShellANCF_3833_Chrono6::Update() {
    ChElementGeneric::Update();
}

// Fill the DD vector with the current field values at the element nodes.
void ChElementShellANCF_3833_Chrono6::GetStateBlock(ChVectorDynamic<>& mDD) {
...
void ChElementShellANCF_3833_Chrono6::ComputeKRMmatricesGlobal(ChMatrixRef H, double Kfactor, double Rfactor, double Mfactor) {
...
void ChElementShellANCF_3833_Chrono6::ComputeMmatrixGlobal(ChMatrixRef M) {
    M = m_MassMatrix;
}
...
class ShellANCF8_Mass : public ChIntegrable3D<ChMatrixNM<double, 72, 72>> {
  public:
    ShellANCF8_Mass(ChElementShellANCF_3833_Chrono6* element) : m_element(element) {}
    ~ShellANCF8_Mass() {}

  private:
    ChElementShellANCF_3833_Chrono6* m_element;
...
void ShellANCF8_Mass::Evaluate(ChMatrixNM<double, 72, 72>& result, const double x, const double y, const double z) {
    ChElementShellANCF_3833_Chrono6::ShapeVector N;
...
void ChElementShellANCF_3833_Chrono6::ComputeMassMatrix() {
...
void ChElementShellANCF_3833_Chrono6::ComputeNodalMass() {
...
class ShellANCF8_Gravity : public ChIntegrable3D<ChVectorN<double, 72>> {
  public:
    ShellANCF8_Gravity(ChElementShellANCF_3833_Chrono6* element, const ChVector<> gacc) : m_element(element), m_gacc(gacc) {}
    ~ShellANCF8_Gravity() {}
...
void ChElementShellANCF_3833_Chrono6::ComputeGravityForce(const ChVector<>& g_acc) {
    m_GravForce.setZero();
...
class ShellANCF8_Force : public ChIntegrable3D<ChVectorN<double, 72>> {
  public:
    ShellANCF8_Force(ChElementShellANCF_3833_Chrono6* element,  // Containing element
...
void ChElementShellANCF_3833_Chrono6::ComputeInternalForces(ChVectorDynamic<>& Fi) {
...
class ShellANCF8_Jacobian : public ChIntegrable3D<ChVectorN<double, 5184>> {
  public:
    ShellANCF8_Jacobian(ChElementShellANCF_3833_Chrono6* element,  // Containing element
...
void ChElementShellANCF_3833_Chrono6::ComputeInternalJacobians(double Kfactor, double Rfactor) {
...
void ChElementShellANCF_3833_Chrono6::ShapeFunctions(ShapeVector& N, double x, double y, double z) {
    double a = GetLengthX();
    double b = GetLengthY();
...
void ChElementShellANCF_3833_Chrono6::ShapeFunctionsDerivativeX(ShapeVector& Nx, double x, double y, double z) {
    double a = GetLengthX();
    double b = GetLengthY();
    double c = m_thickness;
...
void ChElementShellANCF_3833_Chrono6::ShapeFunctionsDerivativeY(ShapeVector& Ny, double x, double y, double z) {
    double a = GetLengthX();
    double b = GetLengthY();
    double c = m_thickness;
...
void ChElementShellANCF_3833_Chrono6::ShapeFunctionsDerivativeZ(ShapeVector& Nz, double x, double y, double z) {
    double a = GetLengthX();
    double b = GetLengthY();
    double c = m_thickness;
    Nz(0) = 0.0;
...
// Helper functions
// -----------------------------------------------------------------------------
double ChElementShellANCF_3833_Chrono6::Calc_detJ0(double x,
                                        double y,
                                        double z,
                                        ShapeVector& Nx,
                                        ShapeVector& Ny,
...
double ChElementShellANCF_3833_Chrono6::Calc_detJ0(double x, double y, double z) {
    ChMatrixNM<double, 1, 24> Nx;
    ChMatrixNM<double, 1, 24> Ny;
    ChMatrixNM<double, 1, 24> Nz;
    ChMatrixNM<double, 1, 3> Nx_d0;
...
void ChElementShellANCF_3833_Chrono6::CalcCoordMatrix(ChMatrixNM<double, 24, 3>& d) {
...
void ChElementShellANCF_3833_Chrono6::CalcCoordDerivMatrix(ChVectorN<double, 72>& dt) {
...
ChStrainStress3D ChElementShellANCF_3833_Chrono6::EvaluateSectionStrainStress(const ChVector<>& loc, int layer_id) {
    // Element shape function
    ShapeVector N;
...
void ChElementShellANCF_3833_Chrono6::EvaluateSectionDisplacement(const double u,
                                                       const double v,
                                                       ChVector<>& u_displ,
                                                       ChVector<>& u_rotaz) {
...
void ChElementShellANCF_3833_Chrono6::EvaluateSectionFrame(const double u,
                                                const double v,
                                                ChVector<>& point,
                                                ChQuaternion<>& rot) {
    // this is not a corotational element, so just do:
...
void ChElementShellANCF_3833_Chrono6::EvaluateSectionPoint(const double u, const double v, ChVector<>& point) {
...
void ChElementShellANCF_3833_Chrono6::LoadableGetStateBlock_x(int block_offset, ChState& mD) {
...
void ChElementShellANCF_3833_Chrono6::LoadableGetStateBlock_w(int block_offset, ChStateDelta& mD) {
...
void ChElementShellANCF_3833_Chrono6::LoadableStateIncrement(const unsigned int off_x,
                                                  ChState& x_new,
                                                  const ChState& x,
...
void ChElementShellANCF_3833_Chrono6::EvaluateSectionVelNorm(double U, double V, ChVector<>& Result) {
    ShapeVector N;
...
void ChElementShellANCF_3833_Chrono6::LoadableGetVariables(std::vector<ChVariables*>& mvars) {
...
void ChElementShellANCF_3833_Chrono6::ComputeNF(
...
double ChElementShellANCF_3833_Chrono6::GetDensity() {
...
ChVector<> ChElementShellANCF_3833_Chrono6::ComputeNormal(const double U, const double V) {
    ShapeVector Nx;
    ShapeVector Ny;
    ShapeVector Nz;
    ShapeFunctionsDerivativeX(Nx, U, V, 0);
...
// ============================================================================
// Implementation of ChElementShellANCF_3833_Chrono6::Layer methods
// ============================================================================

// Private constructor (a layer can be created only by adding it to an element)
ChElementShellANCF_3833_Chrono6::Layer::Layer(ChElementShellANCF_3833_Chrono6* element,
                                   double thickness,
                                   double theta,
...
void ChElementShellANCF_3833_Chrono6::Layer::SetupInitial() {
