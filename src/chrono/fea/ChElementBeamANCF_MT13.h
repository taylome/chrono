...
#ifndef CHELEMENTBEAMANCFMT13_H
#define CHELEMENTBEAMANCFMT13_H
...
class ChApi ChMaterialBeamANCF_MT13 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_MT13(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_MT13 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MT13> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_MT13> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_MT13> m_material;    ///< beam material
