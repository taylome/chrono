...
#ifndef CHELEMENTSHELLANCF3443_TR01_H
#define CHELEMENTSHELLANCF3443_TR01_H
...
class ChApi ChElementShellANCF_3443_TR01 : public ChElementShell, public ChLoadableUV, public ChLoadableUVW {
  public:
    ...
    static const int NP = 7;              ///< number of Gauss quadrature points for each midsurface direction
    static const int NT = 3;              ///< number of quadrature points through the thickness
    ...
    class Layer {
      ...
      public:
        ...
        friend class ChElementShellANCF_3443_TR01;
    };
  ...
  private:
    ...
    Matrix3Nx3N m_MassMatrix;  ///< Mass Matrix in full form;
