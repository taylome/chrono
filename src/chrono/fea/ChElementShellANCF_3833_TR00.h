...
#ifndef CHELEMENTSHELLANCF3833TR00_H
#define CHELEMENTSHELLANCF3833TR00_H
...
/// A o-----E-----o B
/// </pre>
class ChApi ChElementShellANCF_3833_TR00 : public ChElementShell, public ChLoadableUV, public ChLoadableUVW {
  public:
    using ShapeVector = ChMatrixNM<double, 1, 24>;

    ChElementShellANCF_3833_TR00();
    ~ChElementShellANCF_3833_TR00() {}
    ...
    class Layer {
      ...
      private:
        ...
        Layer(ChElementShellANCF_3833_TR00* element,                 ///< containing element
        ...
        ChElementShellANCF_3833_TR00* m_element;                  ///< containing ANCF shell element
      ...
      public:
        ...
        friend class ChElementShellANCF_3833_TR00;
        friend class ShellANCF_3833_TR00_Force;
        friend class ShellANCF_3833_TR00_Jacobian;
    };
  ...
  public:
    ...
    friend class ShellANCF_3833_TR00_Mass;
    friend class ShellANCF_3833_TR00_Gravity;
    friend class ShellANCF_3833_TR00_Force;
    friend class ShellANCF_3833_TR00_Jacobian;
};
