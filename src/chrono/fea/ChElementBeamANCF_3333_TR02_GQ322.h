...
#ifndef CHELEMENTBEAMANC3333FTR02_GQ322_H
#define CHELEMENTBEAMANC3333FTR02_GQ322_H
...
class ChApi ChMaterialBeamANCF_3333_TR02_GQ322 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_3333_TR02_GQ322(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_3333_TR02_GQ322 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    using VectorN = ChVectorN<double, 9>;
    using Vector3N = ChVectorN<double, 27>;
    using Matrix3x3N = ChMatrixNM<double, 3, 27>;
    using Matrix6x3N = ChMatrixNM<double, 6, 27>;
    using Matrix3Nx3N = ChMatrixNM<double, 27, 27>;

    ChElementBeamANCF_3333_TR02_GQ322();
    ~ChElementBeamANCF_3333_TR02_GQ322() {}
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_3333_TR02_GQ322> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_3333_TR02_GQ322> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_3333_TR02_GQ322> m_material;    ///< beam material
