...
// Constructor
// ------------------------------------------------------------------------------
ChElementShellANCF_3833_MR_DampNumJac::ChElementShellANCF_3833_MR_DampNumJac()
...
void ChElementShellANCF_3833_MR_DampNumJac::SetNodes(std::shared_ptr<ChNodeFEAxyzDD> nodeA,
...
void ChElementShellANCF_3833_MR_DampNumJac::AddLayer(double thickness,
...
void ChElementShellANCF_3833_MR_DampNumJac::SetDimensions(double lenX, double lenY) {
    m_lenX = lenX;
    m_lenY = lenY;
}
...
void ChElementShellANCF_3833_MR_DampNumJac::SetMidsurfaceOffset(const double offset) {
...
ChMatrix33d ChElementShellANCF_3833_MR_DampNumJac::GetGreenLagrangeStrain(const double xi,
                                                                  const double eta,
                                                                  const double zeta) {
...
ChMatrix33d ChElementShellANCF_3833_MR_DampNumJac::GetPK2Stress(const double layer,
                                                        const double xi,
                                                        const double eta,
...
double ChElementShellANCF_3833_MR_DampNumJac::GetVonMissesStress(const double layer,
                                                        const double xi,
                                                        const double eta,
                                                        const double layer_zeta) {
    MatrixNx3c Sxi_D;  // Matrix of normalized shape function derivatives
...
void ChElementShellANCF_3833_MR_DampNumJac::SetupInitial(ChSystem* system) {
...
void ChElementShellANCF_3833_MR_DampNumJac::GetStateBlock(ChVectorDynamic<>& mD) {
...
void ChElementShellANCF_3833_MR_DampNumJac::Update() {
    ChElementGeneric::Update();
}

// Return the mass matrix in full sparse form.

void ChElementShellANCF_3833_MR_DampNumJac::ComputeMmatrixGlobal(ChMatrixRef M) {
    M.setZero();
...
void ChElementShellANCF_3833_MR_DampNumJac::ComputeNodalMass() {
...
void ChElementShellANCF_3833_MR_DampNumJac::ComputeInternalForces(ChVectorDynamic<>& Fi) {
...
void ChElementShellANCF_3833_MR_DampNumJac::ComputeKRMmatricesGlobal(ChMatrixRef H,
    double Kfactor,
    double Rfactor,
    double Mfactor) {
...
void ChElementShellANCF_3833_MR_DampNumJac::ComputeGravityForces(ChVectorDynamic<>& Fg, const ChVector3d& G_acc) {
...
void ChElementShellANCF_3833_MR_DampNumJac::EvaluateSectionFrame(const double xi,
                                                        const double eta,
                                                        ChVector3d& point,
                                                        ChQuaternion<>& rot) {
    VectorN Sxi_compact;
...
void ChElementShellANCF_3833_MR_DampNumJac::EvaluateSectionPoint(const double xi, const double eta, ChVector3d& point) {
    VectorN Sxi_compact;
    Calc_Sxi_compact(Sxi_compact, xi, eta, 0, m_thicknessZ, m_midsurfoffset);
...
void ChElementShellANCF_3833_MR_DampNumJac::EvaluateSectionVelNorm(const double xi, const double eta, ChVector3d& Result) {
    VectorN Sxi_compact;
    Calc_Sxi_compact(Sxi_compact, xi, eta, 0, m_thicknessZ, m_midsurfoffset);
...
void ChElementShellANCF_3833_MR_DampNumJac::LoadableGetStateBlockPosLevel(int block_offset, ChState& mD) {
...
void ChElementShellANCF_3833_MR_DampNumJac::LoadableGetStateBlockVelLevel(int block_offset, ChStateDelta& mD) {
...
void ChElementShellANCF_3833_MR_DampNumJac::LoadableStateIncrement(const unsigned int off_x,
                                                          ChState& x_new,
                                                          const ChState& x,
...
void ChElementShellANCF_3833_MR_DampNumJac::LoadableGetVariables(std::vector<ChVariables*>& mvars) {
...
void ChElementShellANCF_3833_MR_DampNumJac::ComputeNF(
...
double ChElementShellANCF_3833_MR_DampNumJac::GetDensity() {
...
ChVector3d ChElementShellANCF_3833_MR_DampNumJac::ComputeNormal(const double xi, const double eta) {
...
void ChElementShellANCF_3833_MR_DampNumJac::ComputeMassMatrixAndGravityForce() {
...
void ChElementShellANCF_3833_MR_DampNumJac::PrecomputeInternalForceMatricesWeights() {
    ChQuadratureTables* GQTable = GetStaticGQTables();
...
void ChElementShellANCF_3833_MR_DampNumJac::ComputeInternalForceDamping(ChVectorDynamic<>& Fi, Matrix6xN& ebar_ebardot) {
...
void ChElementShellANCF_3833_MR_DampNumJac::ComputeInternalForceNoDamping(ChVectorDynamic<>& Fi, Matrix3xN& ebar) {
    assert((unsigned int)Fi.size() == GetNumCoordsPosLevel());
...
void ChElementShellANCF_3833_MR_DampNumJac::ComputeInternalJacobianDamping(ChMatrixRef H, double Kfactor, double Rfactor, double Mfactor) {
...
void ChElementShellANCF_3833_MR_DampNumJac::ComputeInternalJacobianNoDamping(ChMatrixRef H, double Kfactor, double Mfactor) {
    assert((H.rows() == 3 * NSF) && (H.cols() == 3 * NSF));
...
void ChElementShellANCF_3833_MR_DampNumJac::Calc_Sxi_compact(VectorN& Sxi_compact,
                                                    double xi,
                                                    double eta,
                                                    double zeta,
                                                    double thickness,
...
void ChElementShellANCF_3833_MR_DampNumJac::Calc_Sxi_xi_compact(VectorN& Sxi_xi_compact,
                                                       double xi,
                                                       double eta,
                                                       double zeta,
                                                       double thickness,
...
void ChElementShellANCF_3833_MR_DampNumJac::Calc_Sxi_eta_compact(VectorN& Sxi_eta_compact,
                                                        double xi,
                                                        double eta,
                                                        double zeta,
                                                        double thickness,
...
void ChElementShellANCF_3833_MR_DampNumJac::Calc_Sxi_zeta_compact(VectorN& Sxi_zeta_compact,
                                                         double xi,
                                                         double eta,
                                                         double zeta,
                                                         double thickness,
...
void ChElementShellANCF_3833_MR_DampNumJac::Calc_Sxi_D(MatrixNx3c& Sxi_D,
                                              double xi,
                                              double eta,
                                              double zeta,
                                              double thickness,
...
void ChElementShellANCF_3833_MR_DampNumJac::CalcCoordVector(Vector3N& e) {
...
void ChElementShellANCF_3833_MR_DampNumJac::CalcCoordMatrix(Matrix3xN& ebar) {
...
void ChElementShellANCF_3833_MR_DampNumJac::CalcCoordDtVector(Vector3N& edot) {
...
void ChElementShellANCF_3833_MR_DampNumJac::CalcCoordDtMatrix(Matrix3xN& ebardot) {
...
void ChElementShellANCF_3833_MR_DampNumJac::CalcCombinedCoordMatrix(Matrix6xN& ebar_ebardot) {
...
void ChElementShellANCF_3833_MR_DampNumJac::Calc_J_0xi(ChMatrix33d& J_0xi,
                                              double xi,
                                              double eta,
                                              double zeta,
                                              double thickness,
...
double ChElementShellANCF_3833_MR_DampNumJac::Calc_det_J_0xi(double xi,
                                                    double eta,
                                                    double zeta,
                                                    double thickness,
                                                    double zoffset) {
...
void ChElementShellANCF_3833_MR_DampNumJac::RotateReorderStiffnessMatrix(ChMatrix66d& D, double theta) {
...
ChQuadratureTables static_tables_3833_MR_DampNumJac(1, CH_QUADRATURE_STATIC_TABLES);
//#endif // !CH_QUADRATURE_STATIC_TABLES

ChQuadratureTables* ChElementShellANCF_3833_MR_DampNumJac::GetStaticGQTables() {
    return &static_tables_3833_MR_DampNumJac;
}

////////////////////////////////////////////////////////////////

// ============================================================================
// Implementation of ChElementShellANCF_3833_MR_DampNumJac::Layer methods
// ============================================================================

// Private constructor (a layer can be created only by adding it to an element)

ChElementShellANCF_3833_MR_DampNumJac::Layer::Layer(double thickness,
                                           std::shared_ptr<ChMaterialShellANCF_MR> material)
