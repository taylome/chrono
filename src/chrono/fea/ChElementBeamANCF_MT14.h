...
#ifndef CHELEMENTBEAMANCFMT14_H
#define CHELEMENTBEAMANCFMT14_H
...
class ChApi ChMaterialBeamANCF_MT14 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_MT14(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_MT14 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MT14> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_MT14> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_MT14> m_material;    ///< beam material
