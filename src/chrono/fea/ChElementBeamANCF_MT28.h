...
#ifndef CHELEMENTBEAMANCFMT28_H
#define CHELEMENTBEAMANCFMT28_H
...
class ChApi ChMaterialBeamANCF_MT28 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_MT28(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_MT28 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MT28> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_MT28> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::ColMajor, 9, 9>   m_MassMatrix;                  ///< mass matrix - in compact form for reduced memory and reduced KRM matrix computations
    std::shared_ptr<ChMaterialBeamANCF_MT28> m_material;    ///< beam material
    ...
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::ColMajor, 9, 60> m_SD_precompute;             ///< Precomputed corrected normalized shape function derivative matrices for no Poisson Effect followed by Poisson Effect on the beam axis only
    ...
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::ColMajor, 3, 60> m_F_Block;
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::ColMajor, 3, 60> m_Fdot_Block;
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::ColMajor, 96, 1> m_SPK2;
    ChVectorN<double, 12> m_Ediag;
    ChVectorN<double, 12> m_Sdiag;

    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::ColMajor, 9, 48> m_SD_precompute_D0;          ///< Precomputed corrected normalized shape function derivative matrices for no Poisson Effect
    ...
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::ColMajor, 9, 12> m_SD_precompute_Dv;           ///< Precomputed corrected normalized shape function derivative matrices for Poisson Effect on the beam axis only
