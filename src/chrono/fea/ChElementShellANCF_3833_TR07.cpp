...
// -----------------------------------------------------------------------------
void ChElementShellANCF_3833_TR07::ComputeMassMatrixAndGravityForce(const ChVector<>& g_acc) {
...
void ChElementShellANCF_3833_TR07::ComputeInternalForcesAtState(ChVectorDynamic<>& Fi, const MatrixNx6& ebar_ebardot) {
    ...
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::ColMajor>  E0_Block = m_F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(0, 0).cwiseProduct(
    ...
    E0_Block.array() -= 1;
    E0_Block *= 0.5;
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::ColMajor> E_BlockDamping = m_F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(0, 0).cwiseProduct(
    ...
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::ColMajor>  E1_Block = m_F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(64, 0).cwiseProduct(
    ...
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::ColMajor>  E2_Block = m_F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(128, 0).cwiseProduct(
    ...
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::ColMajor>  E3_Block = m_F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(64, 0).cwiseProduct(
        m_F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(128, 0));
    ...
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::ColMajor>  E4_Block = m_F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(0, 0).cwiseProduct(
        m_F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(128, 0));
    ...
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::ColMajor>  E5_Block = m_F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(0, 0).cwiseProduct(
        m_F_Transpose_CombinedBlockDamping_col_ordered.block<64, 1>(64, 0));
...
void ChElementShellANCF_3833_TR07::ComputeInternalForcesAtStateNoDamping(ChVectorDynamic<>& Fi,
...
void ChElementShellANCF_3833_TR07::ComputeInternalJacobians(Matrix3Nx3N& JacobianMatrix,
                                                           double Kfactor,
                                                           double Rfactor) {
...
void ChElementShellANCF_3833_TR07::ComputeInternalJacobianDamping(ChMatrixRef& H,
    double Kfactor,
    double Rfactor,
    double Mfactor) {
...
void ChElementShellANCF_3833_TR07::ComputeInternalJacobianNoDamping(ChMatrixRef& H, double Kfactor, double Mfactor) {
    // ChMatrixNM<double, 48, 180> partial_epsilon_partial_e_Transpose;
    //Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor, 48, 432> partial_epsilon_partial_e_Transpose;
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor> partial_epsilon_partial_e_Transpose;
    partial_epsilon_partial_e_Transpose.resize(72, 384);
    ...
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor, 24, 192> S_scaled_SD_precompute_col_ordered;
    S_scaled_SD_precompute_col_ordered.resize(24, 192);
...
void ChElementShellANCF_3833_TR07::Calc_Sxi(Matrix3x3N& Sxi, double xi, double eta, double zeta) {
    VectorN Sxi_compact;
    Calc_Sxi_compact(Sxi_compact, xi, eta, zeta);
    Sxi.setZero();
...
// [s1; s2; s3; ...]
void ChElementShellANCF_3833_TR07::Calc_Sxi_compact(VectorN& Sxi_compact, double xi, double eta, double zeta) {    
...
// [s1*I_3x3, s2*I_3x3, s3*I_3x3, ...]
void ChElementShellANCF_3833_TR07::Calc_Sxi_xi(Matrix3x3N& Sxi_xi, double xi, double eta, double zeta) {
...
// [s1; s2; s3; ...]
void ChElementShellANCF_3833_TR07::Calc_Sxi_xi_compact(VectorN& Sxi_xi_compact, double xi, double eta, double zeta) {
...
// [s1*I_3x3, s2*I_3x3, s3*I_3x3, ...]
void ChElementShellANCF_3833_TR07::Calc_Sxi_eta(Matrix3x3N& Sxi_eta, double xi, double eta, double zeta) {
...
// [s1; s2; s3; ...]
void ChElementShellANCF_3833_TR07::Calc_Sxi_eta_compact(VectorN& Sxi_eta_compact, double xi, double eta, double zeta) {
...
// [s1*I_3x3, s2*I_3x3, s3*I_3x3, ...]
void ChElementShellANCF_3833_TR07::Calc_Sxi_zeta(Matrix3x3N& Sxi_zeta, double xi, double eta, double zeta) {
...
// [s1; s2; s3; ...]
void ChElementShellANCF_3833_TR07::Calc_Sxi_zeta_compact(VectorN& Sxi_zeta_compact, double xi, double eta, double zeta) {
...
void ChElementShellANCF_3833_TR07::Calc_Sxi_D(MatrixNx3c& Sxi_D, double xi, double eta, double zeta) {
...
void ChElementShellANCF_3833_TR07::CalcCoordMatrix(MatrixNx3c& ebar) {
...
void ChElementShellANCF_3833_TR07::CalcCoordMatrix(MatrixNx3& ebar) {
    ebar.row(0) = m_nodes[0]->GetPos().eigen();
    ebar.row(1) = m_nodes[0]->GetD().eigen();
    ebar.row(2) = m_nodes[0]->GetDD().eigen();
...
void ChElementShellANCF_3833_TR07::CalcCoordDerivMatrix(MatrixNx3c& ebardot) {
...
void ChElementShellANCF_3833_TR07::CalcCombinedCoordMatrix(MatrixNx6& ebar_ebardot) {
...
void ChElementShellANCF_3833_TR07::Calc_J_0xi(ChMatrix33<double>& J_0xi, double xi, double eta, double zeta) {
    MatrixNx3c Sxi_D;
    Calc_Sxi_D(Sxi_D, xi, eta, zeta);
...
double ChElementShellANCF_3833_TR07::Calc_det_J_0xi(double xi, double eta, double zeta) {
...
void ChElementShellANCF_3833_TR07::EvaluateSectionFrame(const double xi, const double eta, ChVector<>& point, ChQuaternion<>& rot) {
    Matrix3x3N Sxi;
    Matrix3x3N Sxi_xi;
    Matrix3x3N Sxi_eta;
...
void ChElementShellANCF_3833_TR07::EvaluateSectionPoint(const double u, const double v, ChVector<>& point) {
    Matrix3x3N Sxi;
    Calc_Sxi(Sxi, u, v, 0);
...
void ChElementShellANCF_3833_TR07::EvaluateSectionVelNorm(double U, double V, ChVector<>& Result) {
    Matrix3x3N Sxi_zeta;
    Vector3N edot;
    ChVector<> r_zeta;
...
ChVector<> ChElementShellANCF_3833_TR07::ComputeNormal(const double U, const double V) {
    Matrix3x3N Sxi_zeta;
    Vector3N e;
    ChVector<> r_zeta;
...
// ============================================================================
// Implementation of ChMaterialShellANCF_3833_TR07 methods
// ============================================================================

// Construct an isotropic material.
ChMaterialShellANCF_3833_TR07::ChMaterialShellANCF_3833_TR07(
...
// Poisson effect
void ChMaterialShellANCF_3833_TR07::Calc_D0_Dv(const ChVector<>& E,
                                              const ChVector<>& nu,
                                              const ChVector<>& G) {
