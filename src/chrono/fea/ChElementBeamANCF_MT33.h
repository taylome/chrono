...
#ifndef CHELEMENTBEAMANCFMT33_H
#define CHELEMENTBEAMANCFMT33_H
...
class ChApi ChMaterialBeamANCF_MT33 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_MT33(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_MT33 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MT33> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_MT33> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_MT33> m_material;    ///< beam material
    ...
    ChMatrixNMc<double, 3, 60> m_F_Block;
    ChMatrixNMc<double, 3, 60> m_Fdot_Block;
    ChVectorN<double, 96> m_SPK2;
