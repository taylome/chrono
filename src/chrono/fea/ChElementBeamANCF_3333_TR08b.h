...
#ifndef CHELEMENTBEAMANCF3333TR08B_H
#define CHELEMENTBEAMANCF3333TR08B_H
...
class ChApi ChMaterialBeamANCF_3333_TR08b {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_3333_TR08b(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_3333_TR08b : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_3333_TR08b> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_3333_TR08b> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_3333_TR08b> m_material;  ///< beam material
