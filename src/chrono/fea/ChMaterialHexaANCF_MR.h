...
// =============================================================================
// Material for ANCF brick Element for a Two term Mooney-Rivlin Hyperelastic Material Law with penalty term for incompressibility with the option for a single coefficient nonlinear KV Damping
// =============================================================================

#ifndef CHMATERIALBRICKANCF_MR_H
#define CHMATERIALBRICKANCF_MR_H
...
class ChApi ChMaterialHexaANCF_MR {
  public:
    /// Construct the material.
      ChMaterialHexaANCF_MR(double rho,  // material Density
