...
#ifndef CHELEMENTSHELLANCF3833MLTR11S_H
#define CHELEMENTSHELLANCF3833MLTR11S_H
...
class ChApi ChMaterialShellANCF_3833ML_TR11S {
  public:
    /// Construct an isotropic material.
    ChMaterialShellANCF_3833ML_TR11S(double rho,  ///< material density
...
class ChApi ChElementShellANCF_3833ML_TR11S : public ChElementShell, public ChLoadableUV, public ChLoadableUVW {
  public:
    ...
    ChElementShellANCF_3833ML_TR11S();
    ~ChElementShellANCF_3833ML_TR11S() {}
    ...
    public:
        ...
        std::shared_ptr<ChMaterialShellANCF_3833ML_TR11S> GetMaterial() const { return m_material; }

    private:
        /// Private constructor (a layer can be created only by adding it to an element)
        Layer(ChElementShellANCF_3833ML_TR11S* element,                 ///< containing element
            double thickness,                              ///< layer thickness
            double theta,                                  ///< fiber angle
            std::shared_ptr<ChMaterialShellANCF_3833ML_TR11S> material  ///< layer material
        );

        ChElementShellANCF_3833ML_TR11S* m_element;                  ///< containing ANCF shell element
        std::shared_ptr<ChMaterialShellANCF_3833ML_TR11S> m_material;  ///< layer material
    ...
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
            ...
            friend class ChElementShellANCF_3833ML_TR11S;
    };
  ...
  private:
    ...
    void ComputeInternalForcesAtState(ChVectorDynamic<>& Fi, const MatrixNx3c& ebar, const Vector3N& edot);
    ...
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::ColMajor> m_K1;
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::ColMajor> m_K2;
