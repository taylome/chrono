...
#ifndef CHELEMENTSHELLANCF3833MLTR02_H
#define CHELEMENTSHELLANCF3833MLTR02_H
...
class ChApi ChMaterialShellANCF_3833ML_TR02 {
  public:
    /// Construct an isotropic material.
    ChMaterialShellANCF_3833ML_TR02(double rho,        ///< material density
...
class ChApi ChElementShellANCF_3833ML_TR02 : public ChElementShell, public ChLoadableUV, public ChLoadableUVW {
  public:
    ...
    ChElementShellANCF_3833ML_TR02();
    ~ChElementShellANCF_3833ML_TR02() {}
    ...
    public:
        ...
        std::shared_ptr<ChMaterialShellANCF_3833ML_TR02> GetMaterial() const { return m_material; }

    private:
        /// Private constructor (a layer can be created only by adding it to an element)
        Layer(ChElementShellANCF_3833ML_TR02* element,                 ///< containing element
            double thickness,                              ///< layer thickness
            double theta,                                  ///< fiber angle
            std::shared_ptr<ChMaterialShellANCF_3833ML_TR02> material  ///< layer material
        );

        ChElementShellANCF_3833ML_TR02* m_element;                  ///< containing ANCF shell element
        std::shared_ptr<ChMaterialShellANCF_3833ML_TR02> m_material;  ///< layer material
    ...
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
            ...
            friend class ChElementShellANCF_3833ML_TR02;
    };
