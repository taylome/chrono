...
#ifndef CHELEMENTBEAMANCFMT41_H
#define CHELEMENTBEAMANCFMT41_H
...
class ChApi ChMaterialBeamANCF_MT41 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_MT41(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_MT41 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MT41> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_MT41> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_MT41> m_material;    ///< beam material
