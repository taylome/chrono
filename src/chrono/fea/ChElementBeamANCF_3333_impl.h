...
ChElementBeamANCF_3333<NP, NT>::ChElementBeamANCF_3333()
...
template <int NP, int NT>
void ChElementBeamANCF_3333<NP, NT>::SetDimensions(double lenX, double thicknessY, double thicknessZ) {
    m_lenX = lenX;
...
template <int NP, int NT>
void ChElementBeamANCF_3333<NP, NT>::SetMaterial(std::shared_ptr<ChMaterialBeamANCF> beam_mat) {
    m_material = beam_mat;
...
template <int NP, int NT>
void ChElementBeamANCF_3333<NP, NT>::SetAlphaDamp(double a) {
    m_Alpha = a;
...
template <int NP, int NT>
void ChElementBeamANCF_3333<NP, NT>::SetIntFrcCalcMethod(IntFrcMethod method) {
    m_method = method;
...
template <int NP, int NT>
void ChElementBeamANCF_3333<NP, NT>::GetGreenLagrangeStrain(const double xi,
                                                            const double eta,
                                                            const double zeta,
                                                            ChMatrix33<>& E) {
...
template <int NP, int NT>
void ChElementBeamANCF_3333<NP, NT>::GetPK2Stress(const double xi,
                                                  const double eta,
                                                  const double zeta,
                                                  ChMatrix33<>& SPK2) {
    MatrixNx3c Sxi_D;  // Matrix of normalized shape function derivatives
...
template <int NP, int NT>
double ChElementBeamANCF_3333<NP, NT>::GetVonMissesStress(const double xi, const double eta, const double zeta) {
    MatrixNx3c Sxi_D;  // Matrix of normalized shape function derivatives
    Calc_Sxi_D(Sxi_D, xi, eta, zeta);
...
template <int NP, int NT>
void ChElementBeamANCF_3333<NP, NT>::SetupInitial(ChSystem* system) {
...
template <int NP, int NT>
void ChElementBeamANCF_3333<NP, NT>::GetStateBlock(ChVectorDynamic<>& mD) {
...
// State update.
template <int NP, int NT>
void ChElementBeamANCF_3333<NP, NT>::Update() {
    ChElementGeneric::Update();
}

// Return the mass matrix in full sparse form.
template <int NP, int NT>
void ChElementBeamANCF_3333<NP, NT>::ComputeMmatrixGlobal(ChMatrixRef M) {
    M.setZero();
...
template <int NP, int NT>
void ChElementBeamANCF_3333<NP, NT>::ComputeNodalMass() {
...
template <int NP, int NT>
void ChElementBeamANCF_3333<NP, NT>::ComputeInternalForces(ChVectorDynamic<>& Fi) {
...
template <int NP, int NT>
void ChElementBeamANCF_3333<NP, NT>::ComputeKRMmatricesGlobal(ChMatrixRef H,
                                                              double Kfactor,
                                                              double Rfactor,
                                                              double Mfactor) {
...
template <int NP, int NT>
void ChElementBeamANCF_3333<NP, NT>::EvaluateSectionFrame(const double xi, ChVector<>& point, ChQuaternion<>& rot) {
    VectorN Sxi_compact;
...
template <int NP, int NT>
void ChElementBeamANCF_3333<NP, NT>::EvaluateSectionPoint(const double xi, ChVector<>& point) {
    VectorN Sxi_compact;
    Calc_Sxi_compact(Sxi_compact, xi, 0, 0);
...
template <int NP, int NT>
void ChElementBeamANCF_3333<NP, NT>::EvaluateSectionVel(const double xi, ChVector<>& Result) {
    VectorN Sxi_compact;
    Calc_Sxi_compact(Sxi_compact, xi, 0, 0);
...
template <int NP, int NT>
void ChElementBeamANCF_3333<NP, NT>::LoadableGetStateBlock_x(int block_offset, ChState& mD) {
...
template <int NP, int NT>
void ChElementBeamANCF_3333<NP, NT>::LoadableGetStateBlock_w(int block_offset, ChStateDelta& mD) {
...
template <int NP, int NT>
void ChElementBeamANCF_3333<NP, NT>::LoadableStateIncrement(const unsigned int off_x,
                                                            ChState& x_new,
                                                            const ChState& x,
...
template <int NP, int NT>
void ChElementBeamANCF_3333<NP, NT>::LoadableGetVariables(std::vector<ChVariables*>& mvars) {
...
template <int NP, int NT>
void ChElementBeamANCF_3333<NP, NT>::ComputeNF(
...
template <int NP, int NT>
double ChElementBeamANCF_3333<NP, NT>::GetDensity() {
    return GetMaterial()->Get_rho();
}

// Calculate tangent to the centerline at coordinate xi [-1 to 1].
template <int NP, int NT>
ChVector<> ChElementBeamANCF_3333<NP, NT>::ComputeTangent(const double xi) {
    VectorN Sxi_xi_compact;
    Calc_Sxi_xi_compact(Sxi_xi_compact, xi, 0, 0);
...
template <int NP, int NT>
void ChElementBeamANCF_3333<NP, NT>::PrecomputeInternalForceMatricesWeights() {
    if (m_method == IntFrcMethod::ContInt)
...
// method
template <int NP, int NT>
void ChElementBeamANCF_3333<NP, NT>::PrecomputeInternalForceMatricesWeightsContInt() {
    ChQuadratureTables* GQTable = GetStaticGQTables();
...
// method
template <int NP, int NT>
void ChElementBeamANCF_3333<NP, NT>::PrecomputeInternalForceMatricesWeightsPreInt() {
    ChQuadratureTables* GQTable = GetStaticGQTables();
    unsigned int GQ_idx_xi = NP - 1;        // Gauss-Quadrature table index for xi
    unsigned int GQ_idx_eta_zeta = NT - 1;  // Gauss-Quadrature table index for eta and zeta
...
template <int NP, int NT>
void ChElementBeamANCF_3333<NP, NT>::ComputeInternalForcesContIntDamping(ChVectorDynamic<>& Fi) {
...
template <int NP, int NT>
void ChElementBeamANCF_3333<NP, NT>::ComputeInternalForcesContIntNoDamping(ChVectorDynamic<>& Fi) {
    // Calculate the generalize internal force vector using the "Continuous Integration" style of method assuming a
...
template <int NP, int NT>
void ChElementBeamANCF_3333<NP, NT>::ComputeInternalForcesContIntPreInt(ChVectorDynamic<>& Fi) {
...
template <int NP, int NT>
void ChElementBeamANCF_3333<NP, NT>::ComputeInternalJacobianContIntDamping(ChMatrixRef& H,
                                                                           double Kfactor,
                                                                           double Rfactor,
                                                                           double Mfactor) {
...
template <int NP, int NT>
void ChElementBeamANCF_3333<NP, NT>::ComputeInternalJacobianContIntNoDamping(ChMatrixRef& H,
                                                                             double Kfactor,
                                                                             double Mfactor) {
    // Calculate the Jacobian of the generalize internal force vector using the "Continuous Integration" style of method
...
template <int NP, int NT>
void ChElementBeamANCF_3333<NP, NT>::ComputeInternalJacobianPreInt(ChMatrixRef& H,
                                                                   double Kfactor,
                                                                   double Rfactor,
                                                                   double Mfactor) {
...
// [s1; s2; s3; ...]
template <int NP, int NT>
void ChElementBeamANCF_3333<NP, NT>::Calc_Sxi_compact(VectorN& Sxi_compact, double xi, double eta, double zeta) {
...
// [s1; s2; s3; ...]
template <int NP, int NT>
void ChElementBeamANCF_3333<NP, NT>::Calc_Sxi_xi_compact(VectorN& Sxi_xi_compact, double xi, double eta, double zeta) {
...
// [s1; s2; s3; ...]
template <int NP, int NT>
void ChElementBeamANCF_3333<NP, NT>::Calc_Sxi_eta_compact(VectorN& Sxi_eta_compact,
                                                          double xi,
                                                          double eta,
                                                          double zeta) {
...
// [s1; s2; s3; ...]
template <int NP, int NT>
void ChElementBeamANCF_3333<NP, NT>::Calc_Sxi_zeta_compact(VectorN& Sxi_zeta_compact,
                                                           double xi,
                                                           double eta,
                                                           double zeta) {
...
// columns
template <int NP, int NT>
void ChElementBeamANCF_3333<NP, NT>::Calc_Sxi_D(MatrixNx3c& Sxi_D, double xi, double eta, double zeta) {
    VectorN Sxi_D_col;
...
template <int NP, int NT>
void ChElementBeamANCF_3333<NP, NT>::CalcCoordVector(Vector3N& e) {
...
template <int NP, int NT>
void ChElementBeamANCF_3333<NP, NT>::CalcCoordMatrix(Matrix3xN& ebar) {
...
template <int NP, int NT>
void ChElementBeamANCF_3333<NP, NT>::CalcCoordDerivVector(Vector3N& edot) {
...
template <int NP, int NT>
void ChElementBeamANCF_3333<NP, NT>::CalcCoordDerivMatrix(Matrix3xN& ebardot) {
...
template <int NP, int NT>
void ChElementBeamANCF_3333<NP, NT>::CalcCombinedCoordMatrix(MatrixNx6& ebar_ebardot) {
...
template <int NP, int NT>
void ChElementBeamANCF_3333<NP, NT>::Calc_J_0xi(ChMatrix33<double>& J_0xi, double xi, double eta, double zeta) {
    MatrixNx3c Sxi_D;
    Calc_Sxi_D(Sxi_D, xi, eta, zeta);
...
template <int NP, int NT>
double ChElementBeamANCF_3333<NP, NT>::Calc_det_J_0xi(double xi, double eta, double zeta) {
...
template <int NP, int NT>
ChQuadratureTables* ChElementBeamANCF_3333<NP, NT>::GetStaticGQTables() {
