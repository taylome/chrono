...
ChElementBeamANCF_3243_MR_DampNumJac::ChElementBeamANCF_3243_MR_DampNumJac()
...
void ChElementBeamANCF_3243_MR_DampNumJac::SetNodes(std::shared_ptr<ChNodeFEAxyzDDD> nodeA,
...
void ChElementBeamANCF_3243_MR_DampNumJac::SetDimensions(double lenX, double thicknessY, double thicknessZ) {
    m_lenX = lenX;
...
void ChElementBeamANCF_3243_MR_DampNumJac::SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MR> beam_mat) {
    m_material = beam_mat;
}
...
ChMatrix33d ChElementBeamANCF_3243_MR_DampNumJac::GetGreenLagrangeStrain(const double xi, const double eta, const double zeta) {
...
ChMatrix33d ChElementBeamANCF_3243_MR_DampNumJac::GetPK2Stress(const double xi, const double eta, const double zeta) {
    MatrixNx3c Sxi_D;  // Matrix of normalized shape function derivatives
    Calc_Sxi_D(Sxi_D, xi, eta, zeta);
...
double ChElementBeamANCF_3243_MR_DampNumJac::GetVonMissesStress(const double xi, const double eta, const double zeta) {
    MatrixNx3c Sxi_D;  // Matrix of normalized shape function derivatives
    Calc_Sxi_D(Sxi_D, xi, eta, zeta);
...
void ChElementBeamANCF_3243_MR_DampNumJac::SetupInitial(ChSystem* system) {
...
void ChElementBeamANCF_3243_MR_DampNumJac::GetStateBlock(ChVectorDynamic<>& mD) {
...
void ChElementBeamANCF_3243_MR_DampNumJac::Update() {
    ChElementGeneric::Update();
}

// Return the mass matrix in full sparse form.

void ChElementBeamANCF_3243_MR_DampNumJac::ComputeMmatrixGlobal(ChMatrixRef M) {
    M.setZero();
...
void ChElementBeamANCF_3243_MR_DampNumJac::ComputeNodalMass() {
...
void ChElementBeamANCF_3243_MR_DampNumJac::ComputeInternalForces(ChVectorDynamic<>& Fi) {
...
void ChElementBeamANCF_3243_MR_DampNumJac::ComputeKRMmatricesGlobal(ChMatrixRef H,
                                                           double Kfactor,
                                                           double Rfactor,
                                                           double Mfactor) {
...
void ChElementBeamANCF_3243_MR_DampNumJac::ComputeGravityForces(ChVectorDynamic<>& Fg, const ChVector3d& G_acc) {
...
void ChElementBeamANCF_3243_MR_DampNumJac::EvaluateSectionFrame(const double xi, ChVector3d& point, ChQuaternion<>& rot) {
    VectorN Sxi_compact;
...
void ChElementBeamANCF_3243_MR_DampNumJac::EvaluateSectionPoint(const double xi, ChVector3d& point) {
    VectorN Sxi_compact;
    Calc_Sxi_compact(Sxi_compact, xi, 0, 0);
...
void ChElementBeamANCF_3243_MR_DampNumJac::EvaluateSectionVel(const double xi, ChVector3d& Result) {
    VectorN Sxi_compact;
    Calc_Sxi_compact(Sxi_compact, xi, 0, 0);
...
void ChElementBeamANCF_3243_MR_DampNumJac::LoadableGetStateBlockPosLevel(int block_offset, ChState& mD) {
...
void ChElementBeamANCF_3243_MR_DampNumJac::LoadableGetStateBlockVelLevel(int block_offset, ChStateDelta& mD) {
...
void ChElementBeamANCF_3243_MR_DampNumJac::LoadableStateIncrement(const unsigned int off_x,
                                                         ChState& x_new,
                                                         const ChState& x,
...
void ChElementBeamANCF_3243_MR_DampNumJac::LoadableGetVariables(std::vector<ChVariables*>& mvars) {
...
void ChElementBeamANCF_3243_MR_DampNumJac::ComputeNF(
...
double ChElementBeamANCF_3243_MR_DampNumJac::GetDensity() {
    return GetMaterial()->GetDensity();
}

// Calculate tangent to the centerline at coordinate xi [-1 to 1].

ChVector3d ChElementBeamANCF_3243_MR_DampNumJac::ComputeTangent(const double xi) {
    VectorN Sxi_xi_compact;
    Calc_Sxi_xi_compact(Sxi_xi_compact, xi, 0, 0);
...
void ChElementBeamANCF_3243_MR_DampNumJac::ComputeMassMatrixAndGravityForce() {
...
void ChElementBeamANCF_3243_MR_DampNumJac::PrecomputeInternalForceMatricesWeights() {
    ChQuadratureTables* GQTable = GetStaticGQTables();
...
void ChElementBeamANCF_3243_MR_DampNumJac::ComputeInternalForceDamping(ChVectorDynamic<>& Fi, Matrix6xN& ebar_ebardot) {
...
void ChElementBeamANCF_3243_MR_DampNumJac::ComputeInternalForceNoDamping(ChVectorDynamic<>& Fi, Matrix3xN& ebar) {
    assert(Fi.size() == 3 * NSF);
...
void ChElementBeamANCF_3243_MR_DampNumJac::ComputeInternalJacobianDamping(ChMatrixRef H, double Kfactor, double Rfactor, double Mfactor) {
...
void ChElementBeamANCF_3243_MR_DampNumJac::ComputeInternalJacobianNoDamping(ChMatrixRef H, double Kfactor, double Mfactor) {
    assert((H.rows() == 3 * NSF) && (H.cols() == 3 * NSF));
...
void ChElementBeamANCF_3243_MR_DampNumJac::Calc_Sxi_compact(VectorN& Sxi_compact, double xi, double eta, double zeta) {
...
void ChElementBeamANCF_3243_MR_DampNumJac::Calc_Sxi_xi_compact(VectorN& Sxi_xi_compact, double xi, double eta, double zeta) {
...
void ChElementBeamANCF_3243_MR_DampNumJac::Calc_Sxi_eta_compact(VectorN& Sxi_eta_compact, double xi, double eta, double zeta) {
...
void ChElementBeamANCF_3243_MR_DampNumJac::Calc_Sxi_zeta_compact(VectorN& Sxi_zeta_compact, double xi, double eta, double zeta) {
...
void ChElementBeamANCF_3243_MR_DampNumJac::Calc_Sxi_D(MatrixNx3c& Sxi_D, double xi, double eta, double zeta) {
    VectorN Sxi_D_col;
...
void ChElementBeamANCF_3243_MR_DampNumJac::CalcCoordVector(Vector3N& e) {
...
void ChElementBeamANCF_3243_MR_DampNumJac::CalcCoordMatrix(Matrix3xN& ebar) {
...
void ChElementBeamANCF_3243_MR_DampNumJac::CalcCoordDtVector(Vector3N& edot) {
...
void ChElementBeamANCF_3243_MR_DampNumJac::CalcCoordDtMatrix(Matrix3xN& ebardot) {
...
void ChElementBeamANCF_3243_MR_DampNumJac::CalcCombinedCoordMatrix(Matrix6xN& ebar_ebardot) {
...
void ChElementBeamANCF_3243_MR_DampNumJac::Calc_J_0xi(ChMatrix33d& J_0xi, double xi, double eta, double zeta) {
    MatrixNx3c Sxi_D;
    Calc_Sxi_D(Sxi_D, xi, eta, zeta);
...
double ChElementBeamANCF_3243_MR_DampNumJac::Calc_det_J_0xi(double xi, double eta, double zeta) {
    ChMatrix33d J_0xi;
...
ChQuadratureTables static_tables_3243_MR_DampNumJac(1, CH_QUADRATURE_STATIC_TABLES);
//#endif // !CH_QUADRATURE_STATIC_TABLES

ChQuadratureTables* ChElementBeamANCF_3243_MR_DampNumJac::GetStaticGQTables() {
    return &static_tables_3243_MR_DampNumJac;
}
