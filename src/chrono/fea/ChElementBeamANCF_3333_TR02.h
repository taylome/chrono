...
#ifndef CHELEMENTBEAMANC3333FTR02_H
#define CHELEMENTBEAMANC3333FTR02_H
...
class ChApi ChMaterialBeamANCF_3333_TR02 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_3333_TR02(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_3333_TR02 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_3333_TR02> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_3333_TR02> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_3333_TR02> m_material;    ///< beam material
