...
#ifndef CHELEMENTBRICKANCF3843TR07_H
#define CHELEMENTBRICKANCF3843TR07_H
...
/// This class implements material properties for an ANCF Brick.
    class ChApi ChMaterialBrickANCF_3843_TR07 {
    public:
        /// Construct an isotropic material.
        ChMaterialBrickANCF_3843_TR07(double rho,        ///< material density
...
class ChApi ChElementBrickANCF_3843_TR07 : public ChElementGeneric, public ChLoadableUVW {
  public:
      ...
      using VectorNIP = ChVectorN<double, 216>;
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBrickANCF_3843_TR07> brick_mat) { m_material = brick_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBrickANCF_3843_TR07> GetMaterial() const { return m_material; }
...
public:
  ...
  private:
      ...
      std::shared_ptr<ChMaterialBrickANCF_3843_TR07> m_material;  ///< shell material
