...
#ifndef CHELEMENTBEAMANCFMT38_H
#define CHELEMENTBEAMANCFMT38_H
...
class ChApi ChMaterialBeamANCF_MT38 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_MT38(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_MT38 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MT38> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_MT38> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_MT38> m_material;    ///< beam material
