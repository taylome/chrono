...
#ifndef CHELEMENTBEAMANCFMT34_H
#define CHELEMENTBEAMANCFMT34_H
...
class ChApi ChMaterialBeamANCF_MT34 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_MT34(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_MT34 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MT34> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_MT34> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_MT34> m_material;    ///< beam material
