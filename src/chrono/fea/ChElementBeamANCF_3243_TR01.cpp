...
ChElementBeamANCF_3243_TR01::ChElementBeamANCF_3243_TR01()
    ...
    m_nodes.resize(2);
    m_strain_form = ChElementBeamANCF_3243_TR01::CMPoisson;
}
...
// -----------------------------------------------------------------------------
void ChElementBeamANCF_3243_TR01::ComputeMassMatrixAndGravityForce(const ChVector<>& g_acc) {
    ...
    for (unsigned int it_xi = 0; it_xi < GQTable->Lroots[GQ_idx_xi].size(); it_xi++) {
        for (unsigned int it_eta = 0; it_eta < GQTable->Lroots[GQ_idx_eta_zeta].size(); it_eta++) {
            for (unsigned int it_zeta = 0; it_zeta < GQTable->Lroots[GQ_idx_eta_zeta].size(); it_zeta++) {
                ...
                Matrix3x3N Sxi;                                    // 3x24 Normalized Shape Function Matrix
...
void ChElementBeamANCF_3243_TR01::ComputeInternalForcesAtState(ChVectorDynamic<>& Fi,
    ...
    // beam axis
    if (GetStrainFormulation() == ChElementBeamANCF_3243_TR01::StrainFormulation::CMPoisson) {
...
void ChElementBeamANCF_3243_TR01::ComputeInternalJacobians(Matrix3Nx3N& JacobianMatrix,
                                                           double Kfactor,
                                                           double Rfactor) {
...
void ChElementBeamANCF_3243_TR01::Calc_Sxi(Matrix3x3N& Sxi, double xi, double eta, double zeta) {
    VectorN Sxi_compact;
...
// -----------------------------------------------------------------------------
// ChVector<> ChElementBeamANCF_3243_TR01::EvaluateBeamSectionStrains() {
...
//}
//
// void ChElementBeamANCF_3243_TR01::EvaluateSectionDisplacement(const double u,
//                                                    const double v,
//                                                    ChVector<>& u_displ,
//                                                    ChVector<>& u_rotaz) {
...
//}
//
// void ChElementBeamANCF_3243_TR01::EvaluateSectionFrame(const double u,
//                                             const double v,
//                                             ChVector<>& point,
//                                             ChQuaternion<>& rot) {
//    // this is not a corotational element, so just do:
...
//}
//
// void ChElementBeamANCF_3243_TR01::EvaluateSectionPoint(const double u,
//                                             const double v,
//                                             ChVector<>& point) {
//    ChVector<> u_displ;
//
...
// void ChElementBeamANCF_3243_TR01::EvaluateSectionVelNorm(double U, ChVector<>& Result) {
//    ChMatrixNM<double, 1, 9> N;
...
ChVector<> ChElementBeamANCF_3243_TR01::ComputeTangent(const double U) {
    Matrix3x3N Sxi_xi;
    Vector3N e;
    ChVector<> r_xi;
...
ChQuadratureTables static_tables_2_TR01(1, CH_QUADRATURE_STATIC_TABLES);
//#endif // !CH_QUADRATURE_STATIC_TABLES

ChQuadratureTables* ChElementBeamANCF_3243_TR01::GetStaticGQTables() {
    return &static_tables_2_TR01;
}

////////////////////////////////////////////////////////////////

// ============================================================================
// Implementation of ChMaterialBeamANCF_3243_TR01 methods
// ============================================================================

// Construct an isotropic material.
ChMaterialBeamANCF_3243_TR01::ChMaterialBeamANCF_3243_TR01(
...
// Poisson effect
void ChMaterialBeamANCF_3243_TR01::Calc_D0_Dv(const ChVector<>& E,
                                              const ChVector<>& nu,
                                              const ChVector<>& G,
                                              double k1,
                                              double k2) {
