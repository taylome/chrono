...
#ifndef CH_ELEMENT_HEXA_ANCF_3843_TR01_H
#define CH_ELEMENT_HEXA_ANCF_3843_TR01_H
...
class ChApi ChElementHexaANCF_3843_TR01 : public ChElementHexahedron, public ChElementGeneric, public ChLoadableUVW {
  public:
    // Using fewer than 3 Gauss quadrature will likely result in numerical issues with the element.
    static const int NP = 7;              ///< number of Gauss quadrature along beam axis
