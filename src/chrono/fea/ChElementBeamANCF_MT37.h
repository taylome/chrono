...
#ifndef CHELEMENTBEAMANCFMT37_H
#define CHELEMENTBEAMANCFMT37_H
...
class ChApi ChMaterialBeamANCF_MT37 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_MT37(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_MT37 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MT37> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_MT37> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_MT37> m_material;    ///< beam material
