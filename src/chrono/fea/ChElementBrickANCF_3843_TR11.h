...
#ifndef CHELEMENTBRICKANCF3843TR11_H
#define CHELEMENTBRICKANCF3843TR11_H
...
class ChApi ChMaterialBrickANCF_3843_TR11 {
  public:
    /// Construct an isotropic material.
    ChMaterialBrickANCF_3843_TR11(double rho,  ///< material density
...
class ChApi ChElementBrickANCF_3843_TR11 : public ChElementGeneric, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBrickANCF_3843_TR11> brick_mat) { m_material = brick_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBrickANCF_3843_TR11> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBrickANCF_3843_TR11> m_material;  ///< shell material
