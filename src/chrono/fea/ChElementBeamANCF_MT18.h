...
#ifndef CHELEMENTBEAMANCFMT18_H
#define CHELEMENTBEAMANCFMT18_H
...
class ChApi ChMaterialBeamANCF_MT18 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_MT18(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_MT18 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MT18> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_MT18> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_MT18> m_material;    ///< beam material
