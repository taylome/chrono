...
#ifndef CHELEMENTSHELLANCF3443MLTR10_H
#define CHELEMENTSHELLANCF3443MLTR10_H
...
class ChApi ChMaterialShellANCF_3443ML_TR10 {
  public:
    /// Construct an isotropic material.
    ChMaterialShellANCF_3443ML_TR10(double rho,        ///< material density
...
class ChApi ChElementShellANCF_3443ML_TR10 : public ChElementShell, public ChLoadableUV, public ChLoadableUVW {
  public:
    ...
    ChElementShellANCF_3443ML_TR10();
    ~ChElementShellANCF_3443ML_TR10() {}
    ...
    public:
        ...
        std::shared_ptr<ChMaterialShellANCF_3443ML_TR10> GetMaterial() const { return m_material; }

    private:
        /// Private constructor (a layer can be created only by adding it to an element)
        Layer(ChElementShellANCF_3443ML_TR10* element,                 ///< containing element
            double thickness,                              ///< layer thickness
            double theta,                                  ///< fiber angle
            std::shared_ptr<ChMaterialShellANCF_3443ML_TR10> material  ///< layer material
        );

        ChElementShellANCF_3443ML_TR10* m_element;                  ///< containing ANCF shell element
        std::shared_ptr<ChMaterialShellANCF_3443ML_TR10> m_material;  ///< layer material
    ...
    public:
        ...
        friend class ChElementShellANCF_3443ML_TR10;
    };
  ...
  private:
    ...
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::ColMajor, 16, 16> m_K3Compact;
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::ColMajor, 16, 16> m_K13Compact;
