...
#ifndef CHELEMENTBEAMANCFMT09_H
#define CHELEMENTBEAMANCFMT09_H
...
class ChApi ChMaterialBeamANCF_MT09 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_MT09(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_MT09 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    using ShapeVector = ChMatrixNM<double, 1, 9>;

    ChElementBeamANCF_MT09();
    ~ChElementBeamANCF_MT09() {}
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MT09> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_MT09> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_MT09> m_material;    ///< beam material
