...
#ifndef CHELEMENTBEAMANCFMT03_H
#define CHELEMENTBEAMANCFMT03_H
...
class ChApi ChMaterialBeamANCF_MT03 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_MT03(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_MT03 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    using ShapeVector = ChMatrixNM<double, 1, 9>;

    ChElementBeamANCF_MT03();
    ~ChElementBeamANCF_MT03() {}
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MT03> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_MT03> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    //Calculate the calculate the generalized internal force integrand at a single point (called for Gauss-Quadrature integration)
    ...
    void Calc_Sxi_D_0xi(ChMatrixNM<double, 9,3>& Sxi_D_0xi, double xi, double eta, double zeta);
    ...
    std::shared_ptr<ChMaterialBeamANCF_MT03> m_material;    ///< beam material
