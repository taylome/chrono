...
#ifndef CHELEMENTBRICKANCF3843TR11S_H
#define CHELEMENTBRICKANCF3843TR11S_H
...
class ChApi ChMaterialBrickANCF_3843_TR11S {
  public:
    /// Construct an isotropic material.
    ChMaterialBrickANCF_3843_TR11S(double rho,  ///< material density
...
class ChApi ChElementBrickANCF_3843_TR11S : public ChElementGeneric, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBrickANCF_3843_TR11S> brick_mat) { m_material = brick_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBrickANCF_3843_TR11S> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBrickANCF_3843_TR11S> m_material;  ///< shell material
