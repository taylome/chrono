...
#ifndef CHELEMENTBEAMANCFMT20_H
#define CHELEMENTBEAMANCFMT20_H
...
class ChApi ChMaterialBeamANCF_MT20 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_MT20(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_MT20 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MT20> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_MT20> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_MT20> m_material;    ///< beam material
