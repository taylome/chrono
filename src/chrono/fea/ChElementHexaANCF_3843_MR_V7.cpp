...
ChElementHexaANCF_3843_MR_V7::ChElementHexaANCF_3843_MR_V7()
...
void ChElementHexaANCF_3843_MR_V7::SetNodes(std::shared_ptr<ChNodeFEAxyzDDD> nodeA,
...
void ChElementHexaANCF_3843_MR_V7::SetDimensions(double lenX, double lenY, double lenZ) {
    m_lenX = lenX;
    m_lenY = lenY;
    m_lenZ = lenZ;
...
void ChElementHexaANCF_3843_MR_V7::SetMaterial(std::shared_ptr<ChMaterialHexaANCF_MR> brick_mat) {
...
ChMatrix33<> ChElementHexaANCF_3843_MR_V7::GetGreenLagrangeStrain(const double xi, const double eta, const double zeta) {
...
ChMatrix33<> ChElementHexaANCF_3843_MR_V7::GetPK2Stress(const double xi, const double eta, const double zeta) {
    MatrixNx3c Sxi_D;  // Matrix of normalized shape function derivatives
    Calc_Sxi_D(Sxi_D, xi, eta, zeta);
...
double ChElementHexaANCF_3843_MR_V7::GetVonMissesStress(const double xi, const double eta, const double zeta) {
    MatrixNx3c Sxi_D;  // Matrix of normalized shape function derivatives
    Calc_Sxi_D(Sxi_D, xi, eta, zeta);
...
void ChElementHexaANCF_3843_MR_V7::SetupInitial(ChSystem* system) {
...
void ChElementHexaANCF_3843_MR_V7::GetStateBlock(ChVectorDynamic<>& mD) {
...
void ChElementHexaANCF_3843_MR_V7::Update() {
    ChElementGeneric::Update();
}

// Return the mass matrix in full sparse form.

void ChElementHexaANCF_3843_MR_V7::ComputeMmatrixGlobal(ChMatrixRef M) {
    M.setZero();
...
void ChElementHexaANCF_3843_MR_V7::ComputeNodalMass() {
...
void ChElementHexaANCF_3843_MR_V7::ComputeInternalForces(ChVectorDynamic<>& Fi) {
...
void ChElementHexaANCF_3843_MR_V7::ComputeKRMmatricesGlobal(ChMatrixRef H, double Kfactor, double Rfactor, double Mfactor) {
...
void ChElementHexaANCF_3843_MR_V7::ComputeGravityForces(ChVectorDynamic<>& Fg, const ChVector<>& G_acc) {
...
void ChElementHexaANCF_3843_MR_V7::EvaluateElementFrame(const double xi,
                                                  const double eta,
                                                  const double zeta,
                                                  ChVector<>& point,
                                                  ChQuaternion<>& rot) {
...
void ChElementHexaANCF_3843_MR_V7::EvaluateElementPoint(const double xi,
                                                  const double eta,
                                                  const double zeta,
                                                  ChVector<>& point) {
    VectorN Sxi_compact;
...
void ChElementHexaANCF_3843_MR_V7::EvaluateElementVel(double xi, double eta, const double zeta, ChVector<>& Result) {
    VectorN Sxi_compact;
    Calc_Sxi_compact(Sxi_compact, xi, eta, zeta);
...
void ChElementHexaANCF_3843_MR_V7::LoadableGetStateBlock_x(int block_offset, ChState& mD) {
...
void ChElementHexaANCF_3843_MR_V7::LoadableGetStateBlock_w(int block_offset, ChStateDelta& mD) {
...
void ChElementHexaANCF_3843_MR_V7::LoadableStateIncrement(const unsigned int off_x,
                                                    ChState& x_new,
                                                    const ChState& x,
...
void ChElementHexaANCF_3843_MR_V7::LoadableGetVariables(std::vector<ChVariables*>& mvars) {
...
void ChElementHexaANCF_3843_MR_V7::ComputeNF(
...
double ChElementHexaANCF_3843_MR_V7::GetDensity() {
...
void ChElementHexaANCF_3843_MR_V7::ComputeMassMatrixAndGravityForce() {
...
void ChElementHexaANCF_3843_MR_V7::PrecomputeInternalForceMatricesWeights() {
    ChQuadratureTables* GQTable = GetStaticGQTables();
...
void ChElementHexaANCF_3843_MR_V7::ComputeInternalForceDamping(ChVectorDynamic<>& Fi) {
...
void ChElementHexaANCF_3843_MR_V7::ComputeInternalForceNoDamping(ChVectorDynamic<>& Fi) {
    assert(Fi.size() == 3 * NSF);
...
void ChElementHexaANCF_3843_MR_V7::ComputeInternalJacobianDamping(ChMatrixRef H, double Kfactor, double Rfactor, double Mfactor) {
    ...
    ArrayNIP ScaleNLKV_11cFdot = CInv00*CInv00;
    ArrayNIP ScaleNLKV_22cFdot = CInv01*CInv01;
    ArrayNIP ScaleNLKV_33cFdot = CInv02*CInv02;
    ArrayNIP ScaleNLKV_12cFdot = CInv00*CInv01;
    ArrayNIP ScaleNLKV_13cFdot = CInv00*CInv02;
    ArrayNIP ScaleNLKV_23cFdot = CInv01*CInv02;
    ArrayNIP ScaleNLKV_11cF = KR * ScaleNLKV_11cFdot;
    ArrayNIP ScaleNLKV_22cF = 4.0 * KK * (C22*EdotC1_CInvC1 - C02 * EdotC3_CInvC1) + KR * ScaleNLKV_22cFdot;
    ArrayNIP ScaleNLKV_33cF = 4.0 * KK * (C11*EdotC1_CInvC1 - C01 * EdotC2_CInvC1) + KR * ScaleNLKV_33cFdot;
    ArrayNIP ScaleNLKV_12cF = 2.0 * KK * (C12*EdotC3_CInvC1 - C22 * EdotC2_CInvC1) + KR * ScaleNLKV_12cFdot;
    ArrayNIP ScaleNLKV_13cF = 2.0 * KK * (C12*EdotC2_CInvC1 - C11 * EdotC3_CInvC1) + KR * ScaleNLKV_13cFdot;
    ArrayNIP ScaleNLKV_23cF = 2.0 * KK * (C01*EdotC3_CInvC1 + C02 * EdotC2_CInvC1 - 2.0 * C12*EdotC1_CInvC1) + KR * ScaleNLKV_23cFdot;
    ...
    ScaleNLKV_11cFdot = CInv01*CInv01;
    ScaleNLKV_22cFdot = CInv11*CInv11;
    ScaleNLKV_33cFdot = CInv12*CInv12;
    ScaleNLKV_12cFdot = CInv01*CInv11;
    ScaleNLKV_13cFdot = CInv01*CInv12;
    ScaleNLKV_23cFdot = CInv11*CInv12;
    ScaleNLKV_11cF = 4.0 * KK * (C22*EdotC2_CInvC2 - C12 * EdotC3_CInvC2) + KR * ScaleNLKV_11cFdot;
    ScaleNLKV_22cF = KR * ScaleNLKV_22cFdot;
    ScaleNLKV_33cF = 4.0 * KK * (C00*EdotC2_CInvC2 - C01 * EdotC1_CInvC2) + KR * ScaleNLKV_33cFdot;
    ScaleNLKV_12cF = 2.0 * KK * (C02*EdotC3_CInvC2 - C22 * EdotC1_CInvC2) + KR * ScaleNLKV_12cFdot;
    ScaleNLKV_13cF = 2.0 * KK * (C01*EdotC3_CInvC2 + C12 * EdotC1_CInvC2 - 2.0 * C02*EdotC2_CInvC2) + KR * ScaleNLKV_13cFdot;
    ScaleNLKV_23cF = 2.0 * KK * (C02*EdotC1_CInvC2 - C00 * EdotC3_CInvC2) + KR * ScaleNLKV_23cFdot;
    ScaleNLKV_11cFdot *= KK;
    ScaleNLKV_22cFdot *= KK;
    ScaleNLKV_33cFdot *= KK;
    ScaleNLKV_12cFdot *= KK;
    ...
    ScaleNLKV_11cFdot = CInv02*CInv02;
    ScaleNLKV_22cFdot = CInv12*CInv12;
    ScaleNLKV_33cFdot = CInv22*CInv22;
    ScaleNLKV_12cFdot = CInv02*CInv12;
    ScaleNLKV_13cFdot = CInv02*CInv22;
    ScaleNLKV_23cFdot = CInv12*CInv22;
    ScaleNLKV_11cF = 4.0 * KK * (C11*EdotC3_CInvC3 - C12 * EdotC2_CInvC3) + KR * ScaleNLKV_11cFdot;
    ScaleNLKV_22cF = 4.0 * KK * (C00*EdotC3_CInvC3 - C02 * EdotC1_CInvC3) + KR * ScaleNLKV_22cFdot;
    ScaleNLKV_33cF = KR * ScaleNLKV_33cFdot;
    ScaleNLKV_12cF = 2.0 * KK * (C02*EdotC2_CInvC3 + C12 * EdotC1_CInvC3 - 2.0 * C01*EdotC3_CInvC3) + KR * ScaleNLKV_12cFdot;
    ScaleNLKV_13cF = 2.0 * KK * (C01*EdotC2_CInvC3 - C11 * EdotC1_CInvC3) + KR * ScaleNLKV_13cFdot;
    ScaleNLKV_23cF = 2.0 * KK * (C01*EdotC1_CInvC3 - C00 * EdotC2_CInvC3) + KR * ScaleNLKV_23cFdot;
    ScaleNLKV_11cFdot *= KK;
    ScaleNLKV_22cFdot *= KK;
    ScaleNLKV_33cFdot *= KK;
    ScaleNLKV_12cFdot *= KK;
    ...
    ScaleNLKV_11cFdot = CInv01*CInv02;
    ScaleNLKV_22cFdot = CInv11*CInv12;
    ScaleNLKV_33cFdot = CInv12*CInv22;
    ScaleNLKV_12cFdot = 0.5 * (CInv01*CInv12 + CInv11 * CInv02);
    ScaleNLKV_13cFdot = 0.5 * (CInv01*CInv22 + CInv02 * CInv12);
    ScaleNLKV_23cFdot = 0.5 * (CInv12*CInv12 + CInv11 * CInv22);
    ScaleNLKV_11cF = 2.0 * KK * (C22*EdotC2_CInvC3 + C11 * EdotC3_CInvC2 - C12 * (EdotC2_CInvC2 + EdotC3_CInvC3)) + KR * ScaleNLKV_11cFdot;
    ScaleNLKV_22cF = 2.0 * KK * (C00*EdotC3_CInvC2 - C02 * EdotC1_CInvC2) + KR * ScaleNLKV_22cFdot;
    ScaleNLKV_33cF = 2.0 * KK * (C00*EdotC2_CInvC3 - C01 * EdotC1_CInvC3) + KR * ScaleNLKV_33cFdot;
    ScaleNLKV_12cF = KK * (C02*(EdotC2_CInvC2 + EdotC3_CInvC3) + C12 * EdotC1_CInvC2 - 2.0 * C01*EdotC3_CInvC2 - C22 * EdotC1_CInvC3) + KR * ScaleNLKV_12cFdot;
    ScaleNLKV_13cF = KK * (C01*(EdotC2_CInvC2 + EdotC3_CInvC3) + C12 * EdotC1_CInvC3 - 2.0 * C02*EdotC2_CInvC3 - C11 * EdotC1_CInvC2) + KR * ScaleNLKV_13cFdot;
    ScaleNLKV_23cF = KK * (C01*EdotC1_CInvC2 + C02 * EdotC1_CInvC3 - C00 * (EdotC2_CInvC2 + EdotC3_CInvC3)) + KR * ScaleNLKV_23cFdot;
    ScaleNLKV_11cFdot *= KK;
    ScaleNLKV_22cFdot *= KK;
    ScaleNLKV_33cFdot *= KK;
    ScaleNLKV_12cFdot *= KK;
    ...
    ScaleNLKV_11cFdot = CInv00*CInv02;
    ScaleNLKV_22cFdot = CInv01*CInv12;
    ScaleNLKV_33cFdot = CInv02*CInv22;
    ScaleNLKV_12cFdot = 0.5 * (CInv00*CInv12 + CInv01 * CInv02);
    ScaleNLKV_13cFdot = 0.5 * (CInv00*CInv22 + CInv02 * CInv02);
    ScaleNLKV_23cFdot = 0.5 * (CInv01*CInv22 + CInv02 * CInv12);
    ScaleNLKV_11cF = 2.0 * KK * (C11*EdotC3_CInvC1 - C12 * EdotC2_CInvC1) + KR * ScaleNLKV_11cFdot;
    ScaleNLKV_22cF = 2.0 * KK * (C00*EdotC3_CInvC1 + C22 * EdotC1_CInvC3 - C02 * (EdotC1_CInvC1 + EdotC3_CInvC3)) + KR * ScaleNLKV_22cFdot;
    ScaleNLKV_33cF = 2.0 * KK * (C11*EdotC1_CInvC3 - C01 * EdotC2_CInvC3) + KR * ScaleNLKV_33cFdot;
    ScaleNLKV_12cF = KK * (C02*EdotC2_CInvC1 + C12 * (EdotC1_CInvC1 + EdotC3_CInvC3) - 2.0 * C01*EdotC3_CInvC1 - C22 * EdotC2_CInvC3) + KR * ScaleNLKV_12cFdot;
    ScaleNLKV_13cF = KK * (C01*EdotC2_CInvC1 + C12 * EdotC2_CInvC3 - C11 * (EdotC1_CInvC1 + EdotC3_CInvC3)) + KR * ScaleNLKV_13cFdot;
    ScaleNLKV_23cF = KK * (C01*(EdotC1_CInvC1 + EdotC3_CInvC3) + C02 * EdotC2_CInvC3 - 2.0 * C12*EdotC1_CInvC3 - C00 * EdotC2_CInvC1) + KR * ScaleNLKV_23cFdot;
    ScaleNLKV_11cFdot *= KK;
    ScaleNLKV_22cFdot *= KK;
    ScaleNLKV_33cFdot *= KK;
    ScaleNLKV_12cFdot *= KK;
    ...
    ScaleNLKV_11cFdot = CInv00*CInv01;
    ScaleNLKV_22cFdot = CInv01*CInv11;
    ScaleNLKV_33cFdot = CInv02*CInv12;
    ScaleNLKV_12cFdot = 0.5 * (CInv00*CInv11 + CInv01 * CInv01);
    ScaleNLKV_13cFdot = 0.5 * (CInv00*CInv12 + CInv01 * CInv02);
    ScaleNLKV_23cFdot = 0.5 * (CInv01*CInv12 + CInv11 * CInv02);
    ScaleNLKV_11cF = 2.0 * KK * (C22*EdotC2_CInvC1 - C12 * EdotC3_CInvC1) + KR * ScaleNLKV_11cFdot;
    ScaleNLKV_22cF = 2.0 * KK * (C22*EdotC1_CInvC2 - C02 * EdotC3_CInvC2) + KR * ScaleNLKV_22cFdot;
    ScaleNLKV_33cF = 2.0 * KK * (C00*EdotC2_CInvC1 + C11 * EdotC1_CInvC2 - C01 * (EdotC1_CInvC1 + EdotC2_CInvC2)) + KR * ScaleNLKV_33cFdot;
    ScaleNLKV_12cF = KK * (C02*EdotC3_CInvC1 + C12 * EdotC3_CInvC2 - C22 * (EdotC1_CInvC1 + EdotC2_CInvC2)) + KR * ScaleNLKV_12cFdot;
    ScaleNLKV_13cF = KK * (C01*EdotC3_CInvC1 + C12 * (EdotC1_CInvC1 + EdotC2_CInvC2) - 2.0 * C02*EdotC2_CInvC1 - C11 * EdotC3_CInvC2) + KR * ScaleNLKV_13cFdot;
    ScaleNLKV_23cF = KK * (C01*EdotC3_CInvC2 + C02 * (EdotC1_CInvC1 + EdotC2_CInvC2) - 2.0 * C12*EdotC1_CInvC2 - C00 * EdotC3_CInvC1) + KR * ScaleNLKV_23cFdot;
    ScaleNLKV_11cFdot *= KK;
    ScaleNLKV_22cFdot *= KK;
    ScaleNLKV_33cFdot *= KK;
    ScaleNLKV_12cFdot *= KK;
...
void ChElementHexaANCF_3843_MR_V7::ComputeInternalJacobianNoDamping(ChMatrixRef H, double Kfactor, double Mfactor) {
    assert((H.rows() == 3 * NSF) && (H.cols() == 3 * NSF));
...
void ChElementHexaANCF_3843_MR_V7::Calc_Sxi_compact(VectorN& Sxi_compact, double xi, double eta, double zeta) {
    Sxi_compact(0) =
...
void ChElementHexaANCF_3843_MR_V7::Calc_Sxi_xi_compact(VectorN& Sxi_xi_compact, double xi, double eta, double zeta) {
...
void ChElementHexaANCF_3843_MR_V7::Calc_Sxi_eta_compact(VectorN& Sxi_eta_compact, double xi, double eta, double zeta) {
...
void ChElementHexaANCF_3843_MR_V7::Calc_Sxi_zeta_compact(VectorN& Sxi_zeta_compact, double xi, double eta, double zeta) {
...
void ChElementHexaANCF_3843_MR_V7::Calc_Sxi_D(MatrixNx3c& Sxi_D, double xi, double eta, double zeta) {
    VectorN Sxi_D_col;
...
void ChElementHexaANCF_3843_MR_V7::CalcCoordVector(Vector3N& e) {
...
void ChElementHexaANCF_3843_MR_V7::CalcCoordMatrix(Matrix3xN& ebar) {
...
void ChElementHexaANCF_3843_MR_V7::CalcCoordDerivVector(Vector3N& edot) {
...
void ChElementHexaANCF_3843_MR_V7::CalcCoordDerivMatrix(Matrix3xN& ebardot) {
...
void ChElementHexaANCF_3843_MR_V7::CalcCombinedCoordMatrix(MatrixNx6& ebar_ebardot) {
...
void ChElementHexaANCF_3843_MR_V7::Calc_J_0xi(ChMatrix33<double>& J_0xi, double xi, double eta, double zeta) {
    MatrixNx3c Sxi_D;
    Calc_Sxi_D(Sxi_D, xi, eta, zeta);
...
double ChElementHexaANCF_3843_MR_V7::Calc_det_J_0xi(double xi, double eta, double zeta) {
...
ChQuadratureTables static_tables_3843_MR_V7(1, CH_QUADRATURE_STATIC_TABLES);
//#endif // !CH_QUADRATURE_STATIC_TABLES

ChQuadratureTables* ChElementHexaANCF_3843_MR_V7::GetStaticGQTables() {
    return &static_tables_3843_MR_V7;
}
