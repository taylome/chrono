...
#ifndef CHELEMENTSHELLANCF3443MLTR05_H
#define CHELEMENTSHELLANCF3443MLTR05_H
...
class ChApi ChMaterialShellANCF_3443ML_TR05 {
  public:
    /// Construct an isotropic material.
    ChMaterialShellANCF_3443ML_TR05(double rho,        ///< material density
...
class ChApi ChElementShellANCF_3443ML_TR05 : public ChElementShell, public ChLoadableUV, public ChLoadableUVW {
  public:
    ...
    ChElementShellANCF_3443ML_TR05();
    ~ChElementShellANCF_3443ML_TR05() {}
    ...
    public:
        ...
        std::shared_ptr<ChMaterialShellANCF_3443ML_TR05> GetMaterial() const { return m_material; }

    private:
        /// Private constructor (a layer can be created only by adding it to an element)
        Layer(ChElementShellANCF_3443ML_TR05* element,                 ///< containing element
            double thickness,                              ///< layer thickness
            double theta,                                  ///< fiber angle
            std::shared_ptr<ChMaterialShellANCF_3443ML_TR05> material  ///< layer material
        );

        ChElementShellANCF_3443ML_TR05* m_element;                  ///< containing ANCF shell element
        std::shared_ptr<ChMaterialShellANCF_3443ML_TR05> m_material;  ///< layer material
    ...
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
            ...
            friend class ChElementShellANCF_3443ML_TR05;
    };
