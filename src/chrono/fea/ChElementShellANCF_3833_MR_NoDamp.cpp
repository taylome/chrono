...
ChMatrix33d ChElementShellANCF_3833_MR_NoDamp::GetGreenLagrangeStrain(const double xi,
                                                                  const double eta,
                                                                  const double zeta) {
...
ChMatrix33d ChElementShellANCF_3833_MR_NoDamp::GetPK2Stress(const double layer,
                                                        const double xi,
                                                        const double eta,
...
void ChElementShellANCF_3833_MR_NoDamp::ComputeGravityForces(ChVectorDynamic<>& Fg, const ChVector3d& G_acc) {
...
void ChElementShellANCF_3833_MR_NoDamp::EvaluateSectionPoint(const double xi, const double eta, ChVector3d& point) {
    VectorN Sxi_compact;
    Calc_Sxi_compact(Sxi_compact, xi, eta, 0, m_thicknessZ, m_midsurfoffset);
...
void ChElementShellANCF_3833_MR_NoDamp::EvaluateSectionVelNorm(const double xi, const double eta, ChVector3d& Result) {
    VectorN Sxi_compact;
    Calc_Sxi_compact(Sxi_compact, xi, eta, 0, m_thicknessZ, m_midsurfoffset);
...
void ChElementShellANCF_3833_MR_NoDamp::LoadableGetStateBlockPosLevel(int block_offset, ChState& mD) {
...
void ChElementShellANCF_3833_MR_NoDamp::LoadableGetStateBlockVelLevel(int block_offset, ChStateDelta& mD) {
...
ChVector3d ChElementShellANCF_3833_MR_NoDamp::ComputeNormal(const double xi, const double eta) {
...
void ChElementShellANCF_3833_MR_NoDamp::CalcCoordDtVector(Vector3N& edot) {
...
void ChElementShellANCF_3833_MR_NoDamp::CalcCoordDtMatrix(Matrix3xN& ebardot) {
...
void ChElementShellANCF_3833_MR_NoDamp::Calc_J_0xi(ChMatrix33d& J_0xi,
                                              double xi,
                                              double eta,
                                              double zeta,
                                              double thickness,
...
void ChElementShellANCF_3833_MR_NoDamp::RotateReorderStiffnessMatrix(ChMatrix66d& D, double theta) {
