...
// =============================================================================
// Higher order ANCF shell element with 8 nodes. Description of this element (3833_MR_NoDamp) and its internal forces may be
...
// Constructor
// ------------------------------------------------------------------------------
ChElementShellANCF_3833_MR_NoDamp::ChElementShellANCF_3833_MR_NoDamp()
...
void ChElementShellANCF_3833_MR_NoDamp::SetNodes(std::shared_ptr<ChNodeFEAxyzDD> nodeA,
...
void ChElementShellANCF_3833_MR_NoDamp::AddLayer(double thickness,
...
void ChElementShellANCF_3833_MR_NoDamp::SetDimensions(double lenX, double lenY) {
    m_lenX = lenX;
    m_lenY = lenY;
}
...
void ChElementShellANCF_3833_MR_NoDamp::SetMidsurfaceOffset(const double offset) {
...
ChMatrix33<> ChElementShellANCF_3833_MR_NoDamp::GetGreenLagrangeStrain(const double xi,
                                                                  const double eta,
                                                                  const double zeta) {
...
ChMatrix33<> ChElementShellANCF_3833_MR_NoDamp::GetPK2Stress(const double layer,
                                                        const double xi,
                                                        const double eta,
...
double ChElementShellANCF_3833_MR_NoDamp::GetVonMissesStress(const double layer,
                                                        const double xi,
                                                        const double eta,
                                                        const double layer_zeta) {
    MatrixNx3c Sxi_D;  // Matrix of normalized shape function derivatives
...
void ChElementShellANCF_3833_MR_NoDamp::SetupInitial(ChSystem* system) {
...
void ChElementShellANCF_3833_MR_NoDamp::GetStateBlock(ChVectorDynamic<>& mD) {
...
void ChElementShellANCF_3833_MR_NoDamp::Update() {
    ChElementGeneric::Update();
}

// Return the mass matrix in full sparse form.

void ChElementShellANCF_3833_MR_NoDamp::ComputeMmatrixGlobal(ChMatrixRef M) {
    M.setZero();
...
void ChElementShellANCF_3833_MR_NoDamp::ComputeNodalMass() {
...
void ChElementShellANCF_3833_MR_NoDamp::ComputeInternalForces(ChVectorDynamic<>& Fi) {
...
void ChElementShellANCF_3833_MR_NoDamp::ComputeKRMmatricesGlobal(ChMatrixRef H,
    double Kfactor,
    double Rfactor,
    double Mfactor) {
...
void ChElementShellANCF_3833_MR_NoDamp::ComputeGravityForces(ChVectorDynamic<>& Fg, const ChVector<>& G_acc) {
...
void ChElementShellANCF_3833_MR_NoDamp::EvaluateSectionFrame(const double xi,
                                                        const double eta,
                                                        ChVector<>& point,
                                                        ChQuaternion<>& rot) {
    VectorN Sxi_compact;
...
void ChElementShellANCF_3833_MR_NoDamp::EvaluateSectionPoint(const double xi, const double eta, ChVector<>& point) {
    VectorN Sxi_compact;
    Calc_Sxi_compact(Sxi_compact, xi, eta, 0, m_thicknessZ, m_midsurfoffset);
...
void ChElementShellANCF_3833_MR_NoDamp::EvaluateSectionVelNorm(const double xi, const double eta, ChVector<>& Result) {
    VectorN Sxi_compact;
    Calc_Sxi_compact(Sxi_compact, xi, eta, 0, m_thicknessZ, m_midsurfoffset);
...
void ChElementShellANCF_3833_MR_NoDamp::LoadableGetStateBlock_x(int block_offset, ChState& mD) {
...
void ChElementShellANCF_3833_MR_NoDamp::LoadableGetStateBlock_w(int block_offset, ChStateDelta& mD) {
...
void ChElementShellANCF_3833_MR_NoDamp::LoadableStateIncrement(const unsigned int off_x,
                                                          ChState& x_new,
                                                          const ChState& x,
...
void ChElementShellANCF_3833_MR_NoDamp::LoadableGetVariables(std::vector<ChVariables*>& mvars) {
...
void ChElementShellANCF_3833_MR_NoDamp::ComputeNF(
...
double ChElementShellANCF_3833_MR_NoDamp::GetDensity() {
...
ChVector<> ChElementShellANCF_3833_MR_NoDamp::ComputeNormal(const double xi, const double eta) {
...
void ChElementShellANCF_3833_MR_NoDamp::ComputeMassMatrixAndGravityForce() {
...
void ChElementShellANCF_3833_MR_NoDamp::PrecomputeInternalForceMatricesWeights() {
    ChQuadratureTables* GQTable = GetStaticGQTables();
...
void ChElementShellANCF_3833_MR_NoDamp::ComputeInternalForceDamping(ChVectorDynamic<>& Fi) {
...
void ChElementShellANCF_3833_MR_NoDamp::ComputeInternalForceNoDamping(ChVectorDynamic<>& Fi) {
    assert(Fi.size() == 3 * NSF);
...
void ChElementShellANCF_3833_MR_NoDamp::ComputeInternalJacobianDamping(ChMatrixRef H, double Kfactor, double Rfactor, double Mfactor) {
    ...
    for (size_t kl = 0; kl < m_numLayers; kl++) {
        ...
        ArrayNIP s1 = (-Kfactor * -4.0 / 3.0 * c10) * detF_m2_3 / detF * m_kGQ.block<1, NIP>(0, kl * NIP);
        ArrayNIP s2 = (-Kfactor * 4.0 * c01) * detF_m2_3*detF_m2_3 * m_kGQ.block<1, NIP>(0, kl * NIP);
        ...
        //Calculate the Contribution from the dC11 / de terms
        {
            ...
            for (auto i = 0; i < NSF; i++) {
                ...
                Right.block<1, NIP>(3 * i + 0, 0).array() = m_SD.block<1, NIP>(i + kl * NSF, 0 * NIP).array() * S1A +
                    m_SD.block<1, NIP>(i + kl * NSF, 1 * NIP).array() * S2A +
                    m_SD.block<1, NIP>(i + kl * NSF, 2 * NIP).array() * S3A;
                Right.block<1, NIP>(3 * i + 1, 0).array() = m_SD.block<1, NIP>(i + kl * NSF, 0 * NIP).array() * S1B +
                    m_SD.block<1, NIP>(i + kl * NSF, 1 * NIP).array() * S2B +
                    m_SD.block<1, NIP>(i + kl * NSF, 2 * NIP).array() * S3B;
                Right.block<1, NIP>(3 * i + 2, 0).array() = m_SD.block<1, NIP>(i + kl * NSF, 0 * NIP).array() * S1C +
        ...
        {
            ArrayNIP s4 = -Kfactor * k * m_kGQ.block<1, NIP>(0, kl * NIP) + (-5.0 / 6.0*s1*I1 + 7.0 / 6.0*s3*I2) / detF;
        ...
        ArrayNIP s7 = (-Kfactor * 2.0 * c10)*m_kGQ.block<1, NIP>(0, kl * NIP)*detF_m2_3 - s5 * I1;
        ArrayNIP s8 = -Kfactor * m_kGQ.block<1, NIP>(0, kl * NIP) * (k * (detF - 1.0) - 2.0 / 3.0 * c10 * I1*detF_m2_3 / detF - 4.0 / 3.0 * c01 * I2*detF_m2_3*detF_m2_3 / detF);
        ...
        for (unsigned int i = 0; i < (NSF - 1); i++) {
            ...
            scaled_SD_row_i.segment(0 * NIP, NIP).array() = m_SD.block<1, NIP>(i + kl * NSF, 0 * NIP).array() * sC11 +
                m_SD.block<1, NIP>(i + kl * NSF, 1 * NIP).array() * sC12 +
                m_SD.block<1, NIP>(i + kl * NSF, 2 * NIP).array() * sC13;
            scaled_SD_row_i.segment(1 * NIP, NIP).array() = m_SD.block<1, NIP>(i + kl * NSF, 0 * NIP).array() * sC12 +
                m_SD.block<1, NIP>(i + kl * NSF, 1 * NIP).array() * sC22 +
                m_SD.block<1, NIP>(i + kl * NSF, 2 * NIP).array() * sC23;
            scaled_SD_row_i.segment(2 * NIP, NIP).array() = m_SD.block<1, NIP>(i + kl * NSF, 0 * NIP).array() * sC13 +
                m_SD.block<1, NIP>(i + kl * NSF, 1 * NIP).array() * sC23 +
                m_SD.block<1, NIP>(i + kl * NSF, 2 * NIP).array() * sC33;

            ChVectorN<double, 3 * NIP> scaled_B2_row_i;
            scaled_B2_row_i.segment(0 * NIP, NIP).array() = m_SD.block<1, NIP>(i + kl * NSF, 1 * NIP).array()*sF33 - m_SD.block<1, NIP>(i + kl * NSF, 2 * NIP).array()*sF32;
            scaled_B2_row_i.segment(1 * NIP, NIP).array() = m_SD.block<1, NIP>(i + kl * NSF, 2 * NIP).array()*sF31 - m_SD.block<1, NIP>(i + kl * NSF, 0 * NIP).array()*sF33;
            scaled_B2_row_i.segment(2 * NIP, NIP).array() = m_SD.block<1, NIP>(i + kl * NSF, 0 * NIP).array()*sF32 - m_SD.block<1, NIP>(i + kl * NSF, 1 * NIP).array()*sF31;

            ChVectorN<double, 3 * NIP> scaled_B3_row_i;
            scaled_B3_row_i.segment(0 * NIP, NIP).array() = m_SD.block<1, NIP>(i + kl * NSF, 2 * NIP).array()*sF22 - m_SD.block<1, NIP>(i + kl * NSF, 1 * NIP).array()*sF23;
            scaled_B3_row_i.segment(1 * NIP, NIP).array() = m_SD.block<1, NIP>(i + kl * NSF, 0 * NIP).array()*sF23 - m_SD.block<1, NIP>(i + kl * NSF, 2 * NIP).array()*sF21;
            scaled_B3_row_i.segment(2 * NIP, NIP).array() = m_SD.block<1, NIP>(i + kl * NSF, 1 * NIP).array()*sF21 - m_SD.block<1, NIP>(i + kl * NSF, 0 * NIP).array()*sF22;

            ChVectorN<double, 3 * NIP> scaled_B4_row_i;
            scaled_B4_row_i.segment(0 * NIP, NIP).array() = m_SD.block<1, NIP>(i + kl * NSF, 1 * NIP).array()*sF13 - m_SD.block<1, NIP>(i + kl * NSF, 2 * NIP).array()*sF12;
            scaled_B4_row_i.segment(1 * NIP, NIP).array() = m_SD.block<1, NIP>(i + kl * NSF, 2 * NIP).array()*sF11 - m_SD.block<1, NIP>(i + kl * NSF, 0 * NIP).array()*sF13;
            scaled_B4_row_i.segment(2 * NIP, NIP).array() = m_SD.block<1, NIP>(i + kl * NSF, 0 * NIP).array()*sF12 - m_SD.block<1, NIP>(i + kl * NSF, 1 * NIP).array()*sF11;

            double d_diag = (scaled_SD_row_i.dot(m_SD.row(i + kl * NSF)));
            ...
            for (unsigned int j = (i + 1); j < NSF; j++) {
                double d = (scaled_SD_row_i.dot(m_SD.row(j + kl * NSF)));
                double B2 = scaled_B2_row_i.dot(m_SD.row(j + kl * NSF));
                double B3 = scaled_B3_row_i.dot(m_SD.row(j + kl * NSF));
                double B4 = scaled_B4_row_i.dot(m_SD.row(j + kl * NSF));
        ...
        ChVectorN<double, 3 * NIP> scaled_SD_row_i;
        scaled_SD_row_i.segment(0 * NIP, NIP).array() = m_SD.block<1, NIP>(NSF - 1 + kl * NSF, 0 * NIP).array() * sC11 +
            m_SD.block<1, NIP>(NSF - 1 + kl * NSF, 1 * NIP).array() * sC12 +
            m_SD.block<1, NIP>(NSF - 1 + kl * NSF, 2 * NIP).array() * sC13;
        scaled_SD_row_i.segment(1 * NIP, NIP).array() = m_SD.block<1, NIP>(NSF - 1 + kl * NSF, 0 * NIP).array() * sC12 +
            m_SD.block<1, NIP>(NSF - 1 + kl * NSF, 1 * NIP).array() * sC22 +
            m_SD.block<1, NIP>(NSF - 1 + kl * NSF, 2 * NIP).array() * sC23;
        scaled_SD_row_i.segment(2 * NIP, NIP).array() = m_SD.block<1, NIP>(NSF - 1 + kl * NSF, 0 * NIP).array() * sC13 +
            m_SD.block<1, NIP>(NSF - 1 + kl * NSF, 1 * NIP).array() * sC23 +
            m_SD.block<1, NIP>(NSF - 1 + kl * NSF, 2 * NIP).array() * sC33;

        double d_diag = (scaled_SD_row_i.dot(m_SD.row(NSF - 1 + kl * NSF)));
...
void ChElementShellANCF_3833_MR_NoDamp::ComputeInternalJacobianNoDamping(ChMatrixRef H, double Kfactor, double Mfactor) {
    assert((H.rows() == 3 * NSF) && (H.cols() == 3 * NSF));
...
void ChElementShellANCF_3833_MR_NoDamp::Calc_Sxi_compact(VectorN& Sxi_compact,
                                                    double xi,
                                                    double eta,
                                                    double zeta,
                                                    double thickness,
...
void ChElementShellANCF_3833_MR_NoDamp::Calc_Sxi_xi_compact(VectorN& Sxi_xi_compact,
                                                       double xi,
                                                       double eta,
                                                       double zeta,
                                                       double thickness,
...
void ChElementShellANCF_3833_MR_NoDamp::Calc_Sxi_eta_compact(VectorN& Sxi_eta_compact,
                                                        double xi,
                                                        double eta,
                                                        double zeta,
                                                        double thickness,
...
void ChElementShellANCF_3833_MR_NoDamp::Calc_Sxi_zeta_compact(VectorN& Sxi_zeta_compact,
                                                         double xi,
                                                         double eta,
                                                         double zeta,
                                                         double thickness,
...
void ChElementShellANCF_3833_MR_NoDamp::Calc_Sxi_D(MatrixNx3c& Sxi_D,
                                              double xi,
                                              double eta,
                                              double zeta,
                                              double thickness,
...
void ChElementShellANCF_3833_MR_NoDamp::CalcCoordVector(Vector3N& e) {
...
void ChElementShellANCF_3833_MR_NoDamp::CalcCoordMatrix(Matrix3xN& ebar) {
...
void ChElementShellANCF_3833_MR_NoDamp::CalcCoordDerivVector(Vector3N& edot) {
...
void ChElementShellANCF_3833_MR_NoDamp::CalcCoordDerivMatrix(Matrix3xN& ebardot) {
...
void ChElementShellANCF_3833_MR_NoDamp::CalcCombinedCoordMatrix(Matrix6xN& ebar_ebardot) {
...
void ChElementShellANCF_3833_MR_NoDamp::Calc_J_0xi(ChMatrix33<double>& J_0xi,
                                              double xi,
                                              double eta,
                                              double zeta,
                                              double thickness,
...
double ChElementShellANCF_3833_MR_NoDamp::Calc_det_J_0xi(double xi,
                                                    double eta,
                                                    double zeta,
                                                    double thickness,
                                                    double zoffset) {
...
void ChElementShellANCF_3833_MR_NoDamp::RotateReorderStiffnessMatrix(ChMatrixNM<double, 6, 6>& D, double theta) {
...
ChQuadratureTables static_tables_3833_MR_NoDamp(1, CH_QUADRATURE_STATIC_TABLES);
//#endif // !CH_QUADRATURE_STATIC_TABLES

ChQuadratureTables* ChElementShellANCF_3833_MR_NoDamp::GetStaticGQTables() {
    return &static_tables_3833_MR_NoDamp;
}

////////////////////////////////////////////////////////////////

// ============================================================================
// Implementation of ChElementShellANCF_3833_MR_NoDamp::Layer methods
// ============================================================================

// Private constructor (a layer can be created only by adding it to an element)

ChElementShellANCF_3833_MR_NoDamp::Layer::Layer(double thickness,
                                           std::shared_ptr<ChMaterialShellANCF_MR> material)
