...
#ifndef CHELEMENTBEAMANCF3333TR07SGQ322_H
#define CHELEMENTBEAMANCF3333TR07SGQ322_H
...
class ChApi ChMaterialBeamANCF_3333_TR07S_GQ322 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_3333_TR07S_GQ322(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_3333_TR07S_GQ322 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    ChElementBeamANCF_3333_TR07S_GQ322();
    ~ChElementBeamANCF_3333_TR07S_GQ322() {}
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_3333_TR07S_GQ322> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_3333_TR07S_GQ322> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_3333_TR07S_GQ322> m_material;  ///< beam material
    ...
    ChVectorN<double, 12> m_SPK2_0_D0_Block;  ///< Cached calculation for the 2nd PK2 Stresses - 1st Entry in Voigt
                                              ///< Notation for all the GQ Points for no Poisson Effect
    ChVectorN<double, 12> m_SPK2_1_D0_Block;  ///< Cached calculation for the 2nd PK2 Stresses - 2nd Entry in Voigt
                                              ///< Notation for all the GQ Points for no Poisson Effect
    ChVectorN<double, 12> m_SPK2_2_D0_Block;  ///< Cached calculation for the 2nd PK2 Stresses - 3rd Entry in Voigt
                                              ///< Notation for all the GQ Points for no Poisson Effect
    ChVectorN<double, 12> m_SPK2_3_D0_Block;  ///< Cached calculation for the 2nd PK2 Stresses - 4th Entry in Voigt
                                              ///< Notation for all the GQ Points for no Poisson Effect
    ChVectorN<double, 12> m_SPK2_4_D0_Block;  ///< Cached calculation for the 2nd PK2 Stresses - 5th Entry in Voigt
                                              ///< Notation for all the GQ Points for no Poisson Effect
    ChVectorN<double, 12> m_SPK2_5_D0_Block;  ///< Cached calculation for the 2nd PK2 Stresses - 6th Entry in Voigt
                                              ///< Notation for all the GQ Points for no Poisson Effect
    ChVectorN<double, 3> m_Sdiag_0_Dv_Block;  ///< Cached calculation for the 2nd PK2 Stresses - 1st Entry in Voigt
                                              ///< Notation for all the GQ Points with Poisson Effect
    ChVectorN<double, 3> m_Sdiag_1_Dv_Block;  ///< Cached calculation for the 2nd PK2 Stresses - 2nd Entry in Voigt
                                              ///< Notation for all the GQ Points with Poisson Effect
    ChVectorN<double, 3> m_Sdiag_2_Dv_Block;  ///< Cached calculation for the 2nd PK2 Stresses - 3rd Entry in Voigt
                                              ///< Notation for all the GQ Points with Poisson Effect
    ChVectorN<double, 45> m_MassMatrix; ///Mass Matrix in extra compact form (Upper Triangular Part only)
