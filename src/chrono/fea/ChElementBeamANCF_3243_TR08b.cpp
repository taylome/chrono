...
ChElementBeamANCF_3243_TR08b::ChElementBeamANCF_3243_TR08b()
...
void ChElementBeamANCF_3243_TR08b::SetNodes(std::shared_ptr<ChNodeFEAxyzDDD> nodeA,
...
void ChElementBeamANCF_3243_TR08b::SetupInitial(ChSystem* system) {
...
// State update.
void ChElementBeamANCF_3243_TR08b::Update() {
    ChElementGeneric::Update();
}

// Fill the D vector with the current field values at the element nodes.
void ChElementBeamANCF_3243_TR08b::GetStateBlock(ChVectorDynamic<>& mD) {
...
void ChElementBeamANCF_3243_TR08b::ComputeKRMmatricesGlobal(ChMatrixRef H,
                                                            double Kfactor,
                                                            double Rfactor,
                                                            double Mfactor) {
...
void ChElementBeamANCF_3243_TR08b::ComputeMmatrixGlobal(ChMatrixRef M) {
    M.setZero();
...
// -----------------------------------------------------------------------------
void ChElementBeamANCF_3243_TR08b::ComputeMassMatrixAndGravityForce(const ChVector<>& g_acc) {
...
void ChElementBeamANCF_3243_TR08b::PrecomputeInternalForceMatricesWeights() {
    ChQuadratureTables* GQTable = GetStaticGQTables();
...
void ChElementBeamANCF_3243_TR08b::ComputeNodalMass() {
...
void ChElementBeamANCF_3243_TR08b::SetAlphaDamp(double a) {
    m_Alpha = a;
    m_2Alpha = 2 * a;
...
void ChElementBeamANCF_3243_TR08b::ComputeInternalForces(ChVectorDynamic<>& Fi) {
...
void ChElementBeamANCF_3243_TR08b::ComputeInternalForcesAtState(ChVectorDynamic<>& Fi,
    ...
    ChVectorN<double, 4> Sdiag_0_Dv_Block;
    Sdiag_0_Dv_Block.noalias() =
        Dv(0, 0) * Ediag_0_Dv_Block + Dv(1, 0) * Ediag_1_Dv_Block + Dv(2, 0) * Ediag_2_Dv_Block;
    ChVectorN<double, 4> Sdiag_1_Dv_Block;
    Sdiag_1_Dv_Block.noalias() =
        Dv(0, 1) * Ediag_0_Dv_Block + Dv(1, 1) * Ediag_1_Dv_Block + Dv(2, 1) * Ediag_2_Dv_Block;
    ChVectorN<double, 4> Sdiag_2_Dv_Block;
    Sdiag_2_Dv_Block.noalias() =
        Dv(0, 2) * Ediag_0_Dv_Block + Dv(1, 2) * Ediag_1_Dv_Block + Dv(2, 2) * Ediag_2_Dv_Block;
...
void ChElementBeamANCF_3243_TR08b::ComputeInternalForcesAtStateNoDamping(ChVectorDynamic<>& Fi,
...
void ChElementBeamANCF_3243_TR08b::ComputeInternalJacobianDamping(ChMatrixRef& H,
                                                                  double Kfactor,
                                                                  double Rfactor,
                                                                  double Mfactor) {
    ChMatrixNM<double, 8, 6> ebar_ebardot;
...
void ChElementBeamANCF_3243_TR08b::ComputeInternalJacobianNoDamping(ChMatrixRef& H, double Kfactor, double Mfactor) {
    ChMatrixNM<double, 8, 3> e_bar;
    CalcCoordMatrix(e_bar);
...
void ChElementBeamANCF_3243_TR08b::ComputeInternalJacobians(ChMatrixNM<double, 24, 24>& JacobianMatrix,
                                                            double Kfactor,
                                                            double Rfactor) {
...
void ChElementBeamANCF_3243_TR08b::Calc_Sxi(ChMatrixNM<double, 3, 24>& Sxi, double xi, double eta, double zeta) {
...
// [s1; s2; s3; ...]
void ChElementBeamANCF_3243_TR08b::Calc_Sxi_compact(ChVectorN<double, 8>& Sxi_compact,
                                                    double xi,
                                                    double eta,
                                                    double zeta) {
...
void ChElementBeamANCF_3243_TR08b::Calc_Sxi_D(ChMatrixNMc<double, 8, 3>& Sxi_D, double xi, double eta, double zeta) {
...
void ChElementBeamANCF_3243_TR08b::CalcCoordMatrix(ChMatrixNMc<double, 8, 3>& e) {
...
void ChElementBeamANCF_3243_TR08b::CalcCoordMatrix(ChMatrixNM<double, 8, 3>& e) {
...
void ChElementBeamANCF_3243_TR08b::CalcCoordVector(ChVectorN<double, 24>& e) {
...
void ChElementBeamANCF_3243_TR08b::CalcCoordDerivMatrix(ChMatrixNMc<double, 8, 3>& edot) {
...
void ChElementBeamANCF_3243_TR08b::CalcCoordDerivVector(ChVectorN<double, 24>& edot) {
...
void ChElementBeamANCF_3243_TR08b::CalcCombinedCoordMatrix(ChMatrixNM<double, 8, 6>& ebar_ebardot) {
...
void ChElementBeamANCF_3243_TR08b::Calc_J_0xi(ChMatrix33<double>& J_0xi, double xi, double eta, double zeta) {
...
double ChElementBeamANCF_3243_TR08b::Calc_det_J_0xi(double xi, double eta, double zeta) {
    ChMatrixNMc<double, 8, 3> Sxi_D;
...
// -----------------------------------------------------------------------------
// ChVector<> ChElementBeamANCF_3243_TR08b::EvaluateBeamSectionStrains() {
...
//}
//
// void ChElementBeamANCF_3243_TR08b::EvaluateSectionDisplacement(const double u,
//                                                    const double v,
//                                                    ChVector<>& u_displ,
//                                                    ChVector<>& u_rotaz) {
...
void ChElementBeamANCF_3243_TR08b::EvaluateSectionFrame(const double xi, ChVector<>& point, ChQuaternion<>& rot) {
    ChMatrixNMc<double, 8, 3> e_bar;
    ChVectorN<double, 8> Sxi_compact;
    ChMatrixNMc<double, 8, 3> Sxi_D;
...
// void ChElementBeamANCF_3243_TR08b::EvaluateSectionPoint(const double u,
//                                             const double v,
//                                             ChVector<>& point) {
//    ChVector<> u_displ;
//
...
void ChElementBeamANCF_3243_TR08b::LoadableGetStateBlock_x(int block_offset, ChState& mD) {
...
void ChElementBeamANCF_3243_TR08b::LoadableGetStateBlock_w(int block_offset, ChStateDelta& mD) {
...
void ChElementBeamANCF_3243_TR08b::LoadableStateIncrement(const unsigned int off_x,
                                                          ChState& x_new,
                                                          const ChState& x,
...
// void ChElementBeamANCF_3243_TR08b::EvaluateSectionVelNorm(double U, ChVector<>& Result) {
//    ShapeVector N;
...
void ChElementBeamANCF_3243_TR08b::LoadableGetVariables(std::vector<ChVariables*>& mvars) {
...
void ChElementBeamANCF_3243_TR08b::ComputeNF(
...
double ChElementBeamANCF_3243_TR08b::GetDensity() {
    return GetMaterial()->Get_rho();
}

// Calculate tangent to the centerline at (U) coordinates.
ChVector<> ChElementBeamANCF_3243_TR08b::ComputeTangent(const double U) {
    ChMatrixNMc<double, 8, 3> e_bar;
    ChMatrixNMc<double, 8, 3> Sxi_D;
    ChVector<> r_xi;
...
ChQuadratureTables static_tables_2_TR08b(1, CH_QUADRATURE_STATIC_TABLES);
//#endif // !CH_QUADRATURE_STATIC_TABLES

ChQuadratureTables* ChElementBeamANCF_3243_TR08b::GetStaticGQTables() {
    return &static_tables_2_TR08b;
}

////////////////////////////////////////////////////////////////

// ============================================================================
// Implementation of ChMaterialBeamANCF_3243_TR08b methods
// ============================================================================

// Construct an isotropic material.
ChMaterialBeamANCF_3243_TR08b::ChMaterialBeamANCF_3243_TR08b(
...
// Poisson effect
void ChMaterialBeamANCF_3243_TR08b::Calc_D0_Dv(const ChVector<>& E,
                                               const ChVector<>& nu,
                                               const ChVector<>& G,
                                               double k1,
                                               double k2) {
