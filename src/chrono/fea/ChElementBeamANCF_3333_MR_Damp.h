...
#ifndef CHELEMENTBEAMANCF3333_MR_DAMP_H
#define CHELEMENTBEAMANCF3333_MR_DAMP_H
...
class ChApi ChElementBeamANCF_3333_MR_Damp : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    ChElementBeamANCF_3333_MR_Damp();
    ~ChElementBeamANCF_3333_MR_Damp() {}
