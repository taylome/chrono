...
// =============================================================================
// Material for ANCF beam Element for a Two term Mooney-Rivlin Hyperelastic Material Law with penalty term for incompressibility with the option for a single coefficient nonlinear KV Damping
// =============================================================================

#ifndef CHMATERIALBEAMANCF_MR_H
#define CHMATERIALBEAMANCF_MR_H
...
/// Definition of materials to be used for ANCF beam elements.
class ChApi ChMaterialBeamANCF_MR {
  public:
    /// Construct the material.
      ChMaterialBeamANCF_MR(double rho,  // material Density
