...
#ifndef CHELEMENTBEAMANCFMT23_H
#define CHELEMENTBEAMANCFMT23_H
...
class ChApi ChMaterialBeamANCF_MT23 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_MT23(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_MT23 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MT23> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_MT23> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_MT23> m_material;    ///< beam material
