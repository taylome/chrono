...
#ifndef CHELEMENTSHELLANCF3443TR05_H
#define CHELEMENTSHELLANCF3443TR05_H
...
class ChApi ChMaterialShellANCF_3443_TR05 {
  public:
    /// Construct an isotropic material.
    ChMaterialShellANCF_3443_TR05(double rho,        ///< material density
...
class ChApi ChElementShellANCF_3443_TR05 : public ChElementShell, public ChLoadableUV, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialShellANCF_3443_TR05> shell_mat) { m_material = shell_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialShellANCF_3443_TR05> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialShellANCF_3443_TR05> m_material;  ///< shell material
