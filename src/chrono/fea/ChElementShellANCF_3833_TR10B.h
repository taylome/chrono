...
#ifndef CHELEMENTSHELLANCF3833_TR10B_H
#define CHELEMENTSHELLANCF3833_TR10B_H
...
class ChApi ChElementShellANCF_3833_TR10B : public ChElementShell, public ChLoadableUV, public ChLoadableUVW {
  public:
    ...
    class Layer {
      ...
      public:
        ...
        friend class ChElementShellANCF_3833_TR10B;
    };
  ...
  private:
    ...
    ChMatrixNM<double, NSF, NSF> m_K3Compact;  ///< Precomputed Matrix combined with the nodal coordinates used for the
                                               ///< "Pre-Integration" style method internal force calculation
    ChMatrixNM<double, NSF, NSF>
