...
#ifndef CHELEMENTSHELLANCF3833MLTR01_H
#define CHELEMENTSHELLANCF3833MLTR01_H
...
class ChApi ChMaterialShellANCF_3833ML_TR01 {
  public:
    /// Construct an isotropic material.
    ChMaterialShellANCF_3833ML_TR01(double rho,        ///< material density
...
class ChApi ChElementShellANCF_3833ML_TR01 : public ChElementShell, public ChLoadableUV, public ChLoadableUVW {
  public:
    ...
    ChElementShellANCF_3833ML_TR01();
    ~ChElementShellANCF_3833ML_TR01() {}
    ...
    public:
        ...
        std::shared_ptr<ChMaterialShellANCF_3833ML_TR01> GetMaterial() const { return m_material; }

    private:
        /// Private constructor (a layer can be created only by adding it to an element)
        Layer(ChElementShellANCF_3833ML_TR01* element,                 ///< containing element
            double thickness,                              ///< layer thickness
            double theta,                                  ///< fiber angle
            std::shared_ptr<ChMaterialShellANCF_3833ML_TR01> material  ///< layer material
        );

        ChElementShellANCF_3833ML_TR01* m_element;                  ///< containing ANCF shell element
        std::shared_ptr<ChMaterialShellANCF_3833ML_TR01> m_material;  ///< layer material
    ...
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
            ...
            friend class ChElementShellANCF_3833ML_TR01;
    };
