...
#ifndef CHELEMENTBEAMANCFMT64_H
#define CHELEMENTBEAMANCFMT64_H
...
class ChApi ChMaterialBeamANCF_MT64 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_MT64(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_MT64 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MT64> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_MT64> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_MT64> m_material;    ///< beam material
