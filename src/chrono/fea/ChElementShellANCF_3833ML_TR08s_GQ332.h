...
#ifndef CHELEMENTSHELLANCF3833MLTR08SGQ332_H
#define CHELEMENTSHELLANCF3833MLTR08SGQ332_H
...
class ChApi ChMaterialShellANCF_3833ML_TR08S_GQ332 {
  public:
    /// Construct an isotropic material.
    ChMaterialShellANCF_3833ML_TR08S_GQ332(double rho,        ///< material density
...
class ChApi ChElementShellANCF_3833ML_TR08S_GQ332 : public ChElementShell, public ChLoadableUV, public ChLoadableUVW {
  public:
    ...
    ChElementShellANCF_3833ML_TR08S_GQ332();
    ~ChElementShellANCF_3833ML_TR08S_GQ332() {}
    ...
    public:
        ...
        std::shared_ptr<ChMaterialShellANCF_3833ML_TR08S_GQ332> GetMaterial() const { return m_material; }

    private:
        /// Private constructor (a layer can be created only by adding it to an element)
        Layer(ChElementShellANCF_3833ML_TR08S_GQ332* element,                 ///< containing element
            double thickness,                              ///< layer thickness
            double theta,                                  ///< fiber angle
            std::shared_ptr<ChMaterialShellANCF_3833ML_TR08S_GQ332> material  ///< layer material
        );

        ChElementShellANCF_3833ML_TR08S_GQ332* m_element;                  ///< containing ANCF shell element
        std::shared_ptr<ChMaterialShellANCF_3833ML_TR08S_GQ332> m_material;  ///< layer material
    ...
    public:
        ...
        friend class ChElementShellANCF_3833ML_TR08S_GQ332;
    };
