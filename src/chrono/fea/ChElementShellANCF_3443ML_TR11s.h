...
#ifndef CHELEMENTSHELLANCF3443MLTR11S_H
#define CHELEMENTSHELLANCF3443MLTR11S_H
...
class ChApi ChMaterialShellANCF_3443ML_TR11S {
  public:
    /// Construct an isotropic material.
    ChMaterialShellANCF_3443ML_TR11S(double rho,  ///< material density
...
class ChApi ChElementShellANCF_3443ML_TR11S : public ChElementShell, public ChLoadableUV, public ChLoadableUVW {
  public:
    ...
    ChElementShellANCF_3443ML_TR11S();
    ~ChElementShellANCF_3443ML_TR11S() {}
    ...
    public:
        ...
        std::shared_ptr<ChMaterialShellANCF_3443ML_TR11S> GetMaterial() const { return m_material; }

    private:
        /// Private constructor (a layer can be created only by adding it to an element)
        Layer(ChElementShellANCF_3443ML_TR11S* element,                 ///< containing element
            double thickness,                              ///< layer thickness
            double theta,                                  ///< fiber angle
            std::shared_ptr<ChMaterialShellANCF_3443ML_TR11S> material  ///< layer material
        );

        ChElementShellANCF_3443ML_TR11S* m_element;                  ///< containing ANCF shell element
        std::shared_ptr<ChMaterialShellANCF_3443ML_TR11S> m_material;  ///< layer material
    ...
    public:
        ...
        friend class ChElementShellANCF_3443ML_TR11S;
    };
