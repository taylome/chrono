...
ChElementShellANCF_3833ML_TR08S_GQ332::ChElementShellANCF_3833ML_TR08S_GQ332()
...
void ChElementShellANCF_3833ML_TR08S_GQ332::SetNodes(std::shared_ptr<ChNodeFEAxyzDD> nodeA,
...
void ChElementShellANCF_3833ML_TR08S_GQ332::AddLayer(double thickness, double theta, std::shared_ptr<ChMaterialShellANCF_3833ML_TR08S_GQ332> material) {
...
void ChElementShellANCF_3833ML_TR08S_GQ332::SetupInitial(ChSystem* system) {
    // Initial positions and slopes of the element nodes
    // These values define the reference configuration of the element
    CalcCoordMatrix(m_ebar0);
...
// State update.
void ChElementShellANCF_3833ML_TR08S_GQ332::Update() {
    ChElementGeneric::Update();
}

// Fill the D vector with the current field values at the element nodes.
void ChElementShellANCF_3833ML_TR08S_GQ332::GetStateBlock(ChVectorDynamic<>& mD) {
...
void ChElementShellANCF_3833ML_TR08S_GQ332::ComputeKRMmatricesGlobal(ChMatrixRef H,
    double Kfactor,
    double Rfactor,
    double Mfactor) {
...
void ChElementShellANCF_3833ML_TR08S_GQ332::ComputeMmatrixGlobal(ChMatrixRef M) {
    M.setZero();
...
// -----------------------------------------------------------------------------
void ChElementShellANCF_3833ML_TR08S_GQ332::ComputeMassMatrixAndGravityForce(const ChVector<>& g_acc) {
...
void ChElementShellANCF_3833ML_TR08S_GQ332::ComputeNodalMass() {
...
void ChElementShellANCF_3833ML_TR08S_GQ332::PrecomputeInternalForceMatricesWeights() {
    ChQuadratureTables* GQTable = GetStaticGQTables();
...
void ChElementShellANCF_3833ML_TR08S_GQ332::SetAlphaDamp(double a) {
    m_Alpha = a;
    m_2Alpha = 2 * a;
...
void ChElementShellANCF_3833ML_TR08S_GQ332::ComputeInternalForces(ChVectorDynamic<>& Fi) {
...
void ChElementShellANCF_3833ML_TR08S_GQ332::ComputeInternalForcesAtState(ChVectorDynamic<>& Fi, const MatrixNx6& ebar_ebardot) {
    ...
    for (size_t kl = 0; kl < m_numLayers; kl++) {
        ChMatrixNMc<double, 54, 6> F_Transpose_CombinedBlockDamping_col_ordered = m_SD_precompute_col_ordered.block<24, 54>(0, 54 * kl).transpose() * ebar_ebardot;
...
void ChElementShellANCF_3833ML_TR08S_GQ332::ComputeInternalForcesAtStateNoDamping(ChVectorDynamic<>& Fi,
    ...
    for (size_t kl = 0; kl < m_numLayers; kl++) {
        ChMatrixNMc<double, 54, 3>  F_Transpose_CombinedBlock_col_ordered = m_SD_precompute_col_ordered.block<24, 54>(0, 54 * kl).transpose() * e_bar;
...
void ChElementShellANCF_3833ML_TR08S_GQ332::ComputeInternalJacobians(Matrix3Nx3N& JacobianMatrix,
                                                           double Kfactor,
                                                           double Rfactor) {
...
void ChElementShellANCF_3833ML_TR08S_GQ332::ComputeInternalJacobianDamping(ChMatrixRef& H,
    double Kfactor,
    double Rfactor,
    double Mfactor) {
    ...
    for (size_t kl = 0; kl < m_numLayers; kl++) {
        ...
        for (auto i = 0; i < 24; i++) {
            partial_epsilon_partial_e_Transpose.block<1, 18>(3 * i, 0).noalias() = m_SD_precompute_col_ordered.block<1, 18>(i, 54 * kl + 0).cwiseProduct(F_Transpose_CombinedBlockDamping_col_ordered.block<18, 1>(0, 0).transpose());
            partial_epsilon_partial_e_Transpose.block<1, 18>(3 * i, 18).noalias() = m_SD_precompute_col_ordered.block<1, 18>(i, 54 * kl + 18).cwiseProduct(F_Transpose_CombinedBlockDamping_col_ordered.block<18, 1>(18, 0).transpose());
            partial_epsilon_partial_e_Transpose.block<1, 18>(3 * i, 36).noalias() = m_SD_precompute_col_ordered.block<1, 18>(i, 54 * kl + 36).cwiseProduct(F_Transpose_CombinedBlockDamping_col_ordered.block<18, 1>(36, 0).transpose());
            partial_epsilon_partial_e_Transpose.block<1, 18>(3 * i, 54).noalias() = m_SD_precompute_col_ordered.block<1, 18>(i, 54 * kl + 36).cwiseProduct(F_Transpose_CombinedBlockDamping_col_ordered.block<18, 1>(18, 0).transpose()) +
            ...
            partial_epsilon_partial_e_Transpose.block<1, 18>(3 * i, 72).noalias() = m_SD_precompute_col_ordered.block<1, 18>(i, 54 * kl + 36).cwiseProduct(F_Transpose_CombinedBlockDamping_col_ordered.block<18, 1>(0, 0).transpose()) +
            ...
            partial_epsilon_partial_e_Transpose.block<1, 18>(3 * i, 90).noalias() = m_SD_precompute_col_ordered.block<1, 18>(i, 54 * kl + 18).cwiseProduct(F_Transpose_CombinedBlockDamping_col_ordered.block<18, 1>(0, 0).transpose()) +
            ...
            partial_epsilon_partial_e_Transpose.block<1, 18>((3 * i) + 1, 0).noalias() = m_SD_precompute_col_ordered.block<1, 18>(i, 54 * kl + 0).cwiseProduct(F_Transpose_CombinedBlockDamping_col_ordered.block<18, 1>(0, 1).transpose());
            partial_epsilon_partial_e_Transpose.block<1, 18>((3 * i) + 1, 18).noalias() = m_SD_precompute_col_ordered.block<1, 18>(i, 54 * kl + 18).cwiseProduct(F_Transpose_CombinedBlockDamping_col_ordered.block<18, 1>(18, 1).transpose());
            partial_epsilon_partial_e_Transpose.block<1, 18>((3 * i) + 1, 36).noalias() = m_SD_precompute_col_ordered.block<1, 18>(i, 54 * kl + 36).cwiseProduct(F_Transpose_CombinedBlockDamping_col_ordered.block<18, 1>(36, 1).transpose());
            partial_epsilon_partial_e_Transpose.block<1, 18>((3 * i) + 1, 54).noalias() = m_SD_precompute_col_ordered.block<1, 18>(i, 54 * kl + 36).cwiseProduct(F_Transpose_CombinedBlockDamping_col_ordered.block<18, 1>(18, 1).transpose()) +
            ...
            partial_epsilon_partial_e_Transpose.block<1, 18>((3 * i) + 1, 72).noalias() = m_SD_precompute_col_ordered.block<1, 18>(i, 54 * kl + 36).cwiseProduct(F_Transpose_CombinedBlockDamping_col_ordered.block<18, 1>(0, 1).transpose()) +
            ...
            partial_epsilon_partial_e_Transpose.block<1, 18>((3 * i) + 1, 90).noalias() = m_SD_precompute_col_ordered.block<1, 18>(i, 54 * kl + 18).cwiseProduct(F_Transpose_CombinedBlockDamping_col_ordered.block<18, 1>(0, 1).transpose()) +
            ...
            partial_epsilon_partial_e_Transpose.block<1, 18>((3 * i) + 2, 0).noalias() = m_SD_precompute_col_ordered.block<1, 18>(i, 54 * kl + 0).cwiseProduct(F_Transpose_CombinedBlockDamping_col_ordered.block<18, 1>(0, 2).transpose());
            partial_epsilon_partial_e_Transpose.block<1, 18>((3 * i) + 2, 18).noalias() = m_SD_precompute_col_ordered.block<1, 18>(i, 54 * kl + 18).cwiseProduct(F_Transpose_CombinedBlockDamping_col_ordered.block<18, 1>(18, 2).transpose());
            partial_epsilon_partial_e_Transpose.block<1, 18>((3 * i) + 2, 36).noalias() = m_SD_precompute_col_ordered.block<1, 18>(i, 54 * kl + 36).cwiseProduct(F_Transpose_CombinedBlockDamping_col_ordered.block<18, 1>(36, 2).transpose());
            partial_epsilon_partial_e_Transpose.block<1, 18>((3 * i) + 2, 54).noalias() = m_SD_precompute_col_ordered.block<1, 18>(i, 54 * kl + 36).cwiseProduct(F_Transpose_CombinedBlockDamping_col_ordered.block<18, 1>(18, 2).transpose()) +
            ...
            partial_epsilon_partial_e_Transpose.block<1, 18>((3 * i) + 2, 72).noalias() = m_SD_precompute_col_ordered.block<1, 18>(i, 54 * kl + 36).cwiseProduct(F_Transpose_CombinedBlockDamping_col_ordered.block<18, 1>(0, 2).transpose()) +
            ...
            partial_epsilon_partial_e_Transpose.block<1, 18>((3 * i) + 2, 90).noalias() = m_SD_precompute_col_ordered.block<1, 18>(i, 54 * kl + 18).cwiseProduct(F_Transpose_CombinedBlockDamping_col_ordered.block<18, 1>(0, 2).transpose()) +
        ...
        //S_scaled_SD_precompute_col_ordered.resize(24, 54);
        ChMatrixNM<double, 24, 54> S_scaled_SD_precompute_col_ordered;
...
void ChElementShellANCF_3833ML_TR08S_GQ332::ComputeInternalJacobianNoDamping(ChMatrixRef& H, double Kfactor, double Mfactor) {
    ...
    for (size_t kl = 0; kl < m_numLayers; kl++) {
        ...
        for (auto i = 0; i < 24; i++) {
            partial_epsilon_partial_e_Transpose.block<1, 18>(3 * i, 0).noalias() = m_SD_precompute_col_ordered.block<1, 18>(i, 54 * kl + 0).cwiseProduct(F_Transpose_CombinedBlock_col_ordered.block<18, 1>(0, 0).transpose());
            partial_epsilon_partial_e_Transpose.block<1, 18>(3 * i, 18).noalias() = m_SD_precompute_col_ordered.block<1, 18>(i, 54 * kl + 18).cwiseProduct(F_Transpose_CombinedBlock_col_ordered.block<18, 1>(18, 0).transpose());
            partial_epsilon_partial_e_Transpose.block<1, 18>(3 * i, 36).noalias() = m_SD_precompute_col_ordered.block<1, 18>(i, 54 * kl + 36).cwiseProduct(F_Transpose_CombinedBlock_col_ordered.block<18, 1>(36, 0).transpose());
            partial_epsilon_partial_e_Transpose.block<1, 18>(3 * i, 54).noalias() = m_SD_precompute_col_ordered.block<1, 18>(i, 54 * kl + 36).cwiseProduct(F_Transpose_CombinedBlock_col_ordered.block<18, 1>(18, 0).transpose()) +
            ...
            partial_epsilon_partial_e_Transpose.block<1, 18>(3 * i, 72).noalias() = m_SD_precompute_col_ordered.block<1, 18>(i, 54 * kl + 36).cwiseProduct(F_Transpose_CombinedBlock_col_ordered.block<18, 1>(0, 0).transpose()) +
            ...
            partial_epsilon_partial_e_Transpose.block<1, 18>(3 * i, 90).noalias() = m_SD_precompute_col_ordered.block<1, 18>(i, 54 * kl + 18).cwiseProduct(F_Transpose_CombinedBlock_col_ordered.block<18, 1>(0, 0).transpose()) +
            ...
            partial_epsilon_partial_e_Transpose.block<1, 18>((3 * i) + 1, 0).noalias() = m_SD_precompute_col_ordered.block<1, 18>(i, 54 * kl + 0).cwiseProduct(F_Transpose_CombinedBlock_col_ordered.block<18, 1>(0, 1).transpose());
            partial_epsilon_partial_e_Transpose.block<1, 18>((3 * i) + 1, 18).noalias() = m_SD_precompute_col_ordered.block<1, 18>(i, 54 * kl + 18).cwiseProduct(F_Transpose_CombinedBlock_col_ordered.block<18, 1>(18, 1).transpose());
            partial_epsilon_partial_e_Transpose.block<1, 18>((3 * i) + 1, 36).noalias() = m_SD_precompute_col_ordered.block<1, 18>(i, 54 * kl + 36).cwiseProduct(F_Transpose_CombinedBlock_col_ordered.block<18, 1>(36, 1).transpose());
            partial_epsilon_partial_e_Transpose.block<1, 18>((3 * i) + 1, 54).noalias() = m_SD_precompute_col_ordered.block<1, 18>(i, 54 * kl + 36).cwiseProduct(F_Transpose_CombinedBlock_col_ordered.block<18, 1>(18, 1).transpose()) +
            ...
            partial_epsilon_partial_e_Transpose.block<1, 18>((3 * i) + 1, 72).noalias() = m_SD_precompute_col_ordered.block<1, 18>(i, 54 * kl + 36).cwiseProduct(F_Transpose_CombinedBlock_col_ordered.block<18, 1>(0, 1).transpose()) +
            ...
            partial_epsilon_partial_e_Transpose.block<1, 18>((3 * i) + 1, 90).noalias() = m_SD_precompute_col_ordered.block<1, 18>(i, 54 * kl + 18).cwiseProduct(F_Transpose_CombinedBlock_col_ordered.block<18, 1>(0, 1).transpose()) +
            ...
            partial_epsilon_partial_e_Transpose.block<1, 18>((3 * i) + 2, 0).noalias() = m_SD_precompute_col_ordered.block<1, 18>(i, 54 * kl + 0).cwiseProduct(F_Transpose_CombinedBlock_col_ordered.block<18, 1>(0, 2).transpose());
            partial_epsilon_partial_e_Transpose.block<1, 18>((3 * i) + 2, 18).noalias() = m_SD_precompute_col_ordered.block<1, 18>(i, 54 * kl + 18).cwiseProduct(F_Transpose_CombinedBlock_col_ordered.block<18, 1>(18, 2).transpose());
            partial_epsilon_partial_e_Transpose.block<1, 18>((3 * i) + 2, 36).noalias() = m_SD_precompute_col_ordered.block<1, 18>(i, 54 * kl + 36).cwiseProduct(F_Transpose_CombinedBlock_col_ordered.block<18, 1>(36, 2).transpose());
            partial_epsilon_partial_e_Transpose.block<1, 18>((3 * i) + 2, 54).noalias() = m_SD_precompute_col_ordered.block<1, 18>(i, 54 * kl + 36).cwiseProduct(F_Transpose_CombinedBlock_col_ordered.block<18, 1>(18, 2).transpose()) +
            ...
            partial_epsilon_partial_e_Transpose.block<1, 18>((3 * i) + 2, 72).noalias() = m_SD_precompute_col_ordered.block<1, 18>(i, 54 * kl + 36).cwiseProduct(F_Transpose_CombinedBlock_col_ordered.block<18, 1>(0, 2).transpose()) +
            ...
            partial_epsilon_partial_e_Transpose.block<1, 18>((3 * i) + 2, 90).noalias() = m_SD_precompute_col_ordered.block<1, 18>(i, 54 * kl + 18).cwiseProduct(F_Transpose_CombinedBlock_col_ordered.block<18, 1>(0, 2).transpose()) +
        ...
        // ChMatrixNM<double, 48, 432> Scaled_Combined_partial_epsilon_partial_e_Transpose;
        //Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor, 72, 108> Scaled_Combined_partial_epsilon_partial_e_Transpose;
        Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor> Scaled_Combined_partial_epsilon_partial_e_Transpose;
        Scaled_Combined_partial_epsilon_partial_e_Transpose.resize(72, 108);
...
void ChElementShellANCF_3833ML_TR08S_GQ332::Calc_Sxi(Matrix3x3N& Sxi, double xi, double eta, double zeta, double thickness, double zoffset) {
    VectorN Sxi_compact;
    Calc_Sxi_compact(Sxi_compact, xi, eta, zeta, thickness, zoffset);
    Sxi.setZero();
...
// [s1; s2; s3; ...]
void ChElementShellANCF_3833ML_TR08S_GQ332::Calc_Sxi_compact(VectorN& Sxi_compact, double xi, double eta, double zeta, double thickness, double zoffset) {
...
// [s1*I_3x3, s2*I_3x3, s3*I_3x3, ...]
void ChElementShellANCF_3833ML_TR08S_GQ332::Calc_Sxi_xi(Matrix3x3N& Sxi_xi, double xi, double eta, double zeta, double thickness, double zoffset) {
...
// [s1; s2; s3; ...]
void ChElementShellANCF_3833ML_TR08S_GQ332::Calc_Sxi_xi_compact(VectorN& Sxi_xi_compact, double xi, double eta, double zeta, double thickness, double zoffset) {
...
// [s1*I_3x3, s2*I_3x3, s3*I_3x3, ...]
void ChElementShellANCF_3833ML_TR08S_GQ332::Calc_Sxi_eta(Matrix3x3N& Sxi_eta, double xi, double eta, double zeta, double thickness, double zoffset) {
...
// [s1; s2; s3; ...]
void ChElementShellANCF_3833ML_TR08S_GQ332::Calc_Sxi_eta_compact(VectorN& Sxi_eta_compact, double xi, double eta, double zeta, double thickness, double zoffset) {
...
// [s1*I_3x3, s2*I_3x3, s3*I_3x3, ...]
void ChElementShellANCF_3833ML_TR08S_GQ332::Calc_Sxi_zeta(Matrix3x3N& Sxi_zeta, double xi, double eta, double zeta, double thickness, double zoffset) {
...
// [s1; s2; s3; ...]
void ChElementShellANCF_3833ML_TR08S_GQ332::Calc_Sxi_zeta_compact(VectorN& Sxi_zeta_compact, double xi, double eta, double zeta, double thickness, double zoffset) {
...
void ChElementShellANCF_3833ML_TR08S_GQ332::Calc_Sxi_D(MatrixNx3c& Sxi_D, double xi, double eta, double zeta, double thickness, double zoffset) {
...
void ChElementShellANCF_3833ML_TR08S_GQ332::CalcCoordVector(Vector3N& e) {
...
void ChElementShellANCF_3833ML_TR08S_GQ332::CalcCoordMatrix(Matrix3xN& ebar) {
...
void ChElementShellANCF_3833ML_TR08S_GQ332::CalcCoordMatrix(MatrixNx3c& ebar) {
...
void ChElementShellANCF_3833ML_TR08S_GQ332::CalcCoordMatrix(MatrixNx3& ebar) {
    ebar.row(0) = m_nodes[0]->GetPos().eigen();
    ebar.row(1) = m_nodes[0]->GetD().eigen();
    ebar.row(2) = m_nodes[0]->GetDD().eigen();
...
void ChElementShellANCF_3833ML_TR08S_GQ332::CalcCoordDerivVector(Vector3N& edot) {
...
void ChElementShellANCF_3833ML_TR08S_GQ332::CalcCoordDerivMatrix(Matrix3xN& ebardot) {
...
void ChElementShellANCF_3833ML_TR08S_GQ332::CalcCoordDerivMatrix(MatrixNx3c& ebardot) {
...
void ChElementShellANCF_3833ML_TR08S_GQ332::CalcCombinedCoordMatrix(MatrixNx6& ebar_ebardot) {
...
void ChElementShellANCF_3833ML_TR08S_GQ332::Calc_J_0xi(ChMatrix33<double>& J_0xi, double xi, double eta, double zeta, double thickness, double zoffset) {
    MatrixNx3c Sxi_D;
    Calc_Sxi_D(Sxi_D, xi, eta, zeta, thickness, zoffset);
...
double ChElementShellANCF_3833ML_TR08S_GQ332::Calc_det_J_0xi(double xi, double eta, double zeta, double thickness, double zoffset) {
...
void ChElementShellANCF_3833ML_TR08S_GQ332::EvaluateSectionFrame(const double xi, const double eta, ChVector<>& point, ChQuaternion<>& rot) {
    Matrix3x3N Sxi;
    Matrix3x3N Sxi_xi;
    Matrix3x3N Sxi_eta;
...
void ChElementShellANCF_3833ML_TR08S_GQ332::EvaluateSectionPoint(const double u, const double v, ChVector<>& point) {
    Matrix3x3N Sxi;
...
void ChElementShellANCF_3833ML_TR08S_GQ332::EvaluateSectionVelNorm(double U, double V, ChVector<>& Result) {
    Matrix3x3N Sxi_zeta;
    Vector3N edot;
    ChVector<> r_zeta;
...
void ChElementShellANCF_3833ML_TR08S_GQ332::LoadableGetStateBlock_x(int block_offset, ChState& mD) {
...
void ChElementShellANCF_3833ML_TR08S_GQ332::LoadableGetStateBlock_w(int block_offset, ChStateDelta& mD) {
...
void ChElementShellANCF_3833ML_TR08S_GQ332::LoadableStateIncrement(const unsigned int off_x,
                                                         ChState& x_new,
                                                         const ChState& x,
...
void ChElementShellANCF_3833ML_TR08S_GQ332::LoadableGetVariables(std::vector<ChVariables*>& mvars) {
...
void ChElementShellANCF_3833ML_TR08S_GQ332::ComputeNF(
...
double ChElementShellANCF_3833ML_TR08S_GQ332::GetDensity() {
...
ChVector<> ChElementShellANCF_3833ML_TR08S_GQ332::ComputeNormal(const double U, const double V) {
    Matrix3x3N Sxi_zeta;
    Vector3N e;
    ChVector<> r_zeta;
...
ChQuadratureTables static_tables_3833ML_TR08S_GQ332(1, CH_QUADRATURE_STATIC_TABLES);
//#endif // !CH_QUADRATURE_STATIC_TABLES

ChQuadratureTables* ChElementShellANCF_3833ML_TR08S_GQ332::GetStaticGQTables() {
    return &static_tables_3833ML_TR08S_GQ332;
}

////////////////////////////////////////////////////////////////

// ============================================================================
// Implementation of ChElementShellANCF_3833ML_TR08S_GQ332::Layer methods
// ============================================================================

// Private constructor (a layer can be created only by adding it to an element)
ChElementShellANCF_3833ML_TR08S_GQ332::Layer::Layer(ChElementShellANCF_3833ML_TR08S_GQ332* element,
    double thickness,
    double theta,
    std::shared_ptr<ChMaterialShellANCF_3833ML_TR08S_GQ332> material)
    : m_element(element), m_thickness(thickness), m_theta(theta), m_material(material) {}

////////////////////////////////////////////////////////////////

// ============================================================================
// Implementation of ChMaterialShellANCF_3833ML_TR08S_GQ332 methods
// ============================================================================

// Construct an isotropic material.
ChMaterialShellANCF_3833ML_TR08S_GQ332::ChMaterialShellANCF_3833ML_TR08S_GQ332(
...
// Poisson effect
void ChMaterialShellANCF_3833ML_TR08S_GQ332::Calc_D0_Dv(const ChVector<>& E,
                                              const ChVector<>& nu,
                                              const ChVector<>& G) {
...
void ChMaterialShellANCF_3833ML_TR08S_GQ332::Get_Rotated_D(ChMatrixNM<double, 6, 6>& D, double theta) {
