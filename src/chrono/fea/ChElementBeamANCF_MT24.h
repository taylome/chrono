...
#ifndef CHELEMENTBEAMANCFMT24_H
#define CHELEMENTBEAMANCFMT24_H
...
class ChApi ChMaterialBeamANCF_MT24 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_MT24(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_MT24 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MT24> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_MT24> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_MT24> m_material;    ///< beam material
