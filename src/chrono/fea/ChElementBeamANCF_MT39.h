...
#ifndef CHELEMENTBEAMANCFMT39_H
#define CHELEMENTBEAMANCFMT39_H
...
class ChApi ChMaterialBeamANCF_MT39 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_MT39(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_MT39 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MT39> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_MT39> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_MT39> m_material;    ///< beam material
