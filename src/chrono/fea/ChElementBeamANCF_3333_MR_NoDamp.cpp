...
ChElementBeamANCF_3333_MR_NoDamp::ChElementBeamANCF_3333_MR_NoDamp()
...
void ChElementBeamANCF_3333_MR_NoDamp::SetNodes(std::shared_ptr<ChNodeFEAxyzDD> nodeA,
...
void ChElementBeamANCF_3333_MR_NoDamp::SetDimensions(double lenX, double thicknessY, double thicknessZ) {
    m_lenX = lenX;
...
void ChElementBeamANCF_3333_MR_NoDamp::SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MR> beam_mat) {
    m_material = beam_mat;
}
...
ChMatrix33d ChElementBeamANCF_3333_MR_NoDamp::GetGreenLagrangeStrain(const double xi, const double eta, const double zeta) {
...
ChMatrix33d ChElementBeamANCF_3333_MR_NoDamp::GetPK2Stress(const double xi, const double eta, const double zeta) {
    MatrixNx3c Sxi_D;  // Matrix of normalized shape function derivatives
    Calc_Sxi_D(Sxi_D, xi, eta, zeta);
...
double ChElementBeamANCF_3333_MR_NoDamp::GetVonMissesStress(const double xi, const double eta, const double zeta) {
    MatrixNx3c Sxi_D;  // Matrix of normalized shape function derivatives
    Calc_Sxi_D(Sxi_D, xi, eta, zeta);
...
void ChElementBeamANCF_3333_MR_NoDamp::SetupInitial(ChSystem* system) {
...
void ChElementBeamANCF_3333_MR_NoDamp::GetStateBlock(ChVectorDynamic<>& mD) {
...
void ChElementBeamANCF_3333_MR_NoDamp::Update() {
    ChElementGeneric::Update();
}

// Return the mass matrix in full sparse form.

void ChElementBeamANCF_3333_MR_NoDamp::ComputeMmatrixGlobal(ChMatrixRef M) {
    M.setZero();
...
void ChElementBeamANCF_3333_MR_NoDamp::ComputeNodalMass() {
...
void ChElementBeamANCF_3333_MR_NoDamp::ComputeInternalForces(ChVectorDynamic<>& Fi) {
...
void ChElementBeamANCF_3333_MR_NoDamp::ComputeKRMmatricesGlobal(ChMatrixRef H,
    double Kfactor,
    double Rfactor,
    double Mfactor) {
...
void ChElementBeamANCF_3333_MR_NoDamp::ComputeGravityForces(ChVectorDynamic<>& Fg, const ChVector3d& G_acc) {
...
void ChElementBeamANCF_3333_MR_NoDamp::EvaluateSectionFrame(const double xi, ChVector3d& point, ChQuaternion<>& rot) {
    VectorN Sxi_compact;
...
void ChElementBeamANCF_3333_MR_NoDamp::EvaluateSectionPoint(const double xi, ChVector3d& point) {
    VectorN Sxi_compact;
    Calc_Sxi_compact(Sxi_compact, xi, 0, 0);
...
void ChElementBeamANCF_3333_MR_NoDamp::EvaluateSectionVel(const double xi, ChVector3d& Result) {
    VectorN Sxi_compact;
    Calc_Sxi_compact(Sxi_compact, xi, 0, 0);
...
void ChElementBeamANCF_3333_MR_NoDamp::LoadableGetStateBlockPosLevel(int block_offset, ChState& mD) {
...
void ChElementBeamANCF_3333_MR_NoDamp::LoadableGetStateBlockVelLevel(int block_offset, ChStateDelta& mD) {
...
void ChElementBeamANCF_3333_MR_NoDamp::LoadableStateIncrement(const unsigned int off_x,
                                                         ChState& x_new,
                                                         const ChState& x,
...
void ChElementBeamANCF_3333_MR_NoDamp::LoadableGetVariables(std::vector<ChVariables*>& mvars) {
...
void ChElementBeamANCF_3333_MR_NoDamp::ComputeNF(
...
double ChElementBeamANCF_3333_MR_NoDamp::GetDensity() {
    return GetMaterial()->GetDensity();
}

// Calculate tangent to the centerline at coordinate xi [-1 to 1].

ChVector3d ChElementBeamANCF_3333_MR_NoDamp::ComputeTangent(const double xi) {
    VectorN Sxi_xi_compact;
    Calc_Sxi_xi_compact(Sxi_xi_compact, xi, 0, 0);
...
void ChElementBeamANCF_3333_MR_NoDamp::ComputeMassMatrixAndGravityForce() {
...
void ChElementBeamANCF_3333_MR_NoDamp::PrecomputeInternalForceMatricesWeights() {
    ChQuadratureTables* GQTable = GetStaticGQTables();
...
void ChElementBeamANCF_3333_MR_NoDamp::ComputeInternalForceDamping(ChVectorDynamic<>& Fi) {
...
void ChElementBeamANCF_3333_MR_NoDamp::ComputeInternalForceNoDamping(ChVectorDynamic<>& Fi) {
    assert((unsigned int)Fi.size() == GetNumCoordsPosLevel());
...
void ChElementBeamANCF_3333_MR_NoDamp::ComputeInternalJacobianDamping(ChMatrixRef H, double Kfactor, double Rfactor, double Mfactor) {
...
void ChElementBeamANCF_3333_MR_NoDamp::ComputeInternalJacobianNoDamping(ChMatrixRef H, double Kfactor, double Mfactor) {
    assert((H.rows() == 3 * NSF) && (H.cols() == 3 * NSF));
...
void ChElementBeamANCF_3333_MR_NoDamp::Calc_Sxi_compact(VectorN& Sxi_compact, double xi, double eta, double zeta) {
...
void ChElementBeamANCF_3333_MR_NoDamp::Calc_Sxi_xi_compact(VectorN& Sxi_xi_compact, double xi, double eta, double zeta) {
...
void ChElementBeamANCF_3333_MR_NoDamp::Calc_Sxi_eta_compact(VectorN& Sxi_eta_compact, double xi, double eta, double zeta) {
...
void ChElementBeamANCF_3333_MR_NoDamp::Calc_Sxi_zeta_compact(VectorN& Sxi_zeta_compact, double xi, double eta, double zeta) {
...
void ChElementBeamANCF_3333_MR_NoDamp::Calc_Sxi_D(MatrixNx3c& Sxi_D, double xi, double eta, double zeta) {
    VectorN Sxi_D_col;
...
void ChElementBeamANCF_3333_MR_NoDamp::CalcCoordVector(Vector3N& e) {
...
void ChElementBeamANCF_3333_MR_NoDamp::CalcCoordMatrix(Matrix3xN& ebar) {
...
void ChElementBeamANCF_3333_MR_NoDamp::CalcCoordDtVector(Vector3N& edot) {
...
void ChElementBeamANCF_3333_MR_NoDamp::CalcCoordDtMatrix(Matrix3xN& ebardot) {
...
void ChElementBeamANCF_3333_MR_NoDamp::CalcCombinedCoordMatrix(Matrix6xN& ebar_ebardot) {
...
void ChElementBeamANCF_3333_MR_NoDamp::Calc_J_0xi(ChMatrix33d& J_0xi, double xi, double eta, double zeta) {
    MatrixNx3c Sxi_D;
    Calc_Sxi_D(Sxi_D, xi, eta, zeta);
...
double ChElementBeamANCF_3333_MR_NoDamp::Calc_det_J_0xi(double xi, double eta, double zeta) {
    ChMatrix33d J_0xi;
...
ChQuadratureTables static_tables_3333_MR_NoDamp(1, CH_QUADRATURE_STATIC_TABLES);
//#endif // !CH_QUADRATURE_STATIC_TABLES

ChQuadratureTables* ChElementBeamANCF_3333_MR_NoDamp::GetStaticGQTables() {
    return &static_tables_3333_MR_NoDamp;
}
