...
#ifndef CHELEMENTBEAMANCF3243_TR01_H
#define CHELEMENTBEAMANCF3243_TR01_H
...
class ChApi ChElementBeamANCF_3243_TR01 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    static const int NP = 5;                 ///< number of Gauss quadrature along beam axis
    static const int NT = 3;                 ///< number of quadrature points through cross section
  ...
  private:
    ...
    /// Calculate the 3x3N Sparse Matrix Form of the Derivative of the Normalized Shape Function Matrix with respect to
    /// eta
    void Calc_Sxi_eta(Matrix3x3N& Sxi_xi, double xi, double eta, double zeta);

    /// Calculate the 3x3N Sparse Matrix Form of the Derivative of the Normalized Shape Function Matrix with respect to
    /// zeta
    void Calc_Sxi_zeta(Matrix3x3N& Sxi_xi, double xi, double eta, double zeta);
