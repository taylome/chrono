...
//
// =============================================================================
// TR04B = Gerstmayr and Shabana without Precomputation
...
ChElementBeamANCF_3243_TR04B::ChElementBeamANCF_3243_TR04B()
...
void ChElementBeamANCF_3243_TR04B::SetNodes(std::shared_ptr<ChNodeFEAxyzDDD> nodeA,
...
void ChElementBeamANCF_3243_TR04B::SetDimensions(double lenX, double thicknessY, double thicknessZ) {
    m_lenX = lenX;
...
void ChElementBeamANCF_3243_TR04B::SetMaterial(std::shared_ptr<ChMaterialBeamANCF> beam_mat) {
    m_material = beam_mat;
}

// Set the value for the single term structural damping coefficient.

void ChElementBeamANCF_3243_TR04B::SetAlphaDamp(double a) {
    m_Alpha = a;
...
ChMatrix33<> ChElementBeamANCF_3243_TR04B::GetGreenLagrangeStrain(const double xi,
                                                                  const double eta,
                                                                  const double zeta) {
...
ChMatrix33<> ChElementBeamANCF_3243_TR04B::GetPK2Stress(const double xi, const double eta, const double zeta) {
    MatrixNx3c Sxi_D;  // Matrix of normalized shape function derivatives
    Calc_Sxi_D(Sxi_D, xi, eta, zeta);
...
double ChElementBeamANCF_3243_TR04B::GetVonMissesStress(const double xi, const double eta, const double zeta) {
    MatrixNx3c Sxi_D;  // Matrix of normalized shape function derivatives
    Calc_Sxi_D(Sxi_D, xi, eta, zeta);
...
void ChElementBeamANCF_3243_TR04B::SetupInitial(ChSystem* system) {
...
void ChElementBeamANCF_3243_TR04B::GetStateBlock(ChVectorDynamic<>& mD) {
...
void ChElementBeamANCF_3243_TR04B::Update() {
    ChElementGeneric::Update();
}

// Return the mass matrix in full sparse form.

void ChElementBeamANCF_3243_TR04B::ComputeMmatrixGlobal(ChMatrixRef M) {
    M.setZero();
...
void ChElementBeamANCF_3243_TR04B::ComputeNodalMass() {
...
void ChElementBeamANCF_3243_TR04B::ComputeInternalForces(ChVectorDynamic<>& Fi) {
...
void ChElementBeamANCF_3243_TR04B::ComputeKRMmatricesGlobal(ChMatrixRef H,
                                                            double Kfactor,
                                                            double Rfactor,
                                                            double Mfactor) {
...
void ChElementBeamANCF_3243_TR04B::ComputeGravityForces(ChVectorDynamic<>& Fg, const ChVector<>& G_acc) {
...
void ChElementBeamANCF_3243_TR04B::EvaluateSectionFrame(const double xi, ChVector<>& point, ChQuaternion<>& rot) {
    VectorN Sxi_compact;
...
void ChElementBeamANCF_3243_TR04B::EvaluateSectionPoint(const double xi, ChVector<>& point) {
    VectorN Sxi_compact;
    Calc_Sxi_compact(Sxi_compact, xi, 0, 0);
...
void ChElementBeamANCF_3243_TR04B::EvaluateSectionVel(const double xi, ChVector<>& Result) {
    VectorN Sxi_compact;
    Calc_Sxi_compact(Sxi_compact, xi, 0, 0);
...
void ChElementBeamANCF_3243_TR04B::LoadableGetStateBlock_x(int block_offset, ChState& mD) {
...
void ChElementBeamANCF_3243_TR04B::LoadableGetStateBlock_w(int block_offset, ChStateDelta& mD) {
...
void ChElementBeamANCF_3243_TR04B::LoadableStateIncrement(const unsigned int off_x,
                                                          ChState& x_new,
                                                          const ChState& x,
...
void ChElementBeamANCF_3243_TR04B::LoadableGetVariables(std::vector<ChVariables*>& mvars) {
...
void ChElementBeamANCF_3243_TR04B::ComputeNF(
...
double ChElementBeamANCF_3243_TR04B::GetDensity() {
    return GetMaterial()->Get_rho();
}

// Calculate tangent to the centerline at coordinate xi [-1 to 1].

ChVector<> ChElementBeamANCF_3243_TR04B::ComputeTangent(const double xi) {
    VectorN Sxi_xi_compact;
    Calc_Sxi_xi_compact(Sxi_xi_compact, xi, 0, 0);
...
void ChElementBeamANCF_3243_TR04B::ComputeMassMatrixAndGravityForce() {
...
void ChElementBeamANCF_3243_TR04B::ComputeInternalForcesAtState(ChVectorDynamic<>& Fi,
...
void ChElementBeamANCF_3243_TR04B::ComputeInternalForcesSingleGQPntD0(Vector3N& Qi,
                                                                      double xi,
                                                                      double eta,
                                                                      double zeta,
...
void ChElementBeamANCF_3243_TR04B::ComputeInternalForcesSingleGQPntDv(Vector3N& Qi,
                                                                      double xi,
                                                                      double eta,
                                                                      double zeta,
                                                                      const ChMatrix33<>& Dv,
    ...
    // Calculate the generalized internal force integrand for a Linear Kelvin-Voigt Viscoelastic material model
    Eigen::Map<MatrixNx3> QiMatrixForm(Qi.data(), NSF, 3);
    QiMatrixForm.noalias() = Sbar_xi_D * (SPK2.asDiagonal() * F.transpose());
}
...
void ChElementBeamANCF_3243_TR04B::Calc_Sxi_compact(VectorN& Sxi_compact, double xi, double eta, double zeta) {
...
void ChElementBeamANCF_3243_TR04B::Calc_Sxi_xi_compact(VectorN& Sxi_xi_compact, double xi, double eta, double zeta) {
...
void ChElementBeamANCF_3243_TR04B::Calc_Sxi_eta_compact(VectorN& Sxi_eta_compact, double xi, double eta, double zeta) {
...
void ChElementBeamANCF_3243_TR04B::Calc_Sxi_zeta_compact(VectorN& Sxi_zeta_compact,
                                                         double xi,
                                                         double eta,
                                                         double zeta) {
...
void ChElementBeamANCF_3243_TR04B::Calc_Sxi_D(MatrixNx3c& Sxi_D, double xi, double eta, double zeta) {
    VectorN Sxi_D_col;
...
void ChElementBeamANCF_3243_TR04B::CalcCoordVector(Vector3N& e) {
...
void ChElementBeamANCF_3243_TR04B::CalcCoordMatrix(Matrix3xN& ebar) {
...
void ChElementBeamANCF_3243_TR04B::CalcCoordDerivVector(Vector3N& edot) {
...
void ChElementBeamANCF_3243_TR04B::CalcCoordDerivMatrix(Matrix3xN& ebardot) {
...
void ChElementBeamANCF_3243_TR04B::CalcCombinedCoordMatrix(Matrix6xN& ebar_ebardot) {
...
void ChElementBeamANCF_3243_TR04B::Calc_J_0xi(ChMatrix33<double>& J_0xi, double xi, double eta, double zeta) {
    MatrixNx3c Sxi_D;
    Calc_Sxi_D(Sxi_D, xi, eta, zeta);
...
double ChElementBeamANCF_3243_TR04B::Calc_det_J_0xi(double xi, double eta, double zeta) {
...
ChQuadratureTables static_tables_3243_TR04B(1, CH_QUADRATURE_STATIC_TABLES);
//#endif // !CH_QUADRATURE_STATIC_TABLES

ChQuadratureTables* ChElementBeamANCF_3243_TR04B::GetStaticGQTables() {
    return &static_tables_3243_TR04B;
}
