...
#ifndef CHELEMENTBEAMANCFMT04_H
#define CHELEMENTBEAMANCFMT04_H
...
class ChApi ChMaterialBeamANCF_MT04 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_MT04(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_MT04 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    using ShapeVector = ChMatrixNM<double, 1, 9>;

    ChElementBeamANCF_MT04();
    ~ChElementBeamANCF_MT04() {}
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MT04> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_MT04> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_MT04> m_material;    ///< beam material
