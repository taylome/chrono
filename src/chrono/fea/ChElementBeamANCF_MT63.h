...
#ifndef CHELEMENTBEAMANCFMT63_H
#define CHELEMENTBEAMANCFMT63_H
...
class ChApi ChMaterialBeamANCF_MT63 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_MT63(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_MT63 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MT63> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_MT63> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_MT63> m_material;    ///< beam material
