...
#ifndef CHELEMENTBEAMANCF3243TR08_H
#define CHELEMENTBEAMANCF3243TR08_H
...
class ChApi ChMaterialBeamANCF_3243_TR08 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_3243_TR08(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_3243_TR08 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_3243_TR08> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_3243_TR08> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_3243_TR08> m_material;  ///< beam material
