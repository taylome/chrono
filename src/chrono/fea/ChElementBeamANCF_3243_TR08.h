...
#ifndef CHELEMENTBEAMANCF3243_TR08_H
#define CHELEMENTBEAMANCF3243_TR08_H
...
class ChApi ChElementBeamANCF_3243_TR08 : public ChElementANCF,
  ...
  public:
    ...
    static const unsigned int NIP_D0 = NP * NT * NT;  ///< number of Gauss quadrature points excluding the Poisson effect for the
                                             ///< Enhanced Continuum Mechanics method
    static const unsigned int NIP_Dv =
    ...
    static const unsigned int NSF = 8;  ///< number of shape functions
  ...
  public:
    ...
    // Dummy method definition - Does not translate to an ANCF continuum mechanics based beam element
    virtual void EvaluateSectionForceTorque(const double, ChVector3d&, ChVector3d&) override {}
