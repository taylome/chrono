...
ChElementBrickANCF_3843_TR07S::ChElementBrickANCF_3843_TR07S()
...
void ChElementBrickANCF_3843_TR07S::SetNodes(std::shared_ptr<ChNodeFEAxyzDDD> nodeA,
...
void ChElementBrickANCF_3843_TR07S::SetupInitial(ChSystem* system) {
    // Initial positions and slopes of the element nodes
    // These values define the reference configuration of the element
    CalcCoordMatrix(m_ebar0);
...
// State update.
void ChElementBrickANCF_3843_TR07S::Update() {
    ChElementGeneric::Update();
}

// Fill the D vector with the current field values at the element nodes.
void ChElementBrickANCF_3843_TR07S::GetStateBlock(ChVectorDynamic<>& mD) {
...
void ChElementBrickANCF_3843_TR07S::ComputeKRMmatricesGlobal(ChMatrixRef H,
    double Kfactor,
    double Rfactor,
    double Mfactor) {
...
void ChElementBrickANCF_3843_TR07S::ComputeMmatrixGlobal(ChMatrixRef M) {
    M.setZero();
...
// -----------------------------------------------------------------------------
void ChElementBrickANCF_3843_TR07S::ComputeMassMatrixAndGravityForce(const ChVector<>& g_acc) {
...
void ChElementBrickANCF_3843_TR07S::ComputeNodalMass() {
...
void ChElementBrickANCF_3843_TR07S::PrecomputeInternalForceMatricesWeights() {
    ChQuadratureTables* GQTable = GetStaticGQTables();
...
void ChElementBrickANCF_3843_TR07S::SetAlphaDamp(double a) {
    m_Alpha = a;
    m_2Alpha = 2 * a;
...
void ChElementBrickANCF_3843_TR07S::ComputeInternalForces(ChVectorDynamic<>& Fi) {
...
void ChElementBrickANCF_3843_TR07S::ComputeInternalForcesAtState(ChVectorDynamic<>& Fi,
    ...
    VectorNIP E0_Block = m_F_Transpose_CombinedBlockDamping_col_ordered.block<216, 1>(0, 0).cwiseProduct(
    ...
    E0_Block.array() -= 1;
    E0_Block *= 0.5;
    VectorNIP E_BlockDamping = m_F_Transpose_CombinedBlockDamping_col_ordered.block<216, 1>(0, 0).cwiseProduct(
    ...
    VectorNIP E1_Block = m_F_Transpose_CombinedBlockDamping_col_ordered.block<216, 1>(216, 0).cwiseProduct(
    ...
    VectorNIP E2_Block = m_F_Transpose_CombinedBlockDamping_col_ordered.block<216, 1>(432, 0).cwiseProduct(
    ...
    VectorNIP E3_Block = m_F_Transpose_CombinedBlockDamping_col_ordered.block<216, 1>(216, 0).cwiseProduct(
        m_F_Transpose_CombinedBlockDamping_col_ordered.block<216, 1>(432, 0));
    ...
    VectorNIP E4_Block = m_F_Transpose_CombinedBlockDamping_col_ordered.block<216, 1>(0, 0).cwiseProduct(
        m_F_Transpose_CombinedBlockDamping_col_ordered.block<216, 1>(432, 0));
    ...
    VectorNIP E5_Block = m_F_Transpose_CombinedBlockDamping_col_ordered.block<216, 1>(0, 0).cwiseProduct(
        m_F_Transpose_CombinedBlockDamping_col_ordered.block<216, 1>(216, 0));
...
void ChElementBrickANCF_3843_TR07S::ComputeInternalForcesAtStateNoDamping(ChVectorDynamic<>& Fi,
...
void ChElementBrickANCF_3843_TR07S::ComputeInternalJacobians(Matrix3Nx3N& JacobianMatrix,
    double Kfactor,
    double Rfactor) {
...
void ChElementBrickANCF_3843_TR07S::ComputeInternalJacobianDamping(ChMatrixRef& H,
    double Kfactor,
    double Rfactor,
    double Mfactor) {
    ...
    //    (m_Alpha * Kfactor) * m_F_Transpose_CombinedBlockDamping_col_ordered.block<648, 3>(0, 3);
    ChMatrixNMc<double, 648, 3> scaled_F_Transpose_col_ordered = (Kfactor + m_Alpha * Rfactor) * m_F_Transpose_CombinedBlockDamping_col_ordered.block<648, 3>(0, 0) +
            (m_Alpha * Kfactor) * m_F_Transpose_CombinedBlockDamping_col_ordered.block<648, 3>(0, 3);
...
void ChElementBrickANCF_3843_TR07S::ComputeInternalJacobianNoDamping(ChMatrixRef& H, double Kfactor, double Mfactor) {
    // ChMatrixNM<double, 48, 180> partial_epsilon_partial_e_Transpose;
    //Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor, 48, 432> partial_epsilon_partial_e_Transpose;
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor> partial_epsilon_partial_e_Transpose;
    partial_epsilon_partial_e_Transpose.resize(96, 1296);
    ...
    ChMatrixNMc<double, 648, 3> scaled_F_Transpose_col_ordered = Kfactor * m_F_Transpose_CombinedBlock_col_ordered;
...
void ChElementBrickANCF_3843_TR07S::Calc_Sxi(Matrix3x3N& Sxi, double xi, double eta, double zeta) {
    VectorN Sxi_compact;
    Calc_Sxi_compact(Sxi_compact, xi, eta, zeta);
    Sxi.setZero();
...
// [s1; s2; s3; ...]
void ChElementBrickANCF_3843_TR07S::Calc_Sxi_compact(VectorN& Sxi_compact, double xi, double eta, double zeta) {
...
// [s1*I_3x3, s2*I_3x3, s3*I_3x3, ...]
void ChElementBrickANCF_3843_TR07S::Calc_Sxi_xi(Matrix3x3N& Sxi_xi, double xi, double eta, double zeta) {
...
// [s1; s2; s3; ...]
void ChElementBrickANCF_3843_TR07S::Calc_Sxi_xi_compact(VectorN& Sxi_xi_compact, double xi, double eta, double zeta) {
...
// [s1*I_3x3, s2*I_3x3, s3*I_3x3, ...]
void ChElementBrickANCF_3843_TR07S::Calc_Sxi_eta(Matrix3x3N& Sxi_eta, double xi, double eta, double zeta) {
...
// [s1; s2; s3; ...]
void ChElementBrickANCF_3843_TR07S::Calc_Sxi_eta_compact(VectorN& Sxi_eta_compact, double xi, double eta, double zeta) {
...
// [s1*I_3x3, s2*I_3x3, s3*I_3x3, ...]
void ChElementBrickANCF_3843_TR07S::Calc_Sxi_zeta(Matrix3x3N& Sxi_zeta, double xi, double eta, double zeta) {
...
// [s1; s2; s3; ...]
void ChElementBrickANCF_3843_TR07S::Calc_Sxi_zeta_compact(VectorN& Sxi_zeta_compact,
                                                         double xi,
                                                         double eta,
                                                         double zeta) {
...
void ChElementBrickANCF_3843_TR07S::Calc_Sxi_D(MatrixNx3c& Sxi_D, double xi, double eta, double zeta) {
...
void ChElementBrickANCF_3843_TR07S::CalcCoordVector(Vector3N& e) {
...
void ChElementBrickANCF_3843_TR07S::CalcCoordMatrix(Matrix3xN& ebar) {
...
void ChElementBrickANCF_3843_TR07S::CalcCoordMatrix(MatrixNx3c& ebar) {
...
void ChElementBrickANCF_3843_TR07S::CalcCoordMatrix(MatrixNx3& ebar) {
    ebar.row(0) = m_nodes[0]->GetPos().eigen();
    ebar.row(1) = m_nodes[0]->GetD().eigen();
    ebar.row(2) = m_nodes[0]->GetDD().eigen();
    ebar.row(3) = m_nodes[0]->GetDDD().eigen();
...
void ChElementBrickANCF_3843_TR07S::CalcCoordDerivVector(Vector3N& edot) {
...
void ChElementBrickANCF_3843_TR07S::CalcCoordDerivMatrix(Matrix3xN& ebardot) {
...
void ChElementBrickANCF_3843_TR07S::CalcCoordDerivMatrix(MatrixNx3c& ebardot) {
...
void ChElementBrickANCF_3843_TR07S::CalcCombinedCoordMatrix(MatrixNx6& ebar_ebardot) {
...
void ChElementBrickANCF_3843_TR07S::Calc_J_0xi(ChMatrix33<double>& J_0xi, double xi, double eta, double zeta) {
    MatrixNx3c Sxi_D;
    Calc_Sxi_D(Sxi_D, xi, eta, zeta);
...
double ChElementBrickANCF_3843_TR07S::Calc_det_J_0xi(double xi, double eta, double zeta) {
...
void ChElementBrickANCF_3843_TR07S::EvaluateSectionFrame(const double xi,
                                                        const double eta,
                                                        const double zeta,
                                                        ChVector<>& point,
                                                        ChQuaternion<>& rot) {
...
void ChElementBrickANCF_3843_TR07S::EvaluateSectionPoint(const double u, const double v, const double w, ChVector<>& point) {
    Matrix3x3N Sxi;
    Calc_Sxi(Sxi, u, v, w);
...
void ChElementBrickANCF_3843_TR07S::LoadableGetStateBlock_x(int block_offset, ChState& mD) {
...
void ChElementBrickANCF_3843_TR07S::LoadableGetStateBlock_w(int block_offset, ChStateDelta& mD) {
...
void ChElementBrickANCF_3843_TR07S::LoadableStateIncrement(const unsigned int off_x,
                                                          ChState& x_new,
                                                          const ChState& x,
...
void ChElementBrickANCF_3843_TR07S::LoadableGetVariables(std::vector<ChVariables*>& mvars) {
...
void ChElementBrickANCF_3843_TR07S::ComputeNF(
...
double ChElementBrickANCF_3843_TR07S::GetDensity() {
...
ChQuadratureTables static_tables_3843_TR07S(1, CH_QUADRATURE_STATIC_TABLES);
//#endif // !CH_QUADRATURE_STATIC_TABLES

ChQuadratureTables* ChElementBrickANCF_3843_TR07S::GetStaticGQTables() {
    return &static_tables_3843_TR07S;
}

////////////////////////////////////////////////////////////////

// ============================================================================
// Implementation of ChMaterialBrickANCF_3843_TR07S methods
// ============================================================================

// Construct an isotropic material.
ChMaterialBrickANCF_3843_TR07S::ChMaterialBrickANCF_3843_TR07S(double rho,  // material density
...
ChMaterialBrickANCF_3843_TR07S::ChMaterialBrickANCF_3843_TR07S(
...
// Poisson effect
void ChMaterialBrickANCF_3843_TR07S::Calc_D0_Dv(const ChVector<>& E, const ChVector<>& nu, const ChVector<>& G) {
