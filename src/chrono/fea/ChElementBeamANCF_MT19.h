...
#ifndef CHELEMENTBEAMANCFMT19_H
#define CHELEMENTBEAMANCFMT19_H
...
class ChApi ChMaterialBeamANCF_MT19 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_MT19(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_MT19 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MT19> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_MT19> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_MT19> m_material;    ///< beam material
