...
ChElementHexaANCF_3843_TR10::ChElementHexaANCF_3843_TR10()
...
void ChElementHexaANCF_3843_TR10::SetNodes(std::shared_ptr<ChNodeFEAxyzDDD> nodeA,
...
void ChElementHexaANCF_3843_TR10::SetDimensions(double lenX, double lenY, double lenZ) {
    m_lenX = lenX;
    m_lenY = lenY;
    m_lenZ = lenZ;
}
...
void ChElementHexaANCF_3843_TR10::SetMaterial(std::shared_ptr<ChMaterialHexaANCF> brick_mat) {
    m_material = brick_mat;
}

// Set the value for the single term structural damping coefficient.

void ChElementHexaANCF_3843_TR10::SetAlphaDamp(double a) {
    m_Alpha = a;
...
ChMatrix33<> ChElementHexaANCF_3843_TR10::GetGreenLagrangeStrain(const double xi, const double eta, const double zeta) {
...
ChMatrix33<> ChElementHexaANCF_3843_TR10::GetPK2Stress(const double xi, const double eta, const double zeta) {
    MatrixNx3c Sxi_D;  // Matrix of normalized shape function derivatives
    Calc_Sxi_D(Sxi_D, xi, eta, zeta);
...
double ChElementHexaANCF_3843_TR10::GetVonMissesStress(const double xi, const double eta, const double zeta) {
    MatrixNx3c Sxi_D;  // Matrix of normalized shape function derivatives
    Calc_Sxi_D(Sxi_D, xi, eta, zeta);
...
void ChElementHexaANCF_3843_TR10::SetupInitial(ChSystem* system) {
...
void ChElementHexaANCF_3843_TR10::GetStateBlock(ChVectorDynamic<>& mD) {
...
void ChElementHexaANCF_3843_TR10::Update() {
    ChElementGeneric::Update();
}

// Return the mass matrix in full sparse form.

void ChElementHexaANCF_3843_TR10::ComputeMmatrixGlobal(ChMatrixRef M) {
    M.setZero();
...
void ChElementHexaANCF_3843_TR10::ComputeNodalMass() {
    m_nodes[0]->m_TotalMass += m_MassMatrix(0, 0) + m_MassMatrix(0, 4) + m_MassMatrix(0, 8) + m_MassMatrix(0, 12) +
                               m_MassMatrix(0, 16) + m_MassMatrix(0, 20) + m_MassMatrix(0, 24) + m_MassMatrix(0, 28);
    m_nodes[1]->m_TotalMass += m_MassMatrix(4, 0) + m_MassMatrix(4, 4) + m_MassMatrix(4, 8) + m_MassMatrix(4, 12) +
                               m_MassMatrix(4, 16) + m_MassMatrix(4, 20) + m_MassMatrix(4, 24) + m_MassMatrix(4, 28);
    m_nodes[2]->m_TotalMass += m_MassMatrix(8, 0) + m_MassMatrix(8, 4) + m_MassMatrix(8, 8) + m_MassMatrix(8, 12) +
                               m_MassMatrix(8, 16) + m_MassMatrix(8, 20) + m_MassMatrix(8, 24) + m_MassMatrix(8, 28);
    m_nodes[3]->m_TotalMass += m_MassMatrix(12, 0) + m_MassMatrix(12, 4) + m_MassMatrix(12, 8) + m_MassMatrix(12, 12) +
                               m_MassMatrix(12, 16) + m_MassMatrix(12, 20) + m_MassMatrix(12, 24) +
                               m_MassMatrix(12, 28);
    m_nodes[4]->m_TotalMass += m_MassMatrix(16, 0) + m_MassMatrix(16, 4) + m_MassMatrix(16, 8) + m_MassMatrix(16, 12) +
                               m_MassMatrix(16, 16) + m_MassMatrix(16, 20) + m_MassMatrix(16, 24) +
                               m_MassMatrix(16, 28);
    m_nodes[5]->m_TotalMass += m_MassMatrix(20, 0) + m_MassMatrix(20, 4) + m_MassMatrix(20, 8) + m_MassMatrix(20, 12) +
                               m_MassMatrix(20, 16) + m_MassMatrix(20, 20) + m_MassMatrix(20, 24) +
                               m_MassMatrix(20, 28);
    m_nodes[6]->m_TotalMass += m_MassMatrix(24, 0) + m_MassMatrix(24, 4) + m_MassMatrix(24, 8) + m_MassMatrix(24, 12) +
                               m_MassMatrix(24, 16) + m_MassMatrix(24, 20) + m_MassMatrix(24, 24) +
                               m_MassMatrix(24, 28);
    m_nodes[7]->m_TotalMass += m_MassMatrix(28, 0) + m_MassMatrix(28, 4) + m_MassMatrix(28, 8) + m_MassMatrix(28, 12) +
                               m_MassMatrix(28, 16) + m_MassMatrix(28, 20) + m_MassMatrix(28, 24) +
                               m_MassMatrix(28, 28);
}

void ChElementHexaANCF_3843_TR10::ComputeInternalForces(ChVectorDynamic<>& Fi) {
...
void ChElementHexaANCF_3843_TR10::ComputeKRMmatricesGlobal(ChMatrixRef H,
                                                           double Kfactor,
                                                           double Rfactor,
                                                           double Mfactor) {
    ...
    // from its [9 x NSF^2] form into its required [3*NSF x 3*NSF]
...
void ChElementHexaANCF_3843_TR10::ComputeGravityForces(ChVectorDynamic<>& Fg, const ChVector<>& G_acc) {
...
void ChElementHexaANCF_3843_TR10::EvaluateElementFrame(const double xi,
                                                       const double eta,
                                                       const double zeta,
                                                       ChVector<>& point,
                                                       ChQuaternion<>& rot) {
...
void ChElementHexaANCF_3843_TR10::EvaluateElementPoint(const double xi,
                                                       const double eta,
                                                       const double zeta,
                                                       ChVector<>& point) {
    VectorN Sxi_compact;
...
void ChElementHexaANCF_3843_TR10::EvaluateElementVel(double xi, double eta, const double zeta, ChVector<>& Result) {
    VectorN Sxi_compact;
    Calc_Sxi_compact(Sxi_compact, xi, eta, zeta);
...
void ChElementHexaANCF_3843_TR10::LoadableGetStateBlock_x(int block_offset, ChState& mD) {
...
void ChElementHexaANCF_3843_TR10::LoadableGetStateBlock_w(int block_offset, ChStateDelta& mD) {
...
void ChElementHexaANCF_3843_TR10::LoadableStateIncrement(const unsigned int off_x,
                                                         ChState& x_new,
                                                         const ChState& x,
...
void ChElementHexaANCF_3843_TR10::LoadableGetVariables(std::vector<ChVariables*>& mvars) {
...
void ChElementHexaANCF_3843_TR10::ComputeNF(
...
double ChElementHexaANCF_3843_TR10::GetDensity() {
...
void ChElementHexaANCF_3843_TR10::ComputeMassMatrixAndGravityForce() {
...
void ChElementHexaANCF_3843_TR10::PrecomputeInternalForceMatricesWeights() {
    ChQuadratureTables* GQTable = GetStaticGQTables();
...
void ChElementHexaANCF_3843_TR10::Calc_Sxi_compact(VectorN& Sxi_compact, double xi, double eta, double zeta) {
    Sxi_compact(0) =
...
void ChElementHexaANCF_3843_TR10::Calc_Sxi_xi_compact(VectorN& Sxi_xi_compact, double xi, double eta, double zeta) {
...
void ChElementHexaANCF_3843_TR10::Calc_Sxi_eta_compact(VectorN& Sxi_eta_compact, double xi, double eta, double zeta) {
...
void ChElementHexaANCF_3843_TR10::Calc_Sxi_zeta_compact(VectorN& Sxi_zeta_compact, double xi, double eta, double zeta) {
...
void ChElementHexaANCF_3843_TR10::Calc_Sxi_D(MatrixNx3c& Sxi_D, double xi, double eta, double zeta) {
    VectorN Sxi_D_col;
...
void ChElementHexaANCF_3843_TR10::CalcCoordVector(Vector3N& e) {
...
void ChElementHexaANCF_3843_TR10::CalcCoordMatrix(Matrix3xN& ebar) {
...
void ChElementHexaANCF_3843_TR10::CalcCoordDerivVector(Vector3N& edot) {
...
void ChElementHexaANCF_3843_TR10::CalcCoordDerivMatrix(Matrix3xN& ebardot) {
...
void ChElementHexaANCF_3843_TR10::CalcCombinedCoordMatrix(Matrix6xN& ebar_ebardot) {
...
void ChElementHexaANCF_3843_TR10::CalcCombinedCoordMatrix(MatrixNx6& ebar_ebardot) {
...
void ChElementHexaANCF_3843_TR10::Calc_J_0xi(ChMatrix33<double>& J_0xi, double xi, double eta, double zeta) {
    MatrixNx3c Sxi_D;
    Calc_Sxi_D(Sxi_D, xi, eta, zeta);
...
double ChElementHexaANCF_3843_TR10::Calc_det_J_0xi(double xi, double eta, double zeta) {
...
ChQuadratureTables static_tables_3843_TR10(1, CH_QUADRATURE_STATIC_TABLES);
//#endif // !CH_QUADRATURE_STATIC_TABLES

ChQuadratureTables* ChElementHexaANCF_3843_TR10::GetStaticGQTables() {
    return &static_tables_3843_TR10;
}
