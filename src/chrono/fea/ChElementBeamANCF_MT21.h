...
#ifndef CHELEMENTBEAMANCFMT21_H
#define CHELEMENTBEAMANCFMT21_H
...
class ChApi ChMaterialBeamANCF_MT21 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_MT21(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_MT21 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MT21> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_MT21> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_MT21> m_material;    ///< beam material
