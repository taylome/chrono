...
#ifndef CHELEMENTSHELLANCF3443MLTR07S_H
#define CHELEMENTSHELLANCF3443MLTR07S_H
...
class ChApi ChMaterialShellANCF_3443ML_TR07S {
  public:
    /// Construct an isotropic material.
    ChMaterialShellANCF_3443ML_TR07S(double rho,        ///< material density
...
class ChApi ChElementShellANCF_3443ML_TR07S : public ChElementShell, public ChLoadableUV, public ChLoadableUVW {
  public:
    ...
    ChElementShellANCF_3443ML_TR07S();
    ~ChElementShellANCF_3443ML_TR07S() {}
    ...
    public:
        ...
        std::shared_ptr<ChMaterialShellANCF_3443ML_TR07S> GetMaterial() const { return m_material; }

    private:
        /// Private constructor (a layer can be created only by adding it to an element)
        Layer(ChElementShellANCF_3443ML_TR07S* element,                 ///< containing element
            double thickness,                              ///< layer thickness
            double theta,                                  ///< fiber angle
            std::shared_ptr<ChMaterialShellANCF_3443ML_TR07S> material  ///< layer material
        );

        ChElementShellANCF_3443ML_TR07S* m_element;                  ///< containing ANCF shell element
        std::shared_ptr<ChMaterialShellANCF_3443ML_TR07S> m_material;  ///< layer material
    ...
    public:
        ...
        friend class ChElementShellANCF_3443ML_TR07S;
    };
