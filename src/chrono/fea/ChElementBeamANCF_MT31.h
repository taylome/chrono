...
#ifndef CHELEMENTBEAMANCFMT31_H
#define CHELEMENTBEAMANCFMT31_H
...
class ChApi ChMaterialBeamANCF_MT31 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_MT31(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_MT31 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MT31> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_MT31> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_MT31> m_material;    ///< beam material
