...
#ifndef CHELEMENTSHELLANCF3833MLTR08S_H
#define CHELEMENTSHELLANCF3833MLTR08S_H
...
class ChApi ChMaterialShellANCF_3833ML_TR08S {
  public:
    /// Construct an isotropic material.
    ChMaterialShellANCF_3833ML_TR08S(double rho,        ///< material density
...
class ChApi ChElementShellANCF_3833ML_TR08S : public ChElementShell, public ChLoadableUV, public ChLoadableUVW {
  public:
    ...
    ChElementShellANCF_3833ML_TR08S();
    ~ChElementShellANCF_3833ML_TR08S() {}
    ...
    public:
        ...
        std::shared_ptr<ChMaterialShellANCF_3833ML_TR08S> GetMaterial() const { return m_material; }

    private:
        /// Private constructor (a layer can be created only by adding it to an element)
        Layer(ChElementShellANCF_3833ML_TR08S* element,                 ///< containing element
            double thickness,                              ///< layer thickness
            double theta,                                  ///< fiber angle
            std::shared_ptr<ChMaterialShellANCF_3833ML_TR08S> material  ///< layer material
        );

        ChElementShellANCF_3833ML_TR08S* m_element;                  ///< containing ANCF shell element
        std::shared_ptr<ChMaterialShellANCF_3833ML_TR08S> m_material;  ///< layer material
    ...
    public:
        ...
        friend class ChElementShellANCF_3833ML_TR08S;
    };
