...
// =============================================================================
//
// MT37 = MT36 with additional optimization (Rearranging Jacobian Code)
...
////
//// What should be done with ChVector<> ChElementBeamANCF_MT37::EvaluateBeamSectionStrains()... It doesn't seems to make sense for this element since there are no input arguments
...
////
//// For ChElementBeamANCF_MT37::ComputeNF, Need to figure out the state update stuff and exactly what Jacobian is being asked for
...
ChElementBeamANCF_MT37::ChElementBeamANCF_MT37() : m_gravity_on(false), m_thicknessY(0), m_thicknessZ(0), m_lenX(0), m_Alpha(0), m_damping_enabled(false){
    m_nodes.resize(3);
...
void ChElementBeamANCF_MT37::SetNodes(std::shared_ptr<ChNodeFEAxyzDD> nodeA,
...
void ChElementBeamANCF_MT37::SetupInitial(ChSystem* system) {
...
// State update.
void ChElementBeamANCF_MT37::Update() {
    ChElementGeneric::Update();
}

// Fill the D vector with the current field values at the element nodes.
void ChElementBeamANCF_MT37::GetStateBlock(ChVectorDynamic<>& mD) {
...
void ChElementBeamANCF_MT37::ComputeKRMmatricesGlobal(ChMatrixRef H, double Kfactor, double Rfactor, double Mfactor) {
...
void ChElementBeamANCF_MT37::ComputeInternalJacobianDamping(ChMatrixRef H, double Kfactor, double Rfactor, double Mfactor) {
    ...
    //ChMatrixNM<double, 9, 180> partial_epsilon_partial_e_Transpose_Block1;
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor, 9, 180> partial_epsilon_partial_e_Transpose_Block1;
    partial_epsilon_partial_e_Transpose_Block1.resize(9, 108);

    for (auto i = 0; i < 9; i++) {
        partial_epsilon_partial_e_Transpose_Block1.block<1, 16>(i, 0).noalias() = m_SD_precompute_col_ordered.block<1, 16>(i, 0).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(0, 0).transpose());
        partial_epsilon_partial_e_Transpose_Block1.block<1, 16>(i, 16).noalias() = m_SD_precompute_col_ordered.block<1, 16>(i, 16).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(16, 0).transpose());
        partial_epsilon_partial_e_Transpose_Block1.block<1, 16>(i, 32).noalias() = m_SD_precompute_col_ordered.block<1, 16>(i, 32).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(32, 0).transpose());
        partial_epsilon_partial_e_Transpose_Block1.block<1, 16>(i, 48).noalias() = m_SD_precompute_col_ordered.block<1, 16>(i, 32).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(16, 0).transpose())
        ...
        partial_epsilon_partial_e_Transpose_Block1.block<1, 16>(i, 64).noalias() = m_SD_precompute_col_ordered.block<1, 16>(i, 32).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(0, 0).transpose())
        ...
        partial_epsilon_partial_e_Transpose_Block1.block<1, 16>(i, 80).noalias() = m_SD_precompute_col_ordered.block<1, 16>(i, 16).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(0, 0).transpose())
        ...
        partial_epsilon_partial_e_Transpose_Block1.block<1, 4>(i, 96).noalias() = m_SD_precompute_col_ordered.block<1, 4>(i, 48).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<4, 1>(48, 0).transpose());
        partial_epsilon_partial_e_Transpose_Block1.block<1, 4>(i, 100).noalias() = m_SD_precompute_col_ordered.block<1, 4>(i, 52).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<4, 1>(52, 0).transpose());
        partial_epsilon_partial_e_Transpose_Block1.block<1, 4>(i, 104).noalias() = m_SD_precompute_col_ordered.block<1, 4>(i, 56).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<4, 1>(56, 0).transpose());
    }

    //ChMatrixNM<double, 9, 108> partial_epsilon_partial_e_Transpose_Block2;
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor, 9, 180> partial_epsilon_partial_e_Transpose_Block2;
    partial_epsilon_partial_e_Transpose_Block2.resize(9, 108);

    for (auto i = 0; i < 9; i++) {
        partial_epsilon_partial_e_Transpose_Block2.block<1, 16>(i, 0).noalias() = m_SD_precompute_col_ordered.block<1, 16>(i, 0).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(0, 1).transpose());
        partial_epsilon_partial_e_Transpose_Block2.block<1, 16>(i, 16).noalias() = m_SD_precompute_col_ordered.block<1, 16>(i, 16).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(16, 1).transpose());
        partial_epsilon_partial_e_Transpose_Block2.block<1, 16>(i, 32).noalias() = m_SD_precompute_col_ordered.block<1, 16>(i, 32).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(32, 1).transpose());
        partial_epsilon_partial_e_Transpose_Block2.block<1, 16>(i, 48).noalias() = m_SD_precompute_col_ordered.block<1, 16>(i, 32).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(16, 1).transpose())
        ...
        partial_epsilon_partial_e_Transpose_Block2.block<1, 16>(i, 64).noalias() = m_SD_precompute_col_ordered.block<1, 16>(i, 32).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(0, 1).transpose())
        ...
        partial_epsilon_partial_e_Transpose_Block2.block<1, 16>(i, 80).noalias() = m_SD_precompute_col_ordered.block<1, 16>(i, 16).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(0, 1).transpose())
        ...
        partial_epsilon_partial_e_Transpose_Block2.block<1, 4>(i, 96).noalias() = m_SD_precompute_col_ordered.block<1, 4>(i, 48).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<4, 1>(48, 1).transpose());
        partial_epsilon_partial_e_Transpose_Block2.block<1, 4>(i, 100).noalias() = m_SD_precompute_col_ordered.block<1, 4>(i, 52).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<4, 1>(52, 1).transpose());
        partial_epsilon_partial_e_Transpose_Block2.block<1, 4>(i, 104).noalias() = m_SD_precompute_col_ordered.block<1, 4>(i, 56).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<4, 1>(56, 1).transpose());
    }

    //ChMatrixNM<double, 9, 108> partial_epsilon_partial_e_Transpose_Block3;
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor, 9, 180> partial_epsilon_partial_e_Transpose_Block3;
    partial_epsilon_partial_e_Transpose_Block3.resize(9, 108);

    for (auto i = 0; i < 9; i++) {
        partial_epsilon_partial_e_Transpose_Block3.block<1, 16>(i, 0).noalias() = m_SD_precompute_col_ordered.block<1, 16>(i, 0).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(0, 2).transpose());
        partial_epsilon_partial_e_Transpose_Block3.block<1, 16>(i, 16).noalias() = m_SD_precompute_col_ordered.block<1, 16>(i, 16).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(16, 2).transpose());
        partial_epsilon_partial_e_Transpose_Block3.block<1, 16>(i, 32).noalias() = m_SD_precompute_col_ordered.block<1, 16>(i, 32).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(32, 2).transpose());
        partial_epsilon_partial_e_Transpose_Block3.block<1, 16>(i, 48).noalias() = m_SD_precompute_col_ordered.block<1, 16>(i, 32).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(16, 2).transpose())
        ...
        partial_epsilon_partial_e_Transpose_Block3.block<1, 16>(i, 64).noalias() = m_SD_precompute_col_ordered.block<1, 16>(i, 32).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(0, 2).transpose())
        ...
        partial_epsilon_partial_e_Transpose_Block3.block<1, 16>(i, 80).noalias() = m_SD_precompute_col_ordered.block<1, 16>(i, 16).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(0, 2).transpose())
        ...
        partial_epsilon_partial_e_Transpose_Block3.block<1, 4>(i, 96).noalias() = m_SD_precompute_col_ordered.block<1, 4>(i, 48).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<4, 1>(48, 2).transpose());
        partial_epsilon_partial_e_Transpose_Block3.block<1, 4>(i, 100).noalias() = m_SD_precompute_col_ordered.block<1, 4>(i, 52).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<4, 1>(52, 2).transpose());
        partial_epsilon_partial_e_Transpose_Block3.block<1, 4>(i, 104).noalias() = m_SD_precompute_col_ordered.block<1, 4>(i, 56).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<4, 1>(56, 2).transpose());
    }
    ...
    //ChMatrixNM<double, 9, 108> Scaled_Combined_partial_epsilon_partial_e_Transpose_Block1;
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor, 9, 180> Scaled_Combined_partial_epsilon_partial_e_Transpose_Block1;
    Scaled_Combined_partial_epsilon_partial_e_Transpose_Block1.resize(9, 108);

    ChVectorN<double, 6> D0 = GetMaterial()->Get_D0();
    
    for (auto i = 0; i < 9; i++) {
        Scaled_Combined_partial_epsilon_partial_e_Transpose_Block1.block<1, 16>(i, 0).noalias() = D0(0)*m_SD_precompute_col_ordered.block<1, 16>(i, 0).cwiseProduct(scaled_F_Transpose_col_ordered.block<16, 1>(0, 0).transpose());
        Scaled_Combined_partial_epsilon_partial_e_Transpose_Block1.block<1, 16>(i, 16).noalias() = D0(1)*m_SD_precompute_col_ordered.block<1, 16>(i, 16).cwiseProduct(scaled_F_Transpose_col_ordered.block<16, 1>(16, 0).transpose());
        Scaled_Combined_partial_epsilon_partial_e_Transpose_Block1.block<1, 16>(i, 32).noalias() = D0(2)*m_SD_precompute_col_ordered.block<1, 16>(i, 32).cwiseProduct(scaled_F_Transpose_col_ordered.block<16, 1>(32, 0).transpose());
        Scaled_Combined_partial_epsilon_partial_e_Transpose_Block1.block<1, 16>(i, 48).noalias() = D0(3)*(m_SD_precompute_col_ordered.block<1, 16>(i, 32).cwiseProduct(scaled_F_Transpose_col_ordered.block<16, 1>(16, 0).transpose())
            + m_SD_precompute_col_ordered.block<1, 16>(i, 16).cwiseProduct(scaled_F_Transpose_col_ordered.block<16, 1>(32, 0).transpose()));
        Scaled_Combined_partial_epsilon_partial_e_Transpose_Block1.block<1, 16>(i, 64).noalias() = D0(4)*(m_SD_precompute_col_ordered.block<1, 16>(i, 32).cwiseProduct(scaled_F_Transpose_col_ordered.block<16, 1>(0, 0).transpose())
            + m_SD_precompute_col_ordered.block<1, 16>(i, 0).cwiseProduct(scaled_F_Transpose_col_ordered.block<16, 1>(32, 0).transpose()));
        Scaled_Combined_partial_epsilon_partial_e_Transpose_Block1.block<1, 16>(i, 80).noalias() = D0(5)*(m_SD_precompute_col_ordered.block<1, 16>(i, 16).cwiseProduct(scaled_F_Transpose_col_ordered.block<16, 1>(0, 0).transpose())
    ...
    //for (auto i = 0; i < 9; i++) {
    //    ChunkSDvA1.block<1, 4>(i, 0).noalias() = m_SD_precompute_col_ordered.block<1, 4>(i, 48).cwiseProduct(scaled_F_Transpose_col_ordered.block<4, 1>(48, 0).transpose());
    //    ChunkSDvB4.block<1, 4>(i, 0).noalias() = m_SD_precompute_col_ordered.block<1, 4>(i, 52).cwiseProduct(scaled_F_Transpose_col_ordered.block<4, 1>(52, 0).transpose());
    //    ChunkSDvC7.block<1, 4>(i, 0).noalias() = m_SD_precompute_col_ordered.block<1, 4>(i, 56).cwiseProduct(scaled_F_Transpose_col_ordered.block<4, 1>(56, 0).transpose());
    //}

    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor, 9, 4> ChunkSDvA;
    ChunkSDvA.resize(9, 4);
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor, 9, 4> ChunkSDvB;
    ChunkSDvB.resize(9, 4);
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor, 9, 4> ChunkSDvC;
    ChunkSDvC.resize(9, 4);

    for (auto i = 0; i < 9; i++) {
        ChunkSDvA.block<1, 4>(i, 0).noalias() = m_SD_precompute_col_ordered.block<1, 4>(i, 48).cwiseProduct(scaled_F_Transpose_col_ordered.block<4, 1>(48, 0).transpose());
        ChunkSDvB.block<1, 4>(i, 0).noalias() = m_SD_precompute_col_ordered.block<1, 4>(i, 52).cwiseProduct(scaled_F_Transpose_col_ordered.block<4, 1>(52, 0).transpose());
        ChunkSDvC.block<1, 4>(i, 0).noalias() = m_SD_precompute_col_ordered.block<1, 4>(i, 56).cwiseProduct(scaled_F_Transpose_col_ordered.block<4, 1>(56, 0).transpose());
    }

    ChMatrix33<double> Dv = GetMaterial()->Get_Dv();

    //Scaled_Combined_partial_epsilon_partial_e_Transpose_Block1.block<9, 4>(0, 96).noalias() = Dv(0, 0)*ChunkSDvA1 + Dv(0, 1)*ChunkSDvB4 + Dv(0, 2)*ChunkSDvC7;
    //Scaled_Combined_partial_epsilon_partial_e_Transpose_Block1.block<9, 4>(0, 100).noalias() = Dv(1, 0)*ChunkSDvA1 + Dv(1, 1)*ChunkSDvB4 + Dv(1, 2)*ChunkSDvC7;
    //Scaled_Combined_partial_epsilon_partial_e_Transpose_Block1.block<9, 4>(0, 104).noalias() = Dv(2, 0)*ChunkSDvA1 + Dv(2, 1)*ChunkSDvB4 + Dv(2, 2)*ChunkSDvC7;
    Scaled_Combined_partial_epsilon_partial_e_Transpose_Block1.block<9, 4>(0, 96).noalias() = Dv(0, 0)*ChunkSDvA + Dv(0, 1)*ChunkSDvB + Dv(0, 2)*ChunkSDvC;
    Scaled_Combined_partial_epsilon_partial_e_Transpose_Block1.block<9, 4>(0, 100).noalias() = Dv(1, 0)*ChunkSDvA + Dv(1, 1)*ChunkSDvB + Dv(1, 2)*ChunkSDvC;
    Scaled_Combined_partial_epsilon_partial_e_Transpose_Block1.block<9, 4>(0, 104).noalias() = Dv(2, 0)*ChunkSDvA + Dv(2, 1)*ChunkSDvB + Dv(2, 2)*ChunkSDvC;

    //ChMatrixNM<double, 9, 108> Scaled_Combined_partial_epsilon_partial_e_Transpose_Block2;
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor, 9, 180> Scaled_Combined_partial_epsilon_partial_e_Transpose_Block2;
    Scaled_Combined_partial_epsilon_partial_e_Transpose_Block2.resize(9, 108);

    for (auto i = 0; i < 9; i++) {
        Scaled_Combined_partial_epsilon_partial_e_Transpose_Block2.block<1, 16>(i, 0).noalias() = D0(0)*m_SD_precompute_col_ordered.block<1, 16>(i, 0).cwiseProduct(scaled_F_Transpose_col_ordered.block<16, 1>(0, 1).transpose());
        Scaled_Combined_partial_epsilon_partial_e_Transpose_Block2.block<1, 16>(i, 16).noalias() = D0(1)*m_SD_precompute_col_ordered.block<1, 16>(i, 16).cwiseProduct(scaled_F_Transpose_col_ordered.block<16, 1>(16, 1).transpose());
        Scaled_Combined_partial_epsilon_partial_e_Transpose_Block2.block<1, 16>(i, 32).noalias() = D0(2)*m_SD_precompute_col_ordered.block<1, 16>(i, 32).cwiseProduct(scaled_F_Transpose_col_ordered.block<16, 1>(32, 1).transpose());
        Scaled_Combined_partial_epsilon_partial_e_Transpose_Block2.block<1, 16>(i, 48).noalias() = D0(3)*(m_SD_precompute_col_ordered.block<1, 16>(i, 32).cwiseProduct(scaled_F_Transpose_col_ordered.block<16, 1>(16, 1).transpose())
            + m_SD_precompute_col_ordered.block<1, 16>(i, 16).cwiseProduct(scaled_F_Transpose_col_ordered.block<16, 1>(32, 1).transpose()));
        Scaled_Combined_partial_epsilon_partial_e_Transpose_Block2.block<1, 16>(i, 64).noalias() = D0(4)*(m_SD_precompute_col_ordered.block<1, 16>(i, 32).cwiseProduct(scaled_F_Transpose_col_ordered.block<16, 1>(0, 1).transpose())
            + m_SD_precompute_col_ordered.block<1, 16>(i, 0).cwiseProduct(scaled_F_Transpose_col_ordered.block<16, 1>(32, 1).transpose()));
        Scaled_Combined_partial_epsilon_partial_e_Transpose_Block2.block<1, 16>(i, 80).noalias() = D0(5)*(m_SD_precompute_col_ordered.block<1, 16>(i, 16).cwiseProduct(scaled_F_Transpose_col_ordered.block<16, 1>(0, 1).transpose())
    ...
    //for (auto i = 0; i < 9; i++) {
    //    ChunkSDvA2.block<1, 4>(i, 0).noalias() = m_SD_precompute_col_ordered.block<1, 4>(i, 48).cwiseProduct(scaled_F_Transpose_col_ordered.block<4, 1>(48, 1).transpose());
    //    ChunkSDvB5.block<1, 4>(i, 0).noalias() = m_SD_precompute_col_ordered.block<1, 4>(i, 52).cwiseProduct(scaled_F_Transpose_col_ordered.block<4, 1>(52, 1).transpose());
    //    ChunkSDvC8.block<1, 4>(i, 0).noalias() = m_SD_precompute_col_ordered.block<1, 4>(i, 56).cwiseProduct(scaled_F_Transpose_col_ordered.block<4, 1>(56, 1).transpose());
    //}
    //
    //Scaled_Combined_partial_epsilon_partial_e_Transpose_Block2.block<9, 4>(0, 96).noalias() = Dv(0, 0)*ChunkSDvA2 + Dv(0, 1)*ChunkSDvB5 + Dv(0, 2)*ChunkSDvC8;
    //Scaled_Combined_partial_epsilon_partial_e_Transpose_Block2.block<9, 4>(0, 100).noalias() = Dv(1, 0)*ChunkSDvA2 + Dv(1, 1)*ChunkSDvB5 + Dv(1, 2)*ChunkSDvC8;
    //Scaled_Combined_partial_epsilon_partial_e_Transpose_Block2.block<9, 4>(0, 104).noalias() = Dv(2, 0)*ChunkSDvA2 + Dv(2, 1)*ChunkSDvB5 + Dv(2, 2)*ChunkSDvC8;

    for (auto i = 0; i < 9; i++) {
        ChunkSDvA.block<1, 4>(i, 0).noalias() = m_SD_precompute_col_ordered.block<1, 4>(i, 48).cwiseProduct(scaled_F_Transpose_col_ordered.block<4, 1>(48, 1).transpose());
        ChunkSDvB.block<1, 4>(i, 0).noalias() = m_SD_precompute_col_ordered.block<1, 4>(i, 52).cwiseProduct(scaled_F_Transpose_col_ordered.block<4, 1>(52, 1).transpose());
        ChunkSDvC.block<1, 4>(i, 0).noalias() = m_SD_precompute_col_ordered.block<1, 4>(i, 56).cwiseProduct(scaled_F_Transpose_col_ordered.block<4, 1>(56, 1).transpose());
    }

    Scaled_Combined_partial_epsilon_partial_e_Transpose_Block2.block<9, 4>(0, 96).noalias() = Dv(0, 0)*ChunkSDvA + Dv(0, 1)*ChunkSDvB + Dv(0, 2)*ChunkSDvC;
    Scaled_Combined_partial_epsilon_partial_e_Transpose_Block2.block<9, 4>(0, 100).noalias() = Dv(1, 0)*ChunkSDvA + Dv(1, 1)*ChunkSDvB + Dv(1, 2)*ChunkSDvC;
    Scaled_Combined_partial_epsilon_partial_e_Transpose_Block2.block<9, 4>(0, 104).noalias() = Dv(2, 0)*ChunkSDvA + Dv(2, 1)*ChunkSDvB + Dv(2, 2)*ChunkSDvC;


    //ChMatrixNM<double, 9, 108> Scaled_Combined_partial_epsilon_partial_e_Transpose_Block3;
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor, 9, 180> Scaled_Combined_partial_epsilon_partial_e_Transpose_Block3;
    Scaled_Combined_partial_epsilon_partial_e_Transpose_Block3.resize(9, 108);

    for (auto i = 0; i < 9; i++) {
        Scaled_Combined_partial_epsilon_partial_e_Transpose_Block3.block<1, 16>(i, 0).noalias() = D0(0)*m_SD_precompute_col_ordered.block<1, 16>(i, 0).cwiseProduct(scaled_F_Transpose_col_ordered.block<16, 1>(0, 2).transpose());
        Scaled_Combined_partial_epsilon_partial_e_Transpose_Block3.block<1, 16>(i, 16).noalias() = D0(1)*m_SD_precompute_col_ordered.block<1, 16>(i, 16).cwiseProduct(scaled_F_Transpose_col_ordered.block<16, 1>(16, 2).transpose());
        Scaled_Combined_partial_epsilon_partial_e_Transpose_Block3.block<1, 16>(i, 32).noalias() = D0(2)*m_SD_precompute_col_ordered.block<1, 16>(i, 32).cwiseProduct(scaled_F_Transpose_col_ordered.block<16, 1>(32, 2).transpose());
        Scaled_Combined_partial_epsilon_partial_e_Transpose_Block3.block<1, 16>(i, 48).noalias() = D0(3)*(m_SD_precompute_col_ordered.block<1, 16>(i, 32).cwiseProduct(scaled_F_Transpose_col_ordered.block<16, 1>(16, 2).transpose())
            + m_SD_precompute_col_ordered.block<1, 16>(i, 16).cwiseProduct(scaled_F_Transpose_col_ordered.block<16, 1>(32, 2).transpose()));
        Scaled_Combined_partial_epsilon_partial_e_Transpose_Block3.block<1, 16>(i, 64).noalias() = D0(4)*(m_SD_precompute_col_ordered.block<1, 16>(i, 32).cwiseProduct(scaled_F_Transpose_col_ordered.block<16, 1>(0, 2).transpose())
            + m_SD_precompute_col_ordered.block<1, 16>(i, 0).cwiseProduct(scaled_F_Transpose_col_ordered.block<16, 1>(32, 2).transpose()));
        Scaled_Combined_partial_epsilon_partial_e_Transpose_Block3.block<1, 16>(i, 80).noalias() = D0(5)*(m_SD_precompute_col_ordered.block<1, 16>(i, 16).cwiseProduct(scaled_F_Transpose_col_ordered.block<16, 1>(0, 2).transpose())
    ...
    //for (auto i = 0; i < 9; i++) {
    //    ChunkSDvA3.block<1, 4>(i, 0).noalias() = m_SD_precompute_col_ordered.block<1, 4>(i, 48).cwiseProduct(scaled_F_Transpose_col_ordered.block<4, 1>(48, 2).transpose());
    //    ChunkSDvB6.block<1, 4>(i, 0).noalias() = m_SD_precompute_col_ordered.block<1, 4>(i, 52).cwiseProduct(scaled_F_Transpose_col_ordered.block<4, 1>(52, 2).transpose());
    //    ChunkSDvC9.block<1, 4>(i, 0).noalias() = m_SD_precompute_col_ordered.block<1, 4>(i, 56).cwiseProduct(scaled_F_Transpose_col_ordered.block<4, 1>(56, 2).transpose());
    //}

    //Scaled_Combined_partial_epsilon_partial_e_Transpose_Block3.block<9, 4>(0, 96).noalias() = Dv(0, 0)*ChunkSDvA3 + Dv(0, 1)*ChunkSDvB6 + Dv(0, 2)*ChunkSDvC9;
    //Scaled_Combined_partial_epsilon_partial_e_Transpose_Block3.block<9, 4>(0, 100).noalias() = Dv(1, 0)*ChunkSDvA3 + Dv(1, 1)*ChunkSDvB6 + Dv(1, 2)*ChunkSDvC9;
    //Scaled_Combined_partial_epsilon_partial_e_Transpose_Block3.block<9, 4>(0, 104).noalias() = Dv(2, 0)*ChunkSDvA3 + Dv(2, 1)*ChunkSDvB6 + Dv(2, 2)*ChunkSDvC9;

    for (auto i = 0; i < 9; i++) {
        ChunkSDvA.block<1, 4>(i, 0).noalias() = m_SD_precompute_col_ordered.block<1, 4>(i, 48).cwiseProduct(scaled_F_Transpose_col_ordered.block<4, 1>(48, 2).transpose());
        ChunkSDvB.block<1, 4>(i, 0).noalias() = m_SD_precompute_col_ordered.block<1, 4>(i, 52).cwiseProduct(scaled_F_Transpose_col_ordered.block<4, 1>(52, 2).transpose());
        ChunkSDvC.block<1, 4>(i, 0).noalias() = m_SD_precompute_col_ordered.block<1, 4>(i, 56).cwiseProduct(scaled_F_Transpose_col_ordered.block<4, 1>(56, 2).transpose());
    }

    Scaled_Combined_partial_epsilon_partial_e_Transpose_Block3.block<9, 4>(0, 96).noalias() = Dv(0, 0)*ChunkSDvA + Dv(0, 1)*ChunkSDvB + Dv(0, 2)*ChunkSDvC;
    Scaled_Combined_partial_epsilon_partial_e_Transpose_Block3.block<9, 4>(0, 100).noalias() = Dv(1, 0)*ChunkSDvA + Dv(1, 1)*ChunkSDvB + Dv(1, 2)*ChunkSDvC;
    Scaled_Combined_partial_epsilon_partial_e_Transpose_Block3.block<9, 4>(0, 104).noalias() = Dv(2, 0)*ChunkSDvA + Dv(2, 1)*ChunkSDvB + Dv(2, 2)*ChunkSDvC;


    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor, 9, 9> Block11;
    Block11.resize(9, 9);
    Block11.noalias() = partial_epsilon_partial_e_Transpose_Block1 * Scaled_Combined_partial_epsilon_partial_e_Transpose_Block1.transpose();
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor, 9, 9> Block12;
    Block12.resize(9, 9);
    Block12.noalias() = partial_epsilon_partial_e_Transpose_Block1 * Scaled_Combined_partial_epsilon_partial_e_Transpose_Block2.transpose();
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor, 9, 9> Block13;
    Block13.resize(9, 9);
    Block13.noalias() = partial_epsilon_partial_e_Transpose_Block1 * Scaled_Combined_partial_epsilon_partial_e_Transpose_Block3.transpose();

    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor, 9, 9> Block21;
    Block21.resize(9, 9);
    Block21.noalias() = partial_epsilon_partial_e_Transpose_Block2 * Scaled_Combined_partial_epsilon_partial_e_Transpose_Block1.transpose();
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor, 9, 9> Block22;
    Block22.resize(9, 9);
    Block22.noalias() = partial_epsilon_partial_e_Transpose_Block2 * Scaled_Combined_partial_epsilon_partial_e_Transpose_Block2.transpose();
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor, 9, 9> Block23;
    Block23.resize(9, 9);
    Block23.noalias() = partial_epsilon_partial_e_Transpose_Block2* Scaled_Combined_partial_epsilon_partial_e_Transpose_Block3.transpose();

    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor, 9, 9> Block31;
    Block31.resize(9, 9);
    Block31.noalias() = partial_epsilon_partial_e_Transpose_Block3 * Scaled_Combined_partial_epsilon_partial_e_Transpose_Block1.transpose();
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor, 9, 9> Block32;
    Block32.resize(9, 9);
    Block32.noalias() = partial_epsilon_partial_e_Transpose_Block3 * Scaled_Combined_partial_epsilon_partial_e_Transpose_Block2.transpose();
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor, 9, 9> Block33;
    Block33.resize(9, 9);
    Block33.noalias() = partial_epsilon_partial_e_Transpose_Block3 * Scaled_Combined_partial_epsilon_partial_e_Transpose_Block3.transpose();

    //ChMatrixNM<double, 9, 9> Block11 = partial_epsilon_partial_e_Transpose_Block1 * Scaled_Combined_partial_epsilon_partial_e_Transpose_Block1.transpose();
    //ChMatrixNM<double, 9, 9> Block12 = partial_epsilon_partial_e_Transpose_Block1 * Scaled_Combined_partial_epsilon_partial_e_Transpose_Block2.transpose();
    //ChMatrixNM<double, 9, 9> Block13 = partial_epsilon_partial_e_Transpose_Block1 * Scaled_Combined_partial_epsilon_partial_e_Transpose_Block3.transpose();

    //ChMatrixNM<double, 9, 9> Block21 = partial_epsilon_partial_e_Transpose_Block2 * Scaled_Combined_partial_epsilon_partial_e_Transpose_Block1.transpose();
    //ChMatrixNM<double, 9, 9> Block22 = partial_epsilon_partial_e_Transpose_Block2 * Scaled_Combined_partial_epsilon_partial_e_Transpose_Block2.transpose();
    //ChMatrixNM<double, 9, 9> Block23 = partial_epsilon_partial_e_Transpose_Block2 * Scaled_Combined_partial_epsilon_partial_e_Transpose_Block3.transpose();

    //ChMatrixNM<double, 9, 9> Block31 = partial_epsilon_partial_e_Transpose_Block3 * Scaled_Combined_partial_epsilon_partial_e_Transpose_Block1.transpose();
    //ChMatrixNM<double, 9, 9> Block32 = partial_epsilon_partial_e_Transpose_Block3 * Scaled_Combined_partial_epsilon_partial_e_Transpose_Block2.transpose();
    //ChMatrixNM<double, 9, 9> Block33 = partial_epsilon_partial_e_Transpose_Block3 * Scaled_Combined_partial_epsilon_partial_e_Transpose_Block3.transpose();


    ////ChMatrixNM<double, 9, 180> partial_epsilon_partial_e_Transpose_Block1;
    //Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor, 9, 180> partial_epsilon_partial_e_Transpose_Block;
    //partial_epsilon_partial_e_Transpose_Block.resize(9, 108);

    //for (auto i = 0; i < 9; i++) {
    //    partial_epsilon_partial_e_Transpose_Block.block<1, 16>(i, 0).noalias() = m_SD_precompute_col_ordered.block<1, 16>(i, 0).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(0, 0).transpose());
    //    partial_epsilon_partial_e_Transpose_Block.block<1, 16>(i, 16).noalias() = m_SD_precompute_col_ordered.block<1, 16>(i, 16).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(16, 0).transpose());
    //    partial_epsilon_partial_e_Transpose_Block.block<1, 16>(i, 32).noalias() = m_SD_precompute_col_ordered.block<1, 16>(i, 32).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(32, 0).transpose());
    //    partial_epsilon_partial_e_Transpose_Block.block<1, 16>(i, 48).noalias() = m_SD_precompute_col_ordered.block<1, 16>(i, 32).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(16, 0).transpose())
    //        + m_SD_precompute_col_ordered.block<1, 16>(i, 16).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(32, 0).transpose());
    //    partial_epsilon_partial_e_Transpose_Block.block<1, 16>(i, 64).noalias() = m_SD_precompute_col_ordered.block<1, 16>(i, 32).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(0, 0).transpose())
    //        + m_SD_precompute_col_ordered.block<1, 16>(i, 0).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(32, 0).transpose());
    //    partial_epsilon_partial_e_Transpose_Block.block<1, 16>(i, 80).noalias() = m_SD_precompute_col_ordered.block<1, 16>(i, 16).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(0, 0).transpose())
    //        + m_SD_precompute_col_ordered.block<1, 16>(i, 0).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(16, 0).transpose());
    //    partial_epsilon_partial_e_Transpose_Block.block<1, 4>(i, 96).noalias() = m_SD_precompute_col_ordered.block<1, 4>(i, 48).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<4, 1>(48, 0).transpose());
    //    partial_epsilon_partial_e_Transpose_Block.block<1, 4>(i, 100).noalias() = m_SD_precompute_col_ordered.block<1, 4>(i, 52).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<4, 1>(52, 0).transpose());
    //    partial_epsilon_partial_e_Transpose_Block.block<1, 4>(i, 104).noalias() = m_SD_precompute_col_ordered.block<1, 4>(i, 56).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<4, 1>(56, 0).transpose());
    //}
    //Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor, 9, 9> Block11;
    //Block11.resize(9, 9);
    //Block11.noalias() = partial_epsilon_partial_e_Transpose_Block * Scaled_Combined_partial_epsilon_partial_e_Transpose_Block1.transpose();
    //Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor, 9, 9> Block12;
    //Block12.resize(9, 9);
    //Block12.noalias() = partial_epsilon_partial_e_Transpose_Block * Scaled_Combined_partial_epsilon_partial_e_Transpose_Block2.transpose();
    //Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor, 9, 9> Block13;
    //Block13.resize(9, 9);
    //Block13.noalias() = partial_epsilon_partial_e_Transpose_Block * Scaled_Combined_partial_epsilon_partial_e_Transpose_Block3.transpose();

    //for (auto i = 0; i < 9; i++) {
    //    partial_epsilon_partial_e_Transpose_Block.block<1, 16>(i, 0).noalias() = m_SD_precompute_col_ordered.block<1, 16>(i, 0).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(0, 1).transpose());
    //    partial_epsilon_partial_e_Transpose_Block.block<1, 16>(i, 16).noalias() = m_SD_precompute_col_ordered.block<1, 16>(i, 16).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(16, 1).transpose());
    //    partial_epsilon_partial_e_Transpose_Block.block<1, 16>(i, 32).noalias() = m_SD_precompute_col_ordered.block<1, 16>(i, 32).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(32, 1).transpose());
    //    partial_epsilon_partial_e_Transpose_Block.block<1, 16>(i, 48).noalias() = m_SD_precompute_col_ordered.block<1, 16>(i, 32).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(16, 1).transpose())
    //        + m_SD_precompute_col_ordered.block<1, 16>(i, 16).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(32, 1).transpose());
    //    partial_epsilon_partial_e_Transpose_Block.block<1, 16>(i, 64).noalias() = m_SD_precompute_col_ordered.block<1, 16>(i, 32).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(0, 1).transpose())
    //        + m_SD_precompute_col_ordered.block<1, 16>(i, 0).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(32, 1).transpose());
    //    partial_epsilon_partial_e_Transpose_Block.block<1, 16>(i, 80).noalias() = m_SD_precompute_col_ordered.block<1, 16>(i, 16).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(0, 1).transpose())
    //        + m_SD_precompute_col_ordered.block<1, 16>(i, 0).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(16, 1).transpose());
    //    partial_epsilon_partial_e_Transpose_Block.block<1, 4>(i, 96).noalias() = m_SD_precompute_col_ordered.block<1, 4>(i, 48).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<4, 1>(48, 1).transpose());
    //    partial_epsilon_partial_e_Transpose_Block.block<1, 4>(i, 100).noalias() = m_SD_precompute_col_ordered.block<1, 4>(i, 52).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<4, 1>(52, 1).transpose());
    //    partial_epsilon_partial_e_Transpose_Block.block<1, 4>(i, 104).noalias() = m_SD_precompute_col_ordered.block<1, 4>(i, 56).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<4, 1>(56, 1).transpose());
    //}
    //Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor, 9, 9> Block21;
    //Block21.resize(9, 9);
    //Block21.noalias() = partial_epsilon_partial_e_Transpose_Block * Scaled_Combined_partial_epsilon_partial_e_Transpose_Block1.transpose();
    //Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor, 9, 9> Block22;
    //Block22.resize(9, 9);
    //Block22.noalias() = partial_epsilon_partial_e_Transpose_Block * Scaled_Combined_partial_epsilon_partial_e_Transpose_Block2.transpose();
    //Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor, 9, 9> Block23;
    //Block23.resize(9, 9);
    //Block23.noalias() = partial_epsilon_partial_e_Transpose_Block * Scaled_Combined_partial_epsilon_partial_e_Transpose_Block3.transpose();

    //for (auto i = 0; i < 9; i++) {
    //    partial_epsilon_partial_e_Transpose_Block.block<1, 16>(i, 0).noalias() = m_SD_precompute_col_ordered.block<1, 16>(i, 0).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(0, 2).transpose());
    //    partial_epsilon_partial_e_Transpose_Block.block<1, 16>(i, 16).noalias() = m_SD_precompute_col_ordered.block<1, 16>(i, 16).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(16, 2).transpose());
    //    partial_epsilon_partial_e_Transpose_Block.block<1, 16>(i, 32).noalias() = m_SD_precompute_col_ordered.block<1, 16>(i, 32).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(32, 2).transpose());
    //    partial_epsilon_partial_e_Transpose_Block.block<1, 16>(i, 48).noalias() = m_SD_precompute_col_ordered.block<1, 16>(i, 32).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(16, 2).transpose())
    //        + m_SD_precompute_col_ordered.block<1, 16>(i, 16).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(32, 2).transpose());
    //    partial_epsilon_partial_e_Transpose_Block.block<1, 16>(i, 64).noalias() = m_SD_precompute_col_ordered.block<1, 16>(i, 32).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(0, 2).transpose())
    //        + m_SD_precompute_col_ordered.block<1, 16>(i, 0).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(32, 2).transpose());
    //    partial_epsilon_partial_e_Transpose_Block.block<1, 16>(i, 80).noalias() = m_SD_precompute_col_ordered.block<1, 16>(i, 16).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(0, 2).transpose())
    //        + m_SD_precompute_col_ordered.block<1, 16>(i, 0).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<16, 1>(16, 2).transpose());
    //    partial_epsilon_partial_e_Transpose_Block.block<1, 4>(i, 96).noalias() = m_SD_precompute_col_ordered.block<1, 4>(i, 48).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<4, 1>(48, 2).transpose());
    //    partial_epsilon_partial_e_Transpose_Block.block<1, 4>(i, 100).noalias() = m_SD_precompute_col_ordered.block<1, 4>(i, 52).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<4, 1>(52, 2).transpose());
    //    partial_epsilon_partial_e_Transpose_Block.block<1, 4>(i, 104).noalias() = m_SD_precompute_col_ordered.block<1, 4>(i, 56).cwiseProduct(m_F_Transpose_CombinedBlockDamping_col_ordered.block<4, 1>(56, 2).transpose());
    //}
    //Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor, 9, 9> Block31;
    //Block31.resize(9, 9);
    //Block31.noalias() = partial_epsilon_partial_e_Transpose_Block * Scaled_Combined_partial_epsilon_partial_e_Transpose_Block1.transpose();
    //Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor, 9, 9> Block32;
    //Block32.resize(9, 9);
    //Block32.noalias() = partial_epsilon_partial_e_Transpose_Block * Scaled_Combined_partial_epsilon_partial_e_Transpose_Block2.transpose();
    //Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor, 9, 9> Block33;
    //Block33.resize(9, 9);
    //Block33.noalias() = partial_epsilon_partial_e_Transpose_Block * Scaled_Combined_partial_epsilon_partial_e_Transpose_Block3.transpose();
    ...
    //for (unsigned int i = 0; i < 9; i++) {
    //    for (unsigned int j = 0; j < 9; j++) {
    //        H(3 * i, 3 * j) += Block11(i, j);
    //        H(3 * i + 1, 3 * j) = Block21(i, j);
    //        H(3 * i + 2, 3 * j) = Block31(i, j);

    //        H(3 * i, 3 * j + 1) = Block12(i, j);
    //        H(3 * i + 1, 3 * j + 1) += Block22(i, j);
    //        H(3 * i + 2, 3 * j + 1) = Block32(i, j);

    //        H(3 * i, 3 * j + 2) = Block13(i, j);
    //        H(3 * i + 1, 3 * j + 2) = Block23(i, j);
    //        H(3 * i + 2, 3 * j + 2) += Block33(i, j);
    //    }
    //}
}

//Calculate the calculate the Jacobian of the internal force integrand without damping included
void ChElementBeamANCF_MT37::ComputeInternalJacobianNoDamping(ChMatrixRef H, double Kfactor, double Rfactor, double Mfactor) {
...
void ChElementBeamANCF_MT37::ComputeMmatrixGlobal(ChMatrixRef M) {
    M.setZero();
...
// -----------------------------------------------------------------------------
void ChElementBeamANCF_MT37::ComputeMassMatrixAndGravityForce(const ChVector<>& g_acc) {
...
void ChElementBeamANCF_MT37::PrecomputeInternalForceMatricesWeights() {
    ChQuadratureTables* GQTable = GetStaticGQTables();
...
void ChElementBeamANCF_MT37::ComputeNodalMass() {
...
void ChElementBeamANCF_MT37::SetAlphaDamp(double a) {
    m_Alpha = a;
    m_2Alpha = 2 * a;
...
void ChElementBeamANCF_MT37::ComputeInternalForces(ChVectorDynamic<>& Fi) {   
...
void ChElementBeamANCF_MT37::ComputeInternalForcesAtState(ChVectorDynamic<>& Fi, const ChMatrixNM<double, 9, 6>& ebar_ebardot) {
...
void ChElementBeamANCF_MT37::ComputeInternalForcesAtStateNoDamping(ChVectorDynamic<>& Fi, const ChMatrixNMc<double, 9, 3>& e_bar) {
...
void ChElementBeamANCF_MT37::ComputeInternalForcesSingleGQPnt(ChMatrixNM<double, 9, 3>& QiCompact, unsigned int index, ChVectorN<double, 6>& D0, ChMatrixNMc<double, 9, 3>& e_bar, ChMatrixNMc<double, 9, 3>& e_bar_dot) {
    //ChMatrix33<double> J_0xi;               //Element Jacobian between the reference configuration and normalized configuration
...
void ChElementBeamANCF_MT37::ComputeInternalForcesSingleGQPnt(ChMatrixNM<double, 9, 3>& QiCompact, unsigned int index, ChMatrix33<double>& Dv, ChMatrixNMc<double, 9, 3>& e_bar, ChMatrixNMc<double, 9, 3>& e_bar_dot) {
    //ChMatrix33<double> J_0xi;               //Element Jacobian between the reference configuration and normalized configuration
    //ChMatrixNM<double, 9, 3> Sxi_D;         //Matrix of normalized shape function derivatives
...
void ChElementBeamANCF_MT37::ComputeInternalForcesSingleGQPnt(ChMatrixNM<double, 9, 3>& QiCompact, double xi, double eta, double zeta, ChMatrixNM<double, 6, 6>& D, ChMatrixNMc<double, 9, 3>& e_bar, ChMatrixNMc<double, 9, 3>& e_bar_dot) {
    ChMatrix33<double> J_0xi;               //Element Jacobian between the reference configuration and normalized configuration
    ChMatrixNMc<double, 9, 3> Sxi_D;         //Matrix of normalized shape function derivatives
...
void ChElementBeamANCF_MT37::ComputeInternalJacobianSingleGQPnt(ChMatrixNM<double, 27, 27>& Jac_Dense, ChMatrixNM<double, 9, 9>& Jac_Compact, double Kfactor, double Rfactor, unsigned int index, ChVectorN<double, 6>& D0, ChMatrixNMc<double, 9, 3>& e_bar, ChMatrixNMc<double, 9, 3>& e_bar_dot) {
...
void ChElementBeamANCF_MT37::ComputeInternalJacobianSingleGQPnt(ChMatrixNM<double, 27, 27>& Jac_Dense, ChMatrixNM<double, 9, 9>& Jac_Compact, double Kfactor, double Rfactor, unsigned int index, ChMatrix33<double>& Dv, ChMatrixNMc<double, 9, 3>& e_bar, ChMatrixNMc<double, 9, 3>& e_bar_dot) {
...
void ChElementBeamANCF_MT37::ComputeInternalJacobianSingleGQPnt(ChMatrixNM<double, 27, 27>& Jac_Dense, ChMatrixNM<double, 9, 9>& Jac_Compact, double Kfactor, double Rfactor, double GQ_weight, double xi, double eta, double zeta, ChMatrixNM<double, 6, 6>& D, ChMatrixNMc<double, 9, 3>& e_bar, ChMatrixNMc<double, 9, 3>& e_bar_dot){
    ChMatrix33<double> J_0xi;               //Element Jacobian between the reference configuration and normalized configuration
    ChMatrixNMc<double, 9, 3> Sxi_D;         //Matrix of normalized shape function derivatives
    ChMatrixNMc<double, 9, 3> Sxi_D_0xi;     //Matrix of normalized shape function derivatives corrected for a potentially non-straight reference configuration
    ChVectorN<double, 6> epsilon;           //Green-Lagrange strain tensor in Voigt notation
...
void ChElementBeamANCF_MT37::ComputeInternalJacobians(ChMatrixNM<double, 27, 27>& JacobianMatrix, double Kfactor, double Rfactor) {
...
void ChElementBeamANCF_MT37::ComputeInternalJacobiansAnalytic(ChMatrixNM<double, 27, 27>& JacobianMatrix, double Kfactor, double Rfactor) {
    ChMatrixNMc<double, 9, 3> e_bar;
    ChMatrixNMc<double, 9, 3> e_bar_dot;
    ...
    //Calculate the portion of the Selective Reduced Integration that account for the Poisson effect, but only on the beam axis
    if (GetStrainFormulation() == ChElementBeamANCF_MT37::StrainFormulation::CMPoisson) {
...
void ChElementBeamANCF_MT37::Calc_Sxi(ChMatrixNM<double, 3, 27>& Sxi, double xi, double eta, double zeta) {
...
// [s1; s2; s3; ...]
void ChElementBeamANCF_MT37::Calc_Sxi_compact(ChVectorN<double, 9>& Sxi_compact, double xi, double eta, double zeta) {
...
void ChElementBeamANCF_MT37::Calc_Sxi_D(ChMatrixNMc<double, 9, 3>& Sxi_D, double xi, double eta, double zeta) {
    Sxi_D(0, 0) = xi - 0.5;
...
void ChElementBeamANCF_MT37::CalcCoordMatrix(ChMatrixNMc<double, 9, 3>& e) {
...
void ChElementBeamANCF_MT37::CalcCoordVector(ChVectorN<double, 27>& e) {
...
void ChElementBeamANCF_MT37::CalcCoordDerivMatrix(ChMatrixNMc<double, 9, 3>& edot) {
...
void ChElementBeamANCF_MT37::CalcCoordDerivVector(ChVectorN<double, 27>& edot) {
...
void ChElementBeamANCF_MT37::CalcCombinedCoordMatrix(ChMatrixNM<double, 9, 6>& ebar_ebardot) {
...
void ChElementBeamANCF_MT37::Calc_J_0xi(ChMatrix33<double>& J_0xi, double xi, double eta, double zeta) {
...
double ChElementBeamANCF_MT37::Calc_det_J_0xi(double xi, double eta, double zeta) {
    ChMatrixNMc<double, 9, 3> Sxi_D;
...
// -----------------------------------------------------------------------------
//ChVector<> ChElementBeamANCF_MT37::EvaluateBeamSectionStrains() {
...
//}
//
// void ChElementBeamANCF_MT37::EvaluateSectionDisplacement(const double u,
//                                                    const double v,
//                                                    ChVector<>& u_displ,
//                                                    ChVector<>& u_rotaz) {
...
void ChElementBeamANCF_MT37::EvaluateSectionFrame(const double eta, ChVector<>& point, ChQuaternion<>& rot) {
...
// void ChElementBeamANCF_MT37::EvaluateSectionPoint(const double u,
//                                             const double v,
//                                             ChVector<>& point) {
//    ChVector<> u_displ;
//
...
void ChElementBeamANCF_MT37::LoadableGetStateBlock_x(int block_offset, ChState& mD) {
...
void ChElementBeamANCF_MT37::LoadableGetStateBlock_w(int block_offset, ChStateDelta& mD) {
...
void ChElementBeamANCF_MT37::LoadableStateIncrement(const unsigned int off_x,
                                               ChState& x_new,
                                               const ChState& x,
...
//void ChElementBeamANCF_MT37::EvaluateSectionVelNorm(double U, ChVector<>& Result) {
//    ShapeVector N;
...
void ChElementBeamANCF_MT37::LoadableGetVariables(std::vector<ChVariables*>& mvars) {
...
void ChElementBeamANCF_MT37::ComputeNF(
...
double ChElementBeamANCF_MT37::GetDensity() {
    return GetMaterial()->Get_rho();
}

// Calculate tangent to the centerline at (U) coordinates.
ChVector<> ChElementBeamANCF_MT37::ComputeTangent(const double U) {
    ChMatrixNMc<double, 9, 3> e_bar;
    ChMatrixNMc<double, 9, 3> Sxi_D;
    ChVector<> r_xi;
...
ChQuadratureTables static_tables_MT37(1, CH_QUADRATURE_STATIC_TABLES);
//#endif // !CH_QUADRATURE_STATIC_TABLES

ChQuadratureTables* ChElementBeamANCF_MT37::GetStaticGQTables() {
    return &static_tables_MT37;
}

////////////////////////////////////////////////////////////////

// ============================================================================
// Implementation of ChMaterialBeamANCF_MT37 methods
// ============================================================================

// Construct an isotropic material.
ChMaterialBeamANCF_MT37::ChMaterialBeamANCF_MT37(double rho,        // material density
...
void ChMaterialBeamANCF_MT37::Calc_D0_Dv(const ChVector<>& E, const ChVector<>& nu, const ChVector<>& G, double k1, double k2) {
