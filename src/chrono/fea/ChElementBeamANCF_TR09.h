...
#ifndef CHELEMENTBEAMANCFTR09_H
#define CHELEMENTBEAMANCFTR09_H
...
class ChApi ChMaterialBeamANCF_TR09 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_TR09(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_TR09 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_TR09> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_TR09> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_TR09> m_material;  ///< beam material
