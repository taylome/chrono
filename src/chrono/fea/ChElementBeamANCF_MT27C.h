...
#ifndef CHELEMENTBEAMANCFMT27C_H
#define CHELEMENTBEAMANCFMT27C_H
...
class ChApi ChMaterialBeamANCF_MT27C {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_MT27C(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_MT27C : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MT27C> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_MT27C> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_MT27C> m_material;    ///< beam material
