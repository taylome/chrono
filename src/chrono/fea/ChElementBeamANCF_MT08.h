...
#ifndef CHELEMENTBEAMANCFMT08_H
#define CHELEMENTBEAMANCFMT08_H
...
class ChApi ChMaterialBeamANCF_MT08 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_MT08(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_MT08 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    using ShapeVector = ChMatrixNM<double, 1, 9>;

    ChElementBeamANCF_MT08();
    ~ChElementBeamANCF_MT08() {}
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MT08> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_MT08> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_MT08> m_material;    ///< beam material
