...
#ifndef CHELEMENTBRICKANCF3843TR03_H
#define CHELEMENTBRICKANCF3843TR03_H
...
/// This class implements material properties for an ANCF Brick.
    class ChApi ChMaterialBrickANCF_3843_TR03 {
    public:
        /// Construct an isotropic material.
        ChMaterialBrickANCF_3843_TR03(double rho,        ///< material density
...
class ChApi ChElementBrickANCF_3843_TR03 : public ChElementGeneric, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBrickANCF_3843_TR03> brick_mat) { m_material = brick_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBrickANCF_3843_TR03> GetMaterial() const { return m_material; }
...
public:
  ...
  private:
      ...
      std::shared_ptr<ChMaterialBrickANCF_3843_TR03> m_material;  ///< shell material
