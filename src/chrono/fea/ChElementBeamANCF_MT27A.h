...
#ifndef CHELEMENTBEAMANCFMT27A_H
#define CHELEMENTBEAMANCFMT27A_H
...
class ChApi ChMaterialBeamANCF_MT27A {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_MT27A(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_MT27A : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MT27A> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_MT27A> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_MT27A> m_material;    ///< beam material
