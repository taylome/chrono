...
ChElementBeamANCF_3333_TR06::ChElementBeamANCF_3333_TR06()
    ...
    m_nodes.resize(3);
    m_strain_form = ChElementBeamANCF_3333_TR06::CMPoisson;
}
...
void ChElementBeamANCF_3333_TR06::ComputeKRMmatricesGlobal(ChMatrixRef H, double Kfactor, double Rfactor, double Mfactor) {
...
// -----------------------------------------------------------------------------
void ChElementBeamANCF_3333_TR06::ComputeMassMatrixAndGravityForce(const ChVector<>& g_acc) {
...
void ChElementBeamANCF_3333_TR06::ComputeInternalForcesAtState(ChVectorDynamic<>& Fi,
    ...
    // beam axis
    if (GetStrainFormulation() == ChElementBeamANCF_3333_TR06::StrainFormulation::CMPoisson) {
...
void ChElementBeamANCF_3333_TR06::ComputeInternalJacobians(ChMatrixNM<double, 27, 27>& JacobianMatrix,
                                                      double Kfactor,
                                                      double Rfactor) {
...
void ChElementBeamANCF_3333_TR06::ComputeInternalJacobianDamping(ChMatrixRef& H,
                                                            double Kfactor,
                                                            double Rfactor,
                                                            double Mfactor) {
    H.setZero();
...
void ChElementBeamANCF_3333_TR06::ComputeInternalJacobianNoDamping(ChMatrixRef& H, double Kfactor, double Mfactor) {
    H.setZero();
...
void ChElementBeamANCF_3333_TR06::Calc_Sxi(ChMatrixNM<double, 3, 27>& Sxi, double xi, double eta, double zeta) {
...
// [s1; s2; s3; ...]
void ChElementBeamANCF_3333_TR06::Calc_Sxi_compact(ChVectorN<double, 9>& Sxi_compact, double xi, double eta, double zeta) {
...
// [s1*I_3x3, s2*I_3x3, s3*I_3x3, ...]
void ChElementBeamANCF_3333_TR06::Calc_Sxi_xi(ChMatrixNM<double, 3, 27>& Sxi_xi, double xi, double eta, double zeta) {
...
// [s1; s2; s3; ...]
void ChElementBeamANCF_3333_TR06::Calc_Sxi_xi_compact(ChVectorN<double, 9>& Sxi_xi_compact,
                                                 double xi,
                                                 double eta,
                                                 double zeta) {
...
// [s1*I_3x3, s2*I_3x3, s3*I_3x3, ...]
void ChElementBeamANCF_3333_TR06::Calc_Sxi_eta(ChMatrixNM<double, 3, 27>& Sxi_eta, double xi, double eta, double zeta) {
...
// [s1; s2; s3; ...]
void ChElementBeamANCF_3333_TR06::Calc_Sxi_eta_compact(ChVectorN<double, 9>& Sxi_eta_compact,
                                                  double xi,
                                                  double eta,
                                                  double zeta) {
...
// [s1*I_3x3, s2*I_3x3, s3*I_3x3, ...]
void ChElementBeamANCF_3333_TR06::Calc_Sxi_zeta(ChMatrixNM<double, 3, 27>& Sxi_zeta, double xi, double eta, double zeta) {
...
// 9x1 Vector Form of the partial derivatives of Normalized Shape Functions with respect to eta
// [s1; s2; s3; ...]
void ChElementBeamANCF_3333_TR06::Calc_Sxi_zeta_compact(ChVectorN<double, 9>& Sxi_zeta_compact,
                                                   double xi,
                                                   double eta,
                                                   double zeta) {
...
void ChElementBeamANCF_3333_TR06::Calc_Sxi_D(ChMatrixNMc<double, 9, 3>& Sxi_D, double xi, double eta, double zeta) {
    Sxi_D(0, 0) = xi - 0.5;
...
void ChElementBeamANCF_3333_TR06::CalcCoordVector(ChVectorN<double, 27>& e) {
...
void ChElementBeamANCF_3333_TR06::CalcCoordMatrix(ChMatrixNM<double, 3, 9>& ebar) {
...
void ChElementBeamANCF_3333_TR06::CalcCoordDerivVector(ChVectorN<double, 27>& edot) {
...
void ChElementBeamANCF_3333_TR06::CalcCoordDerivMatrix(ChMatrixNM<double, 3, 9>& ebardot) {
...
// -----------------------------------------------------------------------------
// ChVector<> ChElementBeamANCF_3333_TR06::EvaluateBeamSectionStrains() {
...
//}
//
// void ChElementBeamANCF_3333_TR06::EvaluateSectionDisplacement(const double u,
//                                                    const double v,
//                                                    ChVector<>& u_displ,
//                                                    ChVector<>& u_rotaz) {
...
//}
//
// void ChElementBeamANCF_3333_TR06::EvaluateSectionFrame(const double u,
//                                             const double v,
//                                             ChVector<>& point,
//                                             ChQuaternion<>& rot) {
//    // this is not a corotational element, so just do:
...
//}
//
// void ChElementBeamANCF_3333_TR06::EvaluateSectionPoint(const double u,
//                                             const double v,
//                                             ChVector<>& point) {
//    ChVector<> u_displ;
//
...
// void ChElementBeamANCF_3333_TR06::EvaluateSectionVelNorm(double U, ChVector<>& Result) {
//    ChMatrixNM<double, 1, 9> N;
...
ChVector<> ChElementBeamANCF_3333_TR06::ComputeTangent(const double U) {
    ChMatrixNM<double, 3, 27> Sxi_xi;
    ChVectorN<double, 27> e;
    ChVector<> r_xi;
...
ChQuadratureTables static_tables_TR06(1, CH_QUADRATURE_STATIC_TABLES);
//#endif // !CH_QUADRATURE_STATIC_TABLES

ChQuadratureTables* ChElementBeamANCF_3333_TR06::GetStaticGQTables() {
    return &static_tables_TR06;
}

////////////////////////////////////////////////////////////////

// ============================================================================
// Implementation of ChMaterialBeamANCF_3333_TR06 methods
// ============================================================================

// Construct an isotropic material.
ChMaterialBeamANCF_3333_TR06::ChMaterialBeamANCF_3333_TR06(double rho,        // material density
...
// Poisson effect
void ChMaterialBeamANCF_3333_TR06::Calc_D0_Dv(const ChVector<>& E,
                                         const ChVector<>& nu,
                                         const ChVector<>& G,
                                         double k1,
                                         double k2) {
