...
ChElementShellANCF_3443ML_TR10::ChElementShellANCF_3443ML_TR10()
    : m_gravity_on(false), m_numLayers(0), m_lenX(0), m_lenY(0), m_thicknessZ(0), m_Alpha(0), m_damping_enabled(false) {
    m_nodes.resize(4);

    m_O1.resize(256, 256);
    //m_O2.resize(256, 256);
    m_K3Compact.resize(16, 16);
    m_K13Compact.resize(16, 16);
...
void ChElementShellANCF_3443ML_TR10::SetNodes(std::shared_ptr<ChNodeFEAxyzDDD> nodeA,
...
void ChElementShellANCF_3443ML_TR10::AddLayer(double thickness, double theta, std::shared_ptr<ChMaterialShellANCF_3443ML_TR10> material) {
...
void ChElementShellANCF_3443ML_TR10::SetupInitial(ChSystem* system) {
...
// State update.
void ChElementShellANCF_3443ML_TR10::Update() {
    ChElementGeneric::Update();
}

// Fill the D vector with the current field values at the element nodes.
void ChElementShellANCF_3443ML_TR10::GetStateBlock(ChVectorDynamic<>& mD) {
...
void ChElementShellANCF_3443ML_TR10::ComputeKRMmatricesGlobal(ChMatrixRef H,
                                                           double Kfactor,
                                                           double Rfactor,
                                                           double Mfactor) {
    ...
    ChMatrixNM<double, 1, 16> tempRow0 = temp.block<1, 16>(0, 0);
    ChMatrixNM<double, 1, 16> tempRow1 = temp.block<1, 16>(1, 0);
    ChMatrixNM<double, 1, 16> tempRow2 = temp.block<1, 16>(2, 0);
    ChMatrixNMc<double, 9, 256> PI2;

    for (unsigned int v = 0; v < 16; v++) {
        PI2.block<3, 16>(0, 16 * v) = e_bar.block<1, 3>(v, 0).transpose() * tempRow0;
        PI2.block<3, 16>(3, 16 * v) = e_bar.block<1, 3>(v, 0).transpose() * tempRow1;
    ...
    for (unsigned int f = 0; f < 16; f++) {
        for (unsigned int t = 0; t < 16; t++) {
            O2.block<16, 16>(16 * t, 16 * f) = m_O1.block<16, 16>(16 * t, 16 * f).transpose();
        }
    }
    ...
    for (unsigned int k = 0; k < 16; k++) {
        for (unsigned int f = 0; f < 16; f++) {
            H.block<3, 1>(3 * k, 3 * f) = K2.block<3, 1>(0, 16 * f + k);
            H.block<3, 1>(3 * k, 3 * f + 1) = K2.block<3, 1>(3, 16 * f + k);
            H.block<3, 1>(3 * k, 3 * f + 2) = K2.block<3, 1>(6, 16 * f + k);
        }
    }
...
void ChElementShellANCF_3443ML_TR10::ComputeMmatrixGlobal(ChMatrixRef M) {
    M.setZero();
...
// -----------------------------------------------------------------------------
void ChElementShellANCF_3443ML_TR10::ComputeMassMatrixAndGravityForce(const ChVector<>& g_acc) {
...
void ChElementShellANCF_3443ML_TR10::ComputeNodalMass() {
...
void ChElementShellANCF_3443ML_TR10::PrecomputeInternalForceMatricesWeights() {
    ChQuadratureTables* GQTable = GetStaticGQTables();
    unsigned int GQ_idx_xi_eta = 6;    // 7 Point Gauss-Quadrature;
    unsigned int GQ_idx_zeta = 2;      // 3 Point Gauss-Quadrature;
                    ...
                    for (unsigned int n = 0; n < 3; n++) {
                        for (unsigned int c = 0; c < 3; c++) {
                            ...
                            MatrixNxN Sxi_D_0xi_n_Sxi_D_0xi_c_transpose =
                                Sxi_D_0xi.block<16, 1>(0, n) * Sxi_D_0xi.block<16, 1>(0, c).transpose();
                            for (unsigned int f = 0; f < 16; f++) {
                                for (unsigned int t = 0; t < 16; t++) {
...
void ChElementShellANCF_3443ML_TR10::SetAlphaDamp(double a) {
    m_Alpha = a;
...
void ChElementShellANCF_3443ML_TR10::ComputeInternalForces(ChVectorDynamic<>& Fi) {
...
void ChElementShellANCF_3443ML_TR10::ComputeInternalForcesAtState(ChVectorDynamic<>& Fi,
    ...
    MatrixNxN K1_matrix;
    Eigen::Map<ChVectorN<double, 256>> PI1(PI1_matrix.data(), PI1_matrix.size());
    Eigen::Map<ChVectorN<double, 256>> K1_vec(K1_matrix.data(), K1_matrix.size());
...
void ChElementShellANCF_3443ML_TR10::ComputeInternalJacobians(Matrix3Nx3N& JacobianMatrix,
                                                           double Kfactor,
                                                           double Rfactor) {
...
void ChElementShellANCF_3443ML_TR10::Calc_Sxi(Matrix3x3N& Sxi, double xi, double eta, double zeta, double thickness, double zoffset) {
    VectorN Sxi_compact;
    Calc_Sxi_compact(Sxi_compact, xi, eta, zeta, thickness, zoffset);
    Sxi.setZero();
...
// [s1; s2; s3; ...]
void ChElementShellANCF_3443ML_TR10::Calc_Sxi_compact(VectorN& Sxi_compact, double xi, double eta, double zeta, double thickness, double zoffset) {
...
// [s1*I_3x3, s2*I_3x3, s3*I_3x3, ...]
void ChElementShellANCF_3443ML_TR10::Calc_Sxi_xi(Matrix3x3N& Sxi_xi, double xi, double eta, double zeta, double thickness, double zoffset) {
...
// [s1; s2; s3; ...]
void ChElementShellANCF_3443ML_TR10::Calc_Sxi_xi_compact(VectorN& Sxi_xi_compact, double xi, double eta, double zeta, double thickness, double zoffset) {
...
// [s1*I_3x3, s2*I_3x3, s3*I_3x3, ...]
void ChElementShellANCF_3443ML_TR10::Calc_Sxi_eta(Matrix3x3N& Sxi_eta, double xi, double eta, double zeta, double thickness, double zoffset) {
...
// [s1; s2; s3; ...]
void ChElementShellANCF_3443ML_TR10::Calc_Sxi_eta_compact(VectorN& Sxi_eta_compact, double xi, double eta, double zeta, double thickness, double zoffset) {
...
// [s1*I_3x3, s2*I_3x3, s3*I_3x3, ...]
void ChElementShellANCF_3443ML_TR10::Calc_Sxi_zeta(Matrix3x3N& Sxi_zeta, double xi, double eta, double zeta, double thickness, double zoffset) {
...
// [s1; s2; s3; ...]
void ChElementShellANCF_3443ML_TR10::Calc_Sxi_zeta_compact(VectorN& Sxi_zeta_compact, double xi, double eta, double zeta, double thickness, double zoffset) {
...
void ChElementShellANCF_3443ML_TR10::Calc_Sxi_D(MatrixNx3c& Sxi_D, double xi, double eta, double zeta, double thickness, double zoffset) {
...
void ChElementShellANCF_3443ML_TR10::CalcCoordVector(Vector3N& e) {
...
void ChElementShellANCF_3443ML_TR10::CalcCoordMatrix(Matrix3xN& ebar) {
...
void ChElementShellANCF_3443ML_TR10::CalcCoordMatrix(MatrixNx3c& ebar) {
...
void ChElementShellANCF_3443ML_TR10::CalcCoordDerivVector(Vector3N& edot) {
...
void ChElementShellANCF_3443ML_TR10::CalcCoordDerivMatrix(Matrix3xN& ebardot) {
...
void ChElementShellANCF_3443ML_TR10::CalcCoordDerivMatrix(MatrixNx3c& ebardot) {
...
void ChElementShellANCF_3443ML_TR10::Calc_J_0xi(ChMatrix33<double>& J_0xi, double xi, double eta, double zeta, double thickness, double zoffset) {
    MatrixNx3c Sxi_D;
    Calc_Sxi_D(Sxi_D, xi, eta, zeta, thickness, zoffset);
...
double ChElementShellANCF_3443ML_TR10::Calc_det_J_0xi(double xi, double eta, double zeta, double thickness, double zoffset) {
...
void ChElementShellANCF_3443ML_TR10::EvaluateSectionFrame(const double xi, const double eta, ChVector<>& point, ChQuaternion<>& rot) {
    Matrix3x3N Sxi;
    Matrix3x3N Sxi_xi;
    Matrix3x3N Sxi_eta;
...
void ChElementShellANCF_3443ML_TR10::EvaluateSectionPoint(const double u, const double v, ChVector<>& point) {
    Matrix3x3N Sxi;
...
void ChElementShellANCF_3443ML_TR10::EvaluateSectionVelNorm(double U, double V, ChVector<>& Result) {
    Matrix3x3N Sxi_zeta;
    Vector3N edot;
    ChVector<> r_zeta;
...
void ChElementShellANCF_3443ML_TR10::LoadableGetStateBlock_x(int block_offset, ChState& mD) {
...
void ChElementShellANCF_3443ML_TR10::LoadableGetStateBlock_w(int block_offset, ChStateDelta& mD) {
...
void ChElementShellANCF_3443ML_TR10::LoadableStateIncrement(const unsigned int off_x,
                                                         ChState& x_new,
                                                         const ChState& x,
...
void ChElementShellANCF_3443ML_TR10::LoadableGetVariables(std::vector<ChVariables*>& mvars) {
...
void ChElementShellANCF_3443ML_TR10::ComputeNF(
...
double ChElementShellANCF_3443ML_TR10::GetDensity() {
...
ChVector<> ChElementShellANCF_3443ML_TR10::ComputeNormal(const double U, const double V) {
    Matrix3x3N Sxi_zeta;
    Vector3N e;
    ChVector<> r_zeta;
...
ChQuadratureTables static_tables_3443ML_TR10(1, CH_QUADRATURE_STATIC_TABLES);
//#endif // !CH_QUADRATURE_STATIC_TABLES

ChQuadratureTables* ChElementShellANCF_3443ML_TR10::GetStaticGQTables() {
    return &static_tables_3443ML_TR10;
}

////////////////////////////////////////////////////////////////

// ============================================================================
// Implementation of ChElementShellANCF_3443ML_TR10::Layer methods
// ============================================================================

// Private constructor (a layer can be created only by adding it to an element)
ChElementShellANCF_3443ML_TR10::Layer::Layer(ChElementShellANCF_3443ML_TR10* element,
    double thickness,
    double theta,
    std::shared_ptr<ChMaterialShellANCF_3443ML_TR10> material)
    : m_element(element), m_thickness(thickness), m_theta(theta), m_material(material) {}

////////////////////////////////////////////////////////////////

// ============================================================================
// Implementation of ChMaterialShellANCF_3443ML_TR10 methods
// ============================================================================

// Construct an isotropic material.
ChMaterialShellANCF_3443ML_TR10::ChMaterialShellANCF_3443ML_TR10(
...
// Poisson effect
void ChMaterialShellANCF_3443ML_TR10::Calc_D0_Dv(const ChVector<>& E,
                                              const ChVector<>& nu,
                                              const ChVector<>& G) {
...
void ChMaterialShellANCF_3443ML_TR10::Get_Rotated_D(ChMatrixNM<double, 6, 6>& D, double theta) {
