...
// Dynamics, 9(2).
// =============================================================================
// TR03_GQ444 = a simple textbook style implementation of the element with a reduced
//     number of Gauss-Quadrature Points and dense internal force mathematics:
//
//  Mass Matrix = Constant, pre-calculated 96x96 matrix
//
...
ChElementBrickANCF_3843_TR03_GQ444::ChElementBrickANCF_3843_TR03_GQ444()
...
void ChElementBrickANCF_3843_TR03_GQ444::SetNodes(std::shared_ptr<ChNodeFEAxyzDDD> nodeA,
...
void ChElementBrickANCF_3843_TR03_GQ444::SetupInitial(ChSystem* system) {
...
// State update.
void ChElementBrickANCF_3843_TR03_GQ444::Update() {
    ChElementGeneric::Update();
}

// Fill the D vector with the current field values at the element nodes.
void ChElementBrickANCF_3843_TR03_GQ444::GetStateBlock(ChVectorDynamic<>& mD) {
...
void ChElementBrickANCF_3843_TR03_GQ444::ComputeKRMmatricesGlobal(ChMatrixRef H,
                                                            double Kfactor,
                                                            double Rfactor,
                                                            double Mfactor) {
...
void ChElementBrickANCF_3843_TR03_GQ444::ComputeMmatrixGlobal(ChMatrixRef M) {
    M = m_MassMatrix;
}
...
// -----------------------------------------------------------------------------
void ChElementBrickANCF_3843_TR03_GQ444::ComputeMassMatrixAndGravityForce(const ChVector<>& g_acc) {
...
void ChElementBrickANCF_3843_TR03_GQ444::ComputeNodalMass() {
...
void ChElementBrickANCF_3843_TR03_GQ444::SetAlphaDamp(double a) {
    m_Alpha = a;
...
void ChElementBrickANCF_3843_TR03_GQ444::ComputeInternalForces(ChVectorDynamic<>& Fi) {
...
void ChElementBrickANCF_3843_TR03_GQ444::ComputeInternalForcesAtState(ChVectorDynamic<>& Fi,
...
void ChElementBrickANCF_3843_TR03_GQ444::ComputeInternalForcesSingleGQPnt(Vector3N& Qi,
                                                                    double xi,
                                                                    double eta,
                                                                    double zeta,
    ...
    ChMatrixNM<double, 32, 3> depsilon_de_compact_row = Sbar_xi_D.col(0) * F.col(0).transpose();
    Eigen::Map<ChVectorN<double, 96>> depsilon_de_row(depsilon_de_compact_row.data(), depsilon_de_compact_row.size());
...
void ChElementBrickANCF_3843_TR03_GQ444::ComputeInternalJacobians(Matrix3Nx3N& JacobianMatrix,
                                                            double Kfactor,
                                                            double Rfactor) {
...
void ChElementBrickANCF_3843_TR03_GQ444::Calc_Sxi(Matrix3x3N& Sxi, double xi, double eta, double zeta) {
    VectorN Sxi_compact;
...
// [s1; s2; s3; ...]
void ChElementBrickANCF_3843_TR03_GQ444::Calc_Sxi_compact(VectorN& Sxi_compact, double xi, double eta, double zeta) {
...
// [s1*I_3x3, s2*I_3x3, s3*I_3x3, ...]
void ChElementBrickANCF_3843_TR03_GQ444::Calc_Sxi_xi(Matrix3x3N& Sxi_xi, double xi, double eta, double zeta) {
...
// [s1; s2; s3; ...]
void ChElementBrickANCF_3843_TR03_GQ444::Calc_Sxi_xi_compact(VectorN& Sxi_xi_compact, double xi, double eta, double zeta) {
...
// [s1*I_3x3, s2*I_3x3, s3*I_3x3, ...]
void ChElementBrickANCF_3843_TR03_GQ444::Calc_Sxi_eta(Matrix3x3N& Sxi_eta, double xi, double eta, double zeta) {
...
// [s1; s2; s3; ...]
void ChElementBrickANCF_3843_TR03_GQ444::Calc_Sxi_eta_compact(VectorN& Sxi_eta_compact, double xi, double eta, double zeta) {
...
// [s1*I_3x3, s2*I_3x3, s3*I_3x3, ...]
void ChElementBrickANCF_3843_TR03_GQ444::Calc_Sxi_zeta(Matrix3x3N& Sxi_zeta, double xi, double eta, double zeta) {
...
// [s1; s2; s3; ...]
void ChElementBrickANCF_3843_TR03_GQ444::Calc_Sxi_zeta_compact(VectorN& Sxi_zeta_compact,
                                                         double xi,
                                                         double eta,
                                                         double zeta) {
...
void ChElementBrickANCF_3843_TR03_GQ444::Calc_Sxi_D(MatrixNx3c& Sxi_D, double xi, double eta, double zeta) {
...
void ChElementBrickANCF_3843_TR03_GQ444::CalcCoordVector(Vector3N& e) {
...
void ChElementBrickANCF_3843_TR03_GQ444::CalcCoordMatrix(Matrix3xN& ebar) {
...
void ChElementBrickANCF_3843_TR03_GQ444::CalcCoordDerivVector(Vector3N& edot) {
...
void ChElementBrickANCF_3843_TR03_GQ444::CalcCoordDerivMatrix(Matrix3xN& ebardot) {
...
void ChElementBrickANCF_3843_TR03_GQ444::Calc_J_0xi(ChMatrix33<double>& J_0xi, double xi, double eta, double zeta) {
    MatrixNx3c Sxi_D;
...
double ChElementBrickANCF_3843_TR03_GQ444::Calc_det_J_0xi(double xi, double eta, double zeta) {
...
void ChElementBrickANCF_3843_TR03_GQ444::EvaluateSectionFrame(const double xi,
                                                        const double eta,
                                                        const double zeta,
                                                        ChVector<>& point,
                                                        ChQuaternion<>& rot) {
...
void ChElementBrickANCF_3843_TR03_GQ444::EvaluateSectionPoint(const double u, const double v, const double w, ChVector<>& point) {
    Matrix3x3N Sxi;
    Calc_Sxi(Sxi, u, v, w);
...
void ChElementBrickANCF_3843_TR03_GQ444::LoadableGetStateBlock_x(int block_offset, ChState& mD) {
...
void ChElementBrickANCF_3843_TR03_GQ444::LoadableGetStateBlock_w(int block_offset, ChStateDelta& mD) {
...
void ChElementBrickANCF_3843_TR03_GQ444::LoadableStateIncrement(const unsigned int off_x,
                                                          ChState& x_new,
                                                          const ChState& x,
...
void ChElementBrickANCF_3843_TR03_GQ444::LoadableGetVariables(std::vector<ChVariables*>& mvars) {
...
void ChElementBrickANCF_3843_TR03_GQ444::ComputeNF(
...
double ChElementBrickANCF_3843_TR03_GQ444::GetDensity() {
...
ChQuadratureTables static_tables_3843_TR03_GQ444(1, CH_QUADRATURE_STATIC_TABLES);
//#endif // !CH_QUADRATURE_STATIC_TABLES

ChQuadratureTables* ChElementBrickANCF_3843_TR03_GQ444::GetStaticGQTables() {
    return &static_tables_3843_TR03_GQ444;
}

////////////////////////////////////////////////////////////////

// ============================================================================
// Implementation of ChMaterialBrickANCF_3843_TR03_GQ444 methods
// ============================================================================

// Construct an isotropic material.
ChMaterialBrickANCF_3843_TR03_GQ444::ChMaterialBrickANCF_3843_TR03_GQ444(double rho,  // material density
...
ChMaterialBrickANCF_3843_TR03_GQ444::ChMaterialBrickANCF_3843_TR03_GQ444(
...
// Poisson effect
void ChMaterialBrickANCF_3843_TR03_GQ444::Calc_D0_Dv(const ChVector<>& E, const ChVector<>& nu, const ChVector<>& G) {
