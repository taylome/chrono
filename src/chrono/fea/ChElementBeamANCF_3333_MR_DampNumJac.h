...
#ifndef CHELEMENTBEAMANCF3333_MR_DAMPNUMJAC_H
#define CHELEMENTBEAMANCF3333_MR_DAMPNUMJAC_H
...
class ChApi ChElementBeamANCF_3333_MR_DampNumJac : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    ChElementBeamANCF_3333_MR_DampNumJac();
    ~ChElementBeamANCF_3333_MR_DampNumJac() {}
