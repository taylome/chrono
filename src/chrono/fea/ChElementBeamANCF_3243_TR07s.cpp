...
#define CHELEMENTBEAMANCF3243TR07S_UT 1
...
ChElementBeamANCF_3243_TR07S::ChElementBeamANCF_3243_TR07S()
...
void ChElementBeamANCF_3243_TR07S::SetNodes(std::shared_ptr<ChNodeFEAxyzDDD> nodeA,
...
void ChElementBeamANCF_3243_TR07S::SetupInitial(ChSystem* system) {
...
// State update.
void ChElementBeamANCF_3243_TR07S::Update() {
    ChElementGeneric::Update();
}

// Fill the D vector with the current field values at the element nodes.
void ChElementBeamANCF_3243_TR07S::GetStateBlock(ChVectorDynamic<>& mD) {
...
void ChElementBeamANCF_3243_TR07S::ComputeKRMmatricesGlobal(ChMatrixRef H,
    double Kfactor,
    double Rfactor,
    double Mfactor) {
...
void ChElementBeamANCF_3243_TR07S::ComputeMmatrixGlobal(ChMatrixRef M) {
    M.setZero();
...
#ifdef CHELEMENTBEAMANCF3243TR07S_UT
    //Upper Triangular
    unsigned int idx = 0;
    for (unsigned int i = 0; i < 8; i++) {
        for (unsigned int j = i; j < 8; j++) {
...
// -----------------------------------------------------------------------------
void ChElementBeamANCF_3243_TR07S::ComputeMassMatrixAndGravityForce(const ChVector<>& g_acc) {
...
void ChElementBeamANCF_3243_TR07S::PrecomputeInternalForceMatricesWeights() {
    ChQuadratureTables* GQTable = GetStaticGQTables();
...
void ChElementBeamANCF_3243_TR07S::ComputeNodalMass() {
...
void ChElementBeamANCF_3243_TR07S::SetAlphaDamp(double a) {
    m_Alpha = a;
    m_2Alpha = 2 * a;
...
void ChElementBeamANCF_3243_TR07S::ComputeInternalForces(ChVectorDynamic<>& Fi) {
...
void ChElementBeamANCF_3243_TR07S::ComputeInternalForcesAtState(ChVectorDynamic<>& Fi,
...
void ChElementBeamANCF_3243_TR07S::ComputeInternalForcesAtStateNoDamping(ChVectorDynamic<>& Fi,
...
void ChElementBeamANCF_3243_TR07S::ComputeInternalJacobianDamping(ChMatrixRef& H,
                                                                 double Kfactor,
                                                                 double Rfactor,
                                                                 double Mfactor) {
...
void ChElementBeamANCF_3243_TR07S::ComputeInternalJacobianNoDamping(ChMatrixRef& H, double Kfactor, double Mfactor) {
    ChMatrixNM<double, 24, 108> partial_epsilon_partial_e_Transpose;
    //Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor, 24, 180> partial_epsilon_partial_e_Transpose;
    //partial_epsilon_partial_e_Transpose.resize(24, 108);
...
void ChElementBeamANCF_3243_TR07S::ComputeInternalJacobians(ChMatrixNM<double, 24, 24>& JacobianMatrix,
                                                           double Kfactor,
                                                           double Rfactor) {
...
void ChElementBeamANCF_3243_TR07S::Calc_Sxi(ChMatrixNM<double, 3, 24>& Sxi, double xi, double eta, double zeta) {
...
// [s1; s2; s3; ...]
void ChElementBeamANCF_3243_TR07S::Calc_Sxi_compact(ChVectorN<double, 8>& Sxi_compact,
                                                   double xi,
                                                   double eta,
                                                   double zeta) {
...
void ChElementBeamANCF_3243_TR07S::Calc_Sxi_D(ChMatrixNMc<double, 8, 3>& Sxi_D, double xi, double eta, double zeta) {
...
void ChElementBeamANCF_3243_TR07S::CalcCoordMatrix(ChMatrixNMc<double, 8, 3>& e) {
...
void ChElementBeamANCF_3243_TR07S::CalcCoordMatrix(ChMatrixNM<double, 8, 3>& e) {
...
void ChElementBeamANCF_3243_TR07S::CalcCoordVector(ChVectorN<double, 24>& e) {
...
void ChElementBeamANCF_3243_TR07S::CalcCoordDerivMatrix(ChMatrixNMc<double, 8, 3>& edot) {
...
void ChElementBeamANCF_3243_TR07S::CalcCoordDerivVector(ChVectorN<double, 24>& edot) {
...
void ChElementBeamANCF_3243_TR07S::CalcCombinedCoordMatrix(ChMatrixNM<double, 8, 6>& ebar_ebardot) {
...
void ChElementBeamANCF_3243_TR07S::Calc_J_0xi(ChMatrix33<double>& J_0xi, double xi, double eta, double zeta) {
...
double ChElementBeamANCF_3243_TR07S::Calc_det_J_0xi(double xi, double eta, double zeta) {
    ChMatrixNMc<double, 8, 3> Sxi_D;
...
// -----------------------------------------------------------------------------
// ChVector<> ChElementBeamANCF_3243_TR07S::EvaluateBeamSectionStrains() {
...
//}
//
// void ChElementBeamANCF_3243_TR07S::EvaluateSectionDisplacement(const double u,
//                                                    const double v,
//                                                    ChVector<>& u_displ,
//                                                    ChVector<>& u_rotaz) {
...
void ChElementBeamANCF_3243_TR07S::EvaluateSectionFrame(const double eta, ChVector<>& point, ChQuaternion<>& rot) {
    ChMatrixNMc<double, 8, 3> e_bar;
    ChVectorN<double, 8> Sxi_compact;
    ChMatrixNMc<double, 8, 3> Sxi_D;
...
// void ChElementBeamANCF_3243_TR07S::EvaluateSectionPoint(const double u,
//                                             const double v,
//                                             ChVector<>& point) {
//    ChVector<> u_displ;
//
...
void ChElementBeamANCF_3243_TR07S::LoadableGetStateBlock_x(int block_offset, ChState& mD) {
...
void ChElementBeamANCF_3243_TR07S::LoadableGetStateBlock_w(int block_offset, ChStateDelta& mD) {
...
void ChElementBeamANCF_3243_TR07S::LoadableStateIncrement(const unsigned int off_x,
                                                         ChState& x_new,
                                                         const ChState& x,
...
// void ChElementBeamANCF_3243_TR07S::EvaluateSectionVelNorm(double U, ChVector<>& Result) {
//    ShapeVector N;
...
void ChElementBeamANCF_3243_TR07S::LoadableGetVariables(std::vector<ChVariables*>& mvars) {
...
void ChElementBeamANCF_3243_TR07S::ComputeNF(
...
double ChElementBeamANCF_3243_TR07S::GetDensity() {
    return GetMaterial()->Get_rho();
}

// Calculate tangent to the centerline at (U) coordinates.
ChVector<> ChElementBeamANCF_3243_TR07S::ComputeTangent(const double U) {
    ChMatrixNMc<double, 8, 3> e_bar;
    ChMatrixNMc<double, 8, 3> Sxi_D;
    ChVector<> r_xi;
...
ChQuadratureTables static_tables_2_TR07S(1, CH_QUADRATURE_STATIC_TABLES);
//#endif // !CH_QUADRATURE_STATIC_TABLES

ChQuadratureTables* ChElementBeamANCF_3243_TR07S::GetStaticGQTables() {
    return &static_tables_2_TR07S;
}

////////////////////////////////////////////////////////////////

// ============================================================================
// Implementation of ChMaterialBeamANCF_3243_TR07S methods
// ============================================================================

// Construct an isotropic material.
ChMaterialBeamANCF_3243_TR07S::ChMaterialBeamANCF_3243_TR07S(
...
// Poisson effect
void ChMaterialBeamANCF_3243_TR07S::Calc_D0_Dv(const ChVector<>& E,
                                              const ChVector<>& nu,
                                              const ChVector<>& G,
                                              double k1,
                                              double k2) {
