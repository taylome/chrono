...
#ifndef CHELEMENTBRICKANCF3843TR05_H
#define CHELEMENTBRICKANCF3843TR05_H
...
/// This class implements material properties for an ANCF Brick.
    class ChApi ChMaterialBrickANCF_3843_TR05 {
    public:
        /// Construct an isotropic material.
        ChMaterialBrickANCF_3843_TR05(double rho,        ///< material density
...
class ChApi ChElementBrickANCF_3843_TR05 : public ChElementGeneric, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBrickANCF_3843_TR05> brick_mat) { m_material = brick_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBrickANCF_3843_TR05> GetMaterial() const { return m_material; }
...
public:
  ...
  private:
      ...
      std::shared_ptr<ChMaterialBrickANCF_3843_TR05> m_material;  ///< shell material
      Matrix3xN m_ebar0;  ///< Element Position Coordinate Vector for the Reference Configuration
      //ChMatrixNMc<double, 32, 648> m_SD_precompute_D;  ///< Precomputed corrected normalized shape function derivative
      //                                                 ///< matrices
      //ChVectorN<double, 216> m_GQWeight_det_J_0xi_D;    ///< Precomputed Gauss-Quadrature Weight & Element Jacobian scale
      //                                                 ///< factors
