...
#ifndef CHELEMENTBEAMANCFMT07_H
#define CHELEMENTBEAMANCFMT07_H
...
class ChApi ChMaterialBeamANCF_MT07 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_MT07(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_MT07 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    using ShapeVector = ChMatrixNM<double, 1, 9>;

    ChElementBeamANCF_MT07();
    ~ChElementBeamANCF_MT07() {}
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MT07> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_MT07> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_MT07> m_material;    ///< beam material
