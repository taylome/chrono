...
//
// =============================================================================
// M113 = Vectorized Continuous Integration without Data Caching for the Jacobian
// =============================================================================
...
#ifndef CHELEMENTSHELLANCF3833_M113_H
#define CHELEMENTSHELLANCF3833_M113_H
...
class ChApi ChElementShellANCF_3833_M113 : public ChElementANCF, public ChElementShell, public ChLoadableUV, public ChLoadableUVW {
  public:
    ...
    class Layer {
      ...
      public:
        ...
        friend class ChElementShellANCF_3833_M113;
    };
  ...
  private:
    ...
    void ComputeInternalForcesLinearLayer(ChVectorDynamic<>& Fi, const Matrix6xN& ebar_ebardot, const int layer_id);
    
    /// Calculate MR layer generalized internal force
    void ComputeInternalForcesMRLayer(ChVectorDynamic<>& Fi, const Matrix6xN& ebar_ebardot, const int layer_id);

    /// Calculate linear elastic layer Jacobian
    void ComputeJacobianLinearLayer(Matrix3Nx3N& Jac, ChVectorN<double, (NSF * (NSF + 1)) / 2>& Jac_CompactPart, const double Kfactor, const double Rfactor, const Matrix6xN& ebar_ebardot, const int layer_id);

    /// Calculate MR layer Jacobian
    void ComputeJacobianMRLayer(Matrix3Nx3N& Jac, const double Kfactor, const double Rfactor, const Matrix6xN& ebar_ebardot, const int layer_id);
