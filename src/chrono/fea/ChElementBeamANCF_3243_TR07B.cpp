...
//
// =============================================================================
// TR07B = Vectorized Continuous Integration with Data Caching for the Jacobian
...
ChElementBeamANCF_3243_TR07B::ChElementBeamANCF_3243_TR07B()
...
void ChElementBeamANCF_3243_TR07B::SetNodes(std::shared_ptr<ChNodeFEAxyzDDD> nodeA,
...
void ChElementBeamANCF_3243_TR07B::SetDimensions(double lenX, double thicknessY, double thicknessZ) {
    m_lenX = lenX;
...
void ChElementBeamANCF_3243_TR07B::SetMaterial(std::shared_ptr<ChMaterialBeamANCF> beam_mat) {
    m_material = beam_mat;
}

// Set the value for the single term structural damping coefficient.

void ChElementBeamANCF_3243_TR07B::SetAlphaDamp(double a) {
    m_Alpha = a;
...
ChMatrix33<> ChElementBeamANCF_3243_TR07B::GetGreenLagrangeStrain(const double xi,
                                                                  const double eta,
                                                                  const double zeta) {
...
ChMatrix33<> ChElementBeamANCF_3243_TR07B::GetPK2Stress(const double xi, const double eta, const double zeta) {
    MatrixNx3c Sxi_D;  // Matrix of normalized shape function derivatives
    Calc_Sxi_D(Sxi_D, xi, eta, zeta);
...
double ChElementBeamANCF_3243_TR07B::GetVonMissesStress(const double xi, const double eta, const double zeta) {
    MatrixNx3c Sxi_D;  // Matrix of normalized shape function derivatives
    Calc_Sxi_D(Sxi_D, xi, eta, zeta);
...
void ChElementBeamANCF_3243_TR07B::SetupInitial(ChSystem* system) {
...
void ChElementBeamANCF_3243_TR07B::GetStateBlock(ChVectorDynamic<>& mD) {
...
void ChElementBeamANCF_3243_TR07B::Update() {
    ChElementGeneric::Update();
}

// Return the mass matrix in full sparse form.

void ChElementBeamANCF_3243_TR07B::ComputeMmatrixGlobal(ChMatrixRef M) {
    M.setZero();
...
void ChElementBeamANCF_3243_TR07B::ComputeNodalMass() {
...
void ChElementBeamANCF_3243_TR07B::ComputeInternalForces(ChVectorDynamic<>& Fi) {
    ...
    m_FC.noalias() = ebar_ebardot * m_SD;  // ChMatrixNM<double, 6, 3 * NIP>

    Eigen::Map<ArrayNIP_D0> F11_D0(m_FC.block<1, NIP_D0>(0, 0 * NIP_D0 + 0 * NIP_Dv).data(), 1, NIP_D0);
    Eigen::Map<ArrayNIP_D0> F12_D0(m_FC.block<1, NIP_D0>(0, 1 * NIP_D0 + 0 * NIP_Dv).data(), 1, NIP_D0);
    Eigen::Map<ArrayNIP_D0> F13_D0(m_FC.block<1, NIP_D0>(0, 2 * NIP_D0 + 0 * NIP_Dv).data(), 1, NIP_D0);
    Eigen::Map<ArrayNIP_Dv> F11_Dv(m_FC.block<1, NIP_Dv>(0, 3 * NIP_D0 + 0 * NIP_Dv).data(), 1, NIP_Dv);
    Eigen::Map<ArrayNIP_Dv> F12_Dv(m_FC.block<1, NIP_Dv>(0, 3 * NIP_D0 + 1 * NIP_Dv).data(), 1, NIP_Dv);
    Eigen::Map<ArrayNIP_Dv> F13_Dv(m_FC.block<1, NIP_Dv>(0, 3 * NIP_D0 + 2 * NIP_Dv).data(), 1, NIP_Dv);

    Eigen::Map<ArrayNIP_D0> F21_D0(m_FC.block<1, NIP_D0>(1, 0 * NIP_D0 + 0 * NIP_Dv).data(), 1, NIP_D0);
    Eigen::Map<ArrayNIP_D0> F22_D0(m_FC.block<1, NIP_D0>(1, 1 * NIP_D0 + 0 * NIP_Dv).data(), 1, NIP_D0);
    Eigen::Map<ArrayNIP_D0> F23_D0(m_FC.block<1, NIP_D0>(1, 2 * NIP_D0 + 0 * NIP_Dv).data(), 1, NIP_D0);
    Eigen::Map<ArrayNIP_Dv> F21_Dv(m_FC.block<1, NIP_Dv>(1, 3 * NIP_D0 + 0 * NIP_Dv).data(), 1, NIP_Dv);
    Eigen::Map<ArrayNIP_Dv> F22_Dv(m_FC.block<1, NIP_Dv>(1, 3 * NIP_D0 + 1 * NIP_Dv).data(), 1, NIP_Dv);
    Eigen::Map<ArrayNIP_Dv> F23_Dv(m_FC.block<1, NIP_Dv>(1, 3 * NIP_D0 + 2 * NIP_Dv).data(), 1, NIP_Dv);

    Eigen::Map<ArrayNIP_D0> F31_D0(m_FC.block<1, NIP_D0>(2, 0 * NIP_D0 + 0 * NIP_Dv).data(), 1, NIP_D0);
    Eigen::Map<ArrayNIP_D0> F32_D0(m_FC.block<1, NIP_D0>(2, 1 * NIP_D0 + 0 * NIP_Dv).data(), 1, NIP_D0);
    Eigen::Map<ArrayNIP_D0> F33_D0(m_FC.block<1, NIP_D0>(2, 2 * NIP_D0 + 0 * NIP_Dv).data(), 1, NIP_D0);
    Eigen::Map<ArrayNIP_Dv> F31_Dv(m_FC.block<1, NIP_Dv>(2, 3 * NIP_D0 + 0 * NIP_Dv).data(), 1, NIP_Dv);
    Eigen::Map<ArrayNIP_Dv> F32_Dv(m_FC.block<1, NIP_Dv>(2, 3 * NIP_D0 + 1 * NIP_Dv).data(), 1, NIP_Dv);
    Eigen::Map<ArrayNIP_Dv> F33_Dv(m_FC.block<1, NIP_Dv>(2, 3 * NIP_D0 + 2 * NIP_Dv).data(), 1, NIP_Dv);

    Eigen::Map<ArrayNIP_D0> Fdot11_D0(m_FC.block<1, NIP_D0>(3, 0 * NIP_D0 + 0 * NIP_Dv).data(), 1, NIP_D0);
    Eigen::Map<ArrayNIP_D0> Fdot12_D0(m_FC.block<1, NIP_D0>(3, 1 * NIP_D0 + 0 * NIP_Dv).data(), 1, NIP_D0);
    Eigen::Map<ArrayNIP_D0> Fdot13_D0(m_FC.block<1, NIP_D0>(3, 2 * NIP_D0 + 0 * NIP_Dv).data(), 1, NIP_D0);
    Eigen::Map<ArrayNIP_Dv> Fdot11_Dv(m_FC.block<1, NIP_Dv>(3, 3 * NIP_D0 + 0 * NIP_Dv).data(), 1, NIP_Dv);
    Eigen::Map<ArrayNIP_Dv> Fdot12_Dv(m_FC.block<1, NIP_Dv>(3, 3 * NIP_D0 + 1 * NIP_Dv).data(), 1, NIP_Dv);
    Eigen::Map<ArrayNIP_Dv> Fdot13_Dv(m_FC.block<1, NIP_Dv>(3, 3 * NIP_D0 + 2 * NIP_Dv).data(), 1, NIP_Dv);

    Eigen::Map<ArrayNIP_D0> Fdot21_D0(m_FC.block<1, NIP_D0>(4, 0 * NIP_D0 + 0 * NIP_Dv).data(), 1, NIP_D0);
    Eigen::Map<ArrayNIP_D0> Fdot22_D0(m_FC.block<1, NIP_D0>(4, 1 * NIP_D0 + 0 * NIP_Dv).data(), 1, NIP_D0);
    Eigen::Map<ArrayNIP_D0> Fdot23_D0(m_FC.block<1, NIP_D0>(4, 2 * NIP_D0 + 0 * NIP_Dv).data(), 1, NIP_D0);
    Eigen::Map<ArrayNIP_Dv> Fdot21_Dv(m_FC.block<1, NIP_Dv>(4, 3 * NIP_D0 + 0 * NIP_Dv).data(), 1, NIP_Dv);
    Eigen::Map<ArrayNIP_Dv> Fdot22_Dv(m_FC.block<1, NIP_Dv>(4, 3 * NIP_D0 + 1 * NIP_Dv).data(), 1, NIP_Dv);
    Eigen::Map<ArrayNIP_Dv> Fdot23_Dv(m_FC.block<1, NIP_Dv>(4, 3 * NIP_D0 + 2 * NIP_Dv).data(), 1, NIP_Dv);

    Eigen::Map<ArrayNIP_D0> Fdot31_D0(m_FC.block<1, NIP_D0>(5, 0 * NIP_D0 + 0 * NIP_Dv).data(), 1, NIP_D0);
    Eigen::Map<ArrayNIP_D0> Fdot32_D0(m_FC.block<1, NIP_D0>(5, 1 * NIP_D0 + 0 * NIP_Dv).data(), 1, NIP_D0);
    Eigen::Map<ArrayNIP_D0> Fdot33_D0(m_FC.block<1, NIP_D0>(5, 2 * NIP_D0 + 0 * NIP_Dv).data(), 1, NIP_D0);
    Eigen::Map<ArrayNIP_Dv> Fdot31_Dv(m_FC.block<1, NIP_Dv>(5, 3 * NIP_D0 + 0 * NIP_Dv).data(), 1, NIP_Dv);
    Eigen::Map<ArrayNIP_Dv> Fdot32_Dv(m_FC.block<1, NIP_Dv>(5, 3 * NIP_D0 + 1 * NIP_Dv).data(), 1, NIP_Dv);
    Eigen::Map<ArrayNIP_Dv> Fdot33_Dv(m_FC.block<1, NIP_Dv>(5, 3 * NIP_D0 + 2 * NIP_Dv).data(), 1, NIP_Dv);
    ...
    m_SPK2_1_D0 = D0(0) * m_kGQ_D0 *
                  ((0.5 * (F11_D0 * F11_D0 + F21_D0 * F21_D0 + F31_D0 * F31_D0) - 0.5) +
                   m_Alpha * (F11_D0 * Fdot11_D0 + F21_D0 * Fdot21_D0 + F31_D0 * Fdot31_D0));
    m_SPK2_2_D0 = D0(1) * m_kGQ_D0 *
                  ((0.5 * (F12_D0 * F12_D0 + F22_D0 * F22_D0 + F32_D0 * F32_D0) - 0.5) +
                   m_Alpha * (F12_D0 * Fdot12_D0 + F22_D0 * Fdot22_D0 + F32_D0 * Fdot32_D0));
    m_SPK2_3_D0 = D0(2) * m_kGQ_D0 *
                  ((0.5 * (F13_D0 * F13_D0 + F23_D0 * F23_D0 + F33_D0 * F33_D0) - 0.5) +
                   m_Alpha * (F13_D0 * Fdot13_D0 + F23_D0 * Fdot23_D0 + F33_D0 * Fdot33_D0));
    m_SPK2_4_D0 = D0(3) * m_kGQ_D0 *
                  ((F12_D0 * F13_D0 + F22_D0 * F23_D0 + F32_D0 * F33_D0) +
                   m_Alpha * (F12_D0 * Fdot13_D0 + F22_D0 * Fdot23_D0 + F32_D0 * Fdot33_D0 + Fdot12_D0 * F13_D0 +
                              Fdot22_D0 * F23_D0 + Fdot32_D0 * F33_D0));
    m_SPK2_5_D0 = D0(4) * m_kGQ_D0 *
                  ((F11_D0 * F13_D0 + F21_D0 * F23_D0 + F31_D0 * F33_D0) +
                   m_Alpha * (F11_D0 * Fdot13_D0 + F21_D0 * Fdot23_D0 + F31_D0 * Fdot33_D0 + Fdot11_D0 * F13_D0 +
                              Fdot21_D0 * F23_D0 + Fdot31_D0 * F33_D0));
    m_SPK2_6_D0 = D0(5) * m_kGQ_D0 *
                  ((F11_D0 * F12_D0 + F21_D0 * F22_D0 + F31_D0 * F32_D0) +
                   m_Alpha * (F11_D0 * Fdot12_D0 + F21_D0 * Fdot22_D0 + F31_D0 * Fdot32_D0 + Fdot11_D0 * F12_D0 +
                              Fdot21_D0 * F22_D0 + Fdot31_D0 * F32_D0));
    ...
    m_Sdiag_1_Dv = Dv(0, 0) * epsilon_combined_1 + Dv(0, 1) * epsilon_combined_2 + Dv(0, 2) * epsilon_combined_3;
    m_Sdiag_2_Dv = Dv(1, 0) * epsilon_combined_1 + Dv(1, 1) * epsilon_combined_2 + Dv(1, 2) * epsilon_combined_3;
    m_Sdiag_3_Dv = Dv(2, 0) * epsilon_combined_1 + Dv(2, 1) * epsilon_combined_2 + Dv(2, 2) * epsilon_combined_3;
    ...
    P_Block.block<NIP_D0, 1>(0 * NIP_D0 + 0 * NIP_Dv, 0).array().transpose() =
        F11_D0 * m_SPK2_1_D0 + F12_D0 * m_SPK2_6_D0 + F13_D0 * m_SPK2_5_D0;
    P_Block.block<NIP_D0, 1>(1 * NIP_D0 + 0 * NIP_Dv, 0).array().transpose() =
        F11_D0 * m_SPK2_6_D0 + F12_D0 * m_SPK2_2_D0 + F13_D0 * m_SPK2_4_D0;
    P_Block.block<NIP_D0, 1>(2 * NIP_D0 + 0 * NIP_Dv, 0).array().transpose() =
        F11_D0 * m_SPK2_5_D0 + F12_D0 * m_SPK2_4_D0 + F13_D0 * m_SPK2_3_D0;
    P_Block.block<NIP_Dv, 1>(3 * NIP_D0 + 0 * NIP_Dv, 0).array().transpose() = F11_Dv * m_Sdiag_1_Dv;
    P_Block.block<NIP_Dv, 1>(3 * NIP_D0 + 1 * NIP_Dv, 0).array().transpose() = F12_Dv * m_Sdiag_2_Dv;
    P_Block.block<NIP_Dv, 1>(3 * NIP_D0 + 2 * NIP_Dv, 0).array().transpose() = F13_Dv * m_Sdiag_3_Dv;

    P_Block.block<NIP_D0, 1>(0 * NIP_D0 + 0 * NIP_Dv, 1).array().transpose() =
        F21_D0 * m_SPK2_1_D0 + F22_D0 * m_SPK2_6_D0 + F23_D0 * m_SPK2_5_D0;
    P_Block.block<NIP_D0, 1>(1 * NIP_D0 + 0 * NIP_Dv, 1).array().transpose() =
        F21_D0 * m_SPK2_6_D0 + F22_D0 * m_SPK2_2_D0 + F23_D0 * m_SPK2_4_D0;
    P_Block.block<NIP_D0, 1>(2 * NIP_D0 + 0 * NIP_Dv, 1).array().transpose() =
        F21_D0 * m_SPK2_5_D0 + F22_D0 * m_SPK2_4_D0 + F23_D0 * m_SPK2_3_D0;
    P_Block.block<NIP_Dv, 1>(3 * NIP_D0 + 0 * NIP_Dv, 1).array().transpose() = F21_Dv * m_Sdiag_1_Dv;
    P_Block.block<NIP_Dv, 1>(3 * NIP_D0 + 1 * NIP_Dv, 1).array().transpose() = F22_Dv * m_Sdiag_2_Dv;
    P_Block.block<NIP_Dv, 1>(3 * NIP_D0 + 2 * NIP_Dv, 1).array().transpose() = F23_Dv * m_Sdiag_3_Dv;

    P_Block.block<NIP_D0, 1>(0 * NIP_D0 + 0 * NIP_Dv, 2).array().transpose() =
        F31_D0 * m_SPK2_1_D0 + F32_D0 * m_SPK2_6_D0 + F33_D0 * m_SPK2_5_D0;
    P_Block.block<NIP_D0, 1>(1 * NIP_D0 + 0 * NIP_Dv, 2).array().transpose() =
        F31_D0 * m_SPK2_6_D0 + F32_D0 * m_SPK2_2_D0 + F33_D0 * m_SPK2_4_D0;
    P_Block.block<NIP_D0, 1>(2 * NIP_D0 + 0 * NIP_Dv, 2).array().transpose() =
        F31_D0 * m_SPK2_5_D0 + F32_D0 * m_SPK2_4_D0 + F33_D0 * m_SPK2_3_D0;
    P_Block.block<NIP_Dv, 1>(3 * NIP_D0 + 0 * NIP_Dv, 2).array().transpose() = F31_Dv * m_Sdiag_1_Dv;
    P_Block.block<NIP_Dv, 1>(3 * NIP_D0 + 1 * NIP_Dv, 2).array().transpose() = F32_Dv * m_Sdiag_2_Dv;
    P_Block.block<NIP_Dv, 1>(3 * NIP_D0 + 2 * NIP_Dv, 2).array().transpose() = F33_Dv * m_Sdiag_3_Dv;
    ...
    FiMatrixForm.noalias() = m_SD * P_Block;
}

// Calculate the global matrix H as a linear combination of K, R, and M:
//   H = Mfactor * [M] + Kfactor * [K] + Rfactor * [R]

void ChElementBeamANCF_3243_TR07B::ComputeKRMmatricesGlobal(ChMatrixRef H,
                                                            double Kfactor,
                                                            double Rfactor,
                                                            double Mfactor) {
    ...
    // Map the components of the cached values of the Deformation Gradient and the time derivative of the Deformation
    // Gradient across all of the GQ points
    Eigen::Map<ArrayNIP_D0> F11_D0(m_FC.block<1, NIP_D0>(0, 0 * NIP_D0 + 0 * NIP_Dv).data(), 1, NIP_D0);
    Eigen::Map<ArrayNIP_D0> F12_D0(m_FC.block<1, NIP_D0>(0, 1 * NIP_D0 + 0 * NIP_Dv).data(), 1, NIP_D0);
    Eigen::Map<ArrayNIP_D0> F13_D0(m_FC.block<1, NIP_D0>(0, 2 * NIP_D0 + 0 * NIP_Dv).data(), 1, NIP_D0);
    Eigen::Map<ArrayNIP_Dv> F11_Dv(m_FC.block<1, NIP_Dv>(0, 3 * NIP_D0 + 0 * NIP_Dv).data(), 1, NIP_Dv);
    ...
    // The Jacobian calculation is performed in two major pieces.  First is the
    ...
    for (auto i = 0; i < NSF; i++) {
        PE.block<1, NIP_D0>(3 * i, 0 * NIP_D0).array() = m_SD.block<1, NIP_D0>(i, 0 * NIP_D0).array() * F11_D0;
        PE.block<1, NIP_D0>(3 * i, 1 * NIP_D0).array() = m_SD.block<1, NIP_D0>(i, 1 * NIP_D0).array() * F12_D0;
        PE.block<1, NIP_D0>(3 * i, 2 * NIP_D0).array() = m_SD.block<1, NIP_D0>(i, 2 * NIP_D0).array() * F13_D0;
        PE.block<1, NIP_D0>(3 * i, 3 * NIP_D0).array() = m_SD.block<1, NIP_D0>(i, 1 * NIP_D0).array() * F13_D0 +
                                                         m_SD.block<1, NIP_D0>(i, 2 * NIP_D0).array() * F12_D0;
        PE.block<1, NIP_D0>(3 * i, 4 * NIP_D0).array() = m_SD.block<1, NIP_D0>(i, 0 * NIP_D0).array() * F13_D0 +
                                                         m_SD.block<1, NIP_D0>(i, 2 * NIP_D0).array() * F11_D0;
        PE.block<1, NIP_D0>(3 * i, 5 * NIP_D0).array() = m_SD.block<1, NIP_D0>(i, 0 * NIP_D0).array() * F12_D0 +
                                                         m_SD.block<1, NIP_D0>(i, 1 * NIP_D0).array() * F11_D0;
        PE.block<1, NIP_Dv>(3 * i, 6 * NIP_D0 + 0 * NIP_Dv).array() =
            m_SD.block<1, NIP_Dv>(i, 3 * NIP_D0 + 0 * NIP_Dv).array() * F11_Dv;
        PE.block<1, NIP_Dv>(3 * i, 6 * NIP_D0 + 1 * NIP_Dv).array() =
            m_SD.block<1, NIP_Dv>(i, 3 * NIP_D0 + 1 * NIP_Dv).array() * F12_Dv;
        PE.block<1, NIP_Dv>(3 * i, 6 * NIP_D0 + 2 * NIP_Dv).array() =
            m_SD.block<1, NIP_Dv>(i, 3 * NIP_D0 + 2 * NIP_Dv).array() * F13_Dv;

        PE.block<1, NIP_D0>(3 * i + 1, 0 * NIP_D0).array() = m_SD.block<1, NIP_D0>(i, 0 * NIP_D0).array() * F21_D0;
        PE.block<1, NIP_D0>(3 * i + 1, 1 * NIP_D0).array() = m_SD.block<1, NIP_D0>(i, 1 * NIP_D0).array() * F22_D0;
        PE.block<1, NIP_D0>(3 * i + 1, 2 * NIP_D0).array() = m_SD.block<1, NIP_D0>(i, 2 * NIP_D0).array() * F23_D0;
        PE.block<1, NIP_D0>(3 * i + 1, 3 * NIP_D0).array() = m_SD.block<1, NIP_D0>(i, 1 * NIP_D0).array() * F23_D0 +
                                                             m_SD.block<1, NIP_D0>(i, 2 * NIP_D0).array() * F22_D0;
        PE.block<1, NIP_D0>(3 * i + 1, 4 * NIP_D0).array() = m_SD.block<1, NIP_D0>(i, 0 * NIP_D0).array() * F23_D0 +
                                                             m_SD.block<1, NIP_D0>(i, 2 * NIP_D0).array() * F21_D0;
        PE.block<1, NIP_D0>(3 * i + 1, 5 * NIP_D0).array() = m_SD.block<1, NIP_D0>(i, 0 * NIP_D0).array() * F22_D0 +
        ...
        PE.block<1, NIP_D0>(3 * i + 2, 0 * NIP_D0).array() = m_SD.block<1, NIP_D0>(i, 0 * NIP_D0).array() * F31_D0;
        PE.block<1, NIP_D0>(3 * i + 2, 1 * NIP_D0).array() = m_SD.block<1, NIP_D0>(i, 1 * NIP_D0).array() * F32_D0;
        PE.block<1, NIP_D0>(3 * i + 2, 2 * NIP_D0).array() = m_SD.block<1, NIP_D0>(i, 2 * NIP_D0).array() * F33_D0;
        PE.block<1, NIP_D0>(3 * i + 2, 3 * NIP_D0).array() = m_SD.block<1, NIP_D0>(i, 1 * NIP_D0).array() * F33_D0 +
                                                             m_SD.block<1, NIP_D0>(i, 2 * NIP_D0).array() * F32_D0;
        PE.block<1, NIP_D0>(3 * i + 2, 4 * NIP_D0).array() = m_SD.block<1, NIP_D0>(i, 0 * NIP_D0).array() * F33_D0 +
                                                             m_SD.block<1, NIP_D0>(i, 2 * NIP_D0).array() * F31_D0;
        PE.block<1, NIP_D0>(3 * i + 2, 5 * NIP_D0).array() = m_SD.block<1, NIP_D0>(i, 0 * NIP_D0).array() * F32_D0 +
    ...
    // deformation gradient block matrix will be ordered by block matrix (row vectors) components
    // =============================================================================

    ChMatrixNM<double, 3, 3 * NIP> FCS = (-Kfactor - m_Alpha * Rfactor) * m_FC.block<3, 3 * NIP>(0, 0) -
                                         (m_Alpha * Kfactor) * m_FC.block<3, 3 * NIP>(3, 0);
    for (auto i = 0; i < 3; i++) {
    ...
    for (auto i = 0; i < NSF; i++) {
        S_scaled_SD.block<1, NIP_D0>(i, 0) = m_SPK2_1_D0 * m_SD.block<1, NIP_D0>(i, 0 * NIP_D0).array() +
                                             m_SPK2_6_D0 * m_SD.block<1, NIP_D0>(i, 1 * NIP_D0).array() +
                                             m_SPK2_5_D0 * m_SD.block<1, NIP_D0>(i, 2 * NIP_D0).array();

        S_scaled_SD.block<1, NIP_D0>(i, NIP_D0) = m_SPK2_6_D0 * m_SD.block<1, NIP_D0>(i, 0 * NIP_D0).array() +
                                                  m_SPK2_2_D0 * m_SD.block<1, NIP_D0>(i, 1 * NIP_D0).array() +
                                                  m_SPK2_4_D0 * m_SD.block<1, NIP_D0>(i, 2 * NIP_D0).array();

        S_scaled_SD.block<1, NIP_D0>(i, 2 * NIP_D0) = m_SPK2_5_D0 * m_SD.block<1, NIP_D0>(i, 0 * NIP_D0).array() +
                                                      m_SPK2_4_D0 * m_SD.block<1, NIP_D0>(i, 1 * NIP_D0).array() +
                                                      m_SPK2_3_D0 * m_SD.block<1, NIP_D0>(i, 2 * NIP_D0).array();

        S_scaled_SD.block<1, NIP_Dv>(i, 3 * NIP_D0 + 0) =
            m_Sdiag_1_Dv * m_SD.block<1, NIP_Dv>(i, 3 * NIP_D0 + 0 * NIP_Dv).array();

        S_scaled_SD.block<1, NIP_Dv>(i, 3 * NIP_D0 + NIP_Dv) =
            m_Sdiag_2_Dv * m_SD.block<1, NIP_Dv>(i, 3 * NIP_D0 + 1 * NIP_Dv).array();

        S_scaled_SD.block<1, NIP_Dv>(i, 3 * NIP_D0 + 2 * NIP_Dv) =
            m_Sdiag_3_Dv * m_SD.block<1, NIP_Dv>(i, 3 * NIP_D0 + 2 * NIP_Dv).array();
    }
    unsigned int idx = 0;
    for (unsigned int i = 0; i < NSF; i++) {
        for (unsigned int j = i; j < NSF; j++) {
...
void ChElementBeamANCF_3243_TR07B::ComputeGravityForces(ChVectorDynamic<>& Fg, const ChVector<>& G_acc) {
...
void ChElementBeamANCF_3243_TR07B::EvaluateSectionFrame(const double xi, ChVector<>& point, ChQuaternion<>& rot) {
    VectorN Sxi_compact;
...
void ChElementBeamANCF_3243_TR07B::EvaluateSectionPoint(const double xi, ChVector<>& point) {
    VectorN Sxi_compact;
    Calc_Sxi_compact(Sxi_compact, xi, 0, 0);
...
void ChElementBeamANCF_3243_TR07B::EvaluateSectionVel(const double xi, ChVector<>& Result) {
    VectorN Sxi_compact;
    Calc_Sxi_compact(Sxi_compact, xi, 0, 0);
...
void ChElementBeamANCF_3243_TR07B::LoadableGetStateBlock_x(int block_offset, ChState& mD) {
...
void ChElementBeamANCF_3243_TR07B::LoadableGetStateBlock_w(int block_offset, ChStateDelta& mD) {
...
void ChElementBeamANCF_3243_TR07B::LoadableStateIncrement(const unsigned int off_x,
                                                          ChState& x_new,
                                                          const ChState& x,
...
void ChElementBeamANCF_3243_TR07B::LoadableGetVariables(std::vector<ChVariables*>& mvars) {
...
void ChElementBeamANCF_3243_TR07B::ComputeNF(
...
double ChElementBeamANCF_3243_TR07B::GetDensity() {
    return GetMaterial()->Get_rho();
}

// Calculate tangent to the centerline at coordinate xi [-1 to 1].

ChVector<> ChElementBeamANCF_3243_TR07B::ComputeTangent(const double xi) {
    VectorN Sxi_xi_compact;
    Calc_Sxi_xi_compact(Sxi_xi_compact, xi, 0, 0);
...
void ChElementBeamANCF_3243_TR07B::ComputeMassMatrixAndGravityForce() {
...
void ChElementBeamANCF_3243_TR07B::PrecomputeInternalForceMatricesWeights() {
    ChQuadratureTables* GQTable = GetStaticGQTables();
    ...
    m_FC.resize(6, 3 * NIP);
    m_SPK2_1_D0.resize(1, NIP_D0);
    m_SPK2_2_D0.resize(1, NIP_D0);
    m_SPK2_3_D0.resize(1, NIP_D0);
    m_SPK2_4_D0.resize(1, NIP_D0);
    m_SPK2_5_D0.resize(1, NIP_D0);
    m_SPK2_6_D0.resize(1, NIP_D0);
    m_Sdiag_1_Dv.resize(1, NIP_Dv);
    m_Sdiag_2_Dv.resize(1, NIP_Dv);
    m_Sdiag_3_Dv.resize(1, NIP_Dv);
...
void ChElementBeamANCF_3243_TR07B::Calc_Sxi_compact(VectorN& Sxi_compact, double xi, double eta, double zeta) {
...
void ChElementBeamANCF_3243_TR07B::Calc_Sxi_xi_compact(VectorN& Sxi_xi_compact, double xi, double eta, double zeta) {
...
void ChElementBeamANCF_3243_TR07B::Calc_Sxi_eta_compact(VectorN& Sxi_eta_compact, double xi, double eta, double zeta) {
...
void ChElementBeamANCF_3243_TR07B::Calc_Sxi_zeta_compact(VectorN& Sxi_zeta_compact,
                                                         double xi,
                                                         double eta,
                                                         double zeta) {
...
void ChElementBeamANCF_3243_TR07B::Calc_Sxi_D(MatrixNx3c& Sxi_D, double xi, double eta, double zeta) {
    VectorN Sxi_D_col;
...
void ChElementBeamANCF_3243_TR07B::CalcCoordVector(Vector3N& e) {
...
void ChElementBeamANCF_3243_TR07B::CalcCoordMatrix(Matrix3xN& ebar) {
...
void ChElementBeamANCF_3243_TR07B::CalcCoordDerivVector(Vector3N& edot) {
...
void ChElementBeamANCF_3243_TR07B::CalcCoordDerivMatrix(Matrix3xN& ebardot) {
...
void ChElementBeamANCF_3243_TR07B::CalcCombinedCoordMatrix(Matrix6xN& ebar_ebardot) {
...
void ChElementBeamANCF_3243_TR07B::Calc_J_0xi(ChMatrix33<double>& J_0xi, double xi, double eta, double zeta) {
    MatrixNx3c Sxi_D;
    Calc_Sxi_D(Sxi_D, xi, eta, zeta);
...
double ChElementBeamANCF_3243_TR07B::Calc_det_J_0xi(double xi, double eta, double zeta) {
...
ChQuadratureTables static_tables_3243_TR07B(1, CH_QUADRATURE_STATIC_TABLES);
//#endif // !CH_QUADRATURE_STATIC_TABLES

ChQuadratureTables* ChElementBeamANCF_3243_TR07B::GetStaticGQTables() {
    return &static_tables_3243_TR07B;
}
