...
#ifndef CHELEMENTSHELLANCF3833TR11S_H
#define CHELEMENTSHELLANCF3833TR11S_H
...
class ChApi ChMaterialShellANCF_3833_TR11S {
  public:
    /// Construct an isotropic material.
    ChMaterialShellANCF_3833_TR11S(double rho,  ///< material density
...
class ChApi ChElementShellANCF_3833_TR11S : public ChElementShell, public ChLoadableUV, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialShellANCF_3833_TR11S> shell_mat) { m_material = shell_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialShellANCF_3833_TR11S> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialShellANCF_3833_TR11S> m_material;  ///< shell material
