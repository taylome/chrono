...
#ifndef CHELEMENTBEAMANCF3243_MR_NODAMPNUMJAC_H
#define CHELEMENTBEAMANCF3243_MR_NODAMPNUMJAC_H
...
class ChApi ChElementBeamANCF_3243_MR_NoDampNumJac : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    // Using fewer than 3 Gauss quadrature points along the beam axis (NP) or 2 points through each cross section direction (NT)
    ...
    static const int NIP_S =
        NP * NT * NT;             ///< number of Gauss quadrature points excluding the volumetric penalty terms
    static const int NIP_P = NP;  ///< number of Gauss quadrature points along the beam axis for selectively integrating
    ...
    // Short-cuts for defining a Eigen arrays of length NIP_S and NIP_P
    ...
    ChElementBeamANCF_3243_MR_NoDampNumJac();
    ~ChElementBeamANCF_3243_MR_NoDampNumJac() {}
