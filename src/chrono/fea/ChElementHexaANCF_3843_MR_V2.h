...
#ifndef CH_ELEMENT_HEXA_ANCF_3843_MR_V2_H
#define CH_ELEMENT_HEXA_ANCF_3843_MR_V2_H
...
class ChApi ChElementHexaANCF_3843_MR_V2 : public ChElementHexahedron, public ChElementGeneric, public ChLoadableUVW {
  public:
  ...
  private:
    ...
    // ---------------------
    void ComputeInternalForcesAtState(ChVectorDynamic<>& Fi, Matrix3xN& ebar, Matrix3xN& ebardot);
