...
#ifndef CHELEMENTBEAMANCFMT40_H
#define CHELEMENTBEAMANCFMT40_H
...
class ChApi ChMaterialBeamANCF_MT40 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_MT40(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_MT40 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MT40> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_MT40> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_MT40> m_material;    ///< beam material
