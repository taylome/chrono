...
#ifndef CHELEMENTBEAMANCF3243TR02GQ322_H
#define CHELEMENTBEAMANCF3243TR02GQ322_H
...
class ChApi ChMaterialBeamANCF_3243_TR02_GQ322 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_3243_TR02_GQ322(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_3243_TR02_GQ322 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    ChElementBeamANCF_3243_TR02_GQ322();
    ~ChElementBeamANCF_3243_TR02_GQ322() {}
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_3243_TR02_GQ322> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_3243_TR02_GQ322> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_3243_TR02_GQ322> m_material;  ///< beam material
