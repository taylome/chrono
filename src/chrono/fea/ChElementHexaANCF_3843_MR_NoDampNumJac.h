...
#ifndef CH_ELEMENT_HEXA_ANCF_3843_MR_NoDampNumJac_H
#define CH_ELEMENT_HEXA_ANCF_3843_MR_NoDampNumJac_H
...
class ChApi ChElementHexaANCF_3843_MR_NoDampNumJac : public ChElementANCF, public ChElementHexahedron, public ChElementGeneric, public ChLoadableUVW {
  public:
    ...
    ChElementHexaANCF_3843_MR_NoDampNumJac();
    ~ChElementHexaANCF_3843_MR_NoDampNumJac() {}
