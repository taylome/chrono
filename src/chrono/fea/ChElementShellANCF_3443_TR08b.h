...
#ifndef CHELEMENTSHELLANCF3443TR08B_H
#define CHELEMENTSHELLANCF3443TR08B_H
...
class ChApi ChMaterialShellANCF_3443_TR08b {
  public:
    /// Construct an isotropic material.
    ChMaterialShellANCF_3443_TR08b(double rho,        ///< material density
...
class ChApi ChElementShellANCF_3443_TR08b : public ChElementShell, public ChLoadableUV, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialShellANCF_3443_TR08b> shell_mat) { m_material = shell_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialShellANCF_3443_TR08b> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialShellANCF_3443_TR08b> m_material;  ///< shell material
    ...
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::ColMajor, 16, 216> m_SD_precompute_D;  ///< Precomputed corrected normalized shape function derivative
                                                 ///< matrices
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor, 16, 216>
        m_SD_precompute_col_ordered;  ///< Precomputed corrected normalized shape function derivative matrices for no
                                      ///< Poisson Effect followed by Poisson Effect on the beam axis only in column by
                                      ///< column order
    //Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::ColMajor, 216, 3>
    //    m_F_Transpose_CombinedBlock_col_ordered;  ///< Cached calculation for all the Deformation Gradients in reordered
    //                                              ///< column format without Fdot
    //Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::ColMajor, 216, 6>
    //    m_F_Transpose_CombinedBlockDamping_col_ordered;  ///< Cached calculation for all the Deformation Gradients in
    //                                                     ///< reordered column format with Fdot
