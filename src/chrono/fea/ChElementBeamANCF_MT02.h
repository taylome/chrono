...
#ifndef CHELEMENTBEAMANCFMT02_H
#define CHELEMENTBEAMANCFMT02_H
...
class ChApi ChMaterialBeamANCF_MT02 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_MT02(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_MT02 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    using ShapeVector = ChMatrixNM<double, 1, 9>;

    ChElementBeamANCF_MT02();
    ~ChElementBeamANCF_MT02() {}
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MT02> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_MT02> GetMaterial() const { return m_material; }
  ...
  public:
    ...
    void ComputeInternalForcesAtState(ChVectorDynamic<>& Fi, ChVectorN<double, 27>& e, ChVectorN<double, 27>& e_dot);
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_MT02> m_material;    ///< beam material
