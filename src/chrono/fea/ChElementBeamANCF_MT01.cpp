...
ChElementBeamANCF_MT01::ChElementBeamANCF_MT01() : m_gravity_on(false), m_thicknessY(0), m_thicknessZ(0), m_lenX(0), m_Alpha(0), m_damping_enabled(false){
    m_nodes.resize(3);
}
...
void ChElementBeamANCF_MT01::SetAlphaDamp(double a) {
    m_Alpha = a;
...
void ChElementBeamANCF_MT01::ComputeInternalForcesAtState(ChVectorDynamic<>& Fi, ChVectorN<double, 27>& e, ChVectorN<double, 27>& e_dot) {
...
void ChElementBeamANCF_MT01::ComputeInternalJacobians(ChMatrixNM<double, 27, 27>& JacobianMatrix, double Kfactor, double Rfactor) {
...
void ChElementBeamANCF_MT01::CalcCoordDerivVector(ChVectorN<double, 27>& edot) {
...
double ChElementBeamANCF_MT01::Calc_det_J_0xi(double xi, double eta, double zeta) {
...
ChQuadratureTables static_tables_MT01(1, CH_QUADRATURE_STATIC_TABLES);
//#endif // !CH_QUADRATURE_STATIC_TABLES

ChQuadratureTables* ChElementBeamANCF_MT01::GetStaticGQTables() {
    return &static_tables_MT01;
}
...
void ChMaterialBeamANCF_MT01::Calc_D0_Dv(const ChVector<>& E, const ChVector<>& nu, const ChVector<>& G, double k1, double k2) {
