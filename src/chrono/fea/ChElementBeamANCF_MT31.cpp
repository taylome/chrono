...
// =============================================================================
//
// MT31 = MT30 + With Just the First Implementation of Liu Calculation Method (comparison code removed)
...
void ChElementBeamANCF_MT31::ComputeInternalForcesAtState(ChVectorDynamic<>& Fi, ChMatrixNMc<double, 9, 3>& e_bar, ChMatrixNMc<double, 9, 3>& e_bar_dot) {
