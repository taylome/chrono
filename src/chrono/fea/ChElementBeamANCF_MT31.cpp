...
// =============================================================================
//
// MT31 = MT25 with for loop free internal force calculation (2nd version)
...
////
//// What should be done with ChVector<> ChElementBeamANCF_MT31::EvaluateBeamSectionStrains()... It doesn't seems to make sense for this element since there are no input arguments
...
////
//// For ChElementBeamANCF_MT31::ComputeNF, Need to figure out the state update stuff and exactly what Jacobian is being asked for
...
void ChElementBeamANCF_MT31::SetNodes(std::shared_ptr<ChNodeFEAxyzDD> nodeA,
...
void ChElementBeamANCF_MT31::SetupInitial(ChSystem* system) {
...
// State update.
void ChElementBeamANCF_MT31::Update() {
    ChElementGeneric::Update();
}

// Fill the D vector with the current field values at the element nodes.
void ChElementBeamANCF_MT31::GetStateBlock(ChVectorDynamic<>& mD) {
...
void ChElementBeamANCF_MT31::ComputeKRMmatricesGlobal(ChMatrixRef H, double Kfactor, double Rfactor, double Mfactor) {
    ...
    if (GetStrainFormulation() == ChElementBeamANCF_MT31::StrainFormulation::CMPoisson) {
...
void ChElementBeamANCF_MT31::ComputeMmatrixGlobal(ChMatrixRef M) {
    M.setZero();
...
// -----------------------------------------------------------------------------
void ChElementBeamANCF_MT31::ComputeMassMatrixAndGravityForce(const ChVector<>& g_acc) {
...
void ChElementBeamANCF_MT31::PrecomputeInternalForceMatricesWeights() {
    ChQuadratureTables* GQTable = GetStaticGQTables();
...
void ChElementBeamANCF_MT31::ComputeNodalMass() {
...
void ChElementBeamANCF_MT31::SetAlphaDamp(double a) {
    m_Alpha = a;
    m_2Alpha = 2 * a;
...
void ChElementBeamANCF_MT31::ComputeInternalForcesAtState(ChVectorDynamic<>& Fi, const ChMatrixNMc<double, 9, 6>& ebar_ebardot) {
    ...
    ChMatrixNMc<double, 16, 3> Fcol0_Transpose_D0_Block = F_Transpose_CombinedBlock_col_ordered.block<16, 3>(0, 0);
    ChMatrixNMc<double, 16, 3> Fdotcol0_Transpose_D0_Block = F_Transpose_CombinedBlock_col_ordered.block<16, 3>(0, 3);
    ChMatrixNMc<double, 16, 3> Fcol1_Transpose_D0_Block = F_Transpose_CombinedBlock_col_ordered.block<16, 3>(16, 0);
    ChMatrixNMc<double, 16, 3> Fdotcol1_Transpose_D0_Block = F_Transpose_CombinedBlock_col_ordered.block<16, 3>(16, 3);
    ChMatrixNMc<double, 16, 3> Fcol2_Transpose_D0_Block = F_Transpose_CombinedBlock_col_ordered.block<16, 3>(32, 0);
    ChMatrixNMc<double, 16, 3> Fdotcol2_Transpose_D0_Block = F_Transpose_CombinedBlock_col_ordered.block<16, 3>(32, 3);

    ChMatrixNMc<double, 4, 3> Fcol0_Transpose_Dv_Block = F_Transpose_CombinedBlock_col_ordered.block<4, 3>(48, 0);
    ChMatrixNMc<double, 4, 3> Fdotcol0_Transpose_Dv_Block = F_Transpose_CombinedBlock_col_ordered.block<4, 3>(48, 3);
    ChMatrixNMc<double, 4, 3> Fcol1_Transpose_Dv_Block = F_Transpose_CombinedBlock_col_ordered.block<4, 3>(52, 0);
    ChMatrixNMc<double, 4, 3> Fdotcol1_Transpose_Dv_Block = F_Transpose_CombinedBlock_col_ordered.block<4, 3>(52, 3);
    ChMatrixNMc<double, 4, 3> Fcol2_Transpose_Dv_Block = F_Transpose_CombinedBlock_col_ordered.block<4, 3>(56, 0);
    ChMatrixNMc<double, 4, 3> Fdotcol2_Transpose_Dv_Block = F_Transpose_CombinedBlock_col_ordered.block<4, 3>(56, 3);
    ...
    ChVectorN<double, 16> SPK2_0_D0_BlockDamping = Fcol0_Transpose_D0_Block.col(0).cwiseProduct(Fdotcol0_Transpose_D0_Block.col(0));
    SPK2_0_D0_BlockDamping += Fcol0_Transpose_D0_Block.col(1).cwiseProduct(Fdotcol0_Transpose_D0_Block.col(1));
    SPK2_0_D0_BlockDamping += Fcol0_Transpose_D0_Block.col(2).cwiseProduct(Fdotcol0_Transpose_D0_Block.col(2));
    ...
    ChVectorN<double, 16> SPK2_1_D0_BlockDamping = Fcol1_Transpose_D0_Block.col(0).cwiseProduct(Fdotcol1_Transpose_D0_Block.col(0));
    SPK2_1_D0_BlockDamping += Fcol1_Transpose_D0_Block.col(1).cwiseProduct(Fdotcol1_Transpose_D0_Block.col(1));
    SPK2_1_D0_BlockDamping += Fcol1_Transpose_D0_Block.col(2).cwiseProduct(Fdotcol1_Transpose_D0_Block.col(2));
    ...
    ChVectorN<double, 16> SPK2_2_D0_BlockDamping = Fcol2_Transpose_D0_Block.col(0).cwiseProduct(Fdotcol2_Transpose_D0_Block.col(0));
    SPK2_2_D0_BlockDamping += Fcol2_Transpose_D0_Block.col(1).cwiseProduct(Fdotcol2_Transpose_D0_Block.col(1));
    SPK2_2_D0_BlockDamping += Fcol2_Transpose_D0_Block.col(2).cwiseProduct(Fdotcol2_Transpose_D0_Block.col(2));
    ...
    ChVectorN<double, 16> SPK2_3_D0_BlockDamping = Fcol2_Transpose_D0_Block.col(0).cwiseProduct(Fdotcol1_Transpose_D0_Block.col(0));
    SPK2_3_D0_BlockDamping += Fcol2_Transpose_D0_Block.col(1).cwiseProduct(Fdotcol1_Transpose_D0_Block.col(1));
    SPK2_3_D0_BlockDamping += Fcol2_Transpose_D0_Block.col(2).cwiseProduct(Fdotcol1_Transpose_D0_Block.col(2));
    SPK2_3_D0_BlockDamping += Fcol1_Transpose_D0_Block.col(0).cwiseProduct(Fdotcol2_Transpose_D0_Block.col(0));
    SPK2_3_D0_BlockDamping += Fcol1_Transpose_D0_Block.col(1).cwiseProduct(Fdotcol2_Transpose_D0_Block.col(1));
    SPK2_3_D0_BlockDamping += Fcol1_Transpose_D0_Block.col(2).cwiseProduct(Fdotcol2_Transpose_D0_Block.col(2));
    ...
    ChVectorN<double, 16> SPK2_4_D0_BlockDamping = Fcol2_Transpose_D0_Block.col(0).cwiseProduct(Fdotcol0_Transpose_D0_Block.col(0));
    SPK2_4_D0_BlockDamping += Fcol2_Transpose_D0_Block.col(1).cwiseProduct(Fdotcol0_Transpose_D0_Block.col(1));
    SPK2_4_D0_BlockDamping += Fcol2_Transpose_D0_Block.col(2).cwiseProduct(Fdotcol0_Transpose_D0_Block.col(2));
    SPK2_4_D0_BlockDamping += Fcol0_Transpose_D0_Block.col(0).cwiseProduct(Fdotcol2_Transpose_D0_Block.col(0));
    SPK2_4_D0_BlockDamping += Fcol0_Transpose_D0_Block.col(1).cwiseProduct(Fdotcol2_Transpose_D0_Block.col(1));
    SPK2_4_D0_BlockDamping += Fcol0_Transpose_D0_Block.col(2).cwiseProduct(Fdotcol2_Transpose_D0_Block.col(2));
    ...
    ChVectorN<double, 16> SPK2_5_D0_BlockDamping = Fcol1_Transpose_D0_Block.col(0).cwiseProduct(Fdotcol0_Transpose_D0_Block.col(0));
    SPK2_5_D0_BlockDamping += Fcol1_Transpose_D0_Block.col(1).cwiseProduct(Fdotcol0_Transpose_D0_Block.col(1));
    SPK2_5_D0_BlockDamping += Fcol1_Transpose_D0_Block.col(2).cwiseProduct(Fdotcol0_Transpose_D0_Block.col(2));
    SPK2_5_D0_BlockDamping += Fcol0_Transpose_D0_Block.col(0).cwiseProduct(Fdotcol1_Transpose_D0_Block.col(0));
    SPK2_5_D0_BlockDamping += Fcol0_Transpose_D0_Block.col(1).cwiseProduct(Fdotcol1_Transpose_D0_Block.col(1));
    SPK2_5_D0_BlockDamping += Fcol0_Transpose_D0_Block.col(2).cwiseProduct(Fdotcol1_Transpose_D0_Block.col(2));
    ...
    P_transpose_scaled_Block_col_ordered.block<16, 1>(0, 0) = Fcol0_Transpose_D0_Block.col(0).cwiseProduct(SPK2_0_D0_Block)
        + Fcol1_Transpose_D0_Block.col(0).cwiseProduct(SPK2_5_D0_Block);
    P_transpose_scaled_Block_col_ordered.block<16, 1>(0, 0) += Fcol2_Transpose_D0_Block.col(0).cwiseProduct(SPK2_4_D0_Block);
    P_transpose_scaled_Block_col_ordered.block<16, 1>(0, 1) = Fcol0_Transpose_D0_Block.col(1).cwiseProduct(SPK2_0_D0_Block)
        + Fcol1_Transpose_D0_Block.col(1).cwiseProduct(SPK2_5_D0_Block);
    P_transpose_scaled_Block_col_ordered.block<16, 1>(0, 1) += Fcol2_Transpose_D0_Block.col(1).cwiseProduct(SPK2_4_D0_Block);
    P_transpose_scaled_Block_col_ordered.block<16, 1>(0, 2) = Fcol0_Transpose_D0_Block.col(2).cwiseProduct(SPK2_0_D0_Block)
        + Fcol1_Transpose_D0_Block.col(2).cwiseProduct(SPK2_5_D0_Block);
    P_transpose_scaled_Block_col_ordered.block<16, 1>(0, 2) += Fcol2_Transpose_D0_Block.col(2).cwiseProduct(SPK2_4_D0_Block);

    P_transpose_scaled_Block_col_ordered.block<16, 1>(16, 0) = Fcol0_Transpose_D0_Block.col(0).cwiseProduct(SPK2_5_D0_Block)
        + Fcol1_Transpose_D0_Block.col(0).cwiseProduct(SPK2_1_D0_Block);
    P_transpose_scaled_Block_col_ordered.block<16, 1>(16, 0) += Fcol2_Transpose_D0_Block.col(0).cwiseProduct(SPK2_3_D0_Block);
    P_transpose_scaled_Block_col_ordered.block<16, 1>(16, 1) = Fcol0_Transpose_D0_Block.col(1).cwiseProduct(SPK2_5_D0_Block)
        + Fcol1_Transpose_D0_Block.col(1).cwiseProduct(SPK2_1_D0_Block);
    P_transpose_scaled_Block_col_ordered.block<16, 1>(16, 1) += Fcol2_Transpose_D0_Block.col(1).cwiseProduct(SPK2_3_D0_Block);
    P_transpose_scaled_Block_col_ordered.block<16, 1>(16, 2) = Fcol0_Transpose_D0_Block.col(2).cwiseProduct(SPK2_5_D0_Block)
        + Fcol1_Transpose_D0_Block.col(2).cwiseProduct(SPK2_1_D0_Block);
    P_transpose_scaled_Block_col_ordered.block<16, 1>(16, 2) += Fcol2_Transpose_D0_Block.col(2).cwiseProduct(SPK2_3_D0_Block);

    P_transpose_scaled_Block_col_ordered.block<16, 1>(32, 0) = Fcol0_Transpose_D0_Block.col(0).cwiseProduct(SPK2_4_D0_Block)
        + Fcol1_Transpose_D0_Block.col(0).cwiseProduct(SPK2_3_D0_Block);
    P_transpose_scaled_Block_col_ordered.block<16, 1>(32, 0) += Fcol2_Transpose_D0_Block.col(0).cwiseProduct(SPK2_2_D0_Block);
    P_transpose_scaled_Block_col_ordered.block<16, 1>(32, 1) = Fcol0_Transpose_D0_Block.col(1).cwiseProduct(SPK2_4_D0_Block)
        + Fcol1_Transpose_D0_Block.col(1).cwiseProduct(SPK2_3_D0_Block);
    P_transpose_scaled_Block_col_ordered.block<16, 1>(32, 1) += Fcol2_Transpose_D0_Block.col(1).cwiseProduct(SPK2_2_D0_Block);
    P_transpose_scaled_Block_col_ordered.block<16, 1>(32, 2) = Fcol0_Transpose_D0_Block.col(2).cwiseProduct(SPK2_4_D0_Block)
        + Fcol1_Transpose_D0_Block.col(2).cwiseProduct(SPK2_3_D0_Block);
    P_transpose_scaled_Block_col_ordered.block<16, 1>(32, 2) += Fcol2_Transpose_D0_Block.col(2).cwiseProduct(SPK2_2_D0_Block);
    ...
    ChVectorN<double, 4> Ediag_0_Dv_BlockDamping = Fcol0_Transpose_Dv_Block.col(0).cwiseProduct(Fdotcol0_Transpose_Dv_Block.col(0));
    Ediag_0_Dv_BlockDamping += Fcol0_Transpose_Dv_Block.col(1).cwiseProduct(Fdotcol0_Transpose_Dv_Block.col(1));
    Ediag_0_Dv_BlockDamping += Fcol0_Transpose_Dv_Block.col(2).cwiseProduct(Fdotcol0_Transpose_Dv_Block.col(2));
    ...
    ChVectorN<double, 4> Ediag_1_Dv_BlockDamping = Fcol1_Transpose_Dv_Block.col(0).cwiseProduct(Fdotcol1_Transpose_Dv_Block.col(0));
    Ediag_1_Dv_BlockDamping += Fcol1_Transpose_Dv_Block.col(1).cwiseProduct(Fdotcol1_Transpose_Dv_Block.col(1));
    Ediag_1_Dv_BlockDamping += Fcol1_Transpose_Dv_Block.col(2).cwiseProduct(Fdotcol1_Transpose_Dv_Block.col(2));
    ...
    ChVectorN<double, 4> Ediag_2_Dv_BlockDamping = Fcol2_Transpose_Dv_Block.col(0).cwiseProduct(Fdotcol2_Transpose_Dv_Block.col(0));
    Ediag_2_Dv_BlockDamping += Fcol2_Transpose_Dv_Block.col(1).cwiseProduct(Fdotcol2_Transpose_Dv_Block.col(1));
    Ediag_2_Dv_BlockDamping += Fcol2_Transpose_Dv_Block.col(2).cwiseProduct(Fdotcol2_Transpose_Dv_Block.col(2));
    ...
    P_transpose_scaled_Block_col_ordered.block<4, 1>(48, 0) = Fcol0_Transpose_Dv_Block.col(0).cwiseProduct(Sdiag_0_Dv_Block);
    P_transpose_scaled_Block_col_ordered.block<4, 1>(48, 1) = Fcol0_Transpose_Dv_Block.col(1).cwiseProduct(Sdiag_0_Dv_Block);
    P_transpose_scaled_Block_col_ordered.block<4, 1>(48, 2) = Fcol0_Transpose_Dv_Block.col(2).cwiseProduct(Sdiag_0_Dv_Block);

    P_transpose_scaled_Block_col_ordered.block<4, 1>(52, 0) = Fcol1_Transpose_Dv_Block.col(0).cwiseProduct(Sdiag_1_Dv_Block);
    P_transpose_scaled_Block_col_ordered.block<4, 1>(52, 1) = Fcol1_Transpose_Dv_Block.col(1).cwiseProduct(Sdiag_1_Dv_Block);
    P_transpose_scaled_Block_col_ordered.block<4, 1>(52, 2) = Fcol1_Transpose_Dv_Block.col(2).cwiseProduct(Sdiag_1_Dv_Block);

    P_transpose_scaled_Block_col_ordered.block<4, 1>(56, 0) = Fcol2_Transpose_Dv_Block.col(0).cwiseProduct(Sdiag_2_Dv_Block);
    P_transpose_scaled_Block_col_ordered.block<4, 1>(56, 1) = Fcol2_Transpose_Dv_Block.col(1).cwiseProduct(Sdiag_2_Dv_Block);
    P_transpose_scaled_Block_col_ordered.block<4, 1>(56, 2) = Fcol2_Transpose_Dv_Block.col(2).cwiseProduct(Sdiag_2_Dv_Block);
...
void ChElementBeamANCF_MT31::ComputeInternalForcesAtStateNoDamping(ChVectorDynamic<>& Fi, const ChMatrixNMc<double, 9, 3>& e_bar) {
...
void ChElementBeamANCF_MT31::ComputeInternalForcesSingleGQPnt(ChMatrixNM<double, 9, 3>& QiCompact, unsigned int index, ChVectorN<double, 6>& D0, ChMatrixNMc<double, 9, 3>& e_bar, ChMatrixNMc<double, 9, 3>& e_bar_dot) {
    //ChMatrix33<double> J_0xi;               //Element Jacobian between the reference configuration and normalized configuration
...
void ChElementBeamANCF_MT31::ComputeInternalForcesSingleGQPnt(ChMatrixNM<double, 9, 3>& QiCompact, unsigned int index, ChMatrix33<double>& Dv, ChMatrixNMc<double, 9, 3>& e_bar, ChMatrixNMc<double, 9, 3>& e_bar_dot) {
    //ChMatrix33<double> J_0xi;               //Element Jacobian between the reference configuration and normalized configuration
    //ChMatrixNM<double, 9, 3> Sxi_D;         //Matrix of normalized shape function derivatives
...
void ChElementBeamANCF_MT31::ComputeInternalForcesSingleGQPnt(ChMatrixNM<double, 9, 3>& QiCompact, double xi, double eta, double zeta, ChMatrixNM<double, 6, 6>& D, ChMatrixNMc<double, 9, 3>& e_bar, ChMatrixNMc<double, 9, 3>& e_bar_dot) {
    ChMatrix33<double> J_0xi;               //Element Jacobian between the reference configuration and normalized configuration
    ChMatrixNMc<double, 9, 3> Sxi_D;         //Matrix of normalized shape function derivatives
...
void ChElementBeamANCF_MT31::ComputeInternalJacobianSingleGQPnt(ChMatrixNM<double, 27, 27>& Jac_Dense, ChMatrixNM<double, 9, 9>& Jac_Compact, double Kfactor, double Rfactor, unsigned int index, ChVectorN<double, 6>& D0, ChMatrixNMc<double, 9, 3>& e_bar, ChMatrixNMc<double, 9, 3>& e_bar_dot) {
...
void ChElementBeamANCF_MT31::ComputeInternalJacobianSingleGQPnt(ChMatrixNM<double, 27, 27>& Jac_Dense, ChMatrixNM<double, 9, 9>& Jac_Compact, double Kfactor, double Rfactor, unsigned int index, ChMatrix33<double>& Dv, ChMatrixNMc<double, 9, 3>& e_bar, ChMatrixNMc<double, 9, 3>& e_bar_dot) {
...
void ChElementBeamANCF_MT31::ComputeInternalJacobianSingleGQPnt(ChMatrixNM<double, 27, 27>& Jac_Dense, ChMatrixNM<double, 9, 9>& Jac_Compact, double Kfactor, double Rfactor, double GQ_weight, double xi, double eta, double zeta, ChMatrixNM<double, 6, 6>& D, ChMatrixNMc<double, 9, 3>& e_bar, ChMatrixNMc<double, 9, 3>& e_bar_dot){
    ChMatrix33<double> J_0xi;               //Element Jacobian between the reference configuration and normalized configuration
    ChMatrixNMc<double, 9, 3> Sxi_D;         //Matrix of normalized shape function derivatives
    ChMatrixNMc<double, 9, 3> Sxi_D_0xi;     //Matrix of normalized shape function derivatives corrected for a potentially non-straight reference configuration
    ChVectorN<double, 6> epsilon;           //Green-Lagrange strain tensor in Voigt notation
...
void ChElementBeamANCF_MT31::ComputeInternalJacobians(ChMatrixNM<double, 27, 27>& JacobianMatrix, double Kfactor, double Rfactor) {
...
void ChElementBeamANCF_MT31::ComputeInternalJacobiansAnalytic(ChMatrixNM<double, 27, 27>& JacobianMatrix, double Kfactor, double Rfactor) {
    ChMatrixNMc<double, 9, 3> e_bar;
    ChMatrixNMc<double, 9, 3> e_bar_dot;
...
void ChElementBeamANCF_MT31::Calc_Sxi(ChMatrixNM<double, 3, 27>& Sxi, double xi, double eta, double zeta) {
...
// [s1; s2; s3; ...]
void ChElementBeamANCF_MT31::Calc_Sxi_compact(ChVectorN<double, 9>& Sxi_compact, double xi, double eta, double zeta) {
...
void ChElementBeamANCF_MT31::Calc_Sxi_D(ChMatrixNMc<double, 9, 3>& Sxi_D, double xi, double eta, double zeta) {
    Sxi_D(0, 0) = xi - 0.5;
...
void ChElementBeamANCF_MT31::CalcCoordMatrix(ChMatrixNMc<double, 9, 3>& e) {
...
void ChElementBeamANCF_MT31::CalcCoordVector(ChVectorN<double, 27>& e) {
...
void ChElementBeamANCF_MT31::CalcCoordDerivMatrix(ChMatrixNMc<double, 9, 3>& edot) {
...
void ChElementBeamANCF_MT31::CalcCoordDerivVector(ChVectorN<double, 27>& edot) {
...
void ChElementBeamANCF_MT31::CalcCombinedCoordMatrix(ChMatrixNMc<double, 9, 6>& ebar_ebardot) {
...
void ChElementBeamANCF_MT31::Calc_J_0xi(ChMatrix33<double>& J_0xi, double xi, double eta, double zeta) {
...
double ChElementBeamANCF_MT31::Calc_det_J_0xi(double xi, double eta, double zeta) {
    ChMatrixNMc<double, 9, 3> Sxi_D;
...
// -----------------------------------------------------------------------------
//ChVector<> ChElementBeamANCF_MT31::EvaluateBeamSectionStrains() {
...
//}
//
// void ChElementBeamANCF_MT31::EvaluateSectionDisplacement(const double u,
//                                                    const double v,
//                                                    ChVector<>& u_displ,
//                                                    ChVector<>& u_rotaz) {
...
void ChElementBeamANCF_MT31::EvaluateSectionFrame(const double eta, ChVector<>& point, ChQuaternion<>& rot) {
...
// void ChElementBeamANCF_MT31::EvaluateSectionPoint(const double u,
//                                             const double v,
//                                             ChVector<>& point) {
//    ChVector<> u_displ;
//
...
void ChElementBeamANCF_MT31::LoadableGetStateBlock_x(int block_offset, ChState& mD) {
...
void ChElementBeamANCF_MT31::LoadableGetStateBlock_w(int block_offset, ChStateDelta& mD) {
...
void ChElementBeamANCF_MT31::LoadableStateIncrement(const unsigned int off_x,
                                               ChState& x_new,
                                               const ChState& x,
...
//void ChElementBeamANCF_MT31::EvaluateSectionVelNorm(double U, ChVector<>& Result) {
//    ShapeVector N;
...
void ChElementBeamANCF_MT31::LoadableGetVariables(std::vector<ChVariables*>& mvars) {
...
void ChElementBeamANCF_MT31::ComputeNF(
...
double ChElementBeamANCF_MT31::GetDensity() {
    return GetMaterial()->Get_rho();
}

// Calculate tangent to the centerline at (U) coordinates.
ChVector<> ChElementBeamANCF_MT31::ComputeTangent(const double U) {
    ChMatrixNMc<double, 9, 3> e_bar;
    ChMatrixNMc<double, 9, 3> Sxi_D;
    ChVector<> r_xi;
...
ChQuadratureTables static_tables_MT31(1, CH_QUADRATURE_STATIC_TABLES);
//#endif // !CH_QUADRATURE_STATIC_TABLES

ChQuadratureTables* ChElementBeamANCF_MT31::GetStaticGQTables() {
    return &static_tables_MT31;
}

////////////////////////////////////////////////////////////////

// ============================================================================
// Implementation of ChMaterialBeamANCF_MT31 methods
// ============================================================================

// Construct an isotropic material.
ChMaterialBeamANCF_MT31::ChMaterialBeamANCF_MT31(double rho,        // material density
...
void ChMaterialBeamANCF_MT31::Calc_D0_Dv(const ChVector<>& E, const ChVector<>& nu, const ChVector<>& G, double k1, double k2) {
