...
#ifndef CHELEMENTSHELLANCF3443TR06_H
#define CHELEMENTSHELLANCF3443TR06_H
...
class ChApi ChMaterialShellANCF_3443_TR06 {
  public:
    /// Construct an isotropic material.
    ChMaterialShellANCF_3443_TR06(double rho,        ///< material density
...
class ChApi ChElementShellANCF_3443_TR06 : public ChElementShell, public ChLoadableUV, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialShellANCF_3443_TR06> shell_mat) { m_material = shell_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialShellANCF_3443_TR06> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialShellANCF_3443_TR06> m_material;  ///< shell material
