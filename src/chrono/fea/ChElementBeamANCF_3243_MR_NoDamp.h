...
#ifndef CHELEMENTBEAMANCF3243_MR_NODAMP_H
#define CHELEMENTBEAMANCF3243_MR_NODAMP_H
...
class ChApi ChElementBeamANCF_3243_MR_NoDamp : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    ChElementBeamANCF_3243_MR_NoDamp();
    ~ChElementBeamANCF_3243_MR_NoDamp() {}
