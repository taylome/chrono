...
#ifndef CHELEMENTBEAMANCFMT27B_H
#define CHELEMENTBEAMANCFMT27B_H
...
class ChApi ChMaterialBeamANCF_MT27B {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_MT27B(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_MT27B : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MT27B> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_MT27B> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_MT27B> m_material;    ///< beam material
