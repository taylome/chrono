...
// =============================================================================
#ifndef CHELEMENTBEAMANCFTR00_H
#define CHELEMENTBEAMANCFTR00_H
...
class ChApi ChMaterialBeamANCF_TR00 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_TR00(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_TR00 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    using ShapeVector = ChMatrixNM<double, 1, 9>;

    ChElementBeamANCF_TR00();
    ~ChElementBeamANCF_TR00() {}
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_TR00> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_TR00> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_TR00> m_material;         ///< beam material
    StrainFormulation m_strain_form;                        ///< Strain formulation

  public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW

    friend class BeamANCF_TR00_Mass;
    friend class BeamANCF_TR00_Gravity;
    friend class BeamANCF_TR00_Force;
    friend class BeamANCF_TR00_ForceNu;
    friend class BeamANCF_TR00_Jacobian;
    friend class BeamANCF_TR00_JacobianNu;
};
