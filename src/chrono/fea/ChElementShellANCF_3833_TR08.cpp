...
ChMatrix33<> ChElementShellANCF_3833_TR08::GetGreenLagrangeStrain(const double xi,
                                                                  const double eta,
                                                                  const double zeta) {
...
ChMatrix33<> ChElementShellANCF_3833_TR08::GetPK2Stress(const double layer,
                                                        const double xi,
                                                        const double eta,
...
void ChElementShellANCF_3833_TR08::ComputeGravityForces(ChVectorDynamic<>& Fg, const ChVector<>& G_acc) {
...
void ChElementShellANCF_3833_TR08::EvaluateSectionPoint(const double xi, const double eta, ChVector<>& point) {
    VectorN Sxi_compact;
    Calc_Sxi_compact(Sxi_compact, xi, eta, 0, m_thicknessZ, m_midsurfoffset);
...
void ChElementShellANCF_3833_TR08::EvaluateSectionVelNorm(const double xi, const double eta, ChVector<>& Result) {
    VectorN Sxi_compact;
    Calc_Sxi_compact(Sxi_compact, xi, eta, 0, m_thicknessZ, m_midsurfoffset);
...
ChVector<> ChElementShellANCF_3833_TR08::ComputeNormal(const double xi, const double eta) {
...
void ChElementShellANCF_3833_TR08::Calc_J_0xi(ChMatrix33<double>& J_0xi,
                                              double xi,
                                              double eta,
                                              double zeta,
                                              double thickness,
...
void ChElementShellANCF_3833_TR08::RotateReorderStiffnessMatrix(ChMatrixNM<double, 6, 6>& D, double theta) {
