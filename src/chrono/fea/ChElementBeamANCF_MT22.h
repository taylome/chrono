...
#ifndef CHELEMENTBEAMANCFMT22_H
#define CHELEMENTBEAMANCFMT22_H
...
class ChApi ChMaterialBeamANCF_MT22 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_MT22(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_MT22 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MT22> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_MT22> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_MT22> m_material;    ///< beam material
