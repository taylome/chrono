...
#ifndef CHELEMENTBEAMANCF3243_MR_DAMP_H
#define CHELEMENTBEAMANCF3243_MR_DAMP_H
...
class ChApi ChElementBeamANCF_3243_MR_Damp : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    ChElementBeamANCF_3243_MR_Damp();
    ~ChElementBeamANCF_3243_MR_Damp() {}
