...
#ifndef CHELEMENTBEAMANCFMT10_H
#define CHELEMENTBEAMANCFMT10_H
...
class ChApi ChMaterialBeamANCF_MT10 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_MT10(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_MT10 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    using ShapeVector = ChMatrixNM<double, 1, 9>;

    ChElementBeamANCF_MT10();
    ~ChElementBeamANCF_MT10() {}
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MT10> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_MT10> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    void ComputeInternalJacobianSingleGQPnt(ChMatrixNM<double, 27, 27>& Jac, double Kfactor, double Rfactor, unsigned int index, ChVectorN<double, 6>& D0, ChMatrixNM<double, 9, 3>& e_bar, ChMatrixNM<double, 9, 3>& e_bar_dot);
    ...
    void ComputeInternalJacobianSingleGQPnt(ChMatrixNM<double, 27, 27>& Jac, double Kfactor, double Rfactor, unsigned int index, ChMatrix33<double>& Dv, ChMatrixNM<double, 9, 3>& e_bar, ChMatrixNM<double, 9, 3>& e_bar_dot);
    ...
    void ComputeInternalForcesSingleGQPnt(ChMatrixNM<double, 9, 3>& QiCompact, unsigned int index, ChVectorN<double, 6>& D0, ChMatrixNM<double, 9, 3>& e_bar, ChMatrixNM<double, 9, 3>& e_bar_dot);
    ...
    void ComputeInternalForcesSingleGQPnt(ChMatrixNM<double, 9, 3>& QiCompact, unsigned int index, ChMatrix33<double>& Dv, ChMatrixNM<double, 9, 3>& e_bar, ChMatrixNM<double, 9, 3>& e_bar_dot);
    ...
    void ComputeInternalForcesSingleGQPnt(ChMatrixNM<double, 9, 3>& QiCompact, double xi, double eta, double zeta, ChMatrixNM<double, 6, 6>& D, ChMatrixNM<double, 9, 3>& e_bar, ChMatrixNM<double, 9, 3>& e_bar_dot);
    ...
    std::shared_ptr<ChMaterialBeamANCF_MT10> m_material;    ///< beam material
