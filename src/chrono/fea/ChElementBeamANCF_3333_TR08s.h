...
#ifndef CHELEMENTBEAMANCF3333TR08S_H
#define CHELEMENTBEAMANCF3333TR08S_H
...
class ChApi ChMaterialBeamANCF_3333_TR08S {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_3333_TR08S(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_3333_TR08S : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_3333_TR08S> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_3333_TR08S> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_3333_TR08S> m_material;  ///< beam material
