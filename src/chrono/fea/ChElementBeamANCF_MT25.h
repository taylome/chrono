...
#ifndef CHELEMENTBEAMANCFMT25_H
#define CHELEMENTBEAMANCFMT25_H
...
class ChApi ChMaterialBeamANCF_MT25 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_MT25(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_MT25 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MT25> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_MT25> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_MT25> m_material;    ///< beam material
