...
#ifndef CHELEMENTBRICKANCF3843TR08_H
#define CHELEMENTBRICKANCF3843TR08_H
...
/// This class implements material properties for an ANCF Brick.
    class ChApi ChMaterialBrickANCF_3843_TR08 {
    public:
        /// Construct an isotropic material.
        ChMaterialBrickANCF_3843_TR08(double rho,        ///< material density
...
class ChApi ChElementBrickANCF_3843_TR08 : public ChElementGeneric, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBrickANCF_3843_TR08> brick_mat) { m_material = brick_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBrickANCF_3843_TR08> GetMaterial() const { return m_material; }
...
public:
  ...
  private:
      ...
      std::shared_ptr<ChMaterialBrickANCF_3843_TR08> m_material;  ///< shell material
