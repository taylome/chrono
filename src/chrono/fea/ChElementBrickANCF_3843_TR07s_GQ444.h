...
#ifndef CHELEMENTBRICKANCF3843TR07SGQ444_H
#define CHELEMENTBRICKANCF3843TR07SGQ444_H
...
/// This class implements material properties for an ANCF Brick.
    class ChApi ChMaterialBrickANCF_3843_TR07S_GQ444 {
    public:
        /// Construct an isotropic material.
        ChMaterialBrickANCF_3843_TR07S_GQ444(double rho,        ///< material density
...
class ChApi ChElementBrickANCF_3843_TR07S_GQ444 : public ChElementGeneric, public ChLoadableUVW {
  public:
    ...
    ChElementBrickANCF_3843_TR07S_GQ444();
    ~ChElementBrickANCF_3843_TR07S_GQ444() {}
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBrickANCF_3843_TR07S_GQ444> brick_mat) { m_material = brick_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBrickANCF_3843_TR07S_GQ444> GetMaterial() const { return m_material; }
...
public:
  ...
  private:
      ...
      std::shared_ptr<ChMaterialBrickANCF_3843_TR07S_GQ444> m_material;  ///< shell material
