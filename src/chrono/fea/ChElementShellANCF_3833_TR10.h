...
#ifndef CHELEMENTSHELLANCF3833TR10_H
#define CHELEMENTSHELLANCF3833TR10_H
...
class ChApi ChMaterialShellANCF_3833_TR10 {
  public:
    /// Construct an isotropic material.
    ChMaterialShellANCF_3833_TR10(double rho,        ///< material density
...
class ChApi ChElementShellANCF_3833_TR10 : public ChElementShell, public ChLoadableUV, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialShellANCF_3833_TR10> shell_mat) { m_material = shell_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialShellANCF_3833_TR10> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialShellANCF_3833_TR10> m_material;  ///< shell material
