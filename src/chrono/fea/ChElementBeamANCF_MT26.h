...
#ifndef CHELEMENTBEAMANCFMT26_H
#define CHELEMENTBEAMANCFMT26_H
...
class ChApi ChMaterialBeamANCF_MT26 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_MT26(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_MT26 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MT26> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_MT26> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_MT26> m_material;    ///< beam material
