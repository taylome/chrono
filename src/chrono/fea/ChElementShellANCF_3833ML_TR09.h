...
#ifndef CHELEMENTSHELLANCF3833MLTR09_H
#define CHELEMENTSHELLANCF3833MLTR09_H
...
class ChApi ChMaterialShellANCF_3833ML_TR09 {
  public:
    /// Construct an isotropic material.
    ChMaterialShellANCF_3833ML_TR09(double rho,        ///< material density
...
class ChApi ChElementShellANCF_3833ML_TR09 : public ChElementShell, public ChLoadableUV, public ChLoadableUVW {
  public:
    ...
    ChElementShellANCF_3833ML_TR09();
    ~ChElementShellANCF_3833ML_TR09() {}
    ...
    public:
        ...
        std::shared_ptr<ChMaterialShellANCF_3833ML_TR09> GetMaterial() const { return m_material; }

    private:
        /// Private constructor (a layer can be created only by adding it to an element)
        Layer(ChElementShellANCF_3833ML_TR09* element,                 ///< containing element
            double thickness,                              ///< layer thickness
            double theta,                                  ///< fiber angle
            std::shared_ptr<ChMaterialShellANCF_3833ML_TR09> material  ///< layer material
        );

        ChElementShellANCF_3833ML_TR09* m_element;                  ///< containing ANCF shell element
        std::shared_ptr<ChMaterialShellANCF_3833ML_TR09> m_material;  ///< layer material
    ...
    public:
        ...
        friend class ChElementShellANCF_3833ML_TR09;
    };
