...
ChElementHexaANCF_3843_MR_V3::ChElementHexaANCF_3843_MR_V3()
...
void ChElementHexaANCF_3843_MR_V3::SetNodes(std::shared_ptr<ChNodeFEAxyzDDD> nodeA,
...
void ChElementHexaANCF_3843_MR_V3::SetDimensions(double lenX, double lenY, double lenZ) {
    m_lenX = lenX;
    m_lenY = lenY;
    m_lenZ = lenZ;
...
void ChElementHexaANCF_3843_MR_V3::SetMaterial(std::shared_ptr<ChMaterialHexaANCF_MR> brick_mat) {
...
ChMatrix33<> ChElementHexaANCF_3843_MR_V3::GetGreenLagrangeStrain(const double xi, const double eta, const double zeta) {
...
ChMatrix33<> ChElementHexaANCF_3843_MR_V3::GetPK2Stress(const double xi, const double eta, const double zeta) {
    MatrixNx3c Sxi_D;  // Matrix of normalized shape function derivatives
    Calc_Sxi_D(Sxi_D, xi, eta, zeta);
...
double ChElementHexaANCF_3843_MR_V3::GetVonMissesStress(const double xi, const double eta, const double zeta) {
    MatrixNx3c Sxi_D;  // Matrix of normalized shape function derivatives
    Calc_Sxi_D(Sxi_D, xi, eta, zeta);
...
void ChElementHexaANCF_3843_MR_V3::SetupInitial(ChSystem* system) {
...
void ChElementHexaANCF_3843_MR_V3::GetStateBlock(ChVectorDynamic<>& mD) {
...
void ChElementHexaANCF_3843_MR_V3::Update() {
    ChElementGeneric::Update();
}

// Return the mass matrix in full sparse form.

void ChElementHexaANCF_3843_MR_V3::ComputeMmatrixGlobal(ChMatrixRef M) {
    M.setZero();
...
void ChElementHexaANCF_3843_MR_V3::ComputeNodalMass() {
...
void ChElementHexaANCF_3843_MR_V3::ComputeInternalForces(ChVectorDynamic<>& Fi) {
...
void ChElementHexaANCF_3843_MR_V3::ComputeKRMmatricesGlobal(ChMatrixRef H, double Kfactor, double Rfactor, double Mfactor) {
...
// m_strainANS and m_strainANS_D (as calculated in ComputeInternalForces).
    ...
    //for (unsigned int i = 0; i < NSF; i++) {
    //    for (unsigned int j = 0; j < NSF; j++) {
    //        H(3 * i, 3 * j) += JacCompact(i, j);
    //        H(3 * i, 3 * j + 1) += FC(i, j);
    //        H(3 * i, 3 * j + 2) -= FB(i, j);

    //        H(3 * i + 1, 3 * j) -= FC(i, j);
    //        H(3 * i + 1, 3 * j + 1) += JacCompact(i, j);
    //        H(3 * i + 1, 3 * j + 2) += FA(i, j);

    //        H(3 * i + 2, 3 * j) += FB(i, j);
    //        H(3 * i + 2, 3 * j + 1) -= FA(i, j);
    //        H(3 * i + 2, 3 * j + 2) += JacCompact(i, j);
    //    }
    //}
...
void ChElementHexaANCF_3843_MR_V3::ComputeGravityForces(ChVectorDynamic<>& Fg, const ChVector<>& G_acc) {
...
void ChElementHexaANCF_3843_MR_V3::EvaluateElementFrame(const double xi,
                                                  const double eta,
                                                  const double zeta,
                                                  ChVector<>& point,
                                                  ChQuaternion<>& rot) {
...
void ChElementHexaANCF_3843_MR_V3::EvaluateElementPoint(const double xi,
                                                  const double eta,
                                                  const double zeta,
                                                  ChVector<>& point) {
    VectorN Sxi_compact;
...
void ChElementHexaANCF_3843_MR_V3::EvaluateElementVel(double xi, double eta, const double zeta, ChVector<>& Result) {
    VectorN Sxi_compact;
    Calc_Sxi_compact(Sxi_compact, xi, eta, zeta);
...
void ChElementHexaANCF_3843_MR_V3::LoadableGetStateBlock_x(int block_offset, ChState& mD) {
...
void ChElementHexaANCF_3843_MR_V3::LoadableGetStateBlock_w(int block_offset, ChStateDelta& mD) {
...
void ChElementHexaANCF_3843_MR_V3::LoadableStateIncrement(const unsigned int off_x,
                                                    ChState& x_new,
                                                    const ChState& x,
...
void ChElementHexaANCF_3843_MR_V3::LoadableGetVariables(std::vector<ChVariables*>& mvars) {
...
void ChElementHexaANCF_3843_MR_V3::ComputeNF(
...
double ChElementHexaANCF_3843_MR_V3::GetDensity() {
...
void ChElementHexaANCF_3843_MR_V3::ComputeMassMatrixAndGravityForce() {
...
void ChElementHexaANCF_3843_MR_V3::PrecomputeInternalForceMatricesWeights() {
    ChQuadratureTables* GQTable = GetStaticGQTables();
...
void ChElementHexaANCF_3843_MR_V3::Calc_Sxi_compact(VectorN& Sxi_compact, double xi, double eta, double zeta) {
    Sxi_compact(0) =
...
void ChElementHexaANCF_3843_MR_V3::Calc_Sxi_xi_compact(VectorN& Sxi_xi_compact, double xi, double eta, double zeta) {
...
void ChElementHexaANCF_3843_MR_V3::Calc_Sxi_eta_compact(VectorN& Sxi_eta_compact, double xi, double eta, double zeta) {
...
void ChElementHexaANCF_3843_MR_V3::Calc_Sxi_zeta_compact(VectorN& Sxi_zeta_compact, double xi, double eta, double zeta) {
...
void ChElementHexaANCF_3843_MR_V3::Calc_Sxi_D(MatrixNx3c& Sxi_D, double xi, double eta, double zeta) {
    VectorN Sxi_D_col;
...
void ChElementHexaANCF_3843_MR_V3::CalcCoordVector(Vector3N& e) {
...
void ChElementHexaANCF_3843_MR_V3::CalcCoordMatrix(Matrix3xN& ebar) {
...
void ChElementHexaANCF_3843_MR_V3::CalcCoordDerivVector(Vector3N& edot) {
...
void ChElementHexaANCF_3843_MR_V3::CalcCoordDerivMatrix(Matrix3xN& ebardot) {
...
void ChElementHexaANCF_3843_MR_V3::CalcCombinedCoordMatrix(MatrixNx6& ebar_ebardot) {
...
void ChElementHexaANCF_3843_MR_V3::Calc_J_0xi(ChMatrix33<double>& J_0xi, double xi, double eta, double zeta) {
    MatrixNx3c Sxi_D;
    Calc_Sxi_D(Sxi_D, xi, eta, zeta);
...
double ChElementHexaANCF_3843_MR_V3::Calc_det_J_0xi(double xi, double eta, double zeta) {
...
ChQuadratureTables static_tables_3843_MR_V3(1, CH_QUADRATURE_STATIC_TABLES);
//#endif // !CH_QUADRATURE_STATIC_TABLES

ChQuadratureTables* ChElementHexaANCF_3843_MR_V3::GetStaticGQTables() {
    return &static_tables_3843_MR_V3;
}
