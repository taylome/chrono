...
ChMatrix33d ChElementShellANCF_3443_MR_DampNumJac::GetGreenLagrangeStrain(const double xi,
                                                                  const double eta,
                                                                  const double zeta) {
...
ChMatrix33d ChElementShellANCF_3443_MR_DampNumJac::GetPK2Stress(const double layer,
                                                        const double xi,
                                                        const double eta,
...
void ChElementShellANCF_3443_MR_DampNumJac::ComputeGravityForces(ChVectorDynamic<>& Fg, const ChVector3d& G_acc) {
...
void ChElementShellANCF_3443_MR_DampNumJac::EvaluateSectionPoint(const double xi, const double eta, ChVector3d& point) {
    VectorN Sxi_compact;
    Calc_Sxi_compact(Sxi_compact, xi, eta, 0, m_thicknessZ, m_midsurfoffset);
...
void ChElementShellANCF_3443_MR_DampNumJac::EvaluateSectionVelNorm(const double xi, const double eta, ChVector3d& Result) {
    VectorN Sxi_compact;
    Calc_Sxi_compact(Sxi_compact, xi, eta, 0, m_thicknessZ, m_midsurfoffset);
...
void ChElementShellANCF_3443_MR_DampNumJac::LoadableGetStateBlockPosLevel(int block_offset, ChState& mD) {
...
void ChElementShellANCF_3443_MR_DampNumJac::LoadableGetStateBlockVelLevel(int block_offset, ChStateDelta& mD) {
...
ChVector3d ChElementShellANCF_3443_MR_DampNumJac::ComputeNormal(const double xi, const double eta) {
...
void ChElementShellANCF_3443_MR_DampNumJac::CalcCoordDtVector(Vector3N& edot) {
...
void ChElementShellANCF_3443_MR_DampNumJac::CalcCoordDtMatrix(Matrix3xN& ebardot) {
...
void ChElementShellANCF_3443_MR_DampNumJac::Calc_J_0xi(ChMatrix33d& J_0xi,
                                              double xi,
                                              double eta,
                                              double zeta,
                                              double thickness,
...
void ChElementShellANCF_3443_MR_DampNumJac::RotateReorderStiffnessMatrix(ChMatrix66d& D, double theta) {
