...
#ifndef CHELEMENTBEAMANCF3333TR04GQ322_H
#define CHELEMENTBEAMANCF3333TR04GQ322_H
...
class ChApi ChMaterialBeamANCF_3333_TR04_GQ322 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_3333_TR04_GQ322(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_3333_TR04_GQ322 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    ChElementBeamANCF_3333_TR04_GQ322();
    ~ChElementBeamANCF_3333_TR04_GQ322() {}
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_3333_TR04_GQ322> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_3333_TR04_GQ322> GetMaterial() const { return m_material; }
  ...
  public:
    ...
    /// and the rotation RxRyRz of section plane, at abscissa 'xi'.
  ...
  private:
    ...
    void ComputeInternalForcesSingleGQPnt(ChVectorN<double, 27>& Qi,
                                          double xi,
                                          double eta,
                                          double zeta,
    ...
    std::shared_ptr<ChMaterialBeamANCF_3333_TR04_GQ322> m_material;    ///< beam material
