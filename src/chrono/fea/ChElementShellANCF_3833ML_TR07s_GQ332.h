...
#ifndef CHELEMENTSHELLANCF3833MLTR07SGQ332_H
#define CHELEMENTSHELLANCF3833MLTR07SGQ332_H
...
class ChApi ChMaterialShellANCF_3833ML_TR07S_GQ332 {
  public:
    /// Construct an isotropic material.
    ChMaterialShellANCF_3833ML_TR07S_GQ332(double rho,        ///< material density
...
class ChApi ChElementShellANCF_3833ML_TR07S_GQ332 : public ChElementShell, public ChLoadableUV, public ChLoadableUVW {
  public:
    ...
    using VectorNIP = ChVectorN<double, 18>;
    ...
    ChElementShellANCF_3833ML_TR07S_GQ332();
    ~ChElementShellANCF_3833ML_TR07S_GQ332() {}
    ...
    public:
        ...
        std::shared_ptr<ChMaterialShellANCF_3833ML_TR07S_GQ332> GetMaterial() const { return m_material; }

    private:
        /// Private constructor (a layer can be created only by adding it to an element)
        Layer(ChElementShellANCF_3833ML_TR07S_GQ332* element,                 ///< containing element
            double thickness,                              ///< layer thickness
            double theta,                                  ///< fiber angle
            std::shared_ptr<ChMaterialShellANCF_3833ML_TR07S_GQ332> material  ///< layer material
        );

        ChElementShellANCF_3833ML_TR07S_GQ332* m_element;                  ///< containing ANCF shell element
        std::shared_ptr<ChMaterialShellANCF_3833ML_TR07S_GQ332> m_material;  ///< layer material
    ...
    public:
        ...
        friend class ChElementShellANCF_3833ML_TR07S_GQ332;
    };
  ...
  private:
    ...
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::ColMajor> m_SPK2_0_Block;  ///< Cached calculation for the 2nd PK2 Stresses - 1st Entry in Voigt
                                              ///< Notation for all the GQ Points for no Poisson Effect
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::ColMajor> m_SPK2_1_Block;  ///< Cached calculation for the 2nd PK2 Stresses - 2nd Entry in Voigt
                                              ///< Notation for all the GQ Points for no Poisson Effect
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::ColMajor> m_SPK2_2_Block;  ///< Cached calculation for the 2nd PK2 Stresses - 3rd Entry in Voigt
                                              ///< Notation for all the GQ Points for no Poisson Effect
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::ColMajor> m_SPK2_3_Block;  ///< Cached calculation for the 2nd PK2 Stresses - 4th Entry in Voigt
                                              ///< Notation for all the GQ Points for no Poisson Effect
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::ColMajor> m_SPK2_4_Block;  ///< Cached calculation for the 2nd PK2 Stresses - 5th Entry in Voigt
                                              ///< Notation for all the GQ Points for no Poisson Effect
    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::ColMajor> m_SPK2_5_Block;  ///< Cached calculation for the 2nd PK2 Stresses - 6th Entry in Voigt
                                              ///< Notation for all the GQ Points for no Poisson Effect
    ChVectorN<double, 300> m_MassMatrix; ///Mass Matrix in extra compact form (Upper Triangular Part only)
