...
ChElementShellANCF_3443ML_TR04::ChElementShellANCF_3443ML_TR04()
...
void ChElementShellANCF_3443ML_TR04::SetNodes(std::shared_ptr<ChNodeFEAxyzDDD> nodeA,
...
void ChElementShellANCF_3443ML_TR04::AddLayer(double thickness, double theta, std::shared_ptr<ChMaterialShellANCF_3443ML_TR04> material) {
...
void ChElementShellANCF_3443ML_TR04::SetupInitial(ChSystem* system) {
...
// State update.
void ChElementShellANCF_3443ML_TR04::Update() {
    ChElementGeneric::Update();
}

// Fill the D vector with the current field values at the element nodes.
void ChElementShellANCF_3443ML_TR04::GetStateBlock(ChVectorDynamic<>& mD) {
...
void ChElementShellANCF_3443ML_TR04::ComputeKRMmatricesGlobal(ChMatrixRef H,
                                                           double Kfactor,
                                                           double Rfactor,
                                                           double Mfactor) {
...
void ChElementShellANCF_3443ML_TR04::ComputeMmatrixGlobal(ChMatrixRef M) {
    M = m_MassMatrix;
}
...
// -----------------------------------------------------------------------------
void ChElementShellANCF_3443ML_TR04::ComputeMassMatrixAndGravityForce(const ChVector<>& g_acc) {
...
void ChElementShellANCF_3443ML_TR04::ComputeNodalMass() {
...
void ChElementShellANCF_3443ML_TR04::SetAlphaDamp(double a) {
    m_Alpha = a;
...
void ChElementShellANCF_3443ML_TR04::ComputeInternalForces(ChVectorDynamic<>& Fi) {
...
void ChElementShellANCF_3443ML_TR04::ComputeInternalForcesAtState(ChVectorDynamic<>& Fi,
...
void ChElementShellANCF_3443ML_TR04::ComputeInternalForcesSingleGQPnt(Vector3N& Qi,
                                                                   double xi,
                                                                   double eta,
                                                                   double zeta,
                                                                   double thickness,
...
void ChElementShellANCF_3443ML_TR04::ComputeInternalJacobians(Matrix3Nx3N& JacobianMatrix,
                                                           double Kfactor,
                                                           double Rfactor) {
...
void ChElementShellANCF_3443ML_TR04::Calc_Sxi(Matrix3x3N& Sxi, double xi, double eta, double zeta, double thickness, double zoffset) {
    VectorN Sxi_compact;
...
// [s1; s2; s3; ...]
void ChElementShellANCF_3443ML_TR04::Calc_Sxi_compact(VectorN& Sxi_compact, double xi, double eta, double zeta, double thickness, double zoffset) {
...
// [s1*I_3x3, s2*I_3x3, s3*I_3x3, ...]
void ChElementShellANCF_3443ML_TR04::Calc_Sxi_xi(Matrix3x3N& Sxi_xi, double xi, double eta, double zeta, double thickness, double zoffset) {
...
// [s1; s2; s3; ...]
void ChElementShellANCF_3443ML_TR04::Calc_Sxi_xi_compact(VectorN& Sxi_xi_compact, double xi, double eta, double zeta, double thickness, double zoffset) {
...
// [s1*I_3x3, s2*I_3x3, s3*I_3x3, ...]
void ChElementShellANCF_3443ML_TR04::Calc_Sxi_eta(Matrix3x3N& Sxi_eta, double xi, double eta, double zeta, double thickness, double zoffset) {
...
// [s1; s2; s3; ...]
void ChElementShellANCF_3443ML_TR04::Calc_Sxi_eta_compact(VectorN& Sxi_eta_compact, double xi, double eta, double zeta, double thickness, double zoffset) {
...
// [s1*I_3x3, s2*I_3x3, s3*I_3x3, ...]
void ChElementShellANCF_3443ML_TR04::Calc_Sxi_zeta(Matrix3x3N& Sxi_zeta, double xi, double eta, double zeta, double thickness, double zoffset) {
...
// [s1; s2; s3; ...]
void ChElementShellANCF_3443ML_TR04::Calc_Sxi_zeta_compact(VectorN& Sxi_zeta_compact, double xi, double eta, double zeta, double thickness, double zoffset) {
...
void ChElementShellANCF_3443ML_TR04::Calc_Sxi_D(MatrixNx3c& Sxi_D, double xi, double eta, double zeta, double thickness, double zoffset) {
...
void ChElementShellANCF_3443ML_TR04::CalcCoordVector(Vector3N& e) {
...
void ChElementShellANCF_3443ML_TR04::CalcCoordMatrix(Matrix3xN& ebar) {
...
void ChElementShellANCF_3443ML_TR04::CalcCoordDerivVector(Vector3N& edot) {
...
void ChElementShellANCF_3443ML_TR04::CalcCoordDerivMatrix(Matrix3xN& ebardot) {
...
void ChElementShellANCF_3443ML_TR04::Calc_J_0xi(ChMatrix33<double>& J_0xi, double xi, double eta, double zeta, double thickness, double zoffset) {
    MatrixNx3c Sxi_D;
...
double ChElementShellANCF_3443ML_TR04::Calc_det_J_0xi(double xi, double eta, double zeta, double thickness, double zoffset) {
...
void ChElementShellANCF_3443ML_TR04::EvaluateSectionFrame(const double xi, const double eta, ChVector<>& point, ChQuaternion<>& rot) {
    Matrix3x3N Sxi;
    Matrix3x3N Sxi_xi;
    Matrix3x3N Sxi_eta;
...
void ChElementShellANCF_3443ML_TR04::EvaluateSectionPoint(const double u, const double v, ChVector<>& point) {
    Matrix3x3N Sxi;
...
void ChElementShellANCF_3443ML_TR04::EvaluateSectionVelNorm(double U, double V, ChVector<>& Result) {
    Matrix3x3N Sxi_zeta;
    Vector3N edot;
    ChVector<> r_zeta;
...
void ChElementShellANCF_3443ML_TR04::LoadableGetStateBlock_x(int block_offset, ChState& mD) {
...
void ChElementShellANCF_3443ML_TR04::LoadableGetStateBlock_w(int block_offset, ChStateDelta& mD) {
...
void ChElementShellANCF_3443ML_TR04::LoadableStateIncrement(const unsigned int off_x,
                                                         ChState& x_new,
                                                         const ChState& x,
...
void ChElementShellANCF_3443ML_TR04::LoadableGetVariables(std::vector<ChVariables*>& mvars) {
...
void ChElementShellANCF_3443ML_TR04::ComputeNF(
...
double ChElementShellANCF_3443ML_TR04::GetDensity() {
...
ChVector<> ChElementShellANCF_3443ML_TR04::ComputeNormal(const double U, const double V) {
    Matrix3x3N Sxi_zeta;
    Vector3N e;
    ChVector<> r_zeta;
...
ChQuadratureTables static_tables_3443ML_TR04(1, CH_QUADRATURE_STATIC_TABLES);
//#endif // !CH_QUADRATURE_STATIC_TABLES

ChQuadratureTables* ChElementShellANCF_3443ML_TR04::GetStaticGQTables() {
    return &static_tables_3443ML_TR04;
}

////////////////////////////////////////////////////////////////

// ============================================================================
// Implementation of ChElementShellANCF_3443ML_TR04::Layer methods
// ============================================================================

// Private constructor (a layer can be created only by adding it to an element)
ChElementShellANCF_3443ML_TR04::Layer::Layer(ChElementShellANCF_3443ML_TR04* element,
    double thickness,
    double theta,
    std::shared_ptr<ChMaterialShellANCF_3443ML_TR04> material)
    : m_element(element), m_thickness(thickness), m_theta(theta), m_material(material) {}

////////////////////////////////////////////////////////////////

// ============================================================================
// Implementation of ChMaterialShellANCF_3443ML_TR04 methods
// ============================================================================

// Construct an isotropic material.
ChMaterialShellANCF_3443ML_TR04::ChMaterialShellANCF_3443ML_TR04(
...
// Poisson effect
void ChMaterialShellANCF_3443ML_TR04::Calc_D0_Dv(const ChVector<>& E,
                                              const ChVector<>& nu,
                                              const ChVector<>& G) {
...
void ChMaterialShellANCF_3443ML_TR04::Get_Rotated_D(ChMatrixNM<double, 6, 6>& D, double theta) {
