...
#ifndef CHELEMENTBEAMANCFMT27_H
#define CHELEMENTBEAMANCFMT27_H
...
class ChApi ChMaterialBeamANCF_MT27 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_MT27(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_MT27 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MT27> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_MT27> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    std::shared_ptr<ChMaterialBeamANCF_MT27> m_material;    ///< beam material
