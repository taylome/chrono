...
#ifndef CHELEMENTBEAMANCFMT15_H
#define CHELEMENTBEAMANCFMT15_H
...
class ChApi ChMaterialBeamANCF_MT15 {
  public:
    /// Construct an isotropic material.
    ChMaterialBeamANCF_MT15(double rho,        ///< material density
...
class ChApi ChElementBeamANCF_MT15 : public ChElementBeam, public ChLoadableU, public ChLoadableUVW {
  public:
    ...
    void SetMaterial(std::shared_ptr<ChMaterialBeamANCF_MT15> beam_mat) { m_material = beam_mat; }
    ...
    /// Return the material.
    std::shared_ptr<ChMaterialBeamANCF_MT15> GetMaterial() const { return m_material; }
  ...
  private:
    ...
    void ComputeInternalForcesSingleGQPnt(ChVectorN<double, 27>& Qi, unsigned int index, ChVectorN<double, 6>& D0, ChMatrixNMc<double, 9, 3>& e_bar, ChMatrixNMc<double, 9, 3>& e_bar_dot);
    ...
    void ComputeInternalForcesSingleGQPnt(ChVectorN<double, 27>& Qi, unsigned int index, ChMatrix33<double>& Dv, ChMatrixNMc<double, 9, 3>& e_bar, ChMatrixNMc<double, 9, 3>& e_bar_dot);
    ...
    void ComputeInternalForcesSingleGQPnt(ChVectorN<double, 27>& Qi, double xi, double eta, double zeta, ChMatrixNM<double, 6, 6>& D, ChMatrixNMc<double, 9, 3>& e_bar, ChMatrixNMc<double, 9, 3>& e_bar_dot);
    ...
    std::shared_ptr<ChMaterialBeamANCF_MT15> m_material;    ///< beam material
