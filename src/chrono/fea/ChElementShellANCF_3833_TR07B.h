...
#ifndef CHELEMENTSHELLANCF3833_TR07B_H
#define CHELEMENTSHELLANCF3833_TR07B_H
...
class ChApi ChElementShellANCF_3833_TR07B : public ChElementShell, public ChLoadableUV, public ChLoadableUVW {
  public:
    ...
    class Layer {
      ...
      public:
        ...
        friend class ChElementShellANCF_3833_TR07B;
    };
  ...
  private:
    ...
    Eigen::Array<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>
        m_SPK2_1;  ///< Cached calculation for the 2nd PK2 Stresses - 1st Entry in Voigt Notation
    Eigen::Array<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>
        m_SPK2_2;  ///< Cached calculation for the 2nd PK2 Stresses - 2nd Entry in Voigt Notation
    Eigen::Array<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>
        m_SPK2_3;  ///< Cached calculation for the 2nd PK2 Stresses - 3rd Entry in Voigt Notation
    Eigen::Array<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>
        m_SPK2_4;  ///< Cached calculation for the 2nd PK2 Stresses - 4th Entry in Voigt Notation
    Eigen::Array<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>
        m_SPK2_5;  ///< Cached calculation for the 2nd PK2 Stresses - 5th Entry in Voigt Notation
    Eigen::Array<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>
        m_SPK2_6;  ///< Cached calculation for the 2nd PK2 Stresses - 6th Entry in Voigt Notation
